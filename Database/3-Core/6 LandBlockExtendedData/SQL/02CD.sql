...
VALUES (1881985035,  7934, 46989697, 108.075, -83.6721, -18.063, 0.9210611, 0, 0, -0.3894181, False); /* Golem Sanctum Portal */
/* @teleloc 0x02CD0181 [108.075000 -83.672100 -18.063000] 0.921061 0.000000 0.000000 -0.389418 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985037,  1302, 46989760, 20, -48, -6, 0, 0, 0, -1, False); /* Door */
/* @teleloc 0x02CD01C0 [20.000000 -48.000000 -6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985040,  8198, 46989832, 19.9039, -17.6644, -0.06299996, -4.37114E-08, 0, 0, -1, False); /* The Floating City */
/* @teleloc 0x02CD0208 [19.903900 -17.664400 -0.063000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985041,   568, 46989857, 50, -14.75, -3.72529E-09, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x02CD0221 [50.000000 -14.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985044,   278, 46989910, 40, -5.25, 6, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0x02CD0256 [40.000000 -5.250000 6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985048,   174, 46989930, 70, -40, 6, 1, 0, 0, 0, False); /* Well */
/* @teleloc 0x02CD026A [70.000000 -40.000000 6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881985051,  8192, 46989952, 23, -20, 11.937, 0.7071068, 0, 0, -0.7071068, False); /* The Floating City */
