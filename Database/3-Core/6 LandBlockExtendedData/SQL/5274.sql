...
VALUES (1965506560, 14502, 1383334145, -3.30366, -89.986, -48.063, 0.714421, 0, 0, 0.699716, False); /* Lower Empyrean Lightning Cistern */
/* @teleloc 0x52740101 [-3.303660 -89.986000 -48.063000] 0.714421 0.000000 0.000000 0.699716 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1965506570, 14501, 1383334155, 32.6071, -89.9579, -48.063, 0.6949892, 0, 0, -0.7190202, False); /* Upper Empyrean Lightning Cistern */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1965506593, 14491, 1383334220, 27.8468, -12.2197, -0.06299996, 0.3551371, 0, 0, 0.9348142, False); /* Surface */
/* @teleloc 0x5274014C [27.846800 -12.219700 -0.063000] 0.355137 0.000000 0.000000 0.934814 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1965506594,  5625, 1383334236, 45.1955, -9.87768, -9.313226E-10, -0.684709, 0, 0, 0.728817, False); /* Door */
/* @teleloc 0x5274015C [45.195500 -9.877680 0.000000] -0.684709 0.000000 0.000000 0.728817 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1965506599, 14537, 1383334173, 2.25, -60, -36, -0.7071068, 0, 0, -0.7071068, False); /* Chest */
