...
VALUES (1880236032,   143, 19005696, -4.05, -27.1675, 0, -0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x01220100 [-4.050000 -27.167500 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236033,   278, 19005698, 4.75, -30, -3.72529E-09, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01220102 [4.750000 -30.000000 0.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236034,  4980, 19005700, 10, -30, 0.05, -0.7071068, 0, 0, -0.7071068, False); /* Refreshing Fountain */
/* @teleloc 0x01220104 [10.000000 -30.000000 0.050000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236035,   278, 19005707, 30, -4.75, -3.72529E-09, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x0122010B [30.000000 -4.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236036,  4979, 19005718, 62.1713, -29.7508, 0, 0.707107, 0, 0, -0.707107, False); /* Sewer */
/* @teleloc 0x01220116 [62.171300 -29.750800 0.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236037,   278, 19005720, 55.25, -30, -3.72529E-09, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01220118 [55.250000 -30.000000 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236038, 42815, 19005734, 30, -63.132, 5.937, 0, 0, 0, -1, False); /* Eastham Portal */
/* @teleloc 0x01220126 [30.000000 -63.132000 5.937000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236039,   568, 19005736, 25.25, -60, 6, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01220128 [25.250000 -60.000000 6.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880236040,   568, 19005737, 34.75, -60, 6, 0.707107, 0, 0, -0.707107, False); /* Door */
