...
VALUES (2074730496,   412, 3130916866, 8.11745, 32.3556, 54.082, 0.9177113, 0, 0, -0.3972481, False); /* Door */
/* @teleloc 0xBA9E0002 [8.117450 32.355600 54.082000] 0.917711 0.000000 0.000000 -0.397248 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2074730497,   412, 3130916866, 14.0508, 32.0618, 54.082, 0.9298167, 0, 0, 0.3680229, False); /* Door */
/* @teleloc 0xBA9E0002 [14.050800 32.061800 54.082000] 0.929817 0.000000 0.000000 0.368023 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2074730498,   412, 3130916882, 57.3292, 42.8662, 54.082, 0.3757201, 0, 0, -0.9267332, False); /* Door */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2074730506, 12304, 3130916882, 52.2586, 41.961, 54, -0.37948, 0, 0, -0.9252, False); /* Agent of the Arcanum  */
