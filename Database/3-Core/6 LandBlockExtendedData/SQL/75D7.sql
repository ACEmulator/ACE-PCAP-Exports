...
VALUES (0x775D7003,  1020, 0x75D70015, 62.5241, 101.819, 429.3656, -0.986944, 0, 0, -0.161066, False, '2019-02-10 00:00:00'); /* Destroyed Portal to Holtburg */
/* @teleloc 0x75D70015 [62.524100 101.819000 429.365600] -0.986944 0.000000 0.000000 -0.161066 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x775D7004, 22870, 0x75D7000D, 35.5979, 116.563, 381.6624, -0.999998, 0, 0, -0.001842, False, '2019-02-10 00:00:00'); /* Crystal Mine Low */
/* @teleloc 0x75D7000D [35.597900 116.563000 381.662400] -0.999998 0.000000 0.000000 -0.001842 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x775D7005, 22871, 0x75D7001D, 88.8858, 113.703, 414.3214, 0.927069, 0, 0, -0.37489, False, '2019-02-10 00:00:00'); /* Crystal Mine New Isparians */
/* @teleloc 0x75D7001D [88.885800 113.703000 414.321400] 0.927069 0.000000 0.000000 -0.374890 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x775D7006, 22872, 0x75D70016, 68.1837, 132.295, 356.3954, 0.701169, 0, 0, -0.712995, False, '2019-02-10 00:00:00'); /* Crystal Mine Mid */
/* @teleloc 0x75D70016 [68.183700 132.295000 356.395400] 0.701169 0.000000 0.000000 -0.712995 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x775D7007, 22868, 0x75D70014, 59.5308, 92.6392, 308.8344, 0.99991, 0, 0, 0.013406, False, '2019-02-10 00:00:00'); /* Crystal Mine Extreme */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x775D7009, 22866, 0x75D70005, 8.62307, 103.312, 235.2184, -0.728768, 0, 0, 0.684761, False, '2019-02-10 00:00:00'); /* Access to Crystal Mines */
