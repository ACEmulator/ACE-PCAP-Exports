...
VALUES (1879146501, 30287, 1573145, 80, -164, -6, 0, 0, 0, -1, False); /* Door */
/* @teleloc 0x00180119 [80.000000 -164.000000 -6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879146515, 30287, 1573208, 100, -196, -6, 0, 0, 0, -1, False); /* Door */
/* @teleloc 0x00180158 [100.000000 -196.000000 -6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879146534, 29434, 1573318, 90, -3, -0.06299996, 1, 0, 0, 0, False); /* Exit Copper Legion Keep */
/* @teleloc 0x001801C6 [90.000000 -3.000000 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879146536,  7323, 1573328, 86, -124.895, 1.5, 0, 0, 0, -1, False); /* Torch */
/* @teleloc 0x001801D0 [86.000000 -124.895000 1.500000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879146553,  2609, 1573434, 130, -213, 0.074, -4.37114E-08, 0, 0, -1, False); /* Lever */
