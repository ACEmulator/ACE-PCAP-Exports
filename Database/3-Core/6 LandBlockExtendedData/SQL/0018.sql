...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70018026, 29434, 0x001801C6, 90, -3, -0.063, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Exit Copper Legion Keep */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70018039,  2609, 0x0018023A, 130, -213, 0.074, 0, 0, 0, -1, False, '2019-02-10 00:00:00'); /* Lever */
