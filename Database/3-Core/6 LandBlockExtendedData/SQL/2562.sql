...
VALUES (1918246914,  1298, 627179540, 66.7459, 84, 20, -0.708352, 0, 0, -0.705859, False); /* Door */
/* @teleloc 0x25620014 [66.745900 84.000000 20.000000] -0.708352 0.000000 0.000000 -0.705859 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1918246927,  1916, 627179780, 159.396, 132.85, 20, 0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x25620104 [159.396000 132.850000 20.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1918246928,  1918, 627179780, 159.415, 131.485, 20, 0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x25620104 [159.415000 131.485000 20.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1918246938,  1925, 627179565, 135.37, 109.602, 35.2, 0.6702712, 0, 0, -0.7421162, False); /* Chest */
/* @teleloc 0x2562002D [135.370000 109.602000 35.200000] 0.670271 0.000000 0.000000 -0.742116 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1918246944,  1936, 627179565, 129.566, 111.334, 35.2, 1, 0, 0, 0, False); /* Chest */
/* @teleloc 0x2562002D [129.566000 111.334000 35.200000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1918246949,  1931, 627179574, 159.235, 133.432, 35.2, 0.6654042, 0, 0, -0.7464833, False); /* Chest */
