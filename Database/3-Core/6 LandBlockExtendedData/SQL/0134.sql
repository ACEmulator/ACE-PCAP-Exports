...
VALUES (1880309760,   143, 20185344, -4.05, -27.1675, 0, -0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x01340100 [-4.050000 -27.167500 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309761,   278, 20185346, 4.74999, -30, 1.862645E-09, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01340102 [4.749990 -30.000000 0.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309762,  4980, 20185348, 10, -30, 0.05, -0.7071068, 0, 0, -0.7071068, False); /* Refreshing Fountain */
/* @teleloc 0x01340104 [10.000000 -30.000000 0.050000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309763,   278, 20185355, 30, -4.75, 1.862645E-09, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x0134010B [30.000000 -4.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309764,  4979, 20185366, 62.1713, -29.7508, 0, 0.707107, 0, 0, -0.707107, False); /* Sewer */
/* @teleloc 0x01340116 [62.171300 -29.750800 0.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309765,   278, 20185368, 55.25, -30, 1.862645E-09, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01340118 [55.250000 -30.000000 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309766, 42824, 20185382, 30, -63.132, 5.937, 0, 0, 0, -1, False); /* Portal to Yaraq */
/* @teleloc 0x01340126 [30.000000 -63.132000 5.937000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309767,   568, 20185384, 25.25, -60, 6, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01340128 [25.250000 -60.000000 6.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880309768,   568, 20185385, 34.75, -60, 6, 0.707107, 0, 0, -0.707107, False); /* Door */
