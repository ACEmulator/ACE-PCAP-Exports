...
VALUES (1971654764,  5625, 1481704100, 12, -70, 63.005, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x585102A4 [12.000000 -70.000000 63.005000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654765,  5625, 1481704103, 12, -80, 63.005, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x585102A7 [12.000000 -80.000000 63.005000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654780,   611, 1481704311, 79.949, -16.77, 72, 1, 0, 0, 0, False); /* Chest */
/* @teleloc 0x58510377 [79.949000 -16.770000 72.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654781,   611, 1481704311, 77.8516, -16.7724, 72, 0.999542, 0, 0, -0.030263, False); /* Chest */
/* @teleloc 0x58510377 [77.851600 -16.772400 72.000000] 0.999542 0.000000 0.000000 -0.030263 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654782,   611, 1481704311, 82.2143, -17.0368, 72, 0.999542, 0, 0, -0.030263, False); /* Chest */
/* @teleloc 0x58510377 [82.214300 -17.036800 72.000000] 0.999542 0.000000 0.000000 -0.030263 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654789, 46925, 1481704379, 16.357, -23.8295, 83.937, 0.7320451, 0, 0, -0.6812561, False); /* Proving Grounds Uber */
/* @teleloc 0x585103BB [16.357000 -23.829500 83.937000] 0.732045 0.000000 0.000000 -0.681256 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654791,   613, 1481704404, 42.98, -64.321, 84, 0, 0, 0, -1, False); /* Chest */
/* @teleloc 0x585103D4 [42.980000 -64.321000 84.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971654793,   613, 1481704414, 46.6969, -64.3805, 84, -4.37114E-08, 0, 0, -1, False); /* Chest */
