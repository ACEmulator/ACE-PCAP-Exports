...
VALUES (1921261568, 40500, 675414274, 112, -600, -6, 0.707107, 0, 0, -0.707107, False); /* Barracks Door */
/* @teleloc 0x28420102 [112.000000 -600.000000 -6.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261583, 40504, 675414372, 210, -720, -0.06299996, 1, 0, 0, -4.37114E-08, False); /* Surface */
/* @teleloc 0x28420164 [210.000000 -720.000000 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261595, 40503, 675414415, 16, -290, 5.937, 0.7071068, 0, 0, -0.7071068, False); /* Apostate Citadel Headquarters */
/* @teleloc 0x2842018F [16.000000 -290.000000 5.937000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261597, 40501, 675414423, 30, -305.5, 6, -4.37114E-08, 0, 0, -1, False); /* Headquarters Door */
/* @teleloc 0x28420197 [30.000000 -305.500000 6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261614, 40504, 675414497, 80, -490, 5.937, 1, 0, 0, -4.37114E-08, False); /* Surface */
/* @teleloc 0x284201E1 [80.000000 -490.000000 5.937000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261615, 40502, 675414506, 90, -567, 5.937, 1, 0, 0, 0, False); /* Apostate Citadel Barracks */
/* @teleloc 0x284201EA [90.000000 -567.000000 5.937000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261627,  6122, 675414272, 30, -300, -12, 1, 0, 0, 0, False); /* Acid */
/* @teleloc 0x28420100 [30.000000 -300.000000 -12.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1921261628, 40504, 675414403, 20, 0, 5.937, 1, 0, 0, -4.37114E-08, False); /* Surface */
