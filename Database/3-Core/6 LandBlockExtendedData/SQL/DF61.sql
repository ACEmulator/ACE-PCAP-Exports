...
VALUES (2113277952,   412, 3747676186, 87.36, 27.2242, 18.082, -1, 0, 0, 0, False); /* Door */
/* @teleloc 0xDF61001A [87.360000 27.224200 18.082000] -1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113277953,   412, 3747676188, 81.48, 84, 18.082, 0.7071068, 0, 0, -0.7071068, False); /* Door */
/* @teleloc 0xDF61001C [81.480000 84.000000 18.082000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113277954,   412, 3747676179, 60, 57.48, 18.082, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0xDF610013 [60.000000 57.480000 18.082000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113277968, 27244, 3747676428, 88.0154, 30.6831, 23, 0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0xDF61010C [88.015400 30.683100 23.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113277997,   174, 3747676186, 73.511, 30.272, 18, 1, 0, 0, 0, False); /* Well */
/* @teleloc 0xDF61001A [73.511000 30.272000 18.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113278010, 27244, 3747676428, 88.0158, 32.1831, 23, 0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0xDF61010C [88.015800 32.183100 23.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113278147,  1925, 3747676437, 101.121, 10.8245, 18, -4.37114E-08, 0, 0, -1, False); /* Chest */
/* @teleloc 0xDF610115 [101.121000 10.824500 18.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113278154,  1947, 3747676452, 79.263, 10.847, 18, -4.37114E-08, 0, 0, -1, False); /* Chest */
/* @teleloc 0xDF610124 [79.263000 10.847000 18.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2113278183, 24678, 3747676448, 91.5268, 19.9141, 28, 1, 0, 0, 0, False); /* Runed Chest */
