...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B973004,   509, 0xB9730031, 151.326, 15.9557, 40, 0.389077, 0, 0, -0.921205, False, '2019-02-10 00:00:00'); /* Life Stone */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7B97300C,  5080, 0xB9730029, 140.684, 11.9603, 40, -0.033725, 0, 0, -0.999431, False, '2019-02-10 00:00:00'); /* North Yanshi Outpost */
