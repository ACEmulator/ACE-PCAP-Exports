...
VALUES (0x70162000,  1915, 0x01620101, 2.96198, -133.634, 0, -0.6264342, 0, 0, -0.7794743, False, '2019-02-10 00:00:00'); /* Chest */
/* @teleloc 0x01620101 [2.961980 -133.634000 0.000000] -0.626434 0.000000 0.000000 -0.779474 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7016200D,  1930, 0x0162017E, 89.9074, -96.5428, 6, -0.9797066, 0, 0, -0.2004369, False, '2019-02-10 00:00:00'); /* Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70162014,  1921, 0x0162019C, 6.23225, -48.1714, 12, -0.8936653, 0, 0, -0.4487341, False, '2019-02-10 00:00:00'); /* Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7016201D,  4938, 0x016201EC, 70.3529, -1.44756, 11.937, -0.7071068, 0, 0, -0.7071068, False, '2019-02-10 00:00:00'); /* Surface */
