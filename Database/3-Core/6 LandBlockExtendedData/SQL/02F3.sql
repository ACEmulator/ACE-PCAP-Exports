...
VALUES (1882140672,  7294, 49479936, 60, -70, -66.063, 1, 0, 0, -4.37114E-08, False); /* Surface Portal */
/* @teleloc 0x02F30100 [60.000000 -70.000000 -66.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140686,  7294, 49480033, 120, -320, -48.063, 1, 0, 0, -4.37114E-08, False); /* Surface Portal */
/* @teleloc 0x02F30161 [120.000000 -320.000000 -48.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140715,  3985, 49480116, 61.5, -40, -30, 0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x02F301B4 [61.500000 -40.000000 -30.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140728,  6122, 49480199, 80, -230, -18, 1, 0, 0, 0, False); /* Acid */
/* @teleloc 0x02F30207 [80.000000 -230.000000 -18.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140730,  6122, 49480214, 110, -230, -18, 1, 0, 0, 0, False); /* Acid */
/* @teleloc 0x02F30216 [110.000000 -230.000000 -18.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140733,  3969, 49480216, -4, -200, -12, -0.7071068, 0, 0, -0.7071068, False); /* Chest */
/* @teleloc 0x02F30218 [-4.000000 -200.000000 -12.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140761,  7294, 49480371, 110, -340, -0.06299996, 0.7071068, 0, 0, -0.7071068, False); /* Surface Portal */
/* @teleloc 0x02F302B3 [110.000000 -340.000000 -0.063000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1882140773, 34915, 49479953, 56.3478, -94.1729, -53.99, 0.9809515, 0, 0, -0.1942525, False); /* Sigil Keeper */
