...
VALUES (2087063552,   720, 3328245810, 156, 28.45, 8, 1, 0, 0, 0, False); /* Sliding Door */
/* @teleloc 0xC6610032 [156.000000 28.450000 8.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2087063553,   720, 3328245810, 156, 43.5247, 11, 1, 0, 0, 0, False); /* Sliding Door */
/* @teleloc 0xC6610032 [156.000000 43.524700 11.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2087063554,   720, 3328245810, 156, 28.45, 11, 1, 0, 0, 0, False); /* Sliding Door */
/* @teleloc 0xC6610032 [156.000000 28.450000 11.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2087063555,   720, 3328245810, 163.55, 36, 11, 0.7071068, 0, 0, -0.7071068, False); /* Sliding Door */
/* @teleloc 0xC6610032 [163.550000 36.000000 11.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2087063556,   720, 3328245810, 148.45, 36, 11, 0.7071068, 0, 0, 0.7071068, False); /* Sliding Door */
