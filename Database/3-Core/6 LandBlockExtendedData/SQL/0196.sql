...
VALUES (1880711219, 29939, 26608535, 80, -44.82, 6, 1, 0, 0, 0, False); /* Guardian */
/* @teleloc 0x01960397 [80.000000 -44.820000 6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880711220,   269, 26608538, 84, -45.1, 7.5, 1, 0, 0, 0, False); /* Button */
/* @teleloc 0x0196039A [84.000000 -45.100000 7.500000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880711225,   269, 26608543, 82.892, -72.179, 7.5, 0.707107, 0, 0, -0.707107, False); /* Button */
/* @teleloc 0x0196039F [82.892000 -72.179000 7.500000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880711226, 29939, 26608544, 80, -65.18, 6, -4.37114E-08, 0, 0, -1, False); /* Guardian */
/* @teleloc 0x019603A0 [80.000000 -65.180000 6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880711340,   269, 26608534, 77.101, -38, 7.5, -0.707107, 0, 0, -0.707107, False); /* Button */
/* @teleloc 0x01960396 [77.101000 -38.000000 7.500000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880711341,   269, 26608539, 76, -64.9, 7.5, 0, 0, 0, -1, False); /* Button */
