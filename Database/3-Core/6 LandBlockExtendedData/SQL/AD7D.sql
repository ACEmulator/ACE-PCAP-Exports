...
VALUES (0x7AD7D004,   143, 0xAD7D011B, 34.5244, 92.9991, 52, 0.997609, 0, 0, 0.069115, False, '2019-02-10 00:00:00'); /* Chest */
/* @teleloc 0xAD7D011B [34.524400 92.999100 52.000000] 0.997609 0.000000 0.000000 0.069115 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7AD7D005,  4980, 0xAD7D000C, 29.7878, 90.2518, 52.05, -0.92388, 0, 0, -0.382683, False, '2019-02-10 00:00:00'); /* Refreshing Fountain */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7AD7D008,  4453, 0xAD7D000C, 36, 73.558, 52, 0, 0, 0, -1, False, '2019-02-10 00:00:00'); /* Door */
