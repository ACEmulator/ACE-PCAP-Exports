...
VALUES (1971662851,   568, 1481834769, 30, -24.75, -1.862645E-09, 0, 0, 0, 1, False); /* Door */
/* @teleloc 0x58530111 [30.000000 -24.750000 0.000000] 0.000000 0.000000 0.000000 1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971662853,   568, 1481834773, 30, -45.25, -1.862645E-09, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0x58530115 [30.000000 -45.250000 0.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971662856,   568, 1481834818, 40, -64, 6, 0.99984, 0, 0, -0.017871, False); /* Door */
/* @teleloc 0x58530142 [40.000000 -64.000000 6.000000] 0.999840 0.000000 0.000000 -0.017871 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1971662857,   568, 1481834820, 40, -55.25, 6, 1, 0, 0, 0, False); /* Door */
