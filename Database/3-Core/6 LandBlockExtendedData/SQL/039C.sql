...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7039C018,   509, 0x039C0199, 89.9443, -101.554, -6, -0.782679, 0, 0, -0.622426, False, '2019-02-10 00:00:00'); /* Life Stone */
/* @teleloc 0x039C0199 [89.944300 -101.554000 -6.000000] -0.782679 0.000000 0.000000 -0.622426 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7039C01E,  4980, 0x039C01B5, 132.168, -87.7702, -5.95, 0.642987, 0, 0, -0.765877, False, '2019-02-10 00:00:00'); /* Refreshing Fountain */
/* @teleloc 0x039C01B5 [132.168000 -87.770200 -5.950000] 0.642987 0.000000 0.000000 -0.765877 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7039C02E, 12697, 0x039C01F6, 31.7322, 1.63691, -0.063, -0.925449, 0, 0, 0.378873, False, '2019-02-10 00:00:00'); /* Surface Portal */
/* @teleloc 0x039C01F6 [31.732200 1.636910 -0.063000] -0.925449 0.000000 0.000000 0.378873 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7039C02F, 12687, 0x039C01F8, 29.2672, -20.2273, 0.005, -0.942175, 0, 0, -0.335122, False, '2019-02-10 00:00:00'); /* Jasin of the Arcanum */
/* @teleloc 0x039C01F8 [29.267200 -20.227300 0.005000] -0.942175 0.000000 0.000000 -0.335122 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7039C030, 12693, 0x039C0200, 90.0029, -42.2002, -0.063, -0.026137, 0, 0, 0.999658, False, '2019-02-10 00:00:00'); /* Exit Portal */
