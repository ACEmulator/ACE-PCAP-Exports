...
VALUES (0x78164000,   412, 0x81640105, 13.76, 107.05, 30.082, -0.7071068, 0, 0, -0.7071068, False, '2019-02-10 00:00:00'); /* Door */
/* @teleloc 0x81640105 [13.760000 107.050000 30.082000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78164002,   509, 0x81640007, 19.2176, 148.024, 24, 0.614668, 0, 0, 0.7887859, False, '2019-02-10 00:00:00'); /* Life Stone */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78164004,  4707, 0x81640108, 9.55362, 153.031, 23.705, 0.06611262, 0, 0, -0.9978122, False, '2019-02-10 00:00:00'); /* Lu'zura the Shopkeeper */
/* @teleloc 0x81640108 [9.553620 153.031000 23.705000] 0.066113 0.000000 0.000000 -0.997812 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78164006,  5108, 0x81640007, 19.6281, 144.634, 24, 0.99998, 0, 0, -0.00637844, False, '2019-02-10 00:00:00'); /* LIFESTONES SIGN */
/* @teleloc 0x81640007 [19.628100 144.634000 24.000000] 0.999980 0.000000 0.000000 -0.006378 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78164007,  5082, 0x81640007, 12.6469, 150.518, 24, 0.999633, 0, 0, -0.0270773, False, '2019-02-10 00:00:00'); /* East Yaraq Outpost */
