...
VALUES (1972678666,   568, 1498087696, 114.75, -30, 0, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x594B0110 [114.750000 -30.000000 0.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678677,   568, 1498087725, 140, -4.75, 0, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x594B012D [140.000000 -4.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678679,   568, 1498087731, 144.75, -30, 0, -0.707107, 0, 0, 0.707107, False); /* Door */
/* @teleloc 0x594B0133 [144.750000 -30.000000 0.000000] -0.707107 0.000000 0.000000 0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678680,   568, 1498087732, 135.25, -30, 0, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x594B0134 [135.250000 -30.000000 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678681,   568, 1498087733, 140, -34.75, 0, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x594B0135 [140.000000 -34.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678682,  5626, 1498087738, 140, -45, -7.450581E-09, 1, 0, 0, -4.37114E-08, False); /* Door */
/* @teleloc 0x594B013A [140.000000 -45.000000 0.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678688,   568, 1498087757, 165.25, -30, 0, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x594B014D [165.250000 -30.000000 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1972678692, 25393, 1498087790, 12.8928, -119.376, 5.937, -0.3777021, 0, 0, -0.9259272, False); /* Exit to Surface */
