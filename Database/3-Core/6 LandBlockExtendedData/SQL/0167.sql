...
VALUES (1880518659,  1943, 23527711, 21.0725, -56.0358, 2.980232E-08, 0.9973065, 0, 0, -0.07334743, False); /* Chest */
/* @teleloc 0x0167011F [21.072500 -56.035800 0.000000] 0.997307 0.000000 0.000000 -0.073347 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518665,  1930, 23527736, 43.5484, -36.4564, 0, 0.9335021, 0, 0, -0.358572, False); /* Chest */
/* @teleloc 0x01670138 [43.548400 -36.456400 0.000000] 0.933502 0.000000 0.000000 -0.358572 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518667,  1289, 23527738, 40, -44.75, -3.72529E-09, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x0167013A [40.000000 -44.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518672,   568, 23527790, 70, -4.75, 6, 1, 0, 0, -4.37114E-08, False); /* Door */
/* @teleloc 0x0167016E [70.000000 -4.750000 6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518678,   568, 23527807, 75.245, -20, 6, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x0167017F [75.245000 -20.000000 6.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518680,   568, 23527836, 110, -4.75, 6, -4.37114E-08, 0, 0, -1, False); /* Door */
/* @teleloc 0x0167019C [110.000000 -4.750000 6.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518684,  4930, 23527848, 110, -50, 5.937, 1, 0, 0, 0, False); /* Surface Portal */
/* @teleloc 0x016701A8 [110.000000 -50.000000 5.937000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880518685,   568, 23527850, 110, -45.25, 6, 0, 0, 0, -1, False); /* Door */
