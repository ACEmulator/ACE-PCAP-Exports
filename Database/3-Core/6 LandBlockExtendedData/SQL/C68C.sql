...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C68C001,  2076, 0xC68C001F, 83.9743, 157.814, 28.93486, 0.4856188, 0, 0, -0.8741707, False, '2019-02-10 00:00:00'); /* Dungeon Gallery Tower */
/* @teleloc 0xC68C001F [83.974300 157.814000 28.934860] 0.485619 0.000000 0.000000 -0.874171 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7C68C002,  4179, 0xC68C0103, 158.53, 82.1065, 21.2, -0.3853171, 0, 0, -0.9227842, False, '2019-02-10 00:00:00'); /* Bonfire */
