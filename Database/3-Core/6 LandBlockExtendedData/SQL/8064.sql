...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78064002,  4676, 0x8064002F, 140.068, 163.032, 28.32767, -0.997157, 0, 0, -0.075353, False, '2019-02-10 00:00:00'); /* Yaraq Outpost */
/* @teleloc 0x8064002F [140.068000 163.032000 28.327670] -0.997157 0.000000 0.000000 -0.075353 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78064003,  4676, 0x80640038, 151.126, 172.613, 28, 0.995039, 0, 0, -0.09949, False, '2019-02-10 00:00:00'); /* Yaraq Outpost */
