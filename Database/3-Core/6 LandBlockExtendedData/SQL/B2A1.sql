...
VALUES (2066354176,   412, 2996895762, 55.34, 39.154, 88.082, 0.7071068, 0, 0, -0.7071068, False); /* Door */
/* @teleloc 0xB2A10012 [55.340000 39.154000 88.082000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2066354177,   412, 2996895762, 64.8575, 32.8435, 88.082, -0.7071068, 0, 0, -0.7071068, False); /* Door */
/* @teleloc 0xB2A10012 [64.857500 32.843500 88.082000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2066354178,   412, 2996895778, 105.94, 30.385, 90.082, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0xB2A10022 [105.940000 30.385000 90.082000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (2066354179,   412, 2996895778, 102.21, 42.345, 90.082, 0.7071068, 0, 0, 0.7071068, False); /* Door */
