...
VALUES (0x7574A000, 23075, 0x574A010C, 40, 0, -0.063, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Surface */
/* @teleloc 0x574A010C [40.000000 0.000000 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7574A001, 23081, 0x574A0123, 80, -40, -0.063, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Warehouse Annex Mine */
