...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7856E004,  1815, 0x856E0100, 129.679, 14.2732, 14.005, 0.37542, 0, 0, -0.926855, False, '2019-02-10 00:00:00'); /* Maqura al-Waryah the Blacksmith */
/* @teleloc 0x856E0100 [129.679000 14.273200 14.005000] 0.375420 0.000000 0.000000 -0.926855 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7856E005,  1816, 0x856E0100, 130.02, 18.8609, 13.205, -0.597316, 0, 0, -0.802006, False, '2019-02-10 00:00:00'); /* Djuyat ibn Fisa the Armorer */
