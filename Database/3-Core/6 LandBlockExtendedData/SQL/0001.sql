...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7000106B, 28783, 0x000102C8, 67.8951, -12.1839, -0.063, 0.401723, 0, 0, 0.915761, False, '2019-02-10 00:00:00'); /* Surface */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x70001076, 29060, 0x00010266, 110.142, -88.9699, -18, 0, 0, 0, -1, False, '2019-02-10 00:00:00'); /* Old Chest */
