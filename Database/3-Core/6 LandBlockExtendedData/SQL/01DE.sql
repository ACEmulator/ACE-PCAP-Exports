...
VALUES (1881006090,   568, 31326554, 74.75, -50, -6, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x01DE015A [74.750000 -50.000000 -6.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881006104,  1934, 31326621, 26.9811, -46.0583, 0, 1, 0, 0, 0, False); /* Chest */
/* @teleloc 0x01DE019D [26.981100 -46.058300 0.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881006105,  1342, 31326629, 29.8926, -78.4609, -0.06299996, 1, 0, 0, 0, False); /* Surface */
/* @teleloc 0x01DE01A5 [29.892600 -78.460900 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881006109,  1342, 31326642, 40.2979, -59.2665, -0.06299996, 0.7071068, 0, 0, -0.7071068, False); /* Surface */
/* @teleloc 0x01DE01B2 [40.297900 -59.266500 -0.063000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881006117,   152, 31326678, 70, -52, -0.00749898, 1, 0, 0, 0, False); /* Font */
/* @teleloc 0x01DE01D6 [70.000000 -52.000000 -0.007499] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1881006118,   568, 31326680, 70, -45.25, 0, 1, 0, 0, 0, False); /* Door */
