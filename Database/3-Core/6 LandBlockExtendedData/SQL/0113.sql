...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880174603,   285, 18022722, 64.3875, -76.7577, -10.5885, 0.7071068, 0, 0, -0.7071068, False); /* Lever */
/* @teleloc 0x01130142 [64.387500 -76.757700 -10.588500] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880174605,  4139, 18022726, 70, -52, -12, 1, 0, 0, -4.37114E-08, False); /* Door */
/* @teleloc 0x01130146 [70.000000 -52.000000 -12.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880174629,   285, 18022929, 29.2355, -15.6046, 7.42488, 1, 0, 0, 0, False); /* Lever */
/* @teleloc 0x01130211 [29.235500 -15.604600 7.424880] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880174632,  6780, 18022940, 50, -16.359, 5.937, 1, 0, 0, 0, False); /* Surface Portal */
