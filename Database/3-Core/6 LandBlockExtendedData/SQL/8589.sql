...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78589001, 27547, 0x85890029, 121.536, 16.1923, 86, -0.998498, 0, 0, 0.054785, False, '2019-02-10 00:00:00'); /* Bind Stone */
/* @teleloc 0x85890029 [121.536000 16.192300 86.000000] -0.998498 0.000000 0.000000 0.054785 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x78589002,  6089, 0x85890101, 108.931, 12.9724, 87.937, -0.946914, 0, 0, -0.321488, False, '2019-02-10 00:00:00'); /* Al-Jalima Meeting Hall Portal */
