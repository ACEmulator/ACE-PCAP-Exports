...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77D6300A,  4179, 0x7D630105, 29.113, 89.58, 9.2, 0.127887, 0, 0, -0.991789, False, '2019-02-10 00:00:00'); /* Bonfire */
/* @teleloc 0x7D630105 [29.113000 89.580000 9.200000] 0.127887 0.000000 0.000000 -0.991789 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x77D6300F, 28709, 0x7D630027, 108.129, 160.372, 11.79017, -0.382683, 0, 0, -0.92388, False, '2019-02-10 00:00:00'); /* Destroyed Portal to Sanamar */
