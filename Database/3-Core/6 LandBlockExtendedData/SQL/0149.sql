...
VALUES (1880395786,   568, 21561687, 30, -85.25, 1.862645E-09, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0x01490157 [30.000000 -85.250000 0.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880395790,  5514, 21561719, 59.898, -43.1179, -0.06299996, 1, 0, 0, 0, False); /* Surface Portal */
/* @teleloc 0x01490177 [59.898000 -43.117900 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880395794,  4811, 21561603, 26.4221, -48.6941, -6, -0.9992224, 0, 0, -0.03942802, False); /* Sarcophagus */
/* @teleloc 0x01490103 [26.422100 -48.694100 -6.000000] -0.999222 0.000000 0.000000 -0.039428 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880395803, 26607, 21561685, 30.111, -93.9495, 0, 0, 0, 0, -1, False); /* Runed Chest */
