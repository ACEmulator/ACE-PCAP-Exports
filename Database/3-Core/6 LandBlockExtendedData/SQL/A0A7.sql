...
VALUES (0x7A0A7000,   143, 0xA0A70100, 61.1334, 41.4899, 64, 0.708956, 0, 0, -0.705253, False, '2019-02-10 00:00:00'); /* Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A0A7002,   412, 0xA0A70012, 64.7409, 35.7324, 64.082, 0.707107, 0, 0, 0.707107, False, '2019-02-10 00:00:00'); /* Door */
/* @teleloc 0xA0A70012 [64.740900 35.732400 64.082000] 0.707107 0.000000 0.000000 0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A0A7003,  1381, 0xA0A70100, 60.0557, 39.6658, 64.005, 0.283076, 0, 0, -0.959098, False, '2019-02-10 00:00:00'); /* Farmer */
