...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1969569806, 21915, 1448345897, 20, -20, 23.99312, 1, 0, 0, -4.37114E-08, False); /* Gaerlan Effect */
/* @teleloc 0x56540129 [20.000000 -20.000000 23.993120] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1969569808, 21400, 1448345898, 19.9771, -32.172, 23.937, -0.00420373, 0, 0, 0.9999912, False); /* Citadel Apex */
