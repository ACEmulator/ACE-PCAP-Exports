...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A4B400A,   143, 0xA4B40113, 53.125, 186.995, 99, 0.976672, 0, 0, -0.214735, False, '2019-02-10 00:00:00'); /* Chest */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7A4B400C,   412, 0xA4B40018, 54.21, 186.345, 96.082, 0.707107, 0, 0, 0.707107, False, '2019-02-10 00:00:00'); /* Door */
