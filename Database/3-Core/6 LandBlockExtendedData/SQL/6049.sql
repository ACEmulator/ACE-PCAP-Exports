...
VALUES (1980010503, 25465, 1615397370, 505.934, -200, -12, -0.707107, 0, 0, -0.707107, False); /* Olthoi Door */
/* @teleloc 0x604901FA [505.934000 -200.000000 -12.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010518,  3960, 1615397518, 140, -4, -6, 1, 0, 0, -4.37114E-08, False); /* Chest */
/* @teleloc 0x6049028E [140.000000 -4.000000 -6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010526,  3960, 1615397562, 190, -86, -6, 0, 0, 0, 1, False); /* Chest */
/* @teleloc 0x604902BA [190.000000 -86.000000 -6.000000] 0.000000 0.000000 0.000000 1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010542,  4455, 1615397665, 50, -85.491, 0, 1, 0, 0, 0, False); /* Door */
/* @teleloc 0x60490321 [50.000000 -85.491000 0.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010545, 25497, 1615397672, 50.007, -118.2897, -0.06299996, -4.37114E-08, 0, 0, -1, False); /* Surface */
/* @teleloc 0x60490328 [50.007000 -118.289700 -0.063000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010563, 25464, 1615397146, 660, -64.0526, -42, 0, 0, 0, -1, False); /* Door */
/* @teleloc 0x6049011A [660.000000 -64.052600 -42.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1980010921,   285, 1615397679, 64.387, -80.953, 1.38475, 0.7071068, 0, 0, -0.7071068, False); /* Lever */
