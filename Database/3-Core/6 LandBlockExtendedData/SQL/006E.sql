...
VALUES (1879498852, 32656, 7209842, 127.281, -50.0794, -18.063, 0.6967069, 0, 0, 0.7173559, False); /* Surface */
/* @teleloc 0x006E0372 [127.281000 -50.079400 -18.063000] 0.696707 0.000000 0.000000 0.717356 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498880,   278, 7209977, 145.25, -50, -12, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x006E03F9 [145.250000 -50.000000 -12.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498887,   278, 7210053, 200, -54.75, -12, 0, 0, 0, 1, False); /* Door */
/* @teleloc 0x006E0445 [200.000000 -54.750000 -12.000000] 0.000000 0.000000 0.000000 1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498888,   278, 7210054, 200, -45.25, -12, -1, 0, 0, 0, False); /* Door */
/* @teleloc 0x006E0446 [200.000000 -45.250000 -12.000000] -1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498905,   278, 7210144, 284.75, -40, -12, -0.707107, 0, 0, 0.707107, False); /* Door */
/* @teleloc 0x006E04A0 [284.750000 -40.000000 -12.000000] -0.707107 0.000000 0.000000 0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498908,   278, 7210154, 284.75, -60, -12, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x006E04AA [284.750000 -60.000000 -12.000000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1879498927, 32656, 7210334, 101.385, -41.4919, -0.06299996, 0.8893856, 0, 0, 0.4571578, False); /* Surface */
