...
VALUES (1970561024,  5625, 1464205988, 12, -70, 63.005, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x574602A4 [12.000000 -70.000000 63.005000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561025,  5625, 1464205991, 12, -80, 63.005, 0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x574602A7 [12.000000 -80.000000 63.005000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561026,   611, 1464206199, 79.949, -16.77, 72, 1, 0, 0, 0, False); /* Chest */
/* @teleloc 0x57460377 [79.949000 -16.770000 72.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561027,   611, 1464206199, 77.8516, -16.7724, 72, 0.999542, 0, 0, -0.030263, False); /* Chest */
/* @teleloc 0x57460377 [77.851600 -16.772400 72.000000] 0.999542 0.000000 0.000000 -0.030263 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561028,   611, 1464206199, 82.2143, -17.0368, 72, 0.999542, 0, 0, -0.030263, False); /* Chest */
/* @teleloc 0x57460377 [82.214300 -17.036800 72.000000] 0.999542 0.000000 0.000000 -0.030263 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561029,   613, 1464206292, 42.98, -64.321, 84, 0, 0, 0, -1, False); /* Chest */
/* @teleloc 0x574603D4 [42.980000 -64.321000 84.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561030,   613, 1464206302, 46.6969, -64.3805, 84, -4.37114E-08, 0, 0, -1, False); /* Chest */
/* @teleloc 0x574603DE [46.696900 -64.380500 84.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1970561097, 21749, 1464206267, 16.357, -23.853, 83.937, 0.714421, 0, 0, -0.699716, False); /* Proving Grounds Low */
