...
VALUES (0x7001A027, 30287, 0x001A01EA, 130, -314, 6, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Door */
/* @teleloc 0x001A01EA [130.000000 -314.000000 6.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7001A02B, 30287, 0x001A01FB, 130, -434, 6, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Door */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7001A043, 30287, 0x001A02AF, 130, -280, 12, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Door */
...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7001A050, 29438, 0x001A0189, 210, -80, -0.063, 1, 0, 0, 0, False, '2019-02-10 00:00:00'); /* Exit Platinum Legion Keep */
