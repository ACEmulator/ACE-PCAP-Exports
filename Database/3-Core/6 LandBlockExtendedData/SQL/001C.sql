...
VALUES (0x7001C001, 29482, 0x001C010A, 8, -68, -0.063, 0.707107, 0, 0, -0.707107, False, '2019-02-10 00:00:00'); /* Exit Lugian Ice Tunnels */
/* @teleloc 0x001C010A [8.000000 -68.000000 -0.063000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x7001C01D, 29482, 0x001C025C, 217.5, -347.5, 23.937, 0.382683, 0, 0, -0.92388, False, '2019-02-10 00:00:00'); /* Exit Lugian Ice Tunnels */
