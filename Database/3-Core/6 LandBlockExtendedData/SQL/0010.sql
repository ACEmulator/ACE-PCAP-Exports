...
INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x700100D9, 30661, 0x00100355, 96.7543, -176.579, -0.06299996, -0.8854389, 0, 0, -0.4647559, False, '2019-02-10 00:00:00'); /* Escape Route */
/* @teleloc 0x00100355 [96.754300 -176.579000 -0.063000] -0.885439 0.000000 0.000000 -0.464756 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x700100E2, 30652, 0x00100364, 125.25, -210, 2.793968E-09, -0.707107, 0, 0, -0.707107, False, '2019-02-10 00:00:00'); /* Door */
/* @teleloc 0x00100364 [125.250000 -210.000000 0.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`, `last_Modified`)
VALUES (0x700100E5, 30661, 0x0010012A, 162.426, -10.4188, -30.063, 0.7071068, 0, 0, -0.7071068, False, '2019-02-10 00:00:00'); /* Escape Route */
