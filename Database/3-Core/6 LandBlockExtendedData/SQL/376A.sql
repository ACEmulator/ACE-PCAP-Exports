...
VALUES (1937154048,   412, 929693747, 147.224, 56.64, 34.082, 0.7071068, 0, 0, -0.7071068, False); /* Door */
/* @teleloc 0x376A0033 [147.224000 56.640000 34.082000] 0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1937154049,   412, 929693740, 140.776, 87.36, 34.082, -0.7071068, 0, 0, -0.7071068, False); /* Door */
/* @teleloc 0x376A002C [140.776000 87.360000 34.082000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1937154050,   174, 929693749, 150.763, 103.116, 34, 1, 0, 0, 0, False); /* Well */
/* @teleloc 0x376A0035 [150.763000 103.116000 34.000000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1937154069,  5629, 929693954, 137.983, 31.1293, 44, -0.999915, 0, 0, -0.0130546, False); /* Door */
/* @teleloc 0x376A0102 [137.983000 31.129300 44.000000] -0.999915 0.000000 0.000000 -0.013055 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1937154076,  4457, 929693738, 121.403, 33, 34, -0.707107, 0, 0, -0.707107, False); /* Door */
/* @teleloc 0x376A002A [121.403000 33.000000 34.000000] -0.707107 0.000000 0.000000 -0.707107 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1937154079,   153, 929694038, 156, 108, 33.9925, 0.7071068, 0, 0, -0.7071068, False); /* Fountain */
