...
VALUES (1880735863,  2506, 27001497, 70, -34.75, 1.862645E-09, 0, 0, 0, -1, False); /* Door */
/* @teleloc 0x019C0299 [70.000000 -34.750000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880735867,  2557, 27001509, 100, -17, -0.06299996, 1, 0, 0, 0, False); /* Surface */
/* @teleloc 0x019C02A5 [100.000000 -17.000000 -0.063000] 1.000000 0.000000 0.000000 0.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880735868,  2557, 27001513, 100, -63, -0.06299996, -4.37114E-08, 0, 0, -1, False); /* Surface */
/* @teleloc 0x019C02A9 [100.000000 -63.000000 -0.063000] 0.000000 0.000000 0.000000 -1.000000 */

INSERT INTO `landblock_instance` (`guid`, `weenie_Class_Id`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`, `is_Link_Child`)
VALUES (1880735871,  2506, 27001525, 130, -45.25, 1.862645E-09, 1, 0, 0, 0, False); /* Door */
