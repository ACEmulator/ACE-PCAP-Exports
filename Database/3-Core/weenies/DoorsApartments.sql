...
VALUES (15451, 48, 15451, 4116, 100668183, NULL, NULL, 33557661, 536870946, 150994966, 'AAA9AAIAAAALAAAA', NULL, 872415275, 104451, NULL, NULL, NULL);
...
INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15451, 93, 65564);

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (15451, 13, True);

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (15451, 12, True);

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (15451, 11, True);
