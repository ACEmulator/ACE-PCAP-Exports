...
REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (38405, 16, 'A glowing gland, removed from one of the Blessed Moars on the isle of Freebooter Keep.');
...
VALUES (38236, 16, 'A token, given to you as a reward for accomplishing goals set to you by those in your Society.')
     , (38236, 14, 'This token may be used to purchase items from your Society Vendors.');
