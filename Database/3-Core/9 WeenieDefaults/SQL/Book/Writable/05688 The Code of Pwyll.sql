...
VALUES (5688, 'bookcodepwyll', 8) /* Book */;
...
VALUES (5688,   1,       8192) /* ItemType - Writable */
     ...
     , (5688,  19,         80) /* Value */
     , (5688,  65,        101) /* Placement - Resting */
     , (5688,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5688,   1, False) /* Stuck */
     , (5688,  11, True ) /* IgnoreCollisions */
     , (5688,  13, True ) /* Ethereal */
     , (5688,  14, True ) /* GravityStatus */
     , (5688,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5688,  39, 1.22000002861023) /* DefaultScale */
     , (5688,  54, 0.300000011920929) /* UseRadius */;
...
VALUES (5688,   2, 1343275484) /* Container */
     , (5688, 8000, 3697643023) /* PCAPRecordedObjectIID */;
