...
VALUES (8857, 'histapr00', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (8857,   1,   33554771) /* Setup */
     ...
     , (8857, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8857, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8857, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8857, 8000, 2616516113) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8857, 16, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8857, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 2, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 8, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 11, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'Again, he was tracked and defeated. Once more he moved, into the Spire found in the festering Blackmire Swamp. Once more he fell, and Black Ferah reappeared in the Direlands to give his troops time to regroup.
...
')
     , (8857, 12, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 13, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 14, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8857, 15, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
