...
VALUES (29073, 'bookthrungusexplorer2', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (29073,   1,       8192) /* ItemType - Writable */
     ...
     , (29073, 8041,        101) /* PCAPRecordedPlacement - Resting */
     , (29073, 8042,          7) /* PCAPRecordedAppraisalPages */
     , (29073, 8043,          7) /* PCAPRecordedAppraisalMaxPages */;
...
')
     , (29073, 4, 4294967295, 'Sir Binwas Loc', 'prewritten', False, 'I spoke to no one of this. I merely let the items lie, hidden from view. I checked on the items several times throughout the day. For a time - three days, actually - nothing happened. They remained undisturbed in their hidden locations. But on the fourth day the first of the items went missing. On the fifth, another item. On the sixth, two more. By the eighth day, all seven items had been stolen, and all in the small hours of night.
')
     , (29073, 5, 4294967295, 'Sir Binwas Loc', 'prewritten', False, 'These items meant nothing to the King, and they were of no more value than a simple Brew Kettle. But they were pleasing to look upon, enough to catch the fancy of a simple-minded fool. My assumption has been correct. I was dealing with some dumb animal. Small and quiet. Adept at hiding in the shadows. Nothing really to fear, but an irritant to deal with nonetheless.
')
     , (29073, 6, 4294967295, 'Sir Binwas Loc', 'prewritten', False, 'But still, I told no one of this. To be truthful, I desired to find that belt and present it to the King myself. Certainly, the one to do so would receive quite a worthy reward in exchange. So I assembled another collection of glittering trinkets, hid them in a small niche near the Royal Kitchens, and set my trap.
');
