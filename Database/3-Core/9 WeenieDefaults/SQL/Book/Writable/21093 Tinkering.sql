...
VALUES (21093, 'booktinkering', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (21093,   1,   33554771) /* Setup */
     ...
     , (21093, 8001,    2097176) /* PCAPRecordedWeenieHeader - Value, Usable, Burden */
     , (21093, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (21093, 8005,     170113) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, Position, AnimationFrame */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (21093, 8040, 2248344124, 57.9623, -31.6294, 0.95454, 0.8792861, 0, 0, -0.476294) /* PCAPRecordedLocation */
/* @teleloc 0x8603023C [57.962300 -31.629400 0.954540] 0.879286 0.000000 0.000000 -0.476294 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (21093, 8000, 3692560701) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (21093, 14, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (21093, 0, 4294967295, 'Ciandra', 'Password is cheese', False, 'When Asheron first came into the Consortium, I was amazed. He offered us knowledge beyond everything we had begun to comprehend thus far and he directed our attentions to some shortcomings. 
...
')
     , (21093, 1, 4294967295, 'Ciandra', 'Password is cheese', False, 'language as explained to us by Asheron. It means; that which reduces, or at least that is the closest conversion in Roulean.
...
')
     , (21093, 2, 4294967295, 'Ciandra', 'Password is cheese', False, 'Basics
...
')
     , (21093, 3, 4294967295, 'Ciandra', 'Password is cheese', False, 'Qualities
...
')
     , (21093, 4, 4294967295, 'Ciandra', 'Password is cheese', False, 'was used to craft the object. Typically these are metals, stones, cloths and gems.
...
')
     , (21093, 5, 4294967295, 'Ciandra', 'Password is cheese', False, 'Ust would mean that all other objects placed within would need to be made of wool in order for the process to work.
...
')
     , (21093, 7, 4294967295, 'Ciandra', 'Password is cheese', False, 'amazing thing about this process is that the Ust recognizes when there are items mixed with materials. When instances such as this arise it will obtain the quantity and average workmanship quality of the items and add them to the existing materials. 
...
')
     , (21093, 8, 4294967295, 'Ciandra', 'Password is cheese', False, 'amount of items used. 
...
')
     , (21093, 9, 4294967295, 'Ciandra', 'Password is cheese', False, 'for example is an excellent source of insulation from the cold. It''s no surprise then that it will affect the level of cold protection that armor offers. 
...
')
     , (21093, 10, 4294967295, 'Ciandra', 'Password is cheese', False, 'working on direct applications, and item tinkerers work with the generic applications such as weight, and value of objects. Again without training in one of these areas, it will not be possible for a person to apply materials.
...
')
     , (21093, 11, 4294967295, 'Ciandra', 'Password is cheese', False, 'the application.
...
')
     , (21093, 12, 4294967295, 'Ciandra', 'Password is cheese', False, 'Second, lesser quality workmanship items are easier to improve as they were not that well crafted to begin with. The more close to perfect an item is the harder it will be to improve.
...
')
     , (21093, 13, 4294967295, 'Ciandra', 'Password is cheese', False, '
');
