...
VALUES (8861, 'histaug00', 8, '2019-02-10 00:00:00') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8861,   1,       8192) /* ItemType - Writable */
     , (8861,   5,         10) /* EncumbranceVal */
     , (8861,  16,          8) /* ItemUseable - Contained */
     , (8861,  65,        101) /* Placement - Resting */
     , (8861,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8861,   1, False) /* Stuck */
     , (8861,  11, True ) /* IgnoreCollisions */
     , (8861,  13, True ) /* Ethereal */
     , (8861,  14, True ) /* GravityStatus */
     , (8861,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8861,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8861,   1,   33554771) /* Setup */
     ...
     , (8861, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8861, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8861, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8861, 8000, 2616274797) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8861, 13, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8861, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8861, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8861, 2, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8861, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8861, 6, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8861, 9, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'Khallayne and Raynie of Thistledown provided chocolate milk. Rhiannon Morgana and Touryan Kurigsun of Frostfell supplied chocolate cake. Betty Crocker of Leafcull, one of the famous chefs of Cragstone Farms Catering, created chocolate ice cream. Chen Kenichi of Frostfell, part of the ill-starred adventuring troupe Vitae Rising, produced the chocolate bar, known colloquially as the "Vitae Bar." Chen proudly noted that infamous beating-magnet Wi loved his creation. Ho Chun and Theran Bakagin of Frostfell, meanwhile, leavened the somewhat bitter Vitae Bar into a creamy milk chocolate bar.
')
     , (8861, 10, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
