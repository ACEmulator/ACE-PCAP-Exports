...
VALUES (25680, 'notebethelcultist', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (25680,   1,       8192) /* ItemType - Writable */
     ...
     , (25680,  65,        101) /* Placement - Resting */
     , (25680,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (25680, 114,          0) /* Attuned - Normal */
     , (25680, 174,         11) /* AppraisalPages */
     , (25680, 175,         11) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (25680,   1, False) /* Stuck */
     , (25680,  11, True ) /* IgnoreCollisions */
     , (25680,  13, True ) /* Ethereal */
     , (25680,  14, True ) /* GravityStatus */
     , (25680,  19, True ) /* Attackable */;
...
VALUES (25680,   1,   33554771) /* Setup */
     ...
     , (25680, 8001,    2097200) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Burden */
     , (25680, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (25680, 8005,     169985) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position, AnimationFrame */;
...
VALUES (25680, 8000, 3333713345) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25680, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25680, 0, 4294967295, 'Jaeget', 'Password is cheese', False, 'Yesterday my brother and I began our usual hunts of the Marescent Plateau. We usually did this in search of pelts and hide from the carenzi and gromnie found there. It''s not a very fulfilling living, but it pays the maintenance on the cottage my family owns.
...
')
     , (25680, 1, 4294967295, 'Jaeget', 'Password is cheese', False, 'He promised something meaningful and worthwhile out of life. I have to admit that sounds a deal more satisfying than how my brother and I are living now.
...
')
     , (25680, 2, 4294967295, 'Jaeget', 'Password is cheese', False, 'So, when Bewren wasn''t looking, I pocketed the pamphlet and attached jewel, and my brother and I continued on past the initiate.
---
...
')
     , (25680, 3, 4294967295, 'Jaeget', 'Password is cheese', False, 'I have made up my mind; I am going to crush this calling stone and invite the Raven Hand to take me. And, I think while they are here I will ask him to take my brother as well. 
...
---
')
     , (25680, 4, 4294967295, 'Jaeget', 'Password is cheese', False, 'Last night I crushed the calling stone and several members of the Raven Hand arrived shortly there after. 
...
')
     , (25680, 5, 4294967295, 'Jaeget', 'Password is cheese', False, 'After I had time to place the few belongings the Order allowed me to bring, they began to question me, to get a feel for where my skills would best be put to use, no doubt.
...
---
')
     , (25680, 6, 4294967295, 'Jaeget', 'Password is cheese', False, 'Today one of the priests pulled me aside and told me my purpose. Since I had a lot of skill with hides and curing, I was set to the task of flask crafting. 
...
')
     , (25680, 7, 4294967295, 'Jaeget', 'Password is cheese', False, 'They issued me a kerchief to cover my mouth and nose with and tasked me with creating a flask that could hold a potently enchanted beaker of Olthoi Ichor.
...
---
')
     , (25680, 8, 4294967295, 'Jaeget', 'Password is cheese', False, 'The past week has been exhausting, but fun. So much fun I can''t remember why I even second-guessed coming here in the first place. 
...
')
     , (25680, 9, 4294967295, 'Jaeget', 'Password is cheese', False, 'During our mid-day meal, the High Priests told us of the capture an interloper named Bewren. They said he was trying to escape with our sculpting secrets.
...
')
     , (25680, 10, 4294967295, 'Jaeget', 'Password is cheese', False, 'They said the intruder, Bewren, would be properly punished and then released from our home. That is enough for me, and none of my concern. 
