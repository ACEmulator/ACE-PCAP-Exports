...
VALUES (6828, 'notemountainfortressletter', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (6828,   1,       8192) /* ItemType - Writable */
     ...
     , (6828,  19,         50) /* Value */
     , (6828,  65,        101) /* Placement - Resting */
     , (6828,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (6828, 174,          4) /* AppraisalPages */
     , (6828, 175,          4) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6828,   1, True ) /* Stuck */
     , (6828,  11, True ) /* IgnoreCollisions */
     , (6828,  13, True ) /* Ethereal */
     , (6828,  14, True ) /* GravityStatus */
     , (6828,  19, True ) /* Attackable */;
...
VALUES (6828, 8000, 1880211459) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6828, 4, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6828, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'My daughter,
...
')
     , (6828, 1, 4294967295, 'prewritten', 'Password is cheese', False, 'Enough of my maunderings.  The real reason I write to you is to send you a warning, my daughter.
