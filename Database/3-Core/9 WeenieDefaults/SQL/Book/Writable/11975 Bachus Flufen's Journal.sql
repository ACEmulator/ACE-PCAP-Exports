...
VALUES (11975, 'journaltanua_xp', 8) /* Book */;
...
VALUES (11975,   1,   33554771) /* Setup */
     ...
     , (11975, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (11975, 8003,        274) /* PCAPRecordedObjectDesc - Inscribable, Attackable, Book */
     , (11975, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (11975,   2, 1342410726) /* Container */
     , (11975, 8000, 2248255306) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (11975, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (11975, 0, 4294967295, 'Bachus Flufens', 'Password is cheese', False, 'Taiaha.  A beautiful word.  I think of farewells on a sandy beach, the sun setting into a blue on blue horizon.  "Taiaha," they would say.  "Taiaha," I would return, the last words spoken before night and sleep came upon us.
...
')
     , (11975, 1, 4294967295, 'Bachus Flufens', 'Password is cheese', False, 'But really, at its essence, it is a tool of war.  Used to kill people.  A thousand people on one end of a field, a thousand different people at the other end.  They shout at each other in excitement as they rush towards the middle of the field to greet each other.  But the pleasantries they exchange are their taiahas, sticking them into each other as fast and hard as they can.   The point of the taiaha is transformation: to transform live beings into dead bodies.    
')
     , (11975, 2, 4294967295, 'Bachus Flufens', 'Password is cheese', False, 'Such a poor juxtaposition of word and meaning proves one important point: that stupidity in a species is not limited to just us humans.
