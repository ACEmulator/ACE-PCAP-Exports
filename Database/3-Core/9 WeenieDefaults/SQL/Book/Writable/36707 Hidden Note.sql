...
VALUES (36707, 'ace36707-hiddennote', 8) /* Book */;
...
VALUES (36707,   1,       8192) /* ItemType - Writable */
     ...
     , (36707,  65,        101) /* Placement - Resting */
     , (36707,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36707, 114,          1) /* Attuned - Attuned */
     , (36707, 174,          1) /* AppraisalPages */
     , (36707, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36707,   1, False) /* Stuck */
     , (36707,  11, True ) /* IgnoreCollisions */
     , (36707,  13, True ) /* Ethereal */
     , (36707,  14, True ) /* GravityStatus */
     , (36707,  19, True ) /* Attackable */;
...
VALUES (36707,   1,   33554773) /* Setup */
     ...
     , (36707, 8001,    2113584) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Container, Burden */
     , (36707, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (36707, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (36707,   2, 1879699554) /* Container */
     , (36707, 8000, 3356489201) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (36707, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (36707, 0, 4294967295, 'Phlynt, Agent of the Hidden Hand', 'Password is cheese', False, '
