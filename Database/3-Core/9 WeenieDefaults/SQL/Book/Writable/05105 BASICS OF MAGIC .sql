...
VALUES (5105, 'trainmagic1sign', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (5105,   1,       8192) /* ItemType - Writable */
     ...
     , (5105,  19,        125) /* Value */
     , (5105,  65,        101) /* Placement - Resting */
     , (5105,  93,       1048) /* PhysicsState - ReportCollisions, IgnoreCollisions, Gravity */
     , (5105, 174,          1) /* AppraisalPages */
     , (5105, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5105,   1, True ) /* Stuck */
     , (5105,  11, True ) /* IgnoreCollisions */
     , (5105,  12, True ) /* ReportCollisions */
     , (5105,  13, False) /* Ethereal */
     , (5105,  14, True ) /* GravityStatus */
     , (5105,  19, True ) /* Attackable */;
