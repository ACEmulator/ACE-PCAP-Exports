...
VALUES (8855, 'histfeb00', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (8855,   1,   33554771) /* Setup */
     ...
     , (8855, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8855, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8855, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8855, 8000, 2616516115) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8855, 13, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8855, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 4, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 5, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 6, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'The hand of darkness also sought allies using means as subtle as the monarch kidnappings were gross. Hamud ibn Rafik, leader of an extremist sect of the Gharu''ndim Zharalim called the Tenebrous Edge, made his presence known in Dereth. He and his daughter Devana sent many adventurers on a test of their own. Success earned a magnificent Pyreal Katar that pulsed with dark power, trailing streamers of sooty, cloying mist. Rumor held that Rafik had lost his mind taking to heart Archephoros'' maxim that to fight darkness, sometimes one must become a shadow.
')
     , (8855, 8, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 9, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 10, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 11, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8855, 12, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
