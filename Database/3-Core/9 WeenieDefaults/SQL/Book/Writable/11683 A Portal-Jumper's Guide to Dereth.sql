...
VALUES (11683, 'bookguidebook', 8) /* Book */;
...
VALUES (11683,   1,   33554771) /* Setup */
     ...
     , (11683, 8001,    2113592) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Container, Burden */
     , (11683, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (11683, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (11683,   2, 2461274288) /* Container */
     , (11683, 8000, 2461420566) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (11683, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (11683, 0, 4294967295, 'by F.P.', 'Password is cheese', False, '   As part of my continuing service to the organization for whom I do my work, I am writing down my observations about this charming little island I seem to have found myself on.  Mind you, this is not a full, that is to say, complete, account of the entire planet, as I find myself unable to leave the island that the locals call "Dereth."
')
