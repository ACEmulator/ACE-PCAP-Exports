...
VALUES (5129, 'book100paths7', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (5129, 8000, 2286933692) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5129, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5129, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'Khaymahlai
...
(more)
')
     , (5129, 1, 4294967295, 'prewritten', 'Password is cheese', False, 'On the edge of the bank there appeared a village, beaten to a pale brown by the sun.  On the bank sat a traveler, who dipped a skin into the river, filled it, and brought it to his lips.
...
(more)
')
     , (5129, 2, 4294967295, 'prewritten', 'Password is cheese', False, '''This village is mine, stranger,'' said Hayyaz.  ''If you wish to drink my water and live, you must do me homage.''  From the shadowed doorways, the lost eyes of children and women reflected torchlight.
...
')
     , (5129, 3, 4294967295, 'prewritten', 'Password is cheese', False, '''Forgive me,'' the traveler said, and rose to his feet.  ''I am new to these lands.  I shall return that which I have taken unearned.''  And at that, he doused the demon Hayyaz with the water from his skin, and with a terrible cry, it was no more.
...
')
     , (5129, 4, 4294967295, 'prewritten', 'Password is cheese', False, 'A woman, frail from sun and work, stumbled from the nearest hut, and cried, ''Who are you, who has delivered us?''
...
')
     , (5129, 5, 1343211716, 'Pygoscelis', 'Password is cheese', False, 'HI THERE');
