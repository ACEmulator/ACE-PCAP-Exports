...
VALUES (8856,   1,       8192) /* ItemType - Writable */
     ...
     , (8856,  19,          0) /* Value */
     , (8856,  65,        101) /* Placement - Resting */
     , (8856,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8856, 174,          6) /* AppraisalPages */
     , (8856, 175,          6) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8856,   1, False) /* Stuck */
     , (8856,  11, True ) /* IgnoreCollisions */
     , (8856,  13, True ) /* Ethereal */
     , (8856,  14, True ) /* GravityStatus */
     , (8856,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8856,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8856,   1,   33554771) /* Setup */
     ...
     , (8856, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8856, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8856, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8856,   2, 1880965200) /* Container */
     , (8856, 8000, 2616516114) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8856, 6, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8856, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8856, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
