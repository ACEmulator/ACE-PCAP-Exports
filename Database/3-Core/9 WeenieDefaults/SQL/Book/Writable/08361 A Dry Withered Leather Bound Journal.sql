...
VALUES (8361, 'bookmartine2', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (8361,   1,       8192) /* ItemType - Writable */
     ...
     , (8361,  19,         10) /* Value */
     , (8361,  65,        101) /* Placement - Resting */
     , (8361,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8361,   1, False) /* Stuck */
     , (8361,  11, True ) /* IgnoreCollisions */
     , (8361,  13, True ) /* Ethereal */
     , (8361,  14, True ) /* GravityStatus */
     , (8361,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8361,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8361,   1,   33554771) /* Setup */
     ...
     , (8361, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (8361, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8361, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8361, 8000, 2153220781) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8361, 16, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8361, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'To whomever may find this:
...
')
     , (8361, 5, 4294967295, 'prewritten', 'Password is cheese', False, 'The near constant physical exertion, almost to the point of exhaustion,  left me unable to truly ponder the circumstances of recent events. 
...
')
     , (8361, 6, 4294967295, 'prewritten', 'Password is cheese', False, 'Many hours and miles passed beneath our feet, and yet step for step was matched by our pursuers for most of the way.  What desire lurked beneath those misshapen bodies to fuel such effort?
...
')
     , (8361, 7, 4294967295, 'prewritten', 'Password is cheese', False, 'homeland.  And yet if they did have such bloodlust towards each other, would we not have seen it before this?
...
')
     , (8361, 12, 4294967295, 'prewritten', 'Password is cheese', False, 'Perhaps the rock has some sort of similar importance for the Banderlings.  I wish I knew more about them, but if you receive this note than please try to find a Olivier  Rognath, who resides in Eastham, on the eastern coast of Dereth.  While he is not a full fledged Explorer in the Society, he has been a close ally to our purposes.  He is also far more knowledgeable about Banderlings than I am, although of course even experts on our new neighbors know little.
')
     , (8361, 13, 4294967295, 'prewritten', 'Password is cheese', False, 'But if you find this note, and its brother, please journey there to see him.  Maybe he can shed some light on what has been transpiring here.  
