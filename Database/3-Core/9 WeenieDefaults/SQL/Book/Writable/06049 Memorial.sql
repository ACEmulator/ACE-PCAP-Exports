...
VALUES (6049, 'lecternjournalfrore', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (6049,   1,       8192) /* ItemType - Writable */
     ...
     , (6049, 174,         20) /* AppraisalPages */
     , (6049, 175,         20) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6049,   1, True ) /* Stuck */
     , (6049,  11, True ) /* IgnoreCollisions */
     , (6049,  13, True ) /* Ethereal */
     , (6049,  14, True ) /* GravityStatus */
     , (6049,  19, True ) /* Attackable */;
...
VALUES (6049,   1,   33556013) /* Setup */
     ...
     , (6049, 8001,    2097208) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Burden */
     , (6049, 8003,        276) /* PCAPRecordedObjectDesc - Stuck, Attackable, Book */
     , (6049, 8005,      38913) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position */;
...
VALUES (6049, 8000, 1880477899) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6049, 20, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6049, 0, 4294967295, 'Tremblant Party Journals', 'Password is cheese', False, '
...
')
     , (6049, 1, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
The Expedition of
...
')
     , (6049, 2, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
Entry 1
...
')
     , (6049, 3, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 4, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 3
...
')
     , (6049, 5, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 6, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 5
...
')
     , (6049, 7, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 6
...
')
     , (6049, 8, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 9, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
Entry 7
...
')
     , (6049, 10, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '-ew ruined structures that lie here we have discovered a locked gate - what lies beyond can only be what we have been searching for!  There is another arrangement of stones here, which seems to radiate a powerful energy.
...
')
     , (6049, 11, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 8
...
')
     , (6049, 12, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 13, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 14, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, '
...
')
     , (6049, 15, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 9
...
')
     , (6049, 16, 4294967295, 'Yarick Pathwarden', 'Password is cheese', False, ' 
Entry 10
...
')
     , (6049, 17, 4294967295, 'Ion Lundgren', 'Password is cheese', False, '
Entry 13
...
')
     , (6049, 18, 4294967295, 'Ion Lundgren', 'Password is cheese', False, '
