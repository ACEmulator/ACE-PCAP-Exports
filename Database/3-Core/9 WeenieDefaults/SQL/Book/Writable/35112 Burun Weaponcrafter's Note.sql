...
VALUES (35112, 'ace35112-burunweaponcraftersnote', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (35112,   1,       8192) /* ItemType - Writable */
     ...
     , (35112, 8041,        101) /* PCAPRecordedPlacement - Resting */
     , (35112, 8042,          3) /* PCAPRecordedAppraisalPages */
     , (35112, 8043,          3) /* PCAPRecordedAppraisalMaxPages */;
...
VALUES (35112,   1, 0x02000155) /* Setup */
     , (35112,   3, 0x20000014) /* SoundTable */
     , (35112,   8, 0x06001310) /* Icon */
     , (35112,  22, 0x3400002B) /* PhysicsEffectTable */
     , (35112, 8001,    2113584) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Container, Burden */
     , (35112, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (35112, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (35112, 8000, 0xDD0F4FBE) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (35112, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (35112, 0, 4294967295, 'Kuurak', 'prewritten', False, 'We Burun have in the past been very conservative in the use of mucor. We remember the memories of our ancient ancestors improperly using mucor and suffering grievous injuries or death. However, after recent conversations with Dobblar, I have come to wonder if perhaps we are being too conservative. After some research, I have come to find some ways in which mucor may be combined with various other materials.
...
')
     , (35112, 2, 4294967295, 'Kuurak', 'prewritten', False, 'Mucor-altered Granite:
Bone Sword
Stone Axe
Bone Dagger
Guruk Fist
