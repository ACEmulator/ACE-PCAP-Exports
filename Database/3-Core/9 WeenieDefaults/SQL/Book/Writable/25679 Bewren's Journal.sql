...
VALUES (25679, 'notebethelbrother', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (25679,   1,       8192) /* ItemType - Writable */
     ...
     , (25679,  65,        101) /* Placement - Resting */
     , (25679,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (25679, 114,          0) /* Attuned - Normal */
     , (25679, 174,          9) /* AppraisalPages */
     , (25679, 175,          9) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (25679,   1, False) /* Stuck */
     , (25679,  11, True ) /* IgnoreCollisions */
     , (25679,  13, True ) /* Ethereal */
     , (25679,  14, True ) /* GravityStatus */
     , (25679,  19, True ) /* Attackable */;
...
VALUES (25679,   1,   33554771) /* Setup */
     ...
     , (25679, 8001,    2097200) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Burden */
     , (25679, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (25679, 8005,     169985) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position, AnimationFrame */;
...
VALUES (25679, 8000, 3333745046) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25679, 9, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25679, 0, 4294967295, 'Bewren', 'Password is cheese', False, 'While we were fur hunting on the Marescent Plateau yesterday, Jaeget and I were approached by a man proclaiming to be capable of making our lives meaningful. 
...
')
     , (25679, 1, 4294967295, 'Bewren', 'Password is cheese', False, 'Poor Jaeget wasn''t alive on Ispar but four years, so luckily he didn''t have to confront any of those types. 
...
---
')
     , (25679, 2, 4294967295, 'Bewren', 'Password is cheese', False, 'Jaeget has done nothing but yammer on about the Order of the Raven Hand since we ran across the recruiter on Marae nearly a week ago. 

What''s worse, his being taken with their beliefs has hurt business. 

We don''t have nearly enough hides to sell as we used to. 
')
     , (25679, 3, 4294967295, 'Bewren', 'Password is cheese', False, 'I would suggest another trip to Marae, though I fear bringing him there would only further advance his desire to join the Raven Hand.
...
--
')
     , (25679, 4, 4294967295, 'Bewren', 'Password is cheese', False, 'I awoke only briefly last night to see my cot surrounded by several men swathed in dark cloaks. In the background I could see them embracing Jaeget and then everything went dark.
...
')
     , (25679, 5, 4294967295, 'Bewren', 'Password is cheese', False, 'His tale was one of woe, though after learning of his previous accommodations, this place seemed more hospitable than what he had previously... but only slightly.
...
---
')
     , (25679, 6, 4294967295, 'Bewren', 'Password is cheese', False, 'I''ve been here for some time now, and I am tired of being here. I have no weapons, no lock picks, and no way of getting both my brother and I out of here safely. 
...
')
     , (25679, 7, 4294967295, 'Bewren', 'Password is cheese', False, 'When the guard comes to deliver our meal, I will liberate his key-ring and escape after curfew has gone into effect. On my way out, I will glean what information I can from the surrounding temple and note where entrances and exits are.
...
---
')
     , (25679, 8, 4294967295, 'Bewren', 'Password is cheese', False, 'Even now my head spins and charcoal-black cysts are beginning to form on my arms and face... I do not know what they did to me, but I know what they plan.  I have been moved away from Twitch and placed in some interim holding cell. Looking out into the room, I can see a pit of some sort.
