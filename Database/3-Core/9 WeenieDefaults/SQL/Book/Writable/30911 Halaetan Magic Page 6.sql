...
VALUES (30911, 'carloloreviamontianmages006', 8) /* Book */;
...
VALUES (30911,   1,       8192) /* ItemType - Writable */
     ...
     , (30911,  65,        101) /* Placement - Resting */
     , (30911,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (30911, 114,          0) /* Attuned - Normal */
     , (30911, 174,          1) /* AppraisalPages */
     , (30911, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30911,   1, False) /* Stuck */
     , (30911,  11, True ) /* IgnoreCollisions */
     , (30911,  13, True ) /* Ethereal */
     , (30911,  14, True ) /* GravityStatus */
     , (30911,  19, True ) /* Attackable */;
...
VALUES (30911,   2, 3682778325) /* Container */
     , (30911, 8000, 3682776042) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (30911, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (30911, 0, 4294967295, 'Carlo di Cenza', 'Password is cheese', False, 'Though the Duke had retired, Eleonora remained. She noticed the looks which Sir Bellas and I exchanged. She approached the two of us and whispered, "Meet me at my cottage. One hour," then left.
