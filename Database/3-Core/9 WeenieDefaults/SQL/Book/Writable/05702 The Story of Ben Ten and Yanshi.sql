...
VALUES (5702, 'lecternbenten', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (5702,   1,       8192) /* ItemType - Writable */
     ...
     , (5702, 174,         14) /* AppraisalPages */
     , (5702, 175,         14) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5702,   1, True ) /* Stuck */
     , (5702,  11, True ) /* IgnoreCollisions */
     , (5702,  13, False) /* Ethereal */
     , (5702,  14, True ) /* GravityStatus */
     , (5702,  19, True ) /* Attackable */;
...
VALUES (5702,   1,   33556013) /* Setup */
     ...
     , (5702, 8001,    2097208) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Burden */
     , (5702, 8003,        276) /* PCAPRecordedObjectDesc - Stuck, Attackable, Book */
     , (5702, 8005,      38913) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (5702, 8040, 3847094538, 80.4384, 83.9541, 12, 0.707107, 0, 0, -0.707107) /* PCAPRecordedLocation */
/* @teleloc 0xE54E010A [80.438400 83.954100 12.000000] 0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (5702, 8000, 2119491597) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5702, 14, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5702, 0, 4294967295, 'Ben Ten and Yanshi', 'Password is cheese', False, 'Ben Ten was, they say, among the first of our people to arrive upon this island, in the days when the Olthoi still ran rampant.  Some say Ben Ten was the first Sho to arrive.  Whether man or woman, we do not even know for sure; we know only that Ben Ten was tall, thin of frame, and wore always a dark hood.  Speaking softly, wielding a tachi of a quality that rivals even the mythical swords of the Dragon Temple, Ben Ten walked the land in search of the desperate who needed help.  I know this because I was one of those rescued by Ben Ten.
')
     , (5702, 1, 4294967295, 'Ben Ten and Yanshi', 'Password is cheese', False, 'As a child of only twelve summers, I was torn from my land and brought here, alone.  As I wandered the plains, it happened that a pack of what I later learned to be reed sharks came upon me, and I remember fleeing toward an unfamiliar cluster of houses, screaming, sobbing, and knowing the terrible monsters would soon catch me.  I saw a shadow come running from a house, and I saw the flash of a sword, but then I tripped and fell.  As I lay cowering, I heard snarling and snapping and growling, and then a long silence.  
')
     , (5702, 2, 4294967295, 'Ben Ten and Yanshi', 'Password is cheese', False, 'At last I heard footsteps approach, and a soft voice - a voice neither deep nor high, neither obviously male or female - asked, "Are you all right?"
