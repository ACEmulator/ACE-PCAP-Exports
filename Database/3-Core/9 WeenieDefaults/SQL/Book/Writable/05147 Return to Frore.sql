...
VALUES (5147,   1,       8192) /* ItemType - Writable */
     ...
     , (5147,  19,         35) /* Value */
     , (5147,  65,        101) /* Placement - Resting */
     , (5147,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (5147, 174,          8) /* AppraisalPages */
     , (5147, 175,          8) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5147,   1, False) /* Stuck */
     , (5147,  11, True ) /* IgnoreCollisions */
     , (5147,  13, True ) /* Ethereal */
     , (5147,  14, True ) /* GravityStatus */
     , (5147,  19, True ) /* Attackable */;
...
VALUES (5147,   1,   33554771) /* Setup */
     ...
     , (5147, 8001,    2113592) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Container, Burden */
     , (5147, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (5147, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (5147,   2, 1342696490) /* Container */
     , (5147, 8000, 2875393000) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5147, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5147, 0, 4294967295, 'Fanzen San', 'Password is cheese', False, '
Introduction
...
')
     , (5147, 1, 4294967295, 'Fanzen San', 'Password is cheese', False, '
...
')
     , (5147, 2, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
...
')
     , (5147, 3, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
...
')
     , (5147, 4, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
...
')
     , (5147, 5, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
...
')
     , (5147, 6, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
...
')
     , (5147, 7, 4294967295, 'Abrim of Morningthaw', 'Password is cheese', False, '
