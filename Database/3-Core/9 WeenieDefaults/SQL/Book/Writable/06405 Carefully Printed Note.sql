...
VALUES (6405, 'morphnote1untranslated', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (6405,   1,       8192) /* ItemType - Writable */
     ...
     , (6405,  19,          3) /* Value */
     , (6405,  65,        101) /* Placement - Resting */
     , (6405,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (6405, 174,          1) /* AppraisalPages */
     , (6405, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6405,   1, False) /* Stuck */
     , (6405,  11, True ) /* IgnoreCollisions */
     , (6405,  13, True ) /* Ethereal */
     , (6405,  14, True ) /* GravityStatus */
     , (6405,  19, True ) /* Attackable */;
...
VALUES (6405, 8040, 18547189, 52.2553, -51.1787, -11.921, 0.387404, 0, 0, -0.92191) /* PCAPRecordedLocation */
/* @teleloc 0x011B01F5 [52.255300 -51.178700 -11.921000] 0.387404 0.000000 0.000000 -0.921910 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (6405, 8000, 2930769502) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6405, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6405, 0, 4294967295, 'Unknown', 'Password is cheese', False, '
