...
VALUES (24871, 'booknuhmudiraharbinger', 8) /* Book */;
...
VALUES (24871,   1,       8192) /* ItemType - Writable */
     ...
     , (24871,  19,          0) /* Value */
     , (24871,  65,        101) /* Placement - Resting */
     , (24871,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (24871, 174,         12) /* AppraisalPages */
     , (24871, 175,         12) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24871,   1, False) /* Stuck */
     , (24871,  11, True ) /* IgnoreCollisions */
     , (24871,  13, True ) /* Ethereal */
     , (24871,  14, True ) /* GravityStatus */
     , (24871,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (24871,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (24871,   2, 1342410606) /* Container */
     , (24871, 8000, 2448208909) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24871, 12, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24871, 0, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Children of Ispar,
...
')
     , (24871, 1, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'I have provided for you where I can, creating new lifestones, and continuing to garner knowledge of Empyrean culture, to learn why they faltered and ultimately were destroyed.
...
')
     , (24871, 2, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'I have also learned that this being, having been removed from the mana streams, is slowly draining the magic from this world. If it is not returned to the place where it was intended to rest, it will ultimately tear this world asunder.
...
')
     , (24871, 3, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'While the Harbinger in it''s physical form is relatively weak in comparison to other creatures, its magical essence is potent. It was the reason that Yanshi burned so quickly.
...
')
     , (24871, 4, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'While this may at first appear as a boon, as the enemies that prowl this land would also be affected, it would mean that the tenacity, and numbers of our enemies would overwhelm us, relegating us to a position of subservience. I will not see that happen.
...
')
     , (24871, 5, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'I have informed him that the items collected and handed to him should represent a skill. These are the items that I desire and the skill that they will represent to Issk:
...
')
     , (24871, 6, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Peerless Drudge Charm = Magic Defense
...
')
     , (24871, 7, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Gauloth Shreth Hide = Recklessness
...
')
     , (24871, 8, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Drudge Ravener Guts = Leadership
...
')
     , (24871, 11, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Returning the Harbinger into the mana streams of the world will be a slow process, one that must be done cautiously. I thank you for your efforts in advance. It is through the wisdom and strength of others like you that we shall see this aberration returned to where it belongs.
