...
VALUES (32847, 'ace32847-lordmarsanslogbook', 8) /* Book */;
...
VALUES (32847,   1,       8192) /* ItemType - Writable */
     ...
     , (32847,  19,         50) /* Value */
     , (32847,  65,        101) /* Placement - Resting */
     , (32847,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (32847,   1, False) /* Stuck */
     , (32847,  11, True ) /* IgnoreCollisions */
     , (32847,  13, True ) /* Ethereal */
     , (32847,  14, True ) /* GravityStatus */
     , (32847,  19, True ) /* Attackable */;
...
')
     , (32847, 6, 4294967295, 'Lord Marsan', 'Password is cheese', False, 'It was midway through one of the Tumerok rants that one of my men noticed that the skies had grown very dark. Since there had not been a cloud in the sky before that, he found it very unusual and worth noting. All of us, even the Tumeroks, stepped out of the tent to view what my man had seen.
...
')
     , (32847, 9, 4294967295, 'Lord Marsan', 'Password is cheese', False, 'We are now in a grove of trees at the edge fo the crater, but I can already sense a darkness closing in. Count Di Orza says he will not succumb lightly, and I am of the same mind. Let whosoever finds this journal bring it to someone...anyone. The Viamontians and New Aluvians will want to know what has happened to their forces, and I imagine even those from Fort Tethana will want to know. Just make sure that someone knows of the doom that came to this battlefield. I do not expect to survive to do so.
