...
VALUES (6878, 'notehamudlasttestament', 8) /* Book */;
...
VALUES (6878,   1,   33554773) /* Setup */
     ...
     , (6878, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (6878, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (6878, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (6878,   2, 1343403077) /* Container */
     , (6878, 8000, 3692812733) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6878, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6878, 0, 4294967295, 'Hamud ibn Rafik', 'Password is cheese', False, 'My daughter,
...
')
     , (6878, 1, 4294967295, 'Hamud ibn Rafik', 'Password is cheese', False, 'Do not fall as I have fallen, my daughter.  Seek a way to escape Dereth.  I have heard that others have disappeared from this undead world.  My hope is that you will find a way to disappear as well.
