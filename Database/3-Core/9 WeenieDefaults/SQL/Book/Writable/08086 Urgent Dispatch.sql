...
VALUES (8086, 'notefenmalainundeadtranslated', 8) /* Book */;
...
VALUES (8086,   1,   33554773) /* Setup */
     ...
     , (8086, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (8086, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8086, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8086,   2, 1343255884) /* Container */
     , (8086, 8000, 2884860702) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8086, 7, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8086, 0, 4294967295, 'Sahoni Arsanc', 'Password is cheese', False, '
My lord Anadil,
...
')
     , (8086, 1, 4294967295, 'Sahoni Arsanc', 'Password is cheese', False, '
...
')
     , (8086, 2, 4294967295, 'Sahoni Arsanc', 'Password is cheese', False, '
...
')
     , (8086, 5, 4294967295, 'Sahoni Arsanc', 'Password is cheese', False, 'My lord, I now command a much-depleted force, consisting of the weaker and wounded common soldiery. I do fear we no longer have sufficient force to hold this facility from the servants of the Enemy. I pray you to speed reinforcement, lest the next sally dislodge us utterly. We expect a fresh assault from the upper levels at any moment. I will send this note to you through our last surviving enchanter, Lord Pleridarc of-

I hear now the clatter of renewed combat. The shouts are foreign. They may be in the tongue of the outlanders.
')
     , (8086, 6, 4294967295, 'Sahoni Arsanc', 'Password is cheese', False, '
