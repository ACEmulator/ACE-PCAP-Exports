...
VALUES (8860, 'histjul00', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (8860,   1,       8192) /* ItemType - Writable */
     ...
     , (8860,  19,          0) /* Value */
     , (8860,  65,        101) /* Placement - Resting */
     , (8860,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8860, 174,         11) /* AppraisalPages */
     , (8860, 175,         11) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8860,   1, False) /* Stuck */
     , (8860,  11, True ) /* IgnoreCollisions */
     , (8860,  13, True ) /* Ethereal */
     , (8860,  14, True ) /* GravityStatus */
     , (8860,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8860,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8860,   1,   33554771) /* Setup */
     ...
     , (8860, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8860, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8860, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8860, 8000, 2616464274) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8860, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8860, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 5, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 6, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 8, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 9, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8860, 10, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
