...
VALUES (7381, 'letteraerfalletranslated', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (7381,   1,       8192) /* ItemType - Writable */
     ...
     , (7381,  19,         90) /* Value */
     , (7381,  65,        101) /* Placement - Resting */
     , (7381,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7381,   1, False) /* Stuck */
     , (7381,  11, True ) /* IgnoreCollisions */
     , (7381,  13, True ) /* Ethereal */
     , (7381,  14, True ) /* GravityStatus */
     , (7381,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (7381,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (7381,   1,   33554771) /* Setup */
     ...
     , (7381, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (7381, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (7381, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (7381, 8000, 3092507579) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (7381, 28, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (7381, 0, 4294967295, 'Kuyiza bint Zayi', 'Password is cheese', False, 'Translator''s note: There is a word early in this text which defies easy conversion from Dericostian to Roulean. This I have rendered as "kemeroi," a direct phonetic equivalent of the original word.
...
')
     , (7381, 1, 4294967295, 'Kuyiza bint Zayi', 'Password is cheese', False, 'at awakening from a nightmare, thing that causes melting, liquid given form by a vessel, the touch of something frozen, and night that moves as a liquid.
...
')
     , (7381, 2, 4294967295, 'Kuyiza bint Zayi', 'Password is cheese', False, '
...
- Kuyiza bint Zayi
')
     , (7381, 3, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
Dearest Rytheran,
...
')
     , (7381, 6, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 12, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 13, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 14, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 15, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 17, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 18, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 19, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 20, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 21, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 22, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 23, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 24, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
...
')
     , (7381, 27, 4294967295, 'Lady Aerfalle', 'Password is cheese', False, '
