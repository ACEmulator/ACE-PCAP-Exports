...
VALUES (6030, 'bookmountainfortressfallenmaster', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (6030,   1,       8192) /* ItemType - Writable */
     ...
     , (6030,  19,         25) /* Value */
     , (6030,  65,        101) /* Placement - Resting */
     , (6030,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (6030, 174,          5) /* AppraisalPages */
     , (6030, 175,          5) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6030,   1, True ) /* Stuck */
     , (6030,  11, True ) /* IgnoreCollisions */
     , (6030,  13, True ) /* Ethereal */
     , (6030,  14, True ) /* GravityStatus */
     , (6030,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (6030,  39, 1.22000002861023) /* DefaultScale */
     , (6030,  54,       1) /* UseRadius */;
...
VALUES (6030, 8040, 18612495, 86.5, -107, -41.93656, 0.7071068, 0, 0, -0.7071068) /* PCAPRecordedLocation */
/* @teleloc 0x011C010F [86.500000 -107.000000 -41.936560] 0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (6030, 8000, 1880211457) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6030, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6030, 0, 4294967295, 'unknown author', 'Password is cheese', False, '
