...
VALUES (24126, 'letterelysatoalatar', 8) /* Book */;
...
VALUES (24126,   1,       8192) /* ItemType - Writable */
     ...
     , (24126,  19,         10) /* Value */
     , (24126,  65,        101) /* Placement - Resting */
     , (24126,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (24126, 174,          8) /* AppraisalPages */
     , (24126, 175,          8) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (24126,   1, False) /* Stuck */
     , (24126,  11, True ) /* IgnoreCollisions */
     , (24126,  13, True ) /* Ethereal */
     , (24126,  14, True ) /* GravityStatus */
     , (24126,  19, True ) /* Attackable */;
...
VALUES (24126,   1,   33554773) /* Setup */
     ...
     , (24126, 8001,    2113592) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Container, Burden */
     , (24126, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (24126, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (24126,   2, 1342814975) /* Container */
     , (24126, 8000, 3683069697) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (24126, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (24126, 0, 4294967295, 'Elysa', 'Password is cheese', False, '
My dear Alatar!
...
')
     , (24126, 1, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 2, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 3, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 4, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 5, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 6, 4294967295, 'Elysa', 'Password is cheese', False, '
...
')
     , (24126, 7, 4294967295, 'Elysa', 'Password is cheese', False, '
