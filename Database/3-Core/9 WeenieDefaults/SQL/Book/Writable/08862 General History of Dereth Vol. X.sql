...
VALUES (8862, 'histsep00', 8, '2019-02-10 08:04:04') /* Book */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8862,   1,       8192) /* ItemType - Writable */
     , (8862,   5,         10) /* EncumbranceVal */
     , (8862,  16,          8) /* ItemUseable - Contained */
     , (8862,  65,        101) /* Placement - Resting */
     , (8862,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8862,   1, False) /* Stuck */
     , (8862,  11, True ) /* IgnoreCollisions */
     , (8862,  13, True ) /* Ethereal */
     , (8862,  14, True ) /* GravityStatus */
     , (8862,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8862,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8862,   1,   33554771) /* Setup */
     ...
     , (8862, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8862, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8862, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8862, 8000, 2616272514) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8862, 12, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8862, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 2, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 6, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'Shadows and undead, apparently the survivors of a massive battle a few hours before. Large companies of Shadows infested the second dungeon, Caulnalain. They appeared to be working at the behest of Isin Dule, for they staunchly defended the facility. The last, Shendolain, was thick with powerful undead from the Direlands castle of Chalicmere and Aerlinthe island. Casualties at this dungeon were horrific.
')
     , (8862, 8, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8862, 9, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
