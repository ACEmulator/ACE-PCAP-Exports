...
VALUES (23918, 'writingtumerokwar5', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (23918,   1,       8192) /* ItemType - Writable */
     ...
     , (23918,  19,          1) /* Value */
     , (23918,  65,        101) /* Placement - Resting */
     , (23918,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (23918, 174,          1) /* AppraisalPages */
     , (23918, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (23918,   1, False) /* Stuck */
     , (23918,  11, True ) /* IgnoreCollisions */
     , (23918,  13, True ) /* Ethereal */
     , (23918,  14, True ) /* GravityStatus */
     , (23918,  19, True ) /* Attackable */;
...
VALUES (23918, 8040, 1447232062, 178.842, -69.6958, -17.921, 0.3726908, 0, 0, 0.9279556) /* PCAPRecordedLocation */
/* @teleloc 0x5643023E [178.842000 -69.695800 -17.921000] 0.372691 0.000000 0.000000 0.927956 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (23918, 8000, 2629757633) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (23918, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (23918, 0, 4294967295, 'Amaltah', 'Password is cheese', False, '
