...
VALUES (25940, 'noteemptysoul1', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (25940,   1,       8192) /* ItemType - Writable */
     ...
     , (25940,  19,         10) /* Value */
     , (25940,  65,        101) /* Placement - Resting */
     , (25940,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (25940, 174,          2) /* AppraisalPages */
     , (25940, 175,          2) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (25940,   1, True ) /* Stuck */
     , (25940,  11, True ) /* IgnoreCollisions */
     , (25940,  13, True ) /* Ethereal */
     , (25940,  14, True ) /* GravityStatus */
     , (25940,  19, True ) /* Attackable */;
...
VALUES (25940, 8040, 3829202993, 150.118, 17.6175, 70.07899, -0.6113209, 0, 0, -0.7913828) /* PCAPRecordedLocation */
/* @teleloc 0xE43D0031 [150.118000 17.617500 70.078990] -0.611321 0.000000 0.000000 -0.791383 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (25940, 8000, 2118373407) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25940, 2, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25940, 0, 4294967295, 'Honshu Takeda', 'Password is cheese', False, 'I am without the tongue to express the emptiness that has entered my being. I have lost sight of what it meant to live a right life. I have placed the need of physical goods over the breath that must fill my soul.
...
(more)
')
     , (25940, 1, 4294967295, 'Honshu Takeda', 'Password is cheese', False, '
