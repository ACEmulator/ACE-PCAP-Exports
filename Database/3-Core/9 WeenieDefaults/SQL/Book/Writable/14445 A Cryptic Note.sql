...
VALUES (14445, 'noteregicideholtburg', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (14445,   1,       8192) /* ItemType - Writable */
     ...
     , (14445,  65,        101) /* Placement - Resting */
     , (14445,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (14445, 114,          1) /* Attuned - Attuned */
     , (14445, 174,          1) /* AppraisalPages */
     , (14445, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (14445,   1, False) /* Stuck */
     , (14445,  11, True ) /* IgnoreCollisions */
     , (14445,  13, True ) /* Ethereal */
     , (14445,  14, True ) /* GravityStatus */
     , (14445,  19, True ) /* Attackable */;
...
VALUES (14445, 8000, 2780559588) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (14445, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (14445, 0, 4294967295, 'prewritten', 'Password is cheese', False, '(The creases in the parchment have obscured much of the writing, but some of it is still discernible.)
