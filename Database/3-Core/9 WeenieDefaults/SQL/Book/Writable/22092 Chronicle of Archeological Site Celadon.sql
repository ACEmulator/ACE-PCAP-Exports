...
VALUES (22092, 'translatedsheafofpapers', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (22092,   1,   33554771) /* Setup */
     ...
     , (22092, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (22092, 8003,        274) /* PCAPRecordedObjectDesc - Inscribable, Attackable, Book */
     , (22092, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (22092, 8000, 3705489529) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (22092, 36, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (22092, 0, 4294967295, 'Jaerak Tiolan', 'Password is cheese', False, 'Day One
...
')
     , (22092, 1, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'Day Two
...
')
     , (22092, 2, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'Aimara insists this is a place of interest, though it is based on a mere feeling.  If I did not know her better, nor her success in these matters, I might give up and proceed to Site Bronze.
...
')
     , (22092, 3, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'of our profession.
...
')
     , (22092, 4, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, '
...
')
     , (22092, 5, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I must have just woken from the nightmare at that moment.
...
')
     , (22092, 6, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'black in color, indeed a black beyond black. It seems to absorb any light that hits it. At the same time the black material sparkles dimly as if it has its own inner light, the tiny points of light appear almost as afterimages in the eyes.
...
')
     , (22092, 7, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'Day Nine
...
')
     , (22092, 10, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'vaguely like us in shape, but had been withered and twisted in upon itself. Had it met its fate on the spot?  We marked the location and rough body outline with wooden markers. One outline of a twisted limb appeared to have been holding another artifact we excavated nearby. It is a curious rod or staff of a stone similar to that of the mysterious sarcophagus. Thus, there is a clear connection between this unhappy creature and the dark coffin but what that may we cannot surmise yet.  The staff has magical qualities- Aimara was holding it and flames burst forth, like a fiery halo.  Yet it did not burn her hands.
')
     , (22092, 11, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'The Dericost are still here and seem to be doing nothing but wander aimlessly through the tunnels. Aimara joked that perhaps the cold helps preserve them and they merely enjoy being down here. Truth that may be, however I am certain there is a connection between their appearance and the dark sarcophagus. Their lack of interaction with us is curious.
...
')
     , (22092, 12, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'may serve us well in conflicts with the Dericost. Drawn to it they are, they wander docilely and do not oppose us. This mystical force should be researched and harnessed! Could the thing in the coffin be an entity of intellect, intelligence, and consciousness? An ancient mentality which reasons with dark purpose?  A mentality which reasons with dark purpose?  Aimara now believes it is just that and reacts warily at my suggestions of the ways it may serve us, its possible utility.

We must safeguard this power, keep it secret until it can be discerned and made use of!
')
     , (22092, 13, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'Day Thirteen
...
All research and no recreation make Jaerak a drab archeologist.
')
     , (22092, 16, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
...
All research and no recreation make Jaerak a drab archeologist.
')
     , (22092, 17, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
All research and no recreation make Jaerak a drab archeologist.
...
All research and no recreation make Jaerak a drab archeologist.
')
     , (22092, 18, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'Day Fourteen
...
')
     , (22092, 19, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I know there has been slaughter on a wide scale. I close my eyes and the sarcophagus shows me a boundless terrain filled with corpses of the slain. The bodies stretch from horizon to horizon under a leaden sky. They are its alimentation. I see them rise as one.
...
')
     , (22092, 20, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I open my eyes suddenly and the frozen stone wall before me halts my flight as if I had raced headlong into it! In the tunnels around us the Dericost mill. I know they grow restless, they sense I will have them under my power soon!
...
')
     , (22092, 22, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I do not believe him, it must be part of his schemes.
...
')
     , (22092, 23, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I screamed at Jaerak to listen to reason, come with me. I begged for lucidity to return to him for just one instant, but the dark sarcophagus would not let go of him, or he of it.  He stood there blankly watching me.
...
')
     , (22092, 24, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'He snatched the hammer from my hand and shoved me aside violently. I fell to the ground. 
...
')
     , (22092, 25, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I could not gain access to the surface. I heard Jaerak following, then he turned away and went upwards. I must stay hidden until I am certain he is not near, then I will make my way to the surface where I hope to get help.
...
')
     , (22092, 26, 4294967295, 'Jaerak Tarnelon', 'Password is cheese', False, 'I scribble this hastily. I am trapped now in a dead-end corridor. Jaerak is in theadjoining tunnel; I hear his ragged breathing, his incoherent screams. His rage is absolute. He will find me soon, will be here any minute. The undead follow him today; I feel they seek me also. 
