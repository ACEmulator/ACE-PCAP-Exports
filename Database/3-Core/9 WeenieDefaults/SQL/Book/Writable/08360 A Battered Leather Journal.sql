...
VALUES (8360, 'bookmartine1', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (8360,   1,   33554771) /* Setup */
     ...
     , (8360, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (8360, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8360, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8360, 8000, 3704191127) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8360, 9, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8360, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'To whomever may find this, please give to Olivier Rognath.  The last I saw of him, he resided in Eastham:
...
')
     , (8360, 1, 4294967295, 'prewritten', 'Password is cheese', False, 'Who could have imagined a world in which death is no longer the end of one''s thoughts and experiences but merely a temporary stage in between?  Unless, one day, it changes...but useless for me to think of that now.
...
')
     , (8360, 2, 4294967295, 'prewritten', 'Password is cheese', False, 'Sir Alayne had sent me to a relatively new Mosswart outpost to take notes on general Mosswart life, and to see if I could verify whether there were any sort of organized movement amongst the creatures, and if so, why.
