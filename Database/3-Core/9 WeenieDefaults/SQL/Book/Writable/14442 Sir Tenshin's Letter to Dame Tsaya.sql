...
VALUES (14442, 'letterregicidetsaya2', 8) /* Book */;
...
VALUES (14442,   1,       8192) /* ItemType - Writable */
     ...
     , (14442,  65,        101) /* Placement - Resting */
     , (14442,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (14442, 114,          1) /* Attuned - Attuned */
     , (14442, 174,          5) /* AppraisalPages */
     , (14442, 175,          5) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (14442,   1, False) /* Stuck */
     , (14442,  11, True ) /* IgnoreCollisions */
     , (14442,  13, True ) /* Ethereal */
     , (14442,  14, True ) /* GravityStatus */
     , (14442,  19, True ) /* Attackable */;
...
VALUES (14442,   1,   33554773) /* Setup */
     ...
     , (14442, 8001,    2113584) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Container, Burden */
     , (14442, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (14442, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (14442,   2, 1342572265) /* Container */
     , (14442, 8000, 3706799675) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (14442, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (14442, 0, 4294967295, 'Sir Tenshin', 'Password is cheese', False, 'Dame Tsaya,
...
')
     , (14442, 1, 4294967295, 'Sir Tenshin', 'Password is cheese', False, 'After interviewing the farmer, the bearer of this message found a trap door towards the rear of his house, leading down to a seeminly innocuous cellar. However, a large cache of weapons was found behind a hidden doorway as well as stacks of Guard uniforms.
...
')
     , (14442, 2, 4294967295, 'Sir Tenshin', 'Password is cheese', False, 'present nervous state I do not trust myself to summarize his words correctly, so I will add his words below. 
...
***
')
     , (14442, 3, 4294967295, 'Sir Tenshin', 'Password is cheese', False, 'Copy of the letter from Sir Rylanan to Sir Tenshin)
