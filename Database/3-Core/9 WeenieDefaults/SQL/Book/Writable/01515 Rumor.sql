...
VALUES (1515, 'lostlighthintf', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (1515,   1,       8192) /* ItemType - Writable */
     ...
     , (1515,  19,          5) /* Value */
     , (1515,  65,        101) /* Placement - Resting */
     , (1515,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (1515, 174,          1) /* AppraisalPages */
     , (1515, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1515,   1, False) /* Stuck */
     , (1515,  11, True ) /* IgnoreCollisions */
     , (1515,  13, True ) /* Ethereal */
     , (1515,  14, True ) /* GravityStatus */
     , (1515,  19, True ) /* Attackable */;
