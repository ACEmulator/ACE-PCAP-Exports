...
VALUES (34349, 'ace34349-lettertobretselfthetranslator', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (34349,   1,       8192) /* ItemType - Writable */
     ...
     , (34349,  19,       5000) /* Value */
     , (34349,  65,        101) /* Placement - Resting */
     , (34349,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (34349, 174,          3) /* AppraisalPages */
     , (34349, 175,          3) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (34349,   1, False) /* Stuck */
     , (34349,  11, True ) /* IgnoreCollisions */
     , (34349,  13, True ) /* Ethereal */
     , (34349,  14, True ) /* GravityStatus */
     , (34349,  19, True ) /* Attackable */;
...
VALUES (34349, 8000, 3645375832) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (34349, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (34349, 0, 4294967295, 'Asheron Realaidain', 'Password is cheese', False, 'To the esteemed scholar Bretself,
