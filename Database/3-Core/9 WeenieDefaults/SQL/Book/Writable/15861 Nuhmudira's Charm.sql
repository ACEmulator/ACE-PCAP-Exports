...
VALUES (15861,   1,       8192) /* ItemType - Writable */
     ...
     , (15861,  65,        101) /* Placement - Resting */
     , (15861,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (15861, 174,          8) /* AppraisalPages */
     , (15861, 175,          8) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (15861,   1, False) /* Stuck */
     , (15861,  11, True ) /* IgnoreCollisions */
     , (15861,  13, True ) /* Ethereal */
     , (15861,  14, True ) /* GravityStatus */
     , (15861,  19, True ) /* Attackable */;
...
VALUES (15861,   2, 1343670165) /* Container */
     , (15861, 8000, 3621813012) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (15861, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (15861, 0, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'He means to seal me within this place for eternity. How could I have been so blind. 
...
')
     , (15861, 1, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'A lesson is learned as the pain begins to spread through me. Never trust...anyone other than yourself. He thinks that I will shrivel so quickly within this cell. 
...
')
     , (15861, 2, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'She collects the red hair, turning white, from her head. Twisting, tightening, tying frayed end to frayed end in tedious precision, strand by strand. The pain must be felt in order for the magic to take hold. 
...
')
     , (15861, 3, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Her hand cups to pool the blood. Her fingers twist the braided strands of hair fashioning a point to make the writing and etching precise.
...
')
     , (15861, 5, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'The star must have the number of cardinal points, and the subsidiary points corresponding to the paths of true magic. Twelve points drawn from her blood, in concert with the timbre of her breathing.
...
')
     , (15861, 6, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'Death closes in upon her, as she feels the life ebbing from the wound, magics hold the flowing blood in place within her hand. Weak, so weak. Three more etchings, must be completed. She steels her mind and continues the rythym of the rite. Breathing her life into the strokes of each sigil.
...
')
     , (15861, 7, 4294967295, 'Nuhmudira', 'Password is cheese', False, 'One final word spoken, and the final breath released. The spell woven into the pages. The blood and pain are thrown onto the pile of lifeless wood, and her chants call to the life she has spread upon the fallen wood. 
