...
VALUES (8720,   1,       8192) /* ItemType - Writable */
     ...
     , (8720,  19,          1) /* Value */
     , (8720,  65,        101) /* Placement - Resting */
     , (8720,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8720,   1, False) /* Stuck */
     , (8720,  11, True ) /* IgnoreCollisions */
     , (8720,  13, True ) /* Ethereal */
     , (8720,  14, True ) /* GravityStatus */
     , (8720,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8720,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8720,   2, 2779768826) /* Container */
     , (8720, 8000, 2779768829) /* PCAPRecordedObjectIID */;
