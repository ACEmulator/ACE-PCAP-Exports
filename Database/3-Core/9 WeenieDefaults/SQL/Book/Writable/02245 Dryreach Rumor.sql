...
VALUES (2245, 'hintdryreach', 8) /* Book */;
...
VALUES (2245,   1,       8192) /* ItemType - Writable */
     ...
     , (2245,  19,          2) /* Value */
     , (2245,  65,        101) /* Placement - Resting */
     , (2245,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2245,   1, False) /* Stuck */
     , (2245,  11, True ) /* IgnoreCollisions */
     , (2245,  13, True ) /* Ethereal */
     , (2245,  14, True ) /* GravityStatus */
     , (2245,  19, True ) /* Attackable */;
...
VALUES (2245,   2, 2917029831) /* Container */
     , (2245, 8000, 2917029835) /* PCAPRecordedObjectIID */;
