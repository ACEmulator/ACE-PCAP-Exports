...
VALUES (5703, 'lecternkengou', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (5703,   1,       8192) /* ItemType - Writable */
     ...
     , (5703, 174,         21) /* AppraisalPages */
     , (5703, 175,         21) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5703,   1, True ) /* Stuck */
     , (5703,  11, True ) /* IgnoreCollisions */
     , (5703,  13, False) /* Ethereal */
     , (5703,  14, True ) /* GravityStatus */
     , (5703,  19, True ) /* Attackable */;
...
VALUES (5703,   1,   33556013) /* Setup */
     ...
     , (5703, 8001,    2097208) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Burden */
     , (5703, 8003,        276) /* PCAPRecordedObjectDesc - Stuck, Attackable, Book */
     , (5703, 8005,      38913) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position */;
...
VALUES (5703, 8000, 2119491600) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5703, 21, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5703, 0, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'This was one of my favorite stories back in the homelands, that warned of the dangers of attachment.  I learned it from my grandmother, and now that I am an old man, it is time that I teach future generations this tale.  Here it is as best as I remember.
')
     , (5703, 1, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'Once upon a time, there was a young man named Ken-gou.  He lived on Chiran-tou, the Island of the Unicorn.  Some said that Ken-gou was taught by the Unicorn in his dreams, for he had grown to become a most gracious person, kind to everyone, and loved by children.  Some said the Ken-gou was trained by the Dragon, for he was ever disciplined and strong.  But his mind was ever on the things beyond the world, and so his parents said that his path must surely be with the Firebird.
')
     , (5703, 2, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'When he came of age he said goodbye to his parents and traveled to the Washui Iiwah Jou, the Temple of the Splendor of the Firebird.  There, he prostrated himself before the Abbess Joutou, and said,
...
')
     , (5703, 3, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'But Abbess Joutou said with a smile,
...
')
     , (5703, 6, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'Ken-gou bowed and said, I will do as you ask.
...
')
     , (5703, 7, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'I will show you the pillar myself, said the Emperor.  And so the three were led down many dark steps until they came to a crude room, at the center of which, surrounded by many unreadable writings, stood the gold pillar.  They could sense the angry spirit of the snake, still wrapped around the pillar.
...
')
     , (5703, 8, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'The disciple of the Dragon was the first to act.  Drawing upon his disciplined powers, he called upon the very Dragon to destroy the snake spirit.  But the Dragon''s voice said, 
...
')
     , (5703, 9, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'The disciple of the Unicorn was the next to try.  Spirit snake, she said, let go the pillar and go to Heaven.  There is peace and Grace there, awaiting you.
...
')
     , (5703, 10, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'The disciple of the Unicorn then said, I will give the spirit my peace, and I will let the spirit stay.  If we do not disturb it, it can rest until the end of the world.
...
')
     , (5703, 11, 4294967295, 'Ken-gou and the Curse of Attachment', 'Password is cheese', False, 'He called the Emperor''s servants to him and said,  We must melt the pillar, right here within this room.  
