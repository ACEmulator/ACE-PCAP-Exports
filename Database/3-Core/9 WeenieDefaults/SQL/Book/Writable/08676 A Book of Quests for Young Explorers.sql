...
VALUES (8676, 'booknewbiequests', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (8676,   1,       8192) /* ItemType - Writable */
     ...
     , (8676, 8041,        101) /* PCAPRecordedPlacement - Resting */
     , (8676, 8042,         11) /* PCAPRecordedAppraisalPages */
     , (8676, 8043,         11) /* PCAPRecordedAppraisalMaxPages */;
...
VALUES (8676,   1,   33554771) /* Setup */
     ...
     , (8676, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8676, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8676, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8676, 8000, 2186220478) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8676, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8676, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'Welcome to the land of Dereth, fellow traveler!
...
')
     , (8676, 4, 4294967295, 'prewritten', 'Password is cheese', False, 'I wish you the best of luck in your journey.   
...
')
     , (8676, 5, 4294967295, 'prewritten', 'Password is cheese', False, 'Al-Arqas 
     ...
     Rewards:
        ...
        Yanshi Letter:  Axe
')
     , (8676, 6, 4294967295, 'prewritten', 'Password is cheese', False, 'Lytelthorpe      
     Agent: Lord Aleval
     Rewards:
