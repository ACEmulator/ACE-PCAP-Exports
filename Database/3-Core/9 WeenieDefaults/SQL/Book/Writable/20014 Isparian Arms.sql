...
VALUES (20014, 'bookisparianarms', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (20014,   1,   33554771) /* Setup */
     ...
     , (20014, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (20014, 8003,        274) /* PCAPRecordedObjectDesc - Inscribable, Attackable, Book */
     , (20014, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (20014, 8000, 2631404665) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (20014, 18, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (20014, 0, 4294967295, 'Ciandra', 'Password is cheese', False, 'Isparian Arms
...
')
     , (20014, 1, 4294967295, 'Ciandra', 'Password is cheese', False, 'this manuscript is written with an air of haste.
...
')
     , (20014, 2, 4294967295, 'Ciandra', 'Password is cheese', False, 'Our first efforts involved the use of Olthoi Ichor and later Grievver Ichor. Neither did anything more than reduce the ingot to slag.
...
')
     , (20014, 3, 4294967295, 'Ciandra', 'Password is cheese', False, 'succeeded at devising a spell that would do just that and hold our elixirs. Hiro, can explain that in more detail than I.
...
')
     , (20014, 4, 4294967295, 'Ciandra', 'Password is cheese', False, 'Purpose
...
')
     , (20014, 5, 4294967295, 'Ciandra', 'Password is cheese', False, 'By the end of a two week deliberation, during which Nuhmudira argued her point so well, that nearly all of the Arcanum agreed that the greatest threat to us on Dereth was indeed the Empyrean, it was decided that we would branch into several different arms.
...
Spellcrafters
')
     , (20014, 6, 4294967295, 'Ciandra', 'Password is cheese', False, 'And Tinkerers.
...
')
     , (20014, 7, 4294967295, 'Ciandra', 'Password is cheese', False, 'When Nuhmudira managed to release so much of the power that had been locked away into the metals we thought she had succeeded at what she wanted.
...
')
     , (20014, 8, 4294967295, 'Ciandra', 'Password is cheese', False, 'over this news.
...
Frustrating.
')
     , (20014, 9, 4294967295, 'Ciandra', 'Password is cheese', False, 'Resolution
...
')
     , (20014, 10, 4294967295, 'Ciandra', 'Password is cheese', False, 'I glanced up and saw his long white beard and amber eyes, Lord Asheron Realaidain.
...
')
     , (20014, 11, 4294967295, 'Ciandra', 'Password is cheese', False, 'He has made efforts to explain what we could not fathom and I have learned from him.
...
Ciandra
')
     , (20014, 12, 4294967295, 'Ciandra', 'Password is cheese', False, 'Diamond Oil
...
')
     , (20014, 13, 4294967295, 'Ciandra', 'Password is cheese', False, 'To craft it we will need powdered chorizite and the mana from the place that Asheron opens. The oil will then be prepared.
...
')
     , (20014, 14, 4294967295, 'Ciandra', 'Password is cheese', False, 'Weapon Infusion
...
')
     , (20014, 15, 4294967295, 'Ciandra ', 'Password is cheese', False, '
Elemental Stones
...
')
     , (20014, 16, 4294967295, 'Ciandra', 'Password is cheese', False, 'This is the process that Nuhmudira was searching for, but Lord Asheron was kind enough to show us.
...
')
     , (20014, 17, 4294967295, 'Ciandra', 'Password is cheese', False, 'Once the heart has been imbued with the oil find one who can carve keys and ask them to craft the altered Diamond Heart for you. The result should be a tool that will fit perfectly into the weapon to remove any of the elemental stones.
');
