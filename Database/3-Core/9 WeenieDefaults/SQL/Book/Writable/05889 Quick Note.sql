...
VALUES (5889, 'tremblantnotestonehold', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (5889,   1,       8192) /* ItemType - Writable */
     ...
     , (5889,  19,         20) /* Value */
     , (5889,  65,        101) /* Placement - Resting */
     , (5889,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (5889, 174,          1) /* AppraisalPages */
     , (5889, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5889,   1, True ) /* Stuck */
     , (5889,  11, True ) /* IgnoreCollisions */
     , (5889,  13, True ) /* Ethereal */
     , (5889,  14, True ) /* GravityStatus */
     , (5889,  19, True ) /* Attackable */;
