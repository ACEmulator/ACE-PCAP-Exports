...
VALUES (27908, 'bookmosswartbleeargh', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (27908,   1,       8192) /* ItemType - Writable */
     ...
     , (27908,  19,         25) /* Value */
     , (27908,  65,        101) /* Placement - Resting */
     , (27908,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (27908, 174,         11) /* AppraisalPages */
     , (27908, 175,         11) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (27908,   1, False) /* Stuck */
     , (27908,  11, True ) /* IgnoreCollisions */
     , (27908,  13, True ) /* Ethereal */
     , (27908,  14, True ) /* GravityStatus */
     , (27908,  19, True ) /* Attackable */;
...
VALUES (27908, 8000, 2982964657) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (27908, 11, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (27908, 0, 4294967295, 'Aliester the Loquacious', 'Password is cheese', False, 'Seedsow, 15 P.Y.
...
')
     , (27908, 1, 4294967295, 'Aliester the Loquacious', 'Password is cheese', False, 'I think we all know how that turned out.
...
')
     , (27908, 2, 4294967295, 'Aliester the Loquacious', 'Password is cheese', False, 'Imagine my surprise when my nephew Ardry claimed to have been approached by a Mosswart in Hebian-To for the purpose of exchanging goods!
