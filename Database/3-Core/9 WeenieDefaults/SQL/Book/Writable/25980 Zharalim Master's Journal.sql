...
VALUES (25980, 'notezharalimmaster', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (25980,   1,       8192) /* ItemType - Writable */
     ...
     , (25980,  19,          5) /* Value */
     , (25980,  65,        101) /* Placement - Resting */
     , (25980,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (25980, 174,          8) /* AppraisalPages */
     , (25980, 175,          8) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (25980,   1, False) /* Stuck */
     , (25980,  11, True ) /* IgnoreCollisions */
     , (25980,  13, True ) /* Ethereal */
     , (25980,  14, True ) /* GravityStatus */
     , (25980,  19, True ) /* Attackable */;
...
VALUES (25980,   1,   33554771) /* Setup */
     ...
     , (25980, 8001,    2097208) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Burden */
     , (25980, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (25980, 8005,     169985) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position, AnimationFrame */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (25980, 8040, 1682571894, 99.4089, -48.602, -17.943, 0.9921976, 0, 0, -0.124675) /* PCAPRecordedLocation */
/* @teleloc 0x644A0276 [99.408900 -48.602000 -17.943000] 0.992198 0.000000 0.000000 -0.124675 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (25980, 8000, 2881361601) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (25980, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (25980, 0, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'Log Entry 1-
...
')
     , (25980, 1, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'Log Entry 2-
...
')
     , (25980, 2, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'Log Entry 3-
...
')
     , (25980, 3, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'Log Entry 4-
...
')
     , (25980, 4, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'As a result of this, I have ordered that any of these beasts be destroyed on the spot and that everyone remain wary. I also ordered Yalik to remain in the top level of the tower. He is a bright lad, but not well versed in combat yet. I do not wish to see another of my command die.
...
')
     , (25980, 5, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'move with their own life. Our foreman has become unaccounted for as have Rheth Al''thok, Rayssid Ibn Alhath, and Tiyol Ibn Yufaj-- our three Cult infiltrators.
...
')
     , (25980, 6, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'The warrior reported they were swathed in black and gold robes, akin to those the Raven Hand has been known to wear.
...
')
     , (25980, 7, 4294967295, 'Zharalim Master Yaral', 'Password is cheese', False, 'I do not believe any of us here are safe from the madness, and so I know what must be done. 
