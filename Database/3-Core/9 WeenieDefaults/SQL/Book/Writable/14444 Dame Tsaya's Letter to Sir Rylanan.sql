...
VALUES (14444, 'letterregiciderylanan2', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (14444,   1,       8192) /* ItemType - Writable */
     ...
     , (14444,  65,        101) /* Placement - Resting */
     , (14444,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (14444, 114,          1) /* Attuned - Attuned */
     , (14444, 174,          5) /* AppraisalPages */
     , (14444, 175,          5) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (14444,   1, False) /* Stuck */
     , (14444,  11, True ) /* IgnoreCollisions */
     , (14444,  13, True ) /* Ethereal */
     , (14444,  14, True ) /* GravityStatus */
     , (14444,  19, True ) /* Attackable */;
...
VALUES (14444,   1,   33554773) /* Setup */
     ...
     , (14444, 8001,    2113584) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Container, Burden */
     , (14444, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (14444, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (14444, 8000, 2164337466) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (14444, 5, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (14444, 0, 4294967295, 'Dame Tsaya', 'Password is cheese', False, 'Sir Rylanan,
...
')
     , (14444, 2, 4294967295, 'Dame Tsaya', 'Password is cheese', False, 'What''s more, Sir Tenshin has written me with news from Shoushi. It seems strange happenings are not unique to Yaraq at this time. I include the text from his message below.
...
***
')
     , (14444, 3, 4294967295, 'Dame Tsaya', 'Password is cheese', False, '(Copy of a letter to Dame Tsaya from Sir Tenshin)
...
')
     , (14444, 4, 4294967295, 'Dame Tsaya', 'Password is cheese', False, 'After interviewing the farmer, the bearer of this message found a trap door towards the rear of his house, leading down to a seeminly innocuous cellar. However, a large cache of weapons was found behind a hidden doorway as well as stacks of Guard uniforms.
