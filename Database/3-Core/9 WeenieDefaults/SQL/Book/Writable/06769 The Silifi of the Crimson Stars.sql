...
VALUES (6769, 'bookcrimsonstars', 8) /* Book */;
...
VALUES (6769,   1,       8192) /* ItemType - Writable */
     ...
     , (6769,  19,         90) /* Value */
     , (6769,  65,        101) /* Placement - Resting */
     , (6769,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6769,   1, False) /* Stuck */
     , (6769,  11, True ) /* IgnoreCollisions */
     , (6769,  13, True ) /* Ethereal */
     , (6769,  14, True ) /* GravityStatus */
     , (6769,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (6769,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (6769,   1,   33554771) /* Setup */
     ...
     , (6769, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (6769, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (6769, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (6769,   2, 1342663805) /* Container */
     , (6769, 8000, 2917761935) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (6769, 35, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (6769, 0, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 1, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 2, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 3, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 4, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 5, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 6, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 11, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 12, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 13, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 14, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 15, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 16, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 17, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 18, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 19, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 20, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 21, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, 'citizens going about their lives, undisturbed by the chaos in the City of Lore. She stood and thoughtfully sipped a cup of spiced tea, breathing in the smell of the land and the people, until the day had lost the blush of its youth. Then, turning briskly, she called for her courtiers to summon three souls.
...
')
     , (6769, 23, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 24, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 25, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 26, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 27, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 28, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 29, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 30, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 31, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
...
')
     , (6769, 32, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, 'fire. Mahwan, which is named for the citadel upon Yujazik, should enable its bearer to parry more blows. Sulmada, named for the old god of dance, should increase the agility of he who wields it."
...
')
     , (6769, 33, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
"I do."
...
')
     , (6769, 34, 4294967295, 'Kayna bint Iswas', 'Password is cheese', False, '
