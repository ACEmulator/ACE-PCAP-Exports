...
VALUES (8638,   1, False) /* Stuck */
     , (8638,  11, True ) /* IgnoreCollisions */
     , (8638,  13, True ) /* Ethereal */
     , (8638,  14, True ) /* GravityStatus */
     , (8638,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8638,  39, 0.400000005960464) /* DefaultScale */;
