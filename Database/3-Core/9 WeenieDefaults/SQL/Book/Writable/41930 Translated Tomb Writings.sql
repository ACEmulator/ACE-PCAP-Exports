...
VALUES (41930, 'ace41930-translatedtombwritings', 8) /* Book */;
...
VALUES (41930,   1,       8192) /* ItemType - Writable */
     ...
     , (41930,  19,          3) /* Value */
     , (41930,  65,        101) /* Placement - Resting */
     , (41930,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41930, 174,          4) /* AppraisalPages */
     , (41930, 175,          4) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41930,   1, False) /* Stuck */
     , (41930,  11, True ) /* IgnoreCollisions */
     , (41930,  13, True ) /* Ethereal */
     , (41930,  14, True ) /* GravityStatus */
     , (41930,  19, True ) /* Attackable */;
...
VALUES (41930,   1,   33554773) /* Setup */
     ...
     , (41930, 8001,    2113592) /* PCAPRecordedWeenieHeader - Value, Usable, UseRadius, Container, Burden */
     , (41930, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (41930, 8005,     137217) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (41930,   2, 1342410606) /* Container */
     , (41930, 8000, 2448390208) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (41930, 4, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (41930, 0, 4294967295, 'Translated by Kuyiza bint Zayi', 'Password is cheese', False, '
...
')
     , (41930, 1, 4294967295, 'Translated by Kuyiza bint Zayi', 'Password is cheese', False, '
...
')
     , (41930, 2, 4294967295, 'Translated by Kuyiza bint Zayi', 'Password is cheese', False, '
...
')
     , (41930, 3, 4294967295, 'Translated by Kuyiza bint Zayi', 'Password is cheese', False, '
