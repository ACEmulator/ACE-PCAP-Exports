...
VALUES (29328, 'bookchatacademy', 8, '2019-02-10 00:00:00') /* Book */;
...
VALUES (29328,   1,   33554771) /* Setup */
     ...
     , (29328, 8001,    2113584) /* PCAPRecordedWeenieHeader - Usable, UseRadius, Container, Burden */
     , (29328, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (29328, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (29328, 8000, 3692822493) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (29328, 12, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (29328, 0, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'To chat with those around you, press the ENTER key, then type your text. When you have finished typing, press ENTER to send the message.
...
')
     , (29328, 2, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'You can reply to someone who just sent you a private tell without typing their whole name. Press ENTER, then type @reply. Then press the SPACEBAR and type your text. For example, if your friend Bob sends you a tell, you would type the following:

@reply Hey Bob! I just received your private tell!
')
     , (29328, 3, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'You can send private messages to the members of your fellowship. To do so, press ENTER then type @fellowship, MESSAGE TEXT. For example, if you want to send a private message to your fellowship, you would type the following:

@fellowship, Hey guys! Did you see that big Olthoi I just killed?
')
     , (29328, 4, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'You can send private messages to the members of your allegiance. To do so, press ENTER then type @allegiance, MESSAGE TEXT. For example, if you want to send a private message to your allegiance, you would type the following

@allegiance, Does anybody have a spare Singularity Key they could let me have?
')
     , (29328, 5, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'Those are the basic chat commands. For more in-depth chat commands, type ''@help chatting'' in the chat window.
...
')
     , (29328, 6, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'There are also four Global Channels that can be read and spoken on by any character, anywhere in the game.
...
')
     , (29328, 7, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'To talk on a Channel, type /, then the nickname of the Channel, then your text. For example, if I wanted to talk on the Trade channel, I could type:
...
')
     , (29328, 8, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'The four Global Channels are:
...
')
     , (29328, 9, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'Trade
Nicknames: trade, ct
Default: ON
Tag: [Trade]
This channel is for arranging in-game trades with other players.
')
     , (29328, 10, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'Looking for Group (LFG)
Nicknames: lfg, clfg
Default: ON
Tag: [LFG]
This channel is for helping you find other players to adventure with.
')
     , (29328, 11, 4294967295, 'Academy Wordsmith', 'Password is cheese', False, 'Roleplay
