...
VALUES (5106, 'trainmagic2sign', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (5106,   1,       8192) /* ItemType - Writable */
     ...
     , (5106,  19,        125) /* Value */
     , (5106,  65,        101) /* Placement - Resting */
     , (5106,  93,       1048) /* PhysicsState - ReportCollisions, IgnoreCollisions, Gravity */
     , (5106, 174,          1) /* AppraisalPages */
     , (5106, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5106,   1, True ) /* Stuck */
     , (5106,  11, True ) /* IgnoreCollisions */
     , (5106,  12, True ) /* ReportCollisions */
     , (5106,  13, False) /* Ethereal */
     , (5106,  14, True ) /* GravityStatus */
     , (5106,  19, True ) /* Attackable */;
...
VALUES (5106, 8040, 2248344174, 65.799, -33.88, 0, 0, 0, 0, -1) /* PCAPRecordedLocation */
/* @teleloc 0x8603026E [65.799000 -33.880000 0.000000] 0.000000 0.000000 0.000000 -1.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (5106, 8000, 2019569745) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5106, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5106, 0, 4294967295, 'Training Master', 'Password is cheese', False, '
