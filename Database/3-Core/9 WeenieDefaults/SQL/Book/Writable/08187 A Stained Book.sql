...
VALUES (8187, 'notefloatingcityb', 8, '2019-02-10 07:19:52') /* Book */;
...
VALUES (8187,   1,       8192) /* ItemType - Writable */
     ...
     , (8187,  19,         90) /* Value */
     , (8187,  65,        101) /* Placement - Resting */
     , (8187,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8187, 174,          3) /* AppraisalPages */
     , (8187, 175,          3) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8187,   1, True ) /* Stuck */
     , (8187,  11, True ) /* IgnoreCollisions */
     , (8187,  13, True ) /* Ethereal */
     , (8187,  14, True ) /* GravityStatus */
     , (8187,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8187,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8187, 8040, 47186282, 28.1178, -31.3216, 12.06344, -0.807861, 0, 0, -0.5893731) /* PCAPRecordedLocation */
/* @teleloc 0x02D0016A [28.117800 -31.321600 12.063440] -0.807861 0.000000 0.000000 -0.589373 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8187, 8000, 1881997315) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8187, 3, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8187, 0, 4294967295, 'prewritten', 'Password is cheese', False, 'It is I, Alatar Locke, writing as I listen to  the comfortingly mysterious sounds of what I call the Lost Chamber of the Floating City.
