...
VALUES (4797, 'brentsellanote', 8) /* Book */;
...
VALUES (4797,   1,       8192) /* ItemType - Writable */
     ...
     , (4797,  65,        101) /* Placement - Resting */
     , (4797,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (4797, 174,          1) /* AppraisalPages */
     , (4797, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4797,   1, False) /* Stuck */
     , (4797,  11, True ) /* IgnoreCollisions */
     , (4797,  13, True ) /* Ethereal */
     , (4797,  14, True ) /* GravityStatus */
     , (4797,  19, True ) /* Attackable */
     , (4797,  22, True ) /* Inscribable */;
...
VALUES (4797,   2, 1343051398) /* Container */
     , (4797, 8000, 3317868732) /* PCAPRecordedObjectIID */;
