...
VALUES (8863, 'histoct00', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (8863,   1,       8192) /* ItemType - Writable */
     ...
     , (8863,  19,          0) /* Value */
     , (8863,  65,        101) /* Placement - Resting */
     , (8863,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8863, 174,         12) /* AppraisalPages */
     , (8863, 175,         12) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8863,   1, False) /* Stuck */
     , (8863,  11, True ) /* IgnoreCollisions */
     , (8863,  13, True ) /* Ethereal */
     , (8863,  14, True ) /* GravityStatus */
     , (8863,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8863,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8863,   1,   33554771) /* Setup */
     ...
     , (8863, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8863, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8863, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8863, 8000, 2616280585) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8863, 12, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8863, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8863, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'The night skies cleared. Stars flickered to life in the void. The glowering volcanic face of Rez''arel and pale, mysterious Alb''arel rose again in their courses.
...
')
     , (8863, 4, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8863, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8863, 10, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8863, 11, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
