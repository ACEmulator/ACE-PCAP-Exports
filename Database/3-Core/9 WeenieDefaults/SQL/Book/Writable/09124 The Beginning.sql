...
VALUES (9124,   1, False) /* Stuck */
     , (9124,  11, True ) /* IgnoreCollisions */
     , (9124,  13, True ) /* Ethereal */
     , (9124,  14, True ) /* GravityStatus */
     , (9124,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (9124,  39, 0.400000005960464) /* DefaultScale */;
