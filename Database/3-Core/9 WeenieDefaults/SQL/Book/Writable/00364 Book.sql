...
VALUES (364,   7, 0x5005C95F) /* Scribe */
     , (364, 8000, 0x878EDCDA) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (364, 50, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (364, 0, 1342556511, 'Juliana Bravehart', 'prewritten', False, '2/23/01 level 10 Brought book in Cragstone
...
2/24/01  I went into Hebian-To, I brought a ')
     , (364, 1, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'nice dress. I recuited a vassel by the name of  Jamem. Showed him all the dungeons in Holtburg.
...
')
     , (364, 2, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'an industrious swordswinger. I may have to go visit Julithmad in Holtburg soon. I have many items to give her.
...
')
     , (364, 3, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'portal to Holtburg and then ran to Cragstone following the river. Took portal to Hebian-to. 
...
')
     , (364, 4, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'needed a new bow.
...
')
     , (364, 5, 1342556511, 'Juliana Bravehart', 'prewritten', False, '3/15/01 Working the Dungeon at Al Jalima. Made level 16. Needed to sell gems so I travelled to Tou-Tou and then took a portal to Arwic.  Going to meet up with the Squire at Holtburg.
3/17/01  Went on a quest for the fenmalian Crystal shield.  this quest took me near the town of Biashi to the dungeon there.From there my fellow adventures and I travelled by portal created by Helm the Palidin to Al Arqas then a long run to coordinates 25.6 S 28.3 E near the town of Uziz (I think that is how it is spelled). then the long run back to Al Arqas, then portal to samsur then portal ')
     , (364, 6, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Holtburg.  I ran to Glenden Wood to get more money and mana stones.
...
')
     , (364, 7, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Strength 145
Endurance 100
Coordination 145
Quickness  90
Focus 50
...
Arcane Lore  50
')
     , (364, 8, 1342556511, 'Juliana Bravehart', 'prewritten', False, '3/23/01 In Holtburg, portaled to Rithwic, ran to Hebian-To, portaled to Qalabar.  Went to citadal.
...
4/4/01 Working the Muddy Dungeon North of Shoushi, has golems that drop motes. Good exp. level 20.')
     , (364, 9, 1342556511, 'Juliana Bravehart', 'prewritten', False, '4/5/01 I have travelled back to Al-Jalima and am fighting the zombies again. Good $$ & exp.
...
')
     , (364, 10, 1342556511, 'Juliana Bravehart', 'prewritten', False, '4/12/01 Back in Tou-Tou working on the island.
...
')
     , (364, 11, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Khayyban. had to portal several times to get there a good dungeon with great exp.
...
')
     , (364, 12, 1342556511, 'Juliana Bravehart', 'prewritten', False, '4/21/01 Back to Glenden Wood for more money and mana stones.
...
5/12/01 Cyrpt of Ashen Tears in Zaikhal.')
     , (364, 13, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'died 8 times in the dungeon had to call Cabirus to help retrieve all the bodies.  Went to Glenden Wood to help Jamen and to work off my vitea.
...
')
     , (364, 14, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Went to Colier (Ghost Town) got totally mobbed died over and over just trying to retrieve stuff. Got 32% vitea. May take me a week to get rid of it. Sword skill with that much vitea penalty is 147. In holtburg to work it off.
...
')
     , (364, 15, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'my sword skill buffed to 275. He portaled me to Crater and I got my peerless Atlan Sword. No give No drop.
...
')
     , (364, 16, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Mayoi to Lin to Nanto to Hebian-To to Shoushi to Saweto to Yanshi to Uziz to Samsur.  In Samsur, found the Desert Mine Dungeon, has skeltons, warrior skeltons, captain skelton and one lord skelton.  Nice loot.
...
')
     , (364, 17, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Today, I went an did the Baron''s Amulet quest by myself.
...
')
     , (364, 18, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'hunting Shadow children.
...
11/4/01 Level 38 Died 239times seven today alone, been exploring the new island of Marae Lassel.')
     , (364, 19, 1342556511, 'Juliana Bravehart', 'prewritten', False, '11/25/01 Level 40, died 265, working new island and trying to get the Squire higher in level.
...
2/23/02 House sold to someone else while i')
     , (364, 20, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'was sleeping. hunting others
...
')
     , (364, 21, 1342556511, 'Juliana Bravehart', 'prewritten', False, '03/29/02 Went on Elysa Favor Quest.
...
05/15/02 Level 47 Trying to do Elysa Favor quest again.')
     , (364, 22, 1342556511, 'Juliana Bravehart', 'prewritten', False, '5/26/02 Elysa Favor quest completed today. at OP BSD now.level 48 died 340 times.
...
06/30/02 going to Lin to get some cogs. Level 50.')
     , (364, 23, 1342556511, 'Juliana Bravehart', 'prewritten', False, '7/4/02 level 50, died 356, going to try out the pit dungeon south of stonehold. love the area up here.
...
')
     , (364, 24, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'showed him the book. He liked it.  Level 51. Died 368. Trained in Item Tinkering.
...
')
     , (364, 25, 1342556511, 'Juliana Bravehart', 'prewritten', False, '9/2/02 Level 53, died 381, tied to lifestone in Holtburg, 2nd portal tie is the Black Spawn Den in Ayan B. Going to do all the pincers that time permits.harvester, gardener died in soldier
...
9/26/02 Level 55, died 398 times, getting pincers, harvester,gardener, soldier too early, legionary...met Bjorn Blackmane fellow soul seeker, added to friends.')
     , (364, 26, 1342556511, 'Juliana Bravehart', 'prewritten', False, '9/28/02 Finished Elysa''s Favor Quest. made level 56 tonight at Ayan Black Spawn Den, fighting Tuskers, Virinidi, Rav Drudges. Died a total of 404 times. 
...
11/02/02 We broke with the Soulseekers.')
     , (364, 27, 1342556511, 'Juliana Bravehart', 'prewritten', False, '11/03/02 Allegience got a new mansion. No name for it yet.
...
11/23/02 been exploring old dungeons, went to Mountain Keep and A Ruin out of holtburg and to Catacombs of the Forgotten out of Cragstone, and to Cave out of Eastham and to Slysfear Dungeon out of Zaikhal, now to the Tusker Island.')
     , (364, 28, 1342556511, 'Juliana Bravehart', 'prewritten', False, '11/28/02 Thanksgiving Day---Elysa''s favor quest. Level 59.
...
')
     , (364, 29, 1342556511, 'Juliana Bravehart', 'prewritten', False, '01/18/03 Pincer and Harvester pincers.
...
03/15/03 Envisorator Pincer. Aerlithe Island with Cabi''s Faith, Mothergoose, and Thor the War Hammer. Goldenback Tusk (1.0N 96.9E) Female Tusk (2.0N 97.9E). Elysa Favor Quest completed.  Turned in 3 large 
  ')
     , (364, 30, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'unlock Mnemo stones and one small.
...
04/18/03 Went on the Overlord Quest with')
     , (364, 31, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'Cabi''s Faith, Mothergoose, and Thor the WarHammer--great quest lots of loot.
...
')
     , (364, 32, 1342556511, 'Juliana Bravehart', 'prewritten', False, '06/06/03 legionary pincer. VOD with Darkworlds II, Ice Prop with monarchy group led by Vainamoinen.
06/07/03 Level 68
...
')
     , (364, 33, 1342556511, 'Juliana Bravehart', 'prewritten', False, '06/23/03 Gaerlan''s quest. 
...
')
     , (364, 34, 1342556511, 'Juliana Bravehart', 'prewritten', False, ' got 250K exp.
...
01/10/04 Gardner, Harvester, and Soldier Pincer quest.')
     , (364, 35, 1342556511, 'Juliana Bravehart', 'prewritten', False, '02/06/04 Guard Tusker quest.
...
07/11/04 Gardener
')
     , (364, 36, 1342556511, 'Juliana Bravehart', 'prewritten', False, '08/01/04 Bobo''s Quest for scroll
0817/04 Level 83
...
')
     , (364, 37, 1342556511, 'Juliana Bravehart', 'prewritten', False, '12/19/04 Male, Female, Crimsonback, Goldenback, Liberator, Slave, Guard Tusker Quest. Harvester and worker Pincer quest.
...
')
     , (364, 38, 1342556511, 'Juliana Bravehart', 'prewritten', False, 'walll quest, healer heart
