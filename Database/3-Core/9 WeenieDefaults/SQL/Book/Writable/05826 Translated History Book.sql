...
VALUES (5826,   1,       8192) /* ItemType - Writable */
     ...
     , (5826,  19,        500) /* Value */
     , (5826,  65,        101) /* Placement - Resting */
     , (5826,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5826,   1, False) /* Stuck */
     , (5826,  11, True ) /* IgnoreCollisions */
     , (5826,  13, True ) /* Ethereal */
     , (5826,  14, True ) /* GravityStatus */
     , (5826,  19, True ) /* Attackable */;
...
VALUES (5826,   2, 1344032604) /* Container */
     , (5826, 8000, 3625372761) /* PCAPRecordedObjectIID */;
