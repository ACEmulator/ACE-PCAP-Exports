...
VALUES (8853, 'histdec99', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (8853,   1,       8192) /* ItemType - Writable */
     ...
     , (8853,  19,          0) /* Value */
     , (8853,  65,        101) /* Placement - Resting */
     , (8853,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8853, 174,         10) /* AppraisalPages */
     , (8853, 175,         10) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8853,   1, False) /* Stuck */
     , (8853,  11, True ) /* IgnoreCollisions */
     , (8853,  13, True ) /* Ethereal */
     , (8853,  14, True ) /* GravityStatus */
     , (8853,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8853,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8853,   1,   33554771) /* Setup */
     ...
     , (8853, 8001,    2113552) /* PCAPRecordedWeenieHeader - Usable, Container, Burden */
     , (8853, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8853, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8853, 8000, 2149431821) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8853, 10, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8853, 0, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 1, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 2, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 3, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 4, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 5, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 6, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 7, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, 'When the explorers rushed to destroy it, the crystal defended itself with powerful magics. Many were slain, but in the end the Isparians prevailed. Abrim of Morningthaw chronicled the final battle against the Work in his tale "Return to Frore," which became a bestseller at the capital towns of Cragstone, Hebian-To, and Zaikhal.
...
')
     , (8853, 8, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
...
')
     , (8853, 9, 4294967295, 'Jaiph Rainshadow', 'Password is cheese', False, '
