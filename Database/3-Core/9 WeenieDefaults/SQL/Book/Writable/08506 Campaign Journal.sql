...
VALUES (8506, 'noteanadil', 8, '2019-02-10 05:41:14') /* Book */;
...
VALUES (8506,   1,       8192) /* ItemType - Writable */
     ...
     , (8506,  19,         90) /* Value */
     , (8506,  65,        101) /* Placement - Resting */
     , (8506,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8506,   1, False) /* Stuck */
     , (8506,  11, True ) /* IgnoreCollisions */
     , (8506,  13, True ) /* Ethereal */
     , (8506,  14, True ) /* GravityStatus */
     , (8506,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8506,  39, 1.22000002861023) /* DefaultScale */;
...
VALUES (8506,   1,   33554771) /* Setup */
     ...
     , (8506, 8001,    2113560) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden */
     , (8506, 8003,        272) /* PCAPRecordedObjectDesc - Attackable, Book */
     , (8506, 8005,     137345) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, STable, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8506, 8000, 2932269073) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (8506, 25, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (8506, 0, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
* *
...
')
     , (8506, 1, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 2, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, 'Asmolum''s divinations brought us the location of the final piece of the Array. Fortuitously enough, it was near at hand. However, my forces were prepared to move on should the Enemy appear, not defend the ground. This field of combat is not one I would have chosen.
...
')
     , (8506, 5, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 6, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 9, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 10, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 11, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 12, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 13, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '* *
...
')
     , (8506, 16, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, 'If you wish to have power over earth and sea, so be it. Be honest about your goal. Do not seek it through duplicity and doubletalk. My father taught me at the council fire that all our gods demand of us is honesty - all other judgements are those of men. The Nali of Haebrous claimed that Adja''s daughters were tainted by the beliefs of the Falatacot. He said their accordance of equal respect to the earth as well as the stars was heretical. What he truly sought was the silencing of a voice other than his own, in a war for the hearts of men. In this, I think, he was the greatest sinner of his time. Men may claim the earth and sea, yet never the stars nor the souls of their brothers.
')
     , (8506, 17, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 18, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 19, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 20, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
* *
...
')
     , (8506, 21, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 22, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
...
')
     , (8506, 23, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '* *
...
')
     , (8506, 24, 4294967295, 'Anadil of Shakrassekor', 'Password is cheese', False, '
