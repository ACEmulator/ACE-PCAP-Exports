...
VALUES (5690, 'lecterncodepwyll', 8, '2019-02-10 08:04:04') /* Book */;
...
VALUES (5690,   1,       8192) /* ItemType - Writable */
     ...
     , (5690, 174,          8) /* AppraisalPages */
     , (5690, 175,          8) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5690,   1, True ) /* Stuck */
     , (5690,  11, True ) /* IgnoreCollisions */
     , (5690,  13, False) /* Ethereal */
     , (5690,  14, True ) /* GravityStatus */
     , (5690,  19, True ) /* Attackable */;
...
VALUES (5690, 8040, 3130982656, 32.2226, 181.959, 56, 0.707107, 0, 0, -0.707107) /* PCAPRecordedLocation */
/* @teleloc 0xBA9F0100 [32.222600 181.959000 56.000000] 0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (5690, 8000, 2074734595) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5690, 8, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5690, 0, 4294967295, 'The Full Code of Pwyll', 'Password is cheese', False, '"It not for all of the people to walk the path of high honor. For some it is enough that they follow the path of low justice. But we, as knights, shall take the high road."  - High King Pwyll
...
')
     , (5690, 3, 4294967295, 'The Full Code of Pwyll', 'Password is cheese', False, '3. Guard the young, for they are our future.  Even the inexperienced young squire may one day become a lord.

4. Slay no one for doing a thing unto you that you would have done unto him, for one day you might die in the same manner.
')
     , (5690, 4, 4294967295, 'The Full Code of Pwyll', 'Password is cheese', False, '5. Obey and honor those above your station, for as they stand above you, so do they keep the sword from falling upon your head.  All parts are necessary for the whole.
...
')
     , (5690, 5, 4294967295, 'The Full Code of Pwyll', 'Password is cheese', False, '7. Let your word be your bond, for when stripped of steel and cloth and youth, a knight has nothing else.

8. Grant succor where you may, for as the need of others is made less, so too the burden of the knight is made less.
')
     , (5690, 6, 4294967295, 'The Full Code of Pwyll', 'Password is cheese', False, '9. Be fair in all judgments, for you too may you one day be judged.  Justice has no mouth with which to speak and no hands with which to enforce the laws, so we must be her eyes and we must act as her hands.
