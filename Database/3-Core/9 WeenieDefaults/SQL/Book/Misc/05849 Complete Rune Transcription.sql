...
VALUES (5849, 'completerunetranscription', 8) /* Book */;
...
VALUES (5849,   1,        128) /* ItemType - Misc */
     ...
     , (5849,  19,         20) /* Value */
     , (5849,  65,        101) /* Placement - Resting */
     , (5849,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (5849, 174,          1) /* AppraisalPages */
     , (5849, 175,          1) /* AppraisalMaxPages */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5849,   1, False) /* Stuck */
     , (5849,  11, True ) /* IgnoreCollisions */
     , (5849,  13, True ) /* Ethereal */
     , (5849,  14, True ) /* GravityStatus */
     , (5849,  19, True ) /* Attackable */
...
VALUES (5849,   2, 1342814975) /* Container */
     , (5849, 8000, 3681069959) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_book` (`object_Id`, `max_Num_Pages`, `max_Num_Chars_Per_Page`)
VALUES (5849, 1, 1000);

INSERT INTO `weenie_properties_book_page_data` (`object_Id`, `page_Id`, `author_Id`, `author_Name`, `author_Account`, `ignore_Author`, `page_Text`)
VALUES (5849, 0, 4294967295, NULL, 'Password is cheese', False, '[You cannot understand the writing on this page.]
');
