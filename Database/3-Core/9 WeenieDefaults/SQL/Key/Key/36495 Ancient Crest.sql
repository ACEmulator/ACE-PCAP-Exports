...
VALUES (36495, 'ace36495-ancientcrest', 22) /* Key */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (36495,   1,      16384) /* ItemType - Key */
     , (36495,   5,          5) /* EncumbranceVal */
     , (36495,  16,          1) /* ItemUseable - No */
     , (36495,  65,        101) /* Placement - Resting */
     , (36495,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36495,  94,        640) /* TargetType - LockableMagicTarget */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36495,   1, False) /* Stuck */
     , (36495,  11, True ) /* IgnoreCollisions */
     , (36495,  13, True ) /* Ethereal */
     , (36495,  14, True ) /* GravityStatus */
     , (36495,  19, True ) /* Attackable */
     , (36495,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (36495,  39, 0.670000016689301) /* DefaultScale */;
...
VALUES (36495,   2, 3467998927) /* Container */
     , (36495, 8000, 3420103608) /* PCAPRecordedObjectIID */;
