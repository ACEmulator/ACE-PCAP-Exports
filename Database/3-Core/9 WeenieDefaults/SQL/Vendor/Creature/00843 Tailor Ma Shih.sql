...
VALUES (843, 'shoushitailor', 12) /* Vendor */;
...
VALUES (843,   1, True ) /* Stuck */
     , (843,  11, True ) /* IgnoreCollisions */
     , (843,  12, True ) /* ReportCollisions */
     , (843,  13, False) /* Ethereal */
     , (843,  14, True ) /* GravityStatus */
     , (843,  19, False) /* Attackable */
     , (843,  39, True ) /* DealMagicalItems */
     , (843,  41, True ) /* ReportCollisionsAsEnvironment */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (843,  37, 0.899999976158142) /* BuyPrice */
     , (843,  38, 1.35000002384186) /* SellPrice */
     , (843,  54,       3) /* UseRadius */;
...
VALUES (843,   1,    75, 0, 0, 75) /* MaxHealth */
     , (843,   3,   120, 0, 0, 120) /* MaxStamina */
     , (843,   5,    50, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (843, 4,   118, -1, 0, 0, False) /* Create Cloth Cap (118) for Shop */
     , (843, 4,   129, -1, 0, 0, False) /* Create Sandals (129) for Shop */
     , (843, 4,  2588, -1, 0, 0, False) /* Create Flared Shirt (2588) for Shop */
