...
VALUES (4543, 'linhealer', 12) /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4543,   1,         16) /* ItemType - Creature */
     , (4543,   2,         31) /* CreatureType - Human */
     , (4543,   6,        255) /* ItemsCapacity */
     , (4543,   7,        255) /* ContainersCapacity */
...
VALUES (4543,   1,    35, 0, 0, 35) /* MaxHealth */
     , (4543,   3,    65, 0, 0, 65) /* MaxStamina */
     , (4543,   5,   120, 0, 0, 120) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4543, 4,   377, -1, 0, 0, False) /* Create Potion of Healing (377) for Shop */
     ...
     , (4543, 4,  4587, -1, 0, 0, False) /* Create  (4587) for Shop */
     , (4543, 4,  4592, -1, 0, 0, False) /* Create  (4592) for Shop */
     , (4543, 4,  4602, -1, 0, 0, False) /* Create  (4602) for Shop */
     , (4543, 4,  4606, -1, 0, 0, False) /* Create  (4606) for Shop */
