...
VALUES (1378,   1,   100, 0, 0, 100) /* MaxHealth */
     , (1378,   3,   250, 0, 0, 250) /* MaxStamina */
     , (1378,   5,    50, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1378, 4,   300, -1, 0, 0, False) /* Create Arrow (300) for Shop */
