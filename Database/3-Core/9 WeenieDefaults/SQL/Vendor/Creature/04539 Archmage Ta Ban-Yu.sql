...
VALUES (4539, 'linarchmage', 12) /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4539,   1,         16) /* ItemType - Creature */
     , (4539,   2,         31) /* CreatureType - Human */
     , (4539,   6,        255) /* ItemsCapacity */
     , (4539,   7,        255) /* ContainersCapacity */
...
VALUES (4539,   1,    53, 0, 0, 53) /* MaxHealth */
     , (4539,   3,    95, 0, 0, 95) /* MaxStamina */
     , (4539,   5,    60, 0, 0, 60) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4539, 4,   136, -1, 0, 0, False) /* Create Pack (136) for Shop */
