...
VALUES (8494, 'freeholdbowyer', 12) /* Vendor */;
...
VALUES (8494,   1,   100, 0, 0, 100) /* MaxHealth */
     , (8494,   3,   220, 0, 0, 220) /* MaxStamina */
     , (8494,   5,    90, 0, 0, 90) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8494, 4,   300, -1, 0, 0, False) /* Create Arrow (300) for Shop */
