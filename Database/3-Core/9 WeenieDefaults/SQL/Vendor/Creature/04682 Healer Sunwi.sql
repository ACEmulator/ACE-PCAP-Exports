...
VALUES (4682, 'alarqashealer', 12) /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4682,   1,         16) /* ItemType - Creature */
     , (4682,   2,         31) /* CreatureType - Human */
     , (4682,   6,        255) /* ItemsCapacity */
     , (4682,   7,        255) /* ContainersCapacity */
...
VALUES (4682,   1,    56, 0, 0, 56) /* MaxHealth */
     , (4682,   3,   100, 0, 0, 100) /* MaxStamina */
     , (4682,   5,    50, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4682, 4,   377, -1, 0, 0, False) /* Create Potion of Healing (377) for Shop */
