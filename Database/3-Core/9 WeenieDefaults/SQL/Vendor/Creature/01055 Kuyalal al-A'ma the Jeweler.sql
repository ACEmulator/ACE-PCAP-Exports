...
VALUES (1055, 'qalabarjeweler', 12) /* Vendor */;
...
VALUES (1055,   1,   150, 0, 0, 150) /* MaxHealth */
     , (1055,   3,   180, 0, 0, 180) /* MaxStamina */
     , (1055,   5,    80, 0, 0, 80) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1055, 4,   294, -1, 0, 0, False) /* Create Amulet (294) for Shop */
