...
VALUES (4446, 'lytelthorpeeastoutpostshopkeep', 12) /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4446,   1,         16) /* ItemType - Creature */
     , (4446,   2,         31) /* CreatureType - Human */
     , (4446,   6,        255) /* ItemsCapacity */
     , (4446,   7,        255) /* ContainersCapacity */
...
VALUES (4446, 8000, 2084044809) /* PCAPRecordedObjectIID */;
...
VALUES (4446,   1,    48, 0, 0, 48) /* MaxHealth */
     , (4446,   3,    85, 0, 0, 85) /* MaxStamina */
     , (4446,   5,    65, 0, 0, 65) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4446, 4,    36, -1, 0, 0, False) /* Create Leather Bracers (36) for Shop */
     ...
     , (4446, 4,   458, -1, 0, 0, False) /* Create  (458) for Shop */
