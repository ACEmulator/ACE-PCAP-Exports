...
VALUES (697, 'arwichealer', 12, '2019-02-10 05:41:14') /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (697,   1,         16) /* ItemType - Creature */
     , (697,   2,         31) /* CreatureType - Human */
     , (697,   6,        255) /* ItemsCapacity */
     , (697,   7,        255) /* ContainersCapacity */
...
VALUES (697, 8000, 2087358516) /* PCAPRecordedObjectIID */;
...
VALUES (697,   1,    10, 0, 0, 90) /* MaxHealth */
     , (697,   3,    10, 0, 0, 160) /* MaxStamina */
     , (697,   5,    10, 0, 0, 165) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (697, 4,   377, -1, 0, 0, False) /* Create Potion of Healing (377) for Shop */
     ...
     , (697, 4,  4587, -1, 0, 0, False) /* Create  (4587) for Shop */
     , (697, 4,  4593, -1, 0, 0, False) /* Create  (4593) for Shop */
     , (697, 4,  4596, -1, 0, 0, False) /* Create  (4596) for Shop */
