...
VALUES (1830, 'uzizhealer', 12) /* Vendor */;
...
VALUES (1830,   1,   150, 0, 0, 150) /* MaxHealth */
     , (1830,   3,   180, 0, 0, 180) /* MaxStamina */
     , (1830,   5,   160, 0, 0, 160) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1830, 4,   377, -1, 0, 0, False) /* Create Potion of Healing (377) for Shop */
