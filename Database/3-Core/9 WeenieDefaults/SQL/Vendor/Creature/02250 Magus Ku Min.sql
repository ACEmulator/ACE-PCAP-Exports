...
VALUES (2250, 'baishiarchmage', 12, '2019-02-10 00:00:00') /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (2250,   1,         16) /* ItemType - Creature */
     , (2250,   2,         31) /* CreatureType - Human */
     , (2250,   6,        255) /* ItemsCapacity */
     , (2250,   7,        255) /* ContainersCapacity */
     ...
     , (2250, 113,          2) /* Gender - Female */
     , (2250, 133,          4) /* ShowableOnRadar - ShowAlways */
     , (2250, 134,         16) /* PlayerKillerStatus - RubberGlue */
     , (2250, 188,          3) /* HeritageGroup - Sho */
     , (2250, 8007,          0) /* PCAPRecordedAutonomousMovement */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2250,   1, True ) /* Stuck */
     , (2250,  11, True ) /* IgnoreCollisions */
     , (2250,  12, True ) /* ReportCollisions */
     , (2250,  13, False) /* Ethereal */
     , (2250,  14, True ) /* GravityStatus */
     , (2250,  19, False) /* Attackable */
     , (2250,  39, True ) /* DealMagicalItems */
     , (2250,  41, True ) /* ReportCollisionsAsEnvironment */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (2250,  37, 0.899999976158142) /* BuyPrice */
     , (2250,  38, 1.54999995231628) /* SellPrice */
     , (2250,  54,       3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (2250,   1, 'Magus Ku Min') /* Name */
     , (2250,   5, 'Archmage') /* Template */
     , (2250, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (2250,   1,   33554510) /* Setup */
     , (2250,   2,  150994945) /* MotionTable */
     , (2250,   3,  536870914) /* SoundTable */
     , (2250,   6,   67108990) /* PaletteBase */
     , (2250,   8,  100667446) /* Icon */
     , (2250,   9,   83890281) /* EyesTexture */
     , (2250,  10,   83890311) /* NoseTexture */
     , (2250,  11,   83890356) /* MouthTexture */
     , (2250,  15,   67117079) /* HairPalette */
     , (2250,  16,   67110063) /* EyesPalette */
     , (2250,  17,   67110057) /* SkinPalette */
     , (2250, 8001,    8388662) /* PCAPRecordedWeenieHeader - ItemsCapacity, ContainersCapacity, Usable, UseRadius, RadarBehavior */
     , (2250, 8003,        516) /* PCAPRecordedObjectDesc - Stuck, Vendor */
     , (2250, 8005,     100355) /* PCAPRecordedPhysicsDesc - CSetup, MTable, STable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (2250, 8040, 3443523843, 108.149, 176.208, 56.005, -0.9799946, 0, 0, -0.199024) /* PCAPRecordedLocation */
/* @teleloc 0xCD400103 [108.149000 176.208000 56.005000] -0.979995 0.000000 0.000000 -0.199024 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (2250, 8000, 2094268422) /* PCAPRecordedObjectIID */;
...
VALUES (2250,   1,    10, 0, 0, 150) /* MaxHealth */
     , (2250,   3,    10, 0, 0, 170) /* MaxStamina */
     , (2250,   5,    10, 0, 0, 170) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (2250, 4,  5940, -1, 0, 0, False) /* Create Smelting Pot (5940) for Shop */
     ...
     , (2250, 4,  6064, -1, 0, 0, False) /* Create  (6064) for Shop */
     , (2250, 4,  6067, -1, 0, 0, False) /* Create  (6067) for Shop */
     ...
     , (2250, 4,   136, -1, 0, 0, False) /* Create Pack (136) for Shop */
     , (2250, 4,   139, -1, 0, 0, False) /* Create Small Belt Pouch (139) for Shop */
     ...
     , (2250, 4,  8180, -1, 0, 0, False) /* Create  (8180) for Shop */
     , (2250, 4,  8181, -1, 0, 0, False) /* Create  (8181) for Shop */
     , (2250, 4,  8182, -1, 0, 0, False) /* Create  (8182) for Shop */
     , (2250, 4,  8183, -1, 0, 0, False) /* Create  (8183) for Shop */
     , (2250, 4,  8184, -1, 0, 0, False) /* Create  (8184) for Shop */
     , (2250, 4,  8185, -1, 0, 0, False) /* Create  (8185) for Shop */;
...
VALUES (2250, 0, 83889072, 83890012)
