...
VALUES (11392, 'greenspiremage_xp', 12) /* Vendor */;
...
VALUES (11392,   1,   180, 0, 0, 180) /* MaxHealth */
     , (11392,   3,   260, 0, 0, 260) /* MaxStamina */
     , (11392,   5,   280, 0, 0, 280) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (11392, 4,   625, -1, 0, 0, False) /* Create Ginseng (625) for Shop */
