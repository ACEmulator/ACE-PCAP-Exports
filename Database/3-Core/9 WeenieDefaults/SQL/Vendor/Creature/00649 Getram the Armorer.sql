...
VALUES (649, 'easthamblacksmith', 12) /* Vendor */;
...
VALUES (649,   1,    95, 0, 0, 95) /* MaxHealth */
     , (649,   3,   150, 0, 0, 150) /* MaxStamina */
     , (649,   5,    75, 0, 0, 75) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (649, 4,    35, -1, 0, 0, False) /* Create Chainmail Basinet (35) for Shop */
