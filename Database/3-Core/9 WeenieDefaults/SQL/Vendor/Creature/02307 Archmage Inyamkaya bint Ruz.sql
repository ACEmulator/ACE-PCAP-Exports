...
VALUES (2307, 'yaraqarchmage', 12) /* Vendor */;
...
VALUES (2307,   1,    80, 0, 0, 80) /* MaxHealth */
     , (2307,   3,   110, 0, 0, 110) /* MaxStamina */
     , (2307,   5,   135, 0, 0, 135) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (2307, 4,   625, -1, 0, 0, False) /* Create Ginseng (625) for Shop */
