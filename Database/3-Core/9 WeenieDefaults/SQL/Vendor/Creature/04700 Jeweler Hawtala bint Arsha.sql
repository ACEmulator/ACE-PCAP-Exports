...
VALUES (4700, 'khayyabanjeweler', 12) /* Vendor */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (4700,   1,         16) /* ItemType - Creature */
     , (4700,   2,         31) /* CreatureType - Human */
     , (4700,   6,        255) /* ItemsCapacity */
     , (4700,   7,        255) /* ContainersCapacity */
...
VALUES (4700,   1,   33554510) /* Setup */
     ...
     , (4700,   6,   67108990) /* PaletteBase */
     , (4700,   8,  100667446) /* Icon */
     , (4700,   9,   83890241) /* EyesTexture */
     , (4700,  10,   83890285) /* NoseTexture */
     , (4700,  11,   83890324) /* MouthTexture */
     , (4700,  15,   67116990) /* HairPalette */
     , (4700,  16,   67110063) /* EyesPalette */
     , (4700,  17,   67109550) /* SkinPalette */
...
VALUES (4700, 8040, 2655256851, 35.9461, 18.0094, 46.005, 0.008774959, 0, 0, -0.9999615) /* PCAPRecordedLocation */
/* @teleloc 0x9E440113 [35.946100 18.009400 46.005000] 0.008775 0.000000 0.000000 -0.999962 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (4700, 8000, 2045001738) /* PCAPRecordedObjectIID */;
...
VALUES (4700,   1,    60, 0, 0, 60) /* MaxHealth */
     , (4700,   3,   110, 0, 0, 110) /* MaxStamina */
     , (4700,   5,    85, 0, 0, 85) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4700, 4,   294, -1, 0, 0, False) /* Create Amulet (294) for Shop */
     ...
     , (4700, 4, 41403, -1, 0, 0, False) /* Create  (41403) for Shop */;
