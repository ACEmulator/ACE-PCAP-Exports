...
VALUES (718, 'holtburgshopkeep', 12) /* Vendor */;
...
VALUES (718,  37, 0.899999976158142) /* BuyPrice */
...
VALUES (718,   1,    75, 0, 0, 75) /* MaxHealth */
     , (718,   3,   110, 0, 0, 110) /* MaxStamina */
     , (718,   5,    30, 0, 0, 30) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (718, 4,    35, -1, 0, 0, False) /* Create Chainmail Basinet (35) for Shop */
