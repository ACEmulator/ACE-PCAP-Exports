...
VALUES (4392, 'scrollarmorself4', 34, '2019-02-10 05:41:14') /* Scroll */;
...
VALUES (4392,   1,       8192) /* ItemType - Writable */
     ...
     , (4392,  19,        100) /* Value */
     , (4392,  65,        101) /* Placement - Resting */
     , (4392,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4392,   1, False) /* Stuck */
     , (4392,  11, True ) /* IgnoreCollisions */
     , (4392,  13, True ) /* Ethereal */
     , (4392,  14, True ) /* GravityStatus */
     , (4392,  19, True ) /* Attackable */
     , (4392,  22, True ) /* Inscribable */;
