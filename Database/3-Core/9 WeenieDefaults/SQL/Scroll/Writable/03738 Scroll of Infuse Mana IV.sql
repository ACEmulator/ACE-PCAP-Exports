...
VALUES (3738, 'scrollinfusemana4', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (3738,   1,       8192) /* ItemType - Writable */
     ...
     , (3738,  19,        100) /* Value */
     , (3738,  65,        101) /* Placement - Resting */
     , (3738,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3738,   1, False) /* Stuck */
     , (3738,  11, True ) /* IgnoreCollisions */
     , (3738,  13, True ) /* Ethereal */
     , (3738,  14, True ) /* GravityStatus */
     , (3738,  19, True ) /* Attackable */
     , (3738,  22, True ) /* Inscribable */;
