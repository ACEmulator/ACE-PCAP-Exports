...
VALUES (2991, 'scrollbladeprotectionother5', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (2991,   1,       8192) /* ItemType - Writable */
     ...
     , (2991,  19,        200) /* Value */
     , (2991,  65,        101) /* Placement - Resting */
     , (2991,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2991,   1, False) /* Stuck */
     , (2991,  11, True ) /* IgnoreCollisions */
     , (2991,  13, True ) /* Ethereal */
     , (2991,  14, True ) /* GravityStatus */
     , (2991,  19, True ) /* Attackable */
     , (2991,  22, True ) /* Inscribable */;
