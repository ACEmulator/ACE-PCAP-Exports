...
VALUES (3374, 'scrolllifemagicmasteryself3', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (3374,   1,       8192) /* ItemType - Writable */
     ...
     , (3374,  19,         20) /* Value */
     , (3374,  65,        101) /* Placement - Resting */
     , (3374,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3374,   1, False) /* Stuck */
     , (3374,  11, True ) /* IgnoreCollisions */
     , (3374,  13, True ) /* Ethereal */
     , (3374,  14, True ) /* GravityStatus */
     , (3374,  19, True ) /* Attackable */
     , (3374,  22, True ) /* Inscribable */;
