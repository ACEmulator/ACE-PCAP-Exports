...
VALUES (8928,   1,       8192) /* ItemType - Writable */
     ...
     , (8928,  19,       1000) /* Value */
     , (8928,  65,        101) /* Placement - Resting */
     , (8928,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8928,   1, False) /* Stuck */
     , (8928,  11, True ) /* IgnoreCollisions */
     , (8928,  13, True ) /* Ethereal */
     , (8928,  14, True ) /* GravityStatus */
     , (8928,  19, True ) /* Attackable */
     , (8928,  22, True ) /* Inscribable */;
