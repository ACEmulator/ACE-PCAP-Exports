...
VALUES (1776,   1,       8192) /* ItemType - Writable */
     ...
     , (1776,  19,          1) /* Value */
     , (1776,  65,        101) /* Placement - Resting */
     , (1776,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1776,   1, False) /* Stuck */
     , (1776,  11, True ) /* IgnoreCollisions */
     , (1776,  13, True ) /* Ethereal */
     , (1776,  14, True ) /* GravityStatus */
     , (1776,  19, True ) /* Attackable */
     , (1776,  22, True ) /* Inscribable */;
