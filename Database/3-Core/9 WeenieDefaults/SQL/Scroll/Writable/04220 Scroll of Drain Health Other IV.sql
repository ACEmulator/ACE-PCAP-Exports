...
VALUES (4220, 'scrolldrainhealth4', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (4220,   1,       8192) /* ItemType - Writable */
     ...
     , (4220,  19,        100) /* Value */
     , (4220,  65,        101) /* Placement - Resting */
     , (4220,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4220,   1, False) /* Stuck */
     , (4220,  11, True ) /* IgnoreCollisions */
     , (4220,  13, True ) /* Ethereal */
     , (4220,  14, True ) /* GravityStatus */
     , (4220,  19, True ) /* Attackable */
     , (4220,  22, True ) /* Inscribable */;
