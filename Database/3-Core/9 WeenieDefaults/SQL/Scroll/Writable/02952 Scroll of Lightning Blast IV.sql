...
VALUES (2952,   1,       8192) /* ItemType - Writable */
     ...
     , (2952,  19,        100) /* Value */
     , (2952,  65,        101) /* Placement - Resting */
     , (2952,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2952,   1, False) /* Stuck */
     , (2952,  11, True ) /* IgnoreCollisions */
     , (2952,  13, True ) /* Ethereal */
     , (2952,  14, True ) /* GravityStatus */
     , (2952,  19, True ) /* Attackable */
     , (2952,  22, True ) /* Inscribable */;
