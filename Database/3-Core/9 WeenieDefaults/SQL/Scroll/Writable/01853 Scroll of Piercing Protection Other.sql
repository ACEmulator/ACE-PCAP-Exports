...
VALUES (1853,   1,       8192) /* ItemType - Writable */
     ...
     , (1853,  19,          1) /* Value */
     , (1853,  65,        101) /* Placement - Resting */
     , (1853,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1853,   1, False) /* Stuck */
     , (1853,  11, True ) /* IgnoreCollisions */
     , (1853,  13, True ) /* Ethereal */
     , (1853,  14, True ) /* GravityStatus */
     , (1853,  19, True ) /* Attackable */
     , (1853,  22, True ) /* Inscribable */;
