...
VALUES (1771,   1,       8192) /* ItemType - Writable */
     ...
     , (1771,  19,          1) /* Value */
     , (1771,  65,        101) /* Placement - Resting */
     , (1771,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1771,   1, False) /* Stuck */
     , (1771,  11, True ) /* IgnoreCollisions */
     , (1771,  13, True ) /* Ethereal */
     , (1771,  14, True ) /* GravityStatus */
     , (1771,  19, True ) /* Attackable */
     , (1771,  22, True ) /* Inscribable */;
