...
VALUES (3093, 'scrollmanadepletion2', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (3093,   1,       8192) /* ItemType - Writable */
     ...
     , (3093,  19,          5) /* Value */
     , (3093,  65,        101) /* Placement - Resting */
     , (3093,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3093,   1, False) /* Stuck */
     , (3093,  11, True ) /* IgnoreCollisions */
     , (3093,  13, True ) /* Ethereal */
     , (3093,  14, True ) /* GravityStatus */
     , (3093,  19, True ) /* Attackable */
     , (3093,  22, True ) /* Inscribable */;
