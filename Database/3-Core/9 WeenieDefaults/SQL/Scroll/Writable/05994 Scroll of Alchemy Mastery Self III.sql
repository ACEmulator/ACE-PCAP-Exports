...
VALUES (5994, 'scrollalchemymasteryself3', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (5994,   1,       8192) /* ItemType - Writable */
     ...
     , (5994,  19,         20) /* Value */
     , (5994,  65,        101) /* Placement - Resting */
     , (5994,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5994,   1, False) /* Stuck */
     , (5994,  11, True ) /* IgnoreCollisions */
     , (5994,  13, True ) /* Ethereal */
     , (5994,  14, True ) /* GravityStatus */
     , (5994,  19, True ) /* Attackable */
     , (5994,  22, True ) /* Inscribable */;
