...
VALUES (2947,   1,       8192) /* ItemType - Writable */
     ...
     , (2947,  19,        200) /* Value */
     , (2947,  65,        101) /* Placement - Resting */
     , (2947,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2947,   1, False) /* Stuck */
     , (2947,  11, True ) /* IgnoreCollisions */
     , (2947,  13, True ) /* Ethereal */
     , (2947,  14, True ) /* GravityStatus */
     , (2947,  19, True ) /* Attackable */
     , (2947,  22, True ) /* Inscribable */;
