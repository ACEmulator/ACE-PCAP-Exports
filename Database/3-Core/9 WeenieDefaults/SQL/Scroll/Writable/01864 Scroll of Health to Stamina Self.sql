...
VALUES (1864,   1,       8192) /* ItemType - Writable */
     ...
     , (1864,  19,          1) /* Value */
     , (1864,  65,        101) /* Placement - Resting */
     , (1864,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1864,   1, False) /* Stuck */
     , (1864,  11, True ) /* IgnoreCollisions */
     , (1864,  13, True ) /* Ethereal */
     , (1864,  14, True ) /* GravityStatus */
     , (1864,  19, True ) /* Attackable */
     , (1864,  22, True ) /* Inscribable */;
