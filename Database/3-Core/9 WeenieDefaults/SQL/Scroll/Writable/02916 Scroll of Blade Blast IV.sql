...
VALUES (2916,   1,       8192) /* ItemType - Writable */
     ...
     , (2916,  19,        100) /* Value */
     , (2916,  65,        101) /* Placement - Resting */
     , (2916,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2916,   1, False) /* Stuck */
     , (2916,  11, True ) /* IgnoreCollisions */
     , (2916,  13, True ) /* Ethereal */
     , (2916,  14, True ) /* GravityStatus */
     , (2916,  19, True ) /* Attackable */
     , (2916,  22, True ) /* Inscribable */;
