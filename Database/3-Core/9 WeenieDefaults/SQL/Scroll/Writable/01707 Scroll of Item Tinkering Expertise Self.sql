...
VALUES (1707, 'scrollitemexpertiseself', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (1707,   1,       8192) /* ItemType - Writable */
     ...
     , (1707,  19,          1) /* Value */
     , (1707,  65,        101) /* Placement - Resting */
     , (1707,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1707,   1, False) /* Stuck */
     , (1707,  11, True ) /* IgnoreCollisions */
     , (1707,  13, True ) /* Ethereal */
     , (1707,  14, True ) /* GravityStatus */
     , (1707,  19, True ) /* Attackable */
     , (1707,  22, True ) /* Inscribable */;
