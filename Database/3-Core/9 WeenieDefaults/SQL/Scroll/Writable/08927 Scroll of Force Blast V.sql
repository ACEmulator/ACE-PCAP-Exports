...
VALUES (8927,   1,       8192) /* ItemType - Writable */
     ...
     , (8927,  19,        200) /* Value */
     , (8927,  65,        101) /* Placement - Resting */
     , (8927,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8927,   1, False) /* Stuck */
     , (8927,  11, True ) /* IgnoreCollisions */
     , (8927,  13, True ) /* Ethereal */
     , (8927,  14, True ) /* GravityStatus */
     , (8927,  19, True ) /* Attackable */
     , (8927,  22, True ) /* Inscribable */;
