...
VALUES (1572,   1,       8192) /* ItemType - Writable */
     ...
     , (1572,  19,         20) /* Value */
     , (1572,  65,        101) /* Placement - Resting */
     , (1572,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1572,   1, False) /* Stuck */
     , (1572,  11, True ) /* IgnoreCollisions */
     , (1572,  13, True ) /* Ethereal */
     , (1572,  14, True ) /* GravityStatus */
     , (1572,  19, True ) /* Attackable */
     , (1572,  22, True ) /* Inscribable */;
