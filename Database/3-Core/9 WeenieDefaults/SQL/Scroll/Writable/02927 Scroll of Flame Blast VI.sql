...
VALUES (2927,   1,       8192) /* ItemType - Writable */
     ...
     , (2927,  19,       1000) /* Value */
     , (2927,  65,        101) /* Placement - Resting */
     , (2927,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2927,   1, False) /* Stuck */
     , (2927,  11, True ) /* IgnoreCollisions */
     , (2927,  13, True ) /* Ethereal */
     , (2927,  14, True ) /* GravityStatus */
     , (2927,  19, True ) /* Attackable */
     , (2927,  22, True ) /* Inscribable */;
