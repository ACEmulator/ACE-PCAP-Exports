...
VALUES (2750, 'scrollweaknessother5', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (2750,   1,       8192) /* ItemType - Writable */
     ...
     , (2750,  19,        200) /* Value */
     , (2750,  65,        101) /* Placement - Resting */
     , (2750,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2750,   1, False) /* Stuck */
     , (2750,  11, True ) /* IgnoreCollisions */
     , (2750,  13, True ) /* Ethereal */
     , (2750,  14, True ) /* GravityStatus */
     , (2750,  19, True ) /* Attackable */
     , (2750,  22, True ) /* Inscribable */;
