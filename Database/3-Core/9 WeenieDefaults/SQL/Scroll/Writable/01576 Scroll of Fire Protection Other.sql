...
VALUES (1576, 'scrollfireprotectionother', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (1576,   1,       8192) /* ItemType - Writable */
     ...
     , (1576,  19,          1) /* Value */
     , (1576,  65,        101) /* Placement - Resting */
     , (1576,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1576,   1, False) /* Stuck */
     , (1576,  11, True ) /* IgnoreCollisions */
     , (1576,  13, True ) /* Ethereal */
     , (1576,  14, True ) /* GravityStatus */
     , (1576,  19, True ) /* Attackable */
     , (1576,  22, True ) /* Inscribable */;
