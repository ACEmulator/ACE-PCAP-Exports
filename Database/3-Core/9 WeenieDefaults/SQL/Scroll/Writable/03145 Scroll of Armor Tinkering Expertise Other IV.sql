...
VALUES (3145, 'scrollarmorexpertiseother4', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (3145,   1,       8192) /* ItemType - Writable */
     ...
     , (3145,  19,        100) /* Value */
     , (3145,  65,        101) /* Placement - Resting */
     , (3145,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3145,   1, False) /* Stuck */
     , (3145,  11, True ) /* IgnoreCollisions */
     , (3145,  13, True ) /* Ethereal */
     , (3145,  14, True ) /* GravityStatus */
     , (3145,  19, True ) /* Attackable */
     , (3145,  22, True ) /* Inscribable */;
