...
VALUES (2953,   1,       8192) /* ItemType - Writable */
     ...
     , (2953,  19,        200) /* Value */
     , (2953,  65,        101) /* Placement - Resting */
     , (2953,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2953,   1, False) /* Stuck */
     , (2953,  11, True ) /* IgnoreCollisions */
     , (2953,  13, True ) /* Ethereal */
     , (2953,  14, True ) /* GravityStatus */
     , (2953,  19, True ) /* Attackable */
     , (2953,  22, True ) /* Inscribable */;
