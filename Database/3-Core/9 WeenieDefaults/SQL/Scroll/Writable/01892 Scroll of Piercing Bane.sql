...
VALUES (1892, 'scrollpiercingbane', 34, '2019-02-10 05:41:14') /* Scroll */;
...
VALUES (1892,   1,       8192) /* ItemType - Writable */
     ...
     , (1892,  19,          1) /* Value */
     , (1892,  65,        101) /* Placement - Resting */
     , (1892,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1892,   1, False) /* Stuck */
     , (1892,  11, True ) /* IgnoreCollisions */
     , (1892,  13, True ) /* Ethereal */
     , (1892,  14, True ) /* GravityStatus */
     , (1892,  19, True ) /* Attackable */
     , (1892,  22, True ) /* Inscribable */;
