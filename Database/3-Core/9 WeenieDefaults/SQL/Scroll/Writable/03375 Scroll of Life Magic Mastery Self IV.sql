...
VALUES (3375, 'scrolllifemagicmasteryself4', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (3375,   1,       8192) /* ItemType - Writable */
     ...
     , (3375,  19,        100) /* Value */
     , (3375,  65,        101) /* Placement - Resting */
     , (3375,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3375,   1, False) /* Stuck */
     , (3375,  11, True ) /* IgnoreCollisions */
     , (3375,  13, True ) /* Ethereal */
     , (3375,  14, True ) /* GravityStatus */
     , (3375,  19, True ) /* Attackable */
     , (3375,  22, True ) /* Inscribable */;
