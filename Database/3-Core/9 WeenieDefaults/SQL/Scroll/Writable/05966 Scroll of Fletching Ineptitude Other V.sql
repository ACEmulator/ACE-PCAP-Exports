...
VALUES (5966, 'scrollfletchingineptitude5', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (5966,   1,       8192) /* ItemType - Writable */
     ...
     , (5966,  19,        200) /* Value */
     , (5966,  65,        101) /* Placement - Resting */
     , (5966,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5966,   1, False) /* Stuck */
     , (5966,  11, True ) /* IgnoreCollisions */
     , (5966,  13, True ) /* Ethereal */
     , (5966,  14, True ) /* GravityStatus */
     , (5966,  19, True ) /* Attackable */
     , (5966,  22, True ) /* Inscribable */;
