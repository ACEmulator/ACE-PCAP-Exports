...
VALUES (8923, 'scrollflamestreak4', 34, '2019-02-10 05:41:14') /* Scroll */;
...
VALUES (8923,   1,       8192) /* ItemType - Writable */
     ...
     , (8923,  19,        100) /* Value */
     , (8923,  65,        101) /* Placement - Resting */
     , (8923,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8923,   1, False) /* Stuck */
     , (8923,  11, True ) /* IgnoreCollisions */
     , (8923,  13, True ) /* Ethereal */
     , (8923,  14, True ) /* GravityStatus */
     , (8923,  19, True ) /* Attackable */
     , (8923,  22, True ) /* Inscribable */;
