...
VALUES (2856, 'scrolllightningbane6', 34, '2019-02-10 05:41:14') /* Scroll */;
...
VALUES (2856,   1,       8192) /* ItemType - Writable */
     ...
     , (2856,  19,       1000) /* Value */
     , (2856,  65,        101) /* Placement - Resting */
     , (2856,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2856,   1, False) /* Stuck */
     , (2856,  11, True ) /* IgnoreCollisions */
     , (2856,  13, True ) /* Ethereal */
     , (2856,  14, True ) /* GravityStatus */
     , (2856,  19, True ) /* Attackable */
     , (2856,  22, True ) /* Inscribable */;
