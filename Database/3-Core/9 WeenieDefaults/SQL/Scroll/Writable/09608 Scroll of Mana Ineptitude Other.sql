...
VALUES (9608,   1,       8192) /* ItemType - Writable */
     ...
     , (9608,  19,          1) /* Value */
     , (9608,  65,        101) /* Placement - Resting */
     , (9608,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9608,   1, False) /* Stuck */
     , (9608,  11, True ) /* IgnoreCollisions */
     , (9608,  13, True ) /* Ethereal */
     , (9608,  14, True ) /* GravityStatus */
     , (9608,  19, True ) /* Attackable */
     , (9608,  22, True ) /* Inscribable */;
