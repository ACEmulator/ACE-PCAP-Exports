...
VALUES (2948,   1,       8192) /* ItemType - Writable */
     ...
     , (2948,  19,       1000) /* Value */
     , (2948,  65,        101) /* Placement - Resting */
     , (2948,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2948,   1, False) /* Stuck */
     , (2948,  11, True ) /* IgnoreCollisions */
     , (2948,  13, True ) /* Ethereal */
     , (2948,  14, True ) /* GravityStatus */
     , (2948,  19, True ) /* Attackable */
     , (2948,  22, True ) /* Inscribable */;
