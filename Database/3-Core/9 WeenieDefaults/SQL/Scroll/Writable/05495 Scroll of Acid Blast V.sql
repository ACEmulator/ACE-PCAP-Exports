...
VALUES (5495,   1,       8192) /* ItemType - Writable */
     ...
     , (5495,  19,        200) /* Value */
     , (5495,  65,        101) /* Placement - Resting */
     , (5495,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5495,   1, False) /* Stuck */
     , (5495,  11, True ) /* IgnoreCollisions */
     , (5495,  13, True ) /* Ethereal */
     , (5495,  14, True ) /* GravityStatus */
     , (5495,  19, True ) /* Attackable */
     , (5495,  22, True ) /* Inscribable */;
