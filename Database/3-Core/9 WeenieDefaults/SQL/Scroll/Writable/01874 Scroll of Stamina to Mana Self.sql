...
VALUES (1874, 'scrollstaminatomanaself', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (1874,   1,       8192) /* ItemType - Writable */
     ...
     , (1874,  19,          1) /* Value */
     , (1874,  65,        101) /* Placement - Resting */
     , (1874,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1874,   1, False) /* Stuck */
     , (1874,  11, True ) /* IgnoreCollisions */
     , (1874,  13, True ) /* Ethereal */
     , (1874,  14, True ) /* GravityStatus */
     , (1874,  19, True ) /* Attackable */
     , (1874,  22, True ) /* Inscribable */;
