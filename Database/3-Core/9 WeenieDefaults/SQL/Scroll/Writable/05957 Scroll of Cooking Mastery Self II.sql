...
VALUES (5957,   1,       8192) /* ItemType - Writable */
     ...
     , (5957,  19,          5) /* Value */
     , (5957,  65,        101) /* Placement - Resting */
     , (5957,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5957,   1, False) /* Stuck */
     , (5957,  11, True ) /* IgnoreCollisions */
     , (5957,  13, True ) /* Ethereal */
     , (5957,  14, True ) /* GravityStatus */
     , (5957,  19, True ) /* Attackable */
     , (5957,  22, True ) /* Inscribable */;
