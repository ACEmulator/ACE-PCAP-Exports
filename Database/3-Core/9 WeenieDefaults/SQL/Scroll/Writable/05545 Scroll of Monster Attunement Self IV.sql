...
VALUES (5545, 'scrollmonsterattunementself4', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (5545,   1,       8192) /* ItemType - Writable */
     ...
     , (5545,  19,        100) /* Value */
     , (5545,  65,        101) /* Placement - Resting */
     , (5545,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5545,   1, False) /* Stuck */
     , (5545,  11, True ) /* IgnoreCollisions */
     , (5545,  13, True ) /* Ethereal */
     , (5545,  14, True ) /* GravityStatus */
     , (5545,  19, True ) /* Attackable */
     , (5545,  22, True ) /* Inscribable */;
