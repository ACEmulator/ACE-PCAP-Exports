...
VALUES (2140,   1,       8192) /* ItemType - Writable */
     ...
     , (2140,  19,         20) /* Value */
     , (2140,  65,        101) /* Placement - Resting */
     , (2140,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2140,   1, False) /* Stuck */
     , (2140,  11, True ) /* IgnoreCollisions */
     , (2140,  13, True ) /* Ethereal */
     , (2140,  14, True ) /* GravityStatus */
     , (2140,  19, True ) /* Attackable */
     , (2140,  22, True ) /* Inscribable */;
