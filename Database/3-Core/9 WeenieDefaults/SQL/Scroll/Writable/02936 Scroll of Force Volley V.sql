...
VALUES (2936,   1,       8192) /* ItemType - Writable */
     ...
     , (2936,  19,        200) /* Value */
     , (2936,  65,        101) /* Placement - Resting */
     , (2936,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2936,   1, False) /* Stuck */
     , (2936,  11, True ) /* IgnoreCollisions */
     , (2936,  13, True ) /* Ethereal */
     , (2936,  14, True ) /* GravityStatus */
     , (2936,  19, True ) /* Attackable */
     , (2936,  22, True ) /* Inscribable */;
