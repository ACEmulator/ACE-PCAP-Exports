...
VALUES (8950, 'scrollshockwavestreak4', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (8950,   1,       8192) /* ItemType - Writable */
     ...
     , (8950,  19,        100) /* Value */
     , (8950,  65,        101) /* Placement - Resting */
     , (8950,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8950,   1, False) /* Stuck */
     , (8950,  11, True ) /* IgnoreCollisions */
     , (8950,  13, True ) /* Ethereal */
     , (8950,  14, True ) /* GravityStatus */
     , (8950,  19, True ) /* Attackable */
     , (8950,  22, True ) /* Inscribable */;
