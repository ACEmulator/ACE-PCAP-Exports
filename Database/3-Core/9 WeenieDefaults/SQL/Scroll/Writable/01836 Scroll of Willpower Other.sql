...
VALUES (1836, 'scrollwillpowerother', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (1836,   1,       8192) /* ItemType - Writable */
     ...
     , (1836,  19,          1) /* Value */
     , (1836,  65,        101) /* Placement - Resting */
     , (1836,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1836,   1, False) /* Stuck */
     , (1836,  11, True ) /* IgnoreCollisions */
     , (1836,  13, True ) /* Ethereal */
     , (1836,  14, True ) /* GravityStatus */
     , (1836,  19, True ) /* Attackable */
     , (1836,  22, True ) /* Inscribable */;
