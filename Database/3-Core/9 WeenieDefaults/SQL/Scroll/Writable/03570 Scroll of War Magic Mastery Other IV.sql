...
VALUES (3570, 'scrollwarmagicmasteryother4', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (3570,   1,       8192) /* ItemType - Writable */
     ...
     , (3570,  19,        100) /* Value */
     , (3570,  65,        101) /* Placement - Resting */
     , (3570,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3570,   1, False) /* Stuck */
     , (3570,  11, True ) /* IgnoreCollisions */
     , (3570,  13, True ) /* Ethereal */
     , (3570,  14, True ) /* GravityStatus */
     , (3570,  19, True ) /* Attackable */
     , (3570,  22, True ) /* Inscribable */;
