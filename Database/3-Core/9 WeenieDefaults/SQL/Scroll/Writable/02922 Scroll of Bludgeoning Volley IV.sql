...
VALUES (2922,   1,       8192) /* ItemType - Writable */
     ...
     , (2922,  19,        100) /* Value */
     , (2922,  65,        101) /* Placement - Resting */
     , (2922,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2922,   1, False) /* Stuck */
     , (2922,  11, True ) /* IgnoreCollisions */
     , (2922,  13, True ) /* Ethereal */
     , (2922,  14, True ) /* GravityStatus */
     , (2922,  19, True ) /* Attackable */
     , (2922,  22, True ) /* Inscribable */;
