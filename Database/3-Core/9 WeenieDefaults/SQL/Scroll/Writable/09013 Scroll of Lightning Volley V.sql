...
VALUES (9013,   1,       8192) /* ItemType - Writable */
     ...
     , (9013,  19,        200) /* Value */
     , (9013,  65,        101) /* Placement - Resting */
     , (9013,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9013,   1, False) /* Stuck */
     , (9013,  11, True ) /* IgnoreCollisions */
     , (9013,  13, True ) /* Ethereal */
     , (9013,  14, True ) /* GravityStatus */
     , (9013,  19, True ) /* Attackable */
     , (9013,  22, True ) /* Inscribable */;
