...
VALUES (2138, 'scrollfrostvolley3', 34, '2019-02-10 08:04:04') /* Scroll */;
...
VALUES (2138,   1,       8192) /* ItemType - Writable */
     ...
     , (2138,  19,         20) /* Value */
     , (2138,  65,        101) /* Placement - Resting */
     , (2138,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2138,   1, False) /* Stuck */
     , (2138,  11, True ) /* IgnoreCollisions */
     , (2138,  13, True ) /* Ethereal */
     , (2138,  14, True ) /* GravityStatus */
     , (2138,  19, True ) /* Attackable */
     , (2138,  22, True ) /* Inscribable */;
