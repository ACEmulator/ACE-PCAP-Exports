...
VALUES (1699, 'scrollfealtyself', 34, '2019-02-10 07:19:52') /* Scroll */;
...
VALUES (1699,   1,       8192) /* ItemType - Writable */
     ...
     , (1699,  19,          1) /* Value */
     , (1699,  65,        101) /* Placement - Resting */
     , (1699,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1699,   1, False) /* Stuck */
     , (1699,  11, True ) /* IgnoreCollisions */
     , (1699,  13, True ) /* Ethereal */
     , (1699,  14, True ) /* GravityStatus */
     , (1699,  19, True ) /* Attackable */
     , (1699,  22, True ) /* Inscribable */;
