...
VALUES (1928, 'chestminermed', 20, '2019-02-10 00:00:00') /* Chest */;
...
VALUES (1928,   1, 0x0200007C) /* Setup */
     , (1928,   2, 0x09000004) /* MotionTable */
     , (1928,   3, 0x20000021) /* SoundTable */
     , (1928,   8, 0x06001020) /* Icon */
     , (1928,  22, 0x3400002B) /* PhysicsEffectTable */
...
VALUES (1928, 8040, 0x01AE0345, 109.173, -83.8966, 0, 0.707107, 0, 0, -0.707107) /* PCAPRecordedLocation */
/* @teleloc 0x01AE0345 [109.173000 -83.896600 0.000000] 0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (1928, 8000, 0x701AE066) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (1928, -1, 2420, 0, 1, 1, 2, 8, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* Generate Gem (2420) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Contain */
     ...
     , (1928, -1, 124, 0, 1, 1, 2, 8, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* Generate Jerkin (124) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Contain */
