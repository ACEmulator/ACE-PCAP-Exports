...
VALUES (7500, 'chestclothingmed', 20, '2019-02-10 00:00:00') /* Chest */;
...
VALUES (7500,   1, 0x0200007C) /* Setup */
     , (7500,   2, 0x09000004) /* MotionTable */
     , (7500,   3, 0x20000021) /* SoundTable */
     , (7500,   8, 0x06001020) /* Icon */
     , (7500,  22, 0x3400002B) /* PhysicsEffectTable */
...
VALUES (7500, 8040, 0x01E2016D, 49.5998, -86.621, -12, 0.999801, 0, 0, -0.01996) /* PCAPRecordedLocation */
/* @teleloc 0x01E2016D [49.599800 -86.621000 -12.000000] 0.999801 0.000000 0.000000 -0.019960 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (7500, 8000, 0x701E20A4) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_generator` (`object_Id`, `probability`, `weenie_Class_Id`, `delay`, `init_Create`, `max_Create`, `when_Create`, `where_Create`, `stack_Size`, `palette_Id`, `shade`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (7500, -1, 48942, 0, 1, 1, 2, 8, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* Generate Fire Skeleton Minion Essence (50) (48942) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Contain */
     , (7500, -1, 2393, 0, 1, 1, 2, 8, 1, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL) /* Generate Gem (2393) (x1 up to max of 1) - Regenerate upon PickUp - Location to (re)Generate: Contain */;
