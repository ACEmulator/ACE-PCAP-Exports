...
VALUES (12503, 'portalholtburgwildernesssettlement', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (12503,   1, True ) /* Stuck */
     ...
     , (12503,  14, True ) /* GravityStatus */
     , (12503,  15, True ) /* LightsStatus */
     , (12503,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12503,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12503,   1, 'Holtburg Wilderness Settlement Portal') /* Name */
     , (12503,  38, 'Holtburg Wilderness Settlement Portal (40.7N, 47.2E).') /* AppraisalPortalDestination */
