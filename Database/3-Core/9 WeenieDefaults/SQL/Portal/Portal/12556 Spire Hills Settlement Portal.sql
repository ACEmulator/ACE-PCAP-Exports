...
VALUES (12556, 'portalspirehillssettlement', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (12556,   1, True ) /* Stuck */
     ...
     , (12556,  14, True ) /* GravityStatus */
     , (12556,  15, True ) /* LightsStatus */
     , (12556,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12556,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12556,   1, 'Spire Hills Settlement Portal') /* Name */
     , (12556,  38, 'Spire Hills Settlement Portal (54.7S, 40.2E).') /* AppraisalPortalDestination */
