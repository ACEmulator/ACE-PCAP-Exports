...
VALUES (14619, 'portaldesertvanguardcottages', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (14619,   1, True ) /* Stuck */
     ...
     , (14619,  14, True ) /* GravityStatus */
     , (14619,  15, True ) /* LightsStatus */
     , (14619,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (14619,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (14619,   1, 'Desert Vanguard Cottages Portal') /* Name */
     , (14619,  38, 'Desert Vanguard Cottages Portal (43.9S, 11.8E).') /* AppraisalPortalDestination */
