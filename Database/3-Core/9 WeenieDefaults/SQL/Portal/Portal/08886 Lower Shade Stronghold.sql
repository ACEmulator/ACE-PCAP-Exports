...
VALUES (8886, 'portalshadestrongholdescapelower', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (8886,   1,      65536) /* ItemType - Portal */
     ...
     , (8886, 8007,          0) /* PCAPRecordedAutonomousMovement */;
...
VALUES (8886,   1, 'Lower Shade Stronghold') /* Name */
     ...
     , (8886, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8886,   1,   33554867) /* Setup */
     , (8886,   2,  150994947) /* MotionTable */
     , (8886,   8,  100667499) /* Icon */
     , (8886, 8001,    8388656) /* PCAPRecordedWeenieHeader - Usable, UseRadius, RadarBehavior */
     , (8886, 8003,     262164) /* PCAPRecordedObjectDesc - Stuck, Attackable, Portal */
     , (8886, 8005,      98307) /* PCAPRecordedPhysicsDesc - CSetup, MTable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8886, 8040, 45220332, 150, -220, 5.937, 1, 0, 0, -4.37114E-08) /* PCAPRecordedLocation */
/* @teleloc 0x02B201EC [150.000000 -220.000000 5.937000] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8886, 8000, 1881874488) /* PCAPRecordedObjectIID */;
