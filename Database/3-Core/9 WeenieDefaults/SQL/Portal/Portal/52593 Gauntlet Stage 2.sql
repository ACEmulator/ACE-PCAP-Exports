...
VALUES (52593, 'ace52593-gauntletstage2', 7, '2019-02-10 00:00:00') /* Portal */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (52593,   1,      65536) /* ItemType - Portal */
     , (52593,  16,         32) /* ItemUseable - Remote */
     , (52593,  93,       1040) /* PhysicsState - IgnoreCollisions, Gravity */
...
VALUES (52593,  54,     0.3) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (52593,   1, 'Gauntlet Stage 2') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (52593,   1, 0x02001541) /* Setup */
     , (52593,   8, 0x060035CE) /* Icon */
...
VALUES (52593, 8040, 0x59610109, 20.44444, -75.5198, 0, 1, 0, 0, 0) /* PCAPRecordedLocation */
/* @teleloc 0x59610109 [20.444440 -75.519800 0.000000] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (52593, 8000, 0xDC3F82CB) /* PCAPRecordedObjectIID */;
