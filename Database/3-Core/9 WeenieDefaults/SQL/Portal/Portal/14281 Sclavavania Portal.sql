...
VALUES (14281, 'portalsclavavania', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (14281,   1, True ) /* Stuck */
     ...
     , (14281,  14, True ) /* GravityStatus */
     , (14281,  15, True ) /* LightsStatus */
     , (14281,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (14281,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (14281,   1, 'Sclavavania Portal') /* Name */
     , (14281,  38, 'Sclavavania Portal (21.9S, 65.6E).') /* AppraisalPortalDestination */
...
VALUES (14281, 8040, 3395092508, 90.3356, 82.534, 11.937, 0.6565711, 0, 0, -0.7542641) /* PCAPRecordedLocation */
/* @teleloc 0xCA5D001C [90.335600 82.534000 11.937000] 0.656571 0.000000 0.000000 -0.754264 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (14281, 8000, 2091241481) /* PCAPRecordedObjectIID */;
