...
VALUES (14262, 'portalgreenswath', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (14262,   1, True ) /* Stuck */
     ...
     , (14262,  14, True ) /* GravityStatus */
     , (14262,  15, True ) /* LightsStatus */
     , (14262,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (14262,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (14262,   1, 'Greenswath Portal') /* Name */
     , (14262,  38, 'Greenswath Portal (7.4N, 24.6E).') /* AppraisalPortalDestination */
