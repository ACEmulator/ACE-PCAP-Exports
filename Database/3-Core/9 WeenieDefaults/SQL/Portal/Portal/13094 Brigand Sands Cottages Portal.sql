...
VALUES (13094, 'portalbrigandsandscottages', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (13094,   1, True ) /* Stuck */
     ...
     , (13094,  14, True ) /* GravityStatus */
     , (13094,  15, True ) /* LightsStatus */
     , (13094,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (13094,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (13094,   1, 'Brigand Sands Cottages Portal') /* Name */
     , (13094,  38, 'Brigand Sands Cottages Portal (60.9S, 24.9E).') /* AppraisalPortalDestination */
