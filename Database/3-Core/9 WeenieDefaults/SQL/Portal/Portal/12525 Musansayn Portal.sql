...
VALUES (12525, 'portalmusansayn', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (12525,   1, True ) /* Stuck */
     ...
     , (12525,  14, True ) /* GravityStatus */
     , (12525,  15, True ) /* LightsStatus */
     , (12525,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12525,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12525,   1, 'Musansayn Portal') /* Name */
     , (12525,  38, 'Musansayn Portal (4.3N, 12.3E).') /* AppraisalPortalDestination */
...
VALUES (12525, 8040, 2223374389, 155.322, 97.7112, 154.9935, 0.19483, 0, 0, -0.980837) /* PCAPRecordedLocation */
/* @teleloc 0x84860035 [155.322000 97.711200 154.993500] 0.194830 0.000000 0.000000 -0.980837 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (12525, 8000, 2018009090) /* PCAPRecordedObjectIID */;
