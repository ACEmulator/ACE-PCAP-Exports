...
VALUES (12567, 'portalwoodshorecottages', 7, '2019-02-10 07:19:52') /* Portal */;
...
VALUES (12567,   1, True ) /* Stuck */
     ...
     , (12567,  14, True ) /* GravityStatus */
     , (12567,  15, True ) /* LightsStatus */
     , (12567,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12567,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12567,   1, 'Woodshore Cottages Portal') /* Name */
     , (12567,  38, 'Woodshore Cottages Portal (77.8N, 44.2W).') /* AppraisalPortalDestination */
