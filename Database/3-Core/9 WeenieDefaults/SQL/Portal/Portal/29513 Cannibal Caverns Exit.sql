...
VALUES (29513,   1,      65536) /* ItemType - Portal */
     ...
     , (29513, 8007,          0) /* PCAPRecordedAutonomousMovement */;
...
VALUES (29513,   1, 'Cannibal Caverns Exit') /* Name */
     , (29513, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (29513,   1,   33554867) /* Setup */
     , (29513,   2,  150994947) /* MotionTable */
     , (29513,   8,  100667499) /* Icon */
     , (29513, 8001,    8388656) /* PCAPRecordedWeenieHeader - Usable, UseRadius, RadarBehavior */
     , (29513, 8003,     262164) /* PCAPRecordedObjectDesc - Stuck, Attackable, Portal */
     , (29513, 8005,      98307) /* PCAPRecordedPhysicsDesc - CSetup, MTable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (29513, 8040, 2228977, 230, 0, -6.063, 1, 0, 0, 0) /* PCAPRecordedLocation */
/* @teleloc 0x002202F1 [230.000000 0.000000 -6.063000] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (29513, 8000, 1879187517) /* PCAPRecordedObjectIID */;
