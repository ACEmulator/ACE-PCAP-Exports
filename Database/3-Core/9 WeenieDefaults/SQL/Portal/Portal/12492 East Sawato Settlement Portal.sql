...
VALUES (12492, 'portaleastsawatosettlement', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (12492,   1, True ) /* Stuck */
     ...
     , (12492,  14, True ) /* GravityStatus */
     , (12492,  15, True ) /* LightsStatus */
     , (12492,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12492,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12492,   1, 'East Sawato Settlement Portal') /* Name */
     , (12492,  38, 'East Sawato Settlement Portal (27.6S, 63.9E).') /* AppraisalPortalDestination */
...
VALUES (12492, 8040, 3395092500, 58.096, 75.8792, 11.937, -0.4038771, 0, 0, -0.9148132) /* PCAPRecordedLocation */
/* @teleloc 0xCA5D0014 [58.096000 75.879200 11.937000] -0.403877 0.000000 0.000000 -0.914813 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (12492, 8000, 2091241472) /* PCAPRecordedObjectIID */;
