...
VALUES (12550, 'portalsouthhebiantocottages', 7, '2019-02-10 07:19:52') /* Portal */;
...
VALUES (12550,   1, True ) /* Stuck */
     ...
     , (12550,  14, True ) /* GravityStatus */
     , (12550,  15, True ) /* LightsStatus */
     , (12550,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12550,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12550,   1, 'South Hebian-To Cottages Portal') /* Name */
     , (12550,  38, 'South Hebian-To Cottages Portal (44.0S, 80.4E).') /* AppraisalPortalDestination */
