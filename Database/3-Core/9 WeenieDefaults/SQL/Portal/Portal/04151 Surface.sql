...
VALUES (4151,   1,      65536) /* ItemType - Portal */
     ...
     , (4151, 8007,          0) /* PCAPRecordedAutonomousMovement */;
...
VALUES (4151,   1, 'Surface') /* Name */
     , (4151, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (4151,   1, 0x020001B3) /* Setup */
     , (4151,   2, 0x09000003) /* MotionTable */
     , (4151,   8, 0x0600106B) /* Icon */
     , (4151, 8001,    8388656) /* PCAPRecordedWeenieHeader - Usable, UseRadius, RadarBehavior */
     , (4151, 8003,     262164) /* PCAPRecordedObjectDesc - Stuck, Attackable, Portal */
     , (4151, 8005,      98307) /* PCAPRecordedPhysicsDesc - CSetup, MTable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (4151, 8040, 0x004A010C, 80, 0, -6.063, -0.707107, 0, 0, -0.707107) /* PCAPRecordedLocation */
/* @teleloc 0x004A010C [80.000000 0.000000 -6.063000] -0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (4151, 8000, 0x7004A007) /* PCAPRecordedObjectIID */;
