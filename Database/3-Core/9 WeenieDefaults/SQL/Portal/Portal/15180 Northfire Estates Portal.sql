...
VALUES (15180, 'portalnorthfireestates', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (15180,   1, True ) /* Stuck */
     ...
     , (15180,  14, True ) /* GravityStatus */
     , (15180,  15, True ) /* LightsStatus */
     , (15180,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (15180,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (15180,   1, 'Northfire Estates Portal') /* Name */
     , (15180,  38, 'Northfire Estates Portal (83.1N, 28.0W).') /* AppraisalPortalDestination */
