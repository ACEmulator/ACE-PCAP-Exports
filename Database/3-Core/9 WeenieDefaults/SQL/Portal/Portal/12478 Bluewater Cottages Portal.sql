...
VALUES (12478, 'portalbluewatercottages', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (12478,   1, True ) /* Stuck */
     ...
     , (12478,  14, True ) /* GravityStatus */
     , (12478,  15, True ) /* LightsStatus */
     , (12478,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12478,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12478,   1, 'Bluewater Cottages Portal') /* Name */
     , (12478,  38, 'Bluewater Cottages Portal (20.3S, 78.5E).') /* AppraisalPortalDestination */
