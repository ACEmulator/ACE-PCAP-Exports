...
VALUES (12486, 'portaldesolationbeach', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (12486,   1, True ) /* Stuck */
     ...
     , (12486,  14, True ) /* GravityStatus */
     , (12486,  15, True ) /* LightsStatus */
     , (12486,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12486,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12486,   1, 'Desolation Beach  Portal') /* Name */
     , (12486,  38, 'Desolation Beach  Portal (82.4N, 43.5W).') /* AppraisalPortalDestination */
