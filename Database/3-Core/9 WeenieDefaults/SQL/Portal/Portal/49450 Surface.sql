...
VALUES (49450, 'ace49450-surface', 7, '2019-02-10 08:04:04') /* Portal */;
...
VALUES (49450,   1,      65536) /* ItemType - Portal */
     ...
     , (49450, 8007,          0) /* PCAPRecordedAutonomousMovement */;
...
VALUES (49450,   1, 'Surface') /* Name */
     ...
     , (49450, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (49450,   1,   33554867) /* Setup */
     , (49450,   2,  150994947) /* MotionTable */
     , (49450,   8,  100667499) /* Icon */
     , (49450, 8001,    8388656) /* PCAPRecordedWeenieHeader - Usable, UseRadius, RadarBehavior */
     , (49450, 8003,     262164) /* PCAPRecordedObjectDesc - Stuck, Attackable, Portal */
     , (49450, 8005,      98307) /* PCAPRecordedPhysicsDesc - CSetup, MTable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (49450, 8040, 1482948882, 147.277, -322.672, -12.063, 0.9238793, 0, 0, -0.3826841) /* PCAPRecordedLocation */
/* @teleloc 0x58640112 [147.277000 -322.672000 -12.063000] 0.923879 0.000000 0.000000 -0.382684 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (49450, 8000, 1971732488) /* PCAPRecordedObjectIID */;
