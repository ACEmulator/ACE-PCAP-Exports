...
VALUES (8382,   1,      65536) /* ItemType - Portal */
     ...
     , (8382, 8007,          0) /* PCAPRecordedAutonomousMovement */;
...
VALUES (8382,   1, 'Surface Portal') /* Name */
     , (8382, 8006, 'AAA9AAAAAAA=') /* PCAPRecordedCurrentMotionState */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (8382,   1,   33554867) /* Setup */
     , (8382,   2,  150994947) /* MotionTable */
     , (8382,   8,  100667499) /* Icon */
     , (8382, 8001,    8388656) /* PCAPRecordedWeenieHeader - Usable, UseRadius, RadarBehavior */
     , (8382, 8003,     262164) /* PCAPRecordedObjectDesc - Stuck, Attackable, Portal */
     , (8382, 8005,      98307) /* PCAPRecordedPhysicsDesc - CSetup, MTable, Position, Movement */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (8382, 8040, 46727427, 120, -680, -54.063, 1, 0, 0, -4.37114E-08) /* PCAPRecordedLocation */
/* @teleloc 0x02C90103 [120.000000 -680.000000 -54.063000] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8382, 8000, 1881968640) /* PCAPRecordedObjectIID */;
