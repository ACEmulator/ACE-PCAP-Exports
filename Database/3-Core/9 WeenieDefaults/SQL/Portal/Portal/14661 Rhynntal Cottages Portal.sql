...
VALUES (14661, 'portalrhynntalcottages', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (14661,   1, True ) /* Stuck */
     ...
     , (14661,  14, True ) /* GravityStatus */
     , (14661,  15, True ) /* LightsStatus */
     , (14661,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (14661,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (14661,   1, 'Rhynntal Cottages Portal') /* Name */
     , (14661,  38, 'Rhynntal Cottages Portal (47.1N, 39.3W).') /* AppraisalPortalDestination */
