...
VALUES (13110, 'portalishilaiinletvillas', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (13110,   1, True ) /* Stuck */
     ...
     , (13110,  14, True ) /* GravityStatus */
     , (13110,  15, True ) /* LightsStatus */
     , (13110,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (13110,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (13110,   1, 'Ishilai Inlet Villas Portal') /* Name */
     , (13110,  38, 'Ishilai Inlet Villas Portal (84.7S, 51.5E).') /* AppraisalPortalDestination */
