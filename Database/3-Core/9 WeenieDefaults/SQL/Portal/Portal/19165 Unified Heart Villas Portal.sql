...
VALUES (19165, 'portalunifiedheartvillas', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (19165,   1, True ) /* Stuck */
     ...
     , (19165,  14, True ) /* GravityStatus */
     , (19165,  15, True ) /* LightsStatus */
     , (19165,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (19165,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (19165,   1, 'Unified Heart Villas Portal') /* Name */
     , (19165,  38, 'Unified Heart Villas Portal (13.6N, 16.2E).') /* AppraisalPortalDestination */
...
VALUES (19165, 8040, 2223374380, 138.758, 85.485, 159.4368, -0.9822285, 0, 0, 0.1876889) /* PCAPRecordedLocation */
/* @teleloc 0x8486002C [138.758000 85.485000 159.436800] -0.982229 0.000000 0.000000 0.187689 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (19165, 8000, 2018009105) /* PCAPRecordedObjectIID */;
