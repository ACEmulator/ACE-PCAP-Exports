...
VALUES (12518, 'portalmajestichillcottages', 7, '2019-02-10 05:41:14') /* Portal */;
...
VALUES (12518,   1, True ) /* Stuck */
     ...
     , (12518,  14, True ) /* GravityStatus */
     , (12518,  15, True ) /* LightsStatus */
     , (12518,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (12518,  54, -0.100000001490116) /* UseRadius */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (12518,   1, 'Majestic Hill Cottages Portal') /* Name */
     , (12518,  38, 'Majestic Hill Cottages Portal (30.9N, 9.0E).') /* AppraisalPortalDestination */
