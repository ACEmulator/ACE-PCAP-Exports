...
VALUES (42277, 'ace42277-reinforceddoor', 19, '2019-02-10 07:19:52') /* Door */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (42277,   1,        128) /* ItemType - Misc */
     , (42277,  16,         32) /* ItemUseable - Remote */
     , (42277,  93,      65560) /* PhysicsState - ReportCollisions, IgnoreCollisions, HasPhysicsBSP */
     , (42277, 8007,          0) /* PCAPRecordedAutonomousMovement */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (42277,   1, True ) /* Stuck */
     , (42277,  11, True ) /* IgnoreCollisions */
     , (42277,  12, True ) /* ReportCollisions */
     , (42277,  13, False) /* Ethereal */
     , (42277,  19, True ) /* Attackable */;
