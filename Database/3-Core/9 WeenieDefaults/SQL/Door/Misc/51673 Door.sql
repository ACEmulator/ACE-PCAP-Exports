...
VALUES (51673, 'ace51673-door', 19, '2019-02-10 08:04:04') /* Door */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51673,   1,        128) /* ItemType - Misc */
     , (51673,  16,          1) /* ItemUseable - No */
     , (51673,  19,          0) /* Value */
     , (51673,  93,      65560) /* PhysicsState - ReportCollisions, IgnoreCollisions, HasPhysicsBSP */
     , (51673, 8007,          0) /* PCAPRecordedAutonomousMovement */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (51673,   1, True ) /* Stuck */
     , (51673,   2, False) /* Open */
     , (51673,  11, True ) /* IgnoreCollisions */
     , (51673,  12, True ) /* ReportCollisions */
     , (51673,  13, False) /* Ethereal */
     , (51673,  19, True ) /* Attackable */;
