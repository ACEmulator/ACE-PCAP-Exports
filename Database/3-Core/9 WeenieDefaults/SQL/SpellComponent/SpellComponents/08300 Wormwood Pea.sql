...
VALUES (8300,   1,       4096) /* ItemType - SpellComponents */
     ...
     , (8300,  19,       1250) /* Value */
     , (8300,  65,        101) /* Placement - Resting */
     , (8300,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8300,   1, False) /* Stuck */
     , (8300,  11, True ) /* IgnoreCollisions */
     , (8300,  13, True ) /* Ethereal */
     , (8300,  14, True ) /* GravityStatus */
     , (8300,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8300,  39, 0.330000013113022) /* DefaultScale */;
