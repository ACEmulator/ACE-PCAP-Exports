...
VALUES (8305,   1,       4096) /* ItemType - SpellComponents */
     ...
     , (8305,  19,        625) /* Value */
     , (8305,  65,        101) /* Placement - Resting */
     , (8305,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8305,   1, False) /* Stuck */
     , (8305,  11, True ) /* IgnoreCollisions */
     , (8305,  13, True ) /* Ethereal */
     , (8305,  14, True ) /* GravityStatus */
     , (8305,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8305,  39, 0.330000013113022) /* DefaultScale */;
...
VALUES (8305,   2, 2258805206) /* Container */
     , (8305, 8000, 2258805211) /* PCAPRecordedObjectIID */;
