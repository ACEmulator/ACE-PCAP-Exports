...
VALUES (8299,   1,       4096) /* ItemType - SpellComponents */
     ...
     , (8299,  19,       1250) /* Value */
     , (8299,  65,        101) /* Placement - Resting */
     , (8299,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8299,   1, False) /* Stuck */
     , (8299,  11, True ) /* IgnoreCollisions */
     , (8299,  13, True ) /* Ethereal */
     , (8299,  14, True ) /* GravityStatus */
     , (8299,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8299,  39, 0.330000013113022) /* DefaultScale */;
