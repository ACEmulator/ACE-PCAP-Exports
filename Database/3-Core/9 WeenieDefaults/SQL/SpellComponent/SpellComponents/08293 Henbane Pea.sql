...
VALUES (8293, 'peaherbhenbane', 32) /* SpellComponent */;
...
VALUES (8293,   1,       4096) /* ItemType - SpellComponents */
     ...
     , (8293,  19,       1250) /* Value */
     , (8293,  65,        101) /* Placement - Resting */
     , (8293,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8293,   1, False) /* Stuck */
     , (8293,  11, True ) /* IgnoreCollisions */
     , (8293,  13, True ) /* Ethereal */
     , (8293,  14, True ) /* GravityStatus */
     , (8293,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8293,  39, 0.330000013113022) /* DefaultScale */;
...
VALUES (8293,   2, 3695853951) /* Container */
     , (8293, 8000, 3695853973) /* PCAPRecordedObjectIID */;
