...
VALUES (8353, 'peataperred', 32) /* SpellComponent */;
...
VALUES (8353,   1,       4096) /* ItemType - SpellComponents */
     ...
     , (8353,  19,       3125) /* Value */
     , (8353,  65,        101) /* Placement - Resting */
     , (8353,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8353,   1, False) /* Stuck */
     , (8353,  11, True ) /* IgnoreCollisions */
     , (8353,  13, True ) /* Ethereal */
     , (8353,  14, True ) /* GravityStatus */
     , (8353,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8353,  39, 0.330000013113022) /* DefaultScale */;
...
VALUES (8353,   2, 1342644320) /* Container */
     , (8353, 8000, 2917028272) /* PCAPRecordedObjectIID */;
