...
VALUES (4726,   1,         32) /* ItemType - Food */
     ...
     , (4726,  19,         25) /* Value */
     , (4726,  65,        101) /* Placement - Resting */
     , (4726,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4726,   1, False) /* Stuck */
     , (4726,  11, True ) /* IgnoreCollisions */
     , (4726,  13, True ) /* Ethereal */
     , (4726,  14, True ) /* GravityStatus */
     , (4726,  19, True ) /* Attackable */;
