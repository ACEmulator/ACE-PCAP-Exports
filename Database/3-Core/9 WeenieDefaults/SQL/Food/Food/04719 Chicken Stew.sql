...
VALUES (4719, 'chickenstew', 18, '2019-02-10 05:41:14') /* Food */;
...
VALUES (4719,   1,         32) /* ItemType - Food */
     ...
     , (4719,  19,         25) /* Value */
     , (4719,  65,        101) /* Placement - Resting */
     , (4719,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4719,   1, False) /* Stuck */
     , (4719,  11, True ) /* IgnoreCollisions */
     , (4719,  13, True ) /* Ethereal */
     , (4719,  14, True ) /* GravityStatus */
     , (4719,  19, True ) /* Attackable */;
