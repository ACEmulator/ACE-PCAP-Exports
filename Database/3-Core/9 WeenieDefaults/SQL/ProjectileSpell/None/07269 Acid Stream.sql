...
VALUES (7269, 'acidring', 33, '2019-02-10 08:04:04') /* ProjectileSpell */;
...
VALUES (7269, 2, 23688,  1, 0, 0, False) /* Create Acid Spear (23688) for Wield */
     , (7269, 2, 32123,  1, 0, 0, False) /* Create Acid Spear (32123) for Wield */
