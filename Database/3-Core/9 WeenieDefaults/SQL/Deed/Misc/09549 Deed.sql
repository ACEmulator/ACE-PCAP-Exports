...
VALUES (9549,   1,        128) /* ItemType - Misc */
     ...
     , (9549,  65,        101) /* Placement - Resting */
     , (9549,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (9549, 114,          2) /* Attuned - Sticky */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9549,   1, False) /* Stuck */
     , (9549,  11, True ) /* IgnoreCollisions */
     , (9549,  13, True ) /* Ethereal */
     , (9549,  14, True ) /* GravityStatus */
     , (9549,  19, True ) /* Attackable */
     , (9549,  22, True ) /* Inscribable */;
...
VALUES (9549,   2, 2186220473) /* Container */
     , (9549, 8000, 2876136310) /* PCAPRecordedObjectIID */;
