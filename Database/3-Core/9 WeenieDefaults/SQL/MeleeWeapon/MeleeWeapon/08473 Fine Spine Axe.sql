...
VALUES (8473,   1, False) /* Stuck */
     , (8473,  11, True ) /* IgnoreCollisions */
...
VALUES (8473,   1,   33558225) /* Setup */
     ...
     , (8473, 8019,         88) /* PCAPRecordedDefaultScript */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (8473,   2, 2166203135) /* Container */
     , (8473, 8000, 2166203132) /* PCAPRecordedObjectIID */;
