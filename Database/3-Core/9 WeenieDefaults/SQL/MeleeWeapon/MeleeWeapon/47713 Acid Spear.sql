...
VALUES (47713, 'ace47713-acidspear', 6) /* MeleeWeapon */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (47713,   1,          1) /* ItemType - MeleeWeapon */
     , (47713,   2,         92) /* CreatureType - ParadoxOlthoi */
     ...
     , (47713,  65,          1) /* Placement - RightHandCombat */
     , (47713,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (47713, 151,          2) /* HookType - Wall */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (47713,   1, False) /* Stuck */
     , (47713,  11, True ) /* IgnoreCollisions */
     , (47713,  13, True ) /* Ethereal */
     , (47713,  14, True ) /* GravityStatus */
     , (47713,  19, True ) /* Attackable */
     , (47713,  22, True ) /* Inscribable */;
...
VALUES (47713,   3, 3689985733) /* Wielder */
     , (47713, 8000, 3689985738) /* PCAPRecordedObjectIID */
     , (47713, 8008, 3689985733) /* PCAPRecordedParentIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (47713,   1,  1570, 0, 0, 1570) /* MaxHealth */;
