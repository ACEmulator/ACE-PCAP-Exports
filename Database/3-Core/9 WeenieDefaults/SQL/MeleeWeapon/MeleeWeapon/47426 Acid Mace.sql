...
VALUES (47426, 'ace47426-acidmace', 6) /* MeleeWeapon */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (47426,   1,          1) /* ItemType - MeleeWeapon */
     , (47426,   2,         20) /* CreatureType - Wisp */
...
VALUES (47426,   3, 3686229538) /* Wielder */
     , (47426, 8000, 3686232843) /* PCAPRecordedObjectIID */
     , (47426, 8008, 3686229538) /* PCAPRecordedParentIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (47426,   1,  1020, 0, 0, 1020) /* MaxHealth */;
