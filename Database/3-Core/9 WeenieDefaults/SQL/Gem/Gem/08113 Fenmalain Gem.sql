...
VALUES (8113, 'gemfenmalain', 38) /* Gem */;
...
VALUES (8113,   1,       2048) /* ItemType - Gem */
     ...
     , (8113,  65,        101) /* Placement - Resting */
     , (8113,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8113, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8113,   1, False) /* Stuck */
     , (8113,  11, True ) /* IgnoreCollisions */
     , (8113,  13, True ) /* Ethereal */
     , (8113,  14, True ) /* GravityStatus */
     , (8113,  19, True ) /* Attackable */
     , (8113,  22, True ) /* Inscribable */;
...
VALUES (8113,   2, 1343293947) /* Container */
     , (8113, 8000, 3261434778) /* PCAPRecordedObjectIID */;
