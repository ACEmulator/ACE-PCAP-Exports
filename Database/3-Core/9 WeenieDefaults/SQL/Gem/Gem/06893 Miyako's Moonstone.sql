...
VALUES (6893, 'moonstonemiyako', 38) /* Gem */;
...
VALUES (6893,   1,       2048) /* ItemType - Gem */
     ...
     , (6893,  19,        483) /* Value */
     , (6893,  65,        101) /* Placement - Resting */
     , (6893,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (6893,   1, False) /* Stuck */
     , (6893,  11, True ) /* IgnoreCollisions */
     , (6893,  13, True ) /* Ethereal */
     , (6893,  14, True ) /* GravityStatus */
     , (6893,  19, True ) /* Attackable */
     , (6893,  22, True ) /* Inscribable */;
...
VALUES (6893,   2, 1342436792) /* Container */
     , (6893, 8000, 2448058034) /* PCAPRecordedObjectIID */;
