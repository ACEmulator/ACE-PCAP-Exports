...
VALUES (7121, 'skeletonbonelord', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (7121,   1,    10, 0, 0, 198) /* MaxHealth */
     , (7121,   3,    10, 0, 0, 285) /* MaxStamina */
     , (7121,   5,    10, 0, 0, 265) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7121, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (7121, 2, 47711,  1, 0, 0, False) /* Create Acid Spear (47711) for Wield */
