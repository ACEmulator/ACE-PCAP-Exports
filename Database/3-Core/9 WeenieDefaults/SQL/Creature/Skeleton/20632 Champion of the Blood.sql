...
VALUES (20632, 'skeletonrelicgelid-nofall', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (20632, 8000, 0xC64DCCB9) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (20632,   1,     0, 0, 0, 1758) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (20632, 2, 48233,  1, 0, 0, False) /* Create Electric Compound Bow (48233) for Wield */
     ...
     , (20632, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
