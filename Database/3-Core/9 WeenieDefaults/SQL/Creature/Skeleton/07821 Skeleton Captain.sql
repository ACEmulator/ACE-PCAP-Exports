...
VALUES (7821, 'skeletoncaptainsoulfearing_melee', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (7821,   1,    10, 0, 0, 95) /* MaxHealth */
     , (7821,   3,    10, 0, 0, 140) /* MaxStamina */
     , (7821,   5,    10, 0, 0, 75) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7821, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (7821, 2, 48241,  1, 0, 0, False) /* Create Longbow (48241) for Wield */
