...
VALUES (8595, 'skeletoncursedbonesmeditate', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (8595,   1,    10, 0, 0, 283) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8595, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (8595, 2, 48233,  1, 0, 0, False) /* Create Electric Compound Bow (48233) for Wield */
