...
VALUES (1760, 'skeletonwarrior', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (1760,   1,    10, 0, 0, 95) /* MaxHealth */
     , (1760,   3,    10, 0, 0, 140) /* MaxStamina */
     , (1760,   5,    10, 0, 0, 75) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1760, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (1760, 2, 47636,  1, 0, 0, False) /* Create Tachi (47636) for Wield */
