...
VALUES (1759, 8040, 0x935C000C, 31.96892, 76.59702, 12.67435, 0.707107, 0, 0, -0.707107) /* PCAPRecordedLocation */
/* @teleloc 0x935C000C [31.968920 76.597020 12.674350] 0.707107 0.000000 0.000000 -0.707107 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (1759, 8000, 0xDBB23D86) /* PCAPRecordedObjectIID */;
...
VALUES (1759,   1,    26, 0, 0, 43) /* MaxHealth */
     , (1759,   3,    15, 0, 0, 50) /* MaxStamina */
     , (1759,   5,     0, 0, 0, 65) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1759, 2, 47438,  1, 0, 0, False) /* Create Mace (47438) for Wield */
     ...
     , (1759, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
