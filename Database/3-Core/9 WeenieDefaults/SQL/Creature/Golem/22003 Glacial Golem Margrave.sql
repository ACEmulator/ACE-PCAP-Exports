...
VALUES (22003, 'golemglacialmargraveportal1', 10, '2019-02-10 05:41:14') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (22003,   1,         16) /* ItemType - Creature */
     , (22003,   2,         13) /* CreatureType - Golem */
     , (22003,   6,        255) /* ItemsCapacity */
     , (22003,   7,        255) /* ContainersCapacity */
...
VALUES (22003, 8000, 2884826322) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (22003,   1,    10, 0, 0, 4870) /* MaxHealth */;
