...
VALUES (8427, 'mosswartfanatic', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (8427,   1,    10, 0, 0, 120) /* MaxHealth */
     , (8427,   3,    10, 0, 0, 220) /* MaxStamina */
     , (8427,   5,    10, 0, 0, 85) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8427, 2, 47523,  1, 0, 0, False) /* Create Acid Javelin (47523) for Wield */
     ...
     , (8427, 2, 47727,  1, 0, 0, False) /* Create Spear (47727) for Wield */
