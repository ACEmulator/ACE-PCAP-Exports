...
VALUES (8, 'mosswartcreeper', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (8,   1,    10, 0, 0, 47) /* MaxHealth */
     , (8,   3,    10, 0, 0, 94) /* MaxStamina */
     , (8,   5,    10, 0, 0, 30) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8, 2, 47520,  1, 0, 0, False) /* Create Acid Javelin (47520) for Wield */
     , (8, 2, 47539,  1, 0, 0, False) /* Create Javelin (47539) for Wield */
     , (8, 2, 47615,  1, 0, 0, False) /* Create Acid Tachi (47615) for Wield */
