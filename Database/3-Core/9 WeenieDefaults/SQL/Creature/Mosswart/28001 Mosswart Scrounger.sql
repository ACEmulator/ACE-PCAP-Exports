...
VALUES (28001, 'mosswartscrounger', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (28001,   1,    10, 0, 0, 490) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (28001, 2, 47529,  1, 0, 0, False) /* Create Acid Javelin (47529) for Wield */
     , (28001, 2, 47548,  1, 0, 0, False) /* Create Javelin (47548) for Wield */
