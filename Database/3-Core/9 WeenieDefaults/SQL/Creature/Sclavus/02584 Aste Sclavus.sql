...
VALUES (2584, 'sclavusaste', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (2584,   1,    10, 0, 0, 85) /* MaxHealth */
     , (2584,   3,    10, 0, 0, 150) /* MaxStamina */
     , (2584,   5,    10, 0, 0, 90) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (2584, 2,  7969,  1, 0, 0, False) /* Create Kite Shield (7969) for Wield */
     ...
     , (2584, 2, 47707,  1, 0, 0, False) /* Create Acid Spear (47707) for Wield */
