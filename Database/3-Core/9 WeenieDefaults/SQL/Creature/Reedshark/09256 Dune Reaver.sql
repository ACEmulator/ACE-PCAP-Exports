...
VALUES (9256, 'reedsharkdunereaver', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (9256,   1,    10, 0, 0, 126) /* MaxHealth */
     , (9256,   3,    10, 0, 0, 340) /* MaxStamina */
     , (9256,   5,    10, 0, 0, 65) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (9256, 9,    54,  0, 0, 0, False) /* Create Yoroi Cuirass (54) for ContainTreasure */
     ...
     , (9256, 9,  2413,  1, 0, 0, False) /* Create Gem (2413) for ContainTreasure */
