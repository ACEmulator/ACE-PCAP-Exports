...
VALUES (51286, 'ace51286-virindisentinel', 10, '2019-02-10 08:04:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51286,   1,         16) /* ItemType - Creature */
     , (51286,   2,         19) /* CreatureType - Virindi */
     , (51286,   6,        255) /* ItemsCapacity */
     , (51286,   7,        255) /* ContainersCapacity */
...
VALUES (51286,   1, True ) /* Stuck */
     , (51286,  12, True ) /* ReportCollisions */
     , (51286,  13, False) /* Ethereal */
     , (51286,  14, True ) /* GravityStatus */
     , (51286,  19, True ) /* Attackable */
     , (51286,  42, True ) /* AllowEdgeSlide */;
...
VALUES (51286,   1,    10, 0, 0, 26375) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (51286, 9,   354,  0, 0, 0, False) /* Create Takuba (354) for ContainTreasure */
     , (51286, 9,  2408,  1, 0, 0, False) /* Create Gem (2408) for ContainTreasure */
     , (51286, 9, 20473,  0, 0, 0, False) /* Create Scroll of Tusker's Gift (20473) for ContainTreasure */
