...
VALUES (9264, 'virindiexecutor', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (9264,   1,    10, 0, 0, 275) /* MaxHealth */
     , (9264,   3,    10, 0, 0, 150) /* MaxStamina */
     , (9264,   5,    10, 0, 0, 500) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (9264, 9,    43,  0, 0, 0, False) /* Create Yoroi Breastplate (43) for ContainTreasure */
     ...
     , (9264, 9, 49485,  1, 0, 0, False) /* Create Encapsulated Spirit (49485) for ContainTreasure */
