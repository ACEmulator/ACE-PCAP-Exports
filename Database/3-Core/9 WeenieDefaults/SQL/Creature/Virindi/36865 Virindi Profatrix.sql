...
VALUES (36865, 'ace36865-virindiprofatrix', 10, '2019-02-10 05:41:14') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (36865,   1,         16) /* ItemType - Creature */
     , (36865,   2,         19) /* CreatureType - Virindi */
     , (36865,   6,        255) /* ItemsCapacity */
     , (36865,   7,        255) /* ContainersCapacity */
...
VALUES (36865, 8000, 3707860618) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (36865,   1,    10, 0, 0, 500) /* MaxHealth */;
