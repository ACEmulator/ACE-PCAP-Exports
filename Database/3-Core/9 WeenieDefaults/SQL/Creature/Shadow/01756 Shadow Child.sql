...
VALUES (1756, 'shadowchild', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (1756,   1,    10, 0, 0, 75) /* MaxHealth */
     , (1756,   3,    10, 0, 0, 120) /* MaxStamina */
     , (1756,   5,    10, 0, 0, 90) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1756, 2, 23685,  1, 0, 0, False) /* Create Kite Shield (23685) for Wield */
     ...
     , (1756, 2, 47877,  1, 0, 0, False) /* Create Nekode (47877) for Wield */
