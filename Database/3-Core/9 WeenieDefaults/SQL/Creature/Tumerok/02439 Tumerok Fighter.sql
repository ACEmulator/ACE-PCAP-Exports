...
VALUES (2439, 'tumerokfighter', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (2439,   1,    10, 0, 0, 78) /* MaxHealth */
     , (2439,   3,    10, 0, 0, 170) /* MaxStamina */
     , (2439,   5,    10, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (2439, 2,   300,  1, 0, 0, False) /* Create Arrow (300) for Wield */
     ...
     , (2439, 2,   363,  1, 0, 0, False) /* Create Yumi (363) for Wield */
