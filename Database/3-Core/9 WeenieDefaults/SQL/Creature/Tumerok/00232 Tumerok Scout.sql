...
VALUES (232, 'tumerokscout', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (232,   1,    10, 0, 0, 45) /* MaxHealth */
     , (232,   3,    10, 0, 0, 138) /* MaxStamina */
     , (232,   5,    10, 0, 0, 40) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (232, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (232, 2,   312,  1, 0, 0, False) /* Create Light Crossbow (312) for Wield */
