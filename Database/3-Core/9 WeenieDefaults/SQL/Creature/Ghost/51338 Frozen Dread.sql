...
VALUES (51338, 'ace51338-frozendread', 10, '2019-02-10 05:41:14') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (51338,   1,         16) /* ItemType - Creature */
     , (51338,   2,         77) /* CreatureType - Ghost */
     , (51338,   6,        255) /* ItemsCapacity */
     , (51338,   7,        255) /* ContainersCapacity */
...
VALUES (51338,   1, True ) /* Stuck */
     ...
     , (51338,  14, True ) /* GravityStatus */
     , (51338,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (51338,  39, 0.800000011920929) /* DefaultScale */
     , (51338,  76, 0.800000011920929) /* Translucency */;
...
VALUES (51338, 8040, 2011693120, 171.0757, 170.3689, 105.8258, 1, 0, 0, 0) /* PCAPRecordedLocation */
/* @teleloc 0x77E80040 [171.075700 170.368900 105.825800] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (51338, 8000, 3695630589) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (51338,   1,    10, 0, 0, 20000) /* MaxHealth */;
