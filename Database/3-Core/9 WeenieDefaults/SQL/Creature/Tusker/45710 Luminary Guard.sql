...
VALUES (45710, 'ace45710-luminaryguard', 10) /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (45710,   1,         16) /* ItemType - Creature */
     , (45710,   2,          8) /* CreatureType - Tusker */
     , (45710,   5,       6080) /* EncumbranceVal */
     , (45710,   6,        255) /* ItemsCapacity */
     , (45710,   7,        255) /* ContainersCapacity */
...
VALUES (45710,   1, True ) /* Stuck */
     , (45710,  12, True ) /* ReportCollisions */
     , (45710,  13, False) /* Ethereal */
     , (45710,  14, True ) /* GravityStatus */
     , (45710,  19, True ) /* Attackable */
     , (45710,  42, True ) /* AllowEdgeSlide */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (45710,  39, 1.29999995231628) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (45710,   1, 'Luminary Guard') /* Name */
     , (45710,  16, 'Killed by Eternal Eclipse.') /* LongDesc */
...
VALUES (45710,   1,   435, 0, 0, 435) /* MaxHealth */;
