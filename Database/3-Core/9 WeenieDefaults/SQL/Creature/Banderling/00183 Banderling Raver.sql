...
VALUES (183, 'banderlingraver', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (183,   1,    10, 0, 0, 70) /* MaxHealth */
     , (183,   3,    10, 0, 0, 160) /* MaxStamina */
     , (183,   5,    10, 0, 0, 38) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (183, 2, 47344,  1, 0, 0, False) /* Create Club (47344) for Wield */
     , (183, 2, 47382,  1, 0, 0, False) /* Create Flaming Club (47382) for Wield */
     , (183, 2, 47439,  1, 0, 0, False) /* Create Mace (47439) for Wield */
