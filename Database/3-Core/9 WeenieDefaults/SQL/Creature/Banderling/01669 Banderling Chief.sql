...
VALUES (1669, 'banderlingchief', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (1669,   1,    10, 0, 0, 95) /* MaxHealth */
     , (1669,   3,    10, 0, 0, 180) /* MaxStamina */
     , (1669,   5,    10, 0, 0, 85) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1669, 2, 47345,  1, 0, 0, False) /* Create Club (47345) for Wield */
     , (1669, 2, 47383,  1, 0, 0, False) /* Create Flaming Club (47383) for Wield */
     , (1669, 2, 47440,  1, 0, 0, False) /* Create Mace (47440) for Wield */
