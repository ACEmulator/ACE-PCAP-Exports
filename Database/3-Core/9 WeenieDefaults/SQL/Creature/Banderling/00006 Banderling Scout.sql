...
VALUES (6, 'banderlingscout', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (6, 8040, 0xDD55003C, 176.3855, 89.78645, 5.10715, -0.581708, 0, 0, -0.813398) /* PCAPRecordedLocation */
/* @teleloc 0xDD55003C [176.385500 89.786450 5.107150] -0.581708 0.000000 0.000000 -0.813398 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (6, 8000, 0xDBA654C3) /* PCAPRecordedObjectIID */;
...
VALUES (6,   1,    11, 0, 0, 43) /* MaxHealth */
     , (6,   3,    10, 0, 0, 75) /* MaxStamina */
     , (6,   5,     1, 0, 0, 31) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (6, 2, 47381,  1, 0, 0, False) /* Create Flaming Club (47381) for Wield */
     , (6, 2, 47343,  1, 0, 0, False) /* Create Club (47343) for Wield */
