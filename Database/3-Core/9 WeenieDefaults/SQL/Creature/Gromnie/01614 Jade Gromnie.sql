...
VALUES (1614,  39,     0.9) /* DefaultScale */
...
VALUES (1614, 8000, 0xDBA62563) /* PCAPRecordedObjectIID */;
...
VALUES (1614,   1,    31, 0, 0, 68) /* MaxHealth */
     , (1614,   3,     0, 0, 0, 75) /* MaxStamina */
     , (1614,   5,     0, 0, 0, 20) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1614, 9,  2431,  1, 0, 0, False) /* Create Gem (2431) for ContainTreasure */
     ...
     , (1614, 9,    59,  0, 0, 0, False) /* Create Studded Leather Gauntlets (59) for ContainTreasure */
