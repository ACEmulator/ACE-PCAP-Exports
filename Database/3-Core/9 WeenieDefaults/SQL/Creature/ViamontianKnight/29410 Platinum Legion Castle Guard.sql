...
VALUES (29410, 'knightcastleguardplatinum', 10, '2019-02-10 08:04:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (29410,   1,         16) /* ItemType - Creature */
     , (29410,   2,         83) /* CreatureType - ViamontianKnight */
     , (29410,   6,        255) /* ItemsCapacity */
     , (29410,   7,        255) /* ContainersCapacity */
...
VALUES (29410,   1, True ) /* Stuck */
     ...
     , (29410,  14, True ) /* GravityStatus */
     , (29410,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (29410,  39, 1.29999995231628) /* DefaultScale */;
...
VALUES (29410,   1,    10, 0, 0, 680) /* MaxHealth */
     , (29410,   3,    10, 0, 0, 910) /* MaxStamina */
     , (29410,   5,    10, 0, 0, 80) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (29410, 2, 29964,  1, 0, 0, False) /* Create Throwing Axe (29964) for Wield */
     , (29410, 2, 29969,  1, 0, 0, False) /* Create Quadrelle (29969) for Wield */
     , (29410, 2, 29979,  1, 0, 0, False) /* Create Spadone (29979) for Wield */
