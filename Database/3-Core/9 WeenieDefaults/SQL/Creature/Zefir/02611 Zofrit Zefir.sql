...
VALUES (2611, 'zefirzofrit', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (2611,   1,    10, 0, 0, 70) /* MaxHealth */
     , (2611,   3,    10, 0, 0, 200) /* MaxStamina */
     , (2611,   5,    10, 0, 0, 250) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (2611, 9,    42,  0, 0, 0, False) /* Create Studded Leather Breastplate (42) for ContainTreasure */
     ...
     , (2611, 9,  2430,  1, 0, 0, False) /* Create Gem (2430) for ContainTreasure */
