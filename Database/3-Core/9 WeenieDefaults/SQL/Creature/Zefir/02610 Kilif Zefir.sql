...
VALUES (2610,   1,         16) /* ItemType - Creature */
     ...
     , (2610,   5,        150) /* EncumbranceVal */
     , (2610,   6,        255) /* ItemsCapacity */
     , (2610,   7,        255) /* ContainersCapacity */
     , (2610,  16,          1) /* ItemUseable - No */
     , (2610,  19,      20717) /* Value */
     , (2610,  25,         15) /* Level */
     , (2610,  28,        180) /* ArmorLevel */
     , (2610,  93,       1032) /* PhysicsState - ReportCollisions, Gravity */
     , (2610, 105,          7) /* ItemWorkmanship */
     , (2610, 106,        370) /* ItemSpellcraft */
     , (2610, 107,       2134) /* ItemCurMana */
     , (2610, 108,       2134) /* ItemMaxMana */
     , (2610, 109,        386) /* ItemDifficulty */
     , (2610, 110,          0) /* ItemAllegianceRankLimit */
     , (2610, 115,          0) /* ItemSkillLevelLimit */
     , (2610, 131,         63) /* MaterialType - Silver */
     , (2610, 133,          2) /* ShowableOnRadar - ShowMovement */
     , (2610, 158,          7) /* WieldRequirements - Level */
     , (2610, 159,          1) /* WieldSkilltype - Axe */
     , (2610, 160,        180) /* WieldDifficulty */
     , (2610, 172,          5) /* AppraisalLongDescDecoration */
     , (2610, 177,          8) /* GemCount */
     , (2610, 178,         41) /* GemType */
     , (2610, 376,          1) /* GearHealingBoost */
...
VALUES (2610,   1, True ) /* Stuck */
     ...
     , (2610, 100, True ) /* Dyable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (2610,   5, -0.0666666666666667) /* ManaRate */
     , (2610,  13, 1.20000004768372) /* ArmorModVsSlash */
     , (2610,  14, 0.800000011920929) /* ArmorModVsPierce */
     , (2610,  15,       1) /* ArmorModVsBludgeon */
     , (2610,  16,     0.5) /* ArmorModVsCold */
     , (2610,  17,     0.5) /* ArmorModVsFire */
     , (2610,  18, 0.300000011920929) /* ArmorModVsAcid */
     , (2610,  19, 0.800000011920929) /* ArmorModVsElectric */
     , (2610,  39, 1.20000004768372) /* DefaultScale */
     , (2610, 165,       1) /* ArmorModVsNether */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (2610,   1, 'Kilif Zefir') /* Name */
     , (2610,  16, 'Gorget of Mana Mastery') /* LongDesc */
