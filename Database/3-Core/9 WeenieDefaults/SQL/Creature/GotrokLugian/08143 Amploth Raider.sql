...
VALUES (8143, 'lugianamplothraider', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (8143,   1,    10, 0, 0, 125) /* MaxHealth */
     , (8143,   3,    10, 0, 0, 300) /* MaxStamina */
     , (8143,   5,    10, 0, 0, 50) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8143, 2,  7577,  1, 0, 0, False) /* Create Lugian Axe (7577) for Wield */
     , (8143, 2,  7578,  1, 0, 0, False) /* Create Rock (7578) for Wield */
