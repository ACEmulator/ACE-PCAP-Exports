...
VALUES (4110, 'shrethblood', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (4110,   1,    10, 0, 0, 38) /* MaxHealth */
     , (4110,   3,    10, 0, 0, 202) /* MaxStamina */
     , (4110,   5,    10, 0, 0, 40) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (4110, 9,    38,  0, 0, 0, False) /* Create Studded Leather Bracers (38) for ContainTreasure */
     ...
     , (4110, 9,   295,  0, 0, 0, False) /* Create Bracelet (295) for ContainTreasure */
