...
VALUES (24309, 'olthoswarmieviscerator_nofall', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (24309,   1,    10, 0, 0, 740) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (24309, 9,    35,  0, 0, 0, False) /* Create Chainmail Basinet (35) for ContainTreasure */
     ...
     , (24309, 9, 31758,  0, 0, 0, False) /* Create Frost Dericost Blade (31758) for ContainTreasure */
