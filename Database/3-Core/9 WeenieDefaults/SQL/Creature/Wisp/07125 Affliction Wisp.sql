...
VALUES (7125, 'wispaffliction', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (7125,   1,    10, 0, 0, 360) /* MaxHealth */
     , (7125,   3,    10, 0, 0, 520) /* MaxStamina */
     , (7125,   5,    10, 0, 0, 335) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7125, 9,    40,  0, 0, 0, False) /* Create Platemail Breastplate (40) for ContainTreasure */
     ...
     , (7125, 9,   142,  0, 0, 0, False) /* Create Chalice (142) for ContainTreasure */
