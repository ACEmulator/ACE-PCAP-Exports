...
VALUES (52709, 'ace52709-stingingarmoredillo', 10, '2019-02-10 08:04:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (52709,   1,         16) /* ItemType - Creature */
     , (52709,   2,         17) /* CreatureType - Armoredillo */
     , (52709,   6,        255) /* ItemsCapacity */
     , (52709,   7,        255) /* ContainersCapacity */
...
VALUES (52709, 8000, 2780707075) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (52709,   1,    10, 0, 0, 52390) /* MaxHealth */;
