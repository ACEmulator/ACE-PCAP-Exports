...
VALUES (31827, 'ace31827-incendiaryknight', 10, '2019-02-10 08:04:04') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (31827,   1,         16) /* ItemType - Creature */
     , (31827,   2,         62) /* CreatureType - Elemental */
     , (31827,   6,        255) /* ItemsCapacity */
     , (31827,   7,        255) /* ContainersCapacity */
...
VALUES (31827,   1, True ) /* Stuck */
     , (31827,  12, True ) /* ReportCollisions */
     , (31827,  13, False) /* Ethereal */
     , (31827,  14, True ) /* GravityStatus */
     , (31827,  19, True ) /* Attackable */
     , (31827,  42, True ) /* AllowEdgeSlide */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (31827,  39, 1.29999995231628) /* DefaultScale */;
...
VALUES (31827, 8040, 3111059485, 72.97897, 110.5155, 10.00325, 1, 0, 0, 0) /* PCAPRecordedLocation */
/* @teleloc 0xB96F001D [72.978970 110.515500 10.003250] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (31827, 8000, 3361221609) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (31827,   1,    10, 0, 0, 2000) /* MaxHealth */;
