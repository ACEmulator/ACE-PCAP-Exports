...
VALUES (45706, 'ace45706-glacialguard', 10, '2019-02-10 05:41:14') /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (45706,   1,         16) /* ItemType - Creature */
     , (45706,   2,         62) /* CreatureType - Elemental */
     , (45706,   6,        255) /* ItemsCapacity */
     , (45706,   7,        255) /* ContainersCapacity */
...
VALUES (45706, 8000, 2879409643) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (45706,   1,    10, 0, 0, 3500) /* MaxHealth */;
