...
VALUES (7091,  39,     1.3) /* DefaultScale */;
...
VALUES (7091,   1,   401, 0, 0, 503) /* MaxHealth */
     , (7091,   3,   500, 0, 0, 705) /* MaxStamina */
     , (7091,   5,   250, 0, 0, 370) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7091, 2, 47295,  1, 0, 0, False) /* Create Fire Board with Nail (47295) for Wield */
     ...
     , (7091, 2, 47238,  1, 0, 0, False) /* Create Acid Board with Nail (47238) for Wield */
