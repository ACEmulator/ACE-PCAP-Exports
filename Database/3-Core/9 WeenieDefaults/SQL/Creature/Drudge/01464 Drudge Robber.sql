...
VALUES (1464, 'drudgerobber', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (1464,   1,    10, 0, 0, 38) /* MaxHealth */
     , (1464,   3,    10, 0, 0, 80) /* MaxStamina */
     , (1464,   5,    10, 0, 0, 15) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (1464, 2, 47229,  1, 0, 0, False) /* Create Acid Board with Nail (47229) for Wield */
     ...
     , (1464, 2, 47343,  1, 0, 0, False) /* Create Club (47343) for Wield */
