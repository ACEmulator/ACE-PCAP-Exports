...
VALUES (7, 'drudgeskulker', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (7,   1,    10, 0, 0, 42) /* MaxHealth */
     , (7,   3,    10, 0, 0, 80) /* MaxStamina */
     , (7,   5,    10, 0, 0, 15) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7, 2, 47229,  1, 0, 0, False) /* Create Acid Board with Nail (47229) for Wield */
     , (7, 2, 47248,  1, 0, 0, False) /* Create Board with Nail (47248) for Wield */
