...
VALUES (9251, 'monougabrutish', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (9251,   1,    10, 0, 0, 190) /* MaxHealth */
     , (9251,   3,    10, 0, 0, 410) /* MaxStamina */
     , (9251,   5,    10, 0, 0, 100) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (9251, 2,   310,  1, 0, 0, False) /* Create Throwing Club (310) for Wield */
     , (9251, 2,  3943,  1, 0, 0, False) /* Create Club (3943) for Wield */
