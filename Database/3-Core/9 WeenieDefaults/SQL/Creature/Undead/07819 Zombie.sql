...
VALUES (7819, 'zombiesoulfearing_melee', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (7819,   1,    10, 0, 0, 70) /* MaxHealth */
     , (7819,   3,    10, 0, 0, 120) /* MaxStamina */
     , (7819,   5,    10, 0, 0, 105) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7819, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (7819, 2, 47878,  1, 0, 0, False) /* Create Acid Nekode (47878) for Wield */
