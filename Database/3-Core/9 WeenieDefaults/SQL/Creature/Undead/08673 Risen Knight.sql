...
VALUES (8673, 'zombierisenknight', 10, '2019-02-10 07:19:52') /* Creature */;
...
VALUES (8673,   1,    10, 0, 0, 135) /* MaxHealth */
     , (8673,   3,    10, 0, 0, 210) /* MaxStamina */
     , (8673,   5,    10, 0, 0, 140) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (8673, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (8673, 2, 47920,  1, 0, 0, False) /* Create Katar (47920) for Wield */
