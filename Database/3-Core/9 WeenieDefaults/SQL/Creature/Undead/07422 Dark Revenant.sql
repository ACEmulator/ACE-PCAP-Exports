...
VALUES (7422, 'zombiedarkrevenantnofall', 10, '2019-02-10 05:41:14') /* Creature */;
...
VALUES (7422,   1,    10, 0, 0, 300) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7422, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (7422, 2, 47974,  1, 0, 0, False) /* Create Acid Ono (47974) for Wield */
