...
VALUES (12037, 'undeadbossmonster', 10, '2019-02-10 00:00:00') /* Creature */;
...
VALUES (12037, 8040, 0x33430012, 57.4216, 42.86526, 10.57746, -0.99985, 0, 0, -0.017311) /* PCAPRecordedLocation */
/* @teleloc 0x33430012 [57.421600 42.865260 10.577460] -0.999850 0.000000 0.000000 -0.017311 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (12037, 8000, 0xDCA1F0D1) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (12037,   1,     0, 0, 0, 395) /* MaxHealth */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (12037, 2, 23663,  1, 0, 0, False) /* Create Frost Throwing Club (23663) for Wield */
     , (12037, 2, 23736,  1, 0, 0, False) /* Create Yumi (23736) for Wield */
     , (12037, 2, 23655,  1, 0, 0, False) /* Create Throwing Club (23655) for Wield */
     , (12037, 2,  5304,  1, 0, 0, False) /* Create Greater Arrow (5304) for Wield */
