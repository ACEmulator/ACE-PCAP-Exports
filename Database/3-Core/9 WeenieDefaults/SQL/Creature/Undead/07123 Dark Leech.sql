...
VALUES (7123, 'zombiedarkleech', 10, '2019-02-10 08:04:04') /* Creature */;
...
VALUES (7123,   1,    10, 0, 0, 300) /* MaxHealth */
     , (7123,   3,    10, 0, 0, 420) /* MaxStamina */
     , (7123,   5,    10, 0, 0, 325) /* MaxMana */;

INSERT INTO `weenie_properties_create_list` (`object_Id`, `destination_Type`, `weenie_Class_Id`, `stack_Size`, `palette`, `shade`, `try_To_Bond`)
VALUES (7123, 2,    44,  1, 0, 0, False) /* Create Buckler (44) for Wield */
     ...
     , (7123, 2, 47970,  1, 0, 0, False) /* Create Silifi (47970) for Wield */
