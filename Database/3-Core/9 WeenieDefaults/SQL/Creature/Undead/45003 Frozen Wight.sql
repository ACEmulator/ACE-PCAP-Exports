...
VALUES (45003, 'ace45003-frozenwight', 10) /* Creature */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (45003,   1,         16) /* ItemType - Creature */
     , (45003,   2,         14) /* CreatureType - Undead */
     , (45003,   6,        255) /* ItemsCapacity */
     , (45003,   7,        255) /* ContainersCapacity */
...
VALUES (45003,   1, True ) /* Stuck */
     ...
     , (45003,  14, True ) /* GravityStatus */
     , (45003,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (45003,  39, 1.10000002384186) /* DefaultScale */;
...
VALUES (45003,   1,  3000, 0, 0, 3000) /* MaxHealth */;
