...
VALUES (2622, 'tradenote500', 51, '2019-02-10 05:41:14') /* Stackable */;
...
VALUES (2622,   1,     262144) /* ItemType - PromissoryNote */
     ...
     , (2622,  65,        101) /* Placement - Resting */
     , (2622,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2622,   1, False) /* Stuck */
     , (2622,  11, True ) /* IgnoreCollisions */
...
VALUES (2622, 8000, 2856726464) /* PCAPRecordedObjectIID */;
