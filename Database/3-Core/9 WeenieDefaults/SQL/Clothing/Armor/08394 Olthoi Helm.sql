...
VALUES (8394, 'helmolthoinew', 2, '2019-02-10 05:41:14') /* Clothing */;
...
VALUES (8394,   1,          2) /* ItemType - Armor */
     ...
     , (8394,  65,        101) /* Placement - Resting */
     , (8394,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (8394, 151,          2) /* HookType - Wall */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8394,   1, False) /* Stuck */
     , (8394,  11, True ) /* IgnoreCollisions */
     , (8394,  13, True ) /* Ethereal */
     , (8394,  14, True ) /* GravityStatus */
     , (8394,  19, True ) /* Attackable */
     , (8394,  22, True ) /* Inscribable */
     , (8394, 100, True ) /* Dyable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (8394,  13,       1) /* ArmorModVsSlash */
     , (8394,  14, 0.800000011920929) /* ArmorModVsPierce */
     , (8394,  15, 0.600000023841858) /* ArmorModVsBludgeon */
     , (8394,  16, 0.600000023841858) /* ArmorModVsCold */
     , (8394,  17,       1) /* ArmorModVsFire */
     , (8394,  18, 0.800000011920929) /* ArmorModVsAcid */
