...
VALUES (9935,   1,        128) /* ItemType - Misc */
     ...
     , (9935, 8041,        101) /* PCAPRecordedPlacement - Resting */;
...
VALUES (9935,   1,   33557058) /* Setup */
     ...
     , (9935, 8001,  203423760) /* PCAPRecordedWeenieHeader - Usable, Burden, HouseRestrictions, PScript */
     , (9935, 8003,        148) /* PCAPRecordedObjectDesc - Stuck, Attackable, UiHidden */
     , (9935, 8005,     163969) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, Position, AnimationFrame */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (9935, 8040, 3497263394, 156.604, 79.8544, 29.9995, 0.7301959, 0, 0, -0.6832379) /* PCAPRecordedLocation */
/* @teleloc 0xD0740122 [156.604000 79.854400 29.999500] 0.730196 0.000000 0.000000 -0.683238 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (9935, 8000, 2097627294) /* PCAPRecordedObjectIID */;
