...
VALUES (13894,   1, True ) /* Stuck */
     , (13894,  11, True ) /* IgnoreCollisions */
     , (13894,  13, True ) /* Ethereal */
     , (13894,  19, True ) /* Attackable */
     , (13894,  24, True ) /* UiHidden */
     , (13894,  71, True ) /* NoDraw */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (13894,  39, 0.100000001490116) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (13894,   1, 'Cottage') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (13894,   1,   33557058) /* Setup */
     , (13894,   8,  100671873) /* Icon */
...
VALUES (13894, 8040, 1118437666, 128.874, 156.896, 53.9995, 0.9998596, 0, 0, -0.01675739) /* PCAPRecordedLocation */
/* @teleloc 0x42AA0122 [128.874000 156.896000 53.999500] 0.999860 0.000000 0.000000 -0.016757 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (13894, 8000, 1948950947) /* PCAPRecordedObjectIID */;
