...
VALUES (16463, 'houseapartment3423', 53) /* House */;
...
VALUES (16463,   1,        128) /* ItemType - Misc */
     ...
     , (16463,  19,          0) /* Value */
     , (16463,  65,        101) /* Placement - Resting */
     , (16463,  93,         52) /* PhysicsState - Ethereal, IgnoreCollisions, NoDraw */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (16463,   1, True ) /* Stuck */
     , (16463,  11, True ) /* IgnoreCollisions */
     , (16463,  13, True ) /* Ethereal */
     , (16463,  19, True ) /* Attackable */
     , (16463,  24, True ) /* UiHidden */
     , (16463,  71, True ) /* NoDraw */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (16463,  39, 0.100000001490116) /* DefaultScale */;

INSERT INTO `weenie_properties_string` (`object_Id`, `type`, `value`)
VALUES (16463,   1, 'Apartment') /* Name */;

INSERT INTO `weenie_properties_d_i_d` (`object_Id`, `type`, `value`)
VALUES (16463,   1,   33557058) /* Setup */
     , (16463,   8,  100671873) /* Icon */
...
VALUES (16463, 8040, 1399129009, 90, -60, 5.9995, 1, 0, 0, 0) /* PCAPRecordedLocation */
/* @teleloc 0x536503B1 [90.000000 -60.000000 5.999500] 1.000000 0.000000 0.000000 0.000000 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (16463, 8000, 1966494208) /* PCAPRecordedObjectIID */;
