...
VALUES (1686, 'scrollbowmasteryother', 1) /* Generic */;
...
VALUES (1686,   1,       8192) /* ItemType - Writable */
     ...
     , (1686,  19,          1) /* Value */
     , (1686,  65,        101) /* Placement - Resting */
     , (1686,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1686,   1, False) /* Stuck */
     , (1686,  11, True ) /* IgnoreCollisions */
...
VALUES (1686,   2, 3361998386) /* Container */
     , (1686, 8000, 3361998387) /* PCAPRecordedObjectIID */;
