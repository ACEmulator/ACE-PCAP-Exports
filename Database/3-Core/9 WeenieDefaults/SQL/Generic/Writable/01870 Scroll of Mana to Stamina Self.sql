...
VALUES (1870, 'scrollmanatostaminaself', 1) /* Generic */;
...
VALUES (1870,   1,       8192) /* ItemType - Writable */
     ...
     , (1870,  19,          1) /* Value */
     , (1870,  65,        101) /* Placement - Resting */
     , (1870,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1870,   1, False) /* Stuck */
     , (1870,  11, True ) /* IgnoreCollisions */
     , (1870,  13, True ) /* Ethereal */
     , (1870,  14, True ) /* GravityStatus */
     , (1870,  19, True ) /* Attackable */
     , (1870,  22, True ) /* Inscribable */;
...
VALUES (1870,   2, 2778776470) /* Container */
     , (1870, 8000, 2779121349) /* PCAPRecordedObjectIID */;
