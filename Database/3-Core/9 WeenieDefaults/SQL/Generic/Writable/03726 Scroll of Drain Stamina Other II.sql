...
VALUES (3726, 'scrolldrainstamina2', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (3726,   1,       8192) /* ItemType - Writable */
     , (3726,   2,         13) /* CreatureType - Golem */
     , (3726,   5,         30) /* EncumbranceVal */
     , (3726,  16,          8) /* ItemUseable - Contained */
     , (3726,  19,          5) /* Value */
     , (3726,  25,        100) /* Level */
     , (3726,  65,        101) /* Placement - Resting */
     , (3726,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3726,   1, False) /* Stuck */
     , (3726,  11, True ) /* IgnoreCollisions */
     , (3726,  13, True ) /* Ethereal */
     , (3726,  14, True ) /* GravityStatus */
     , (3726,  19, True ) /* Attackable */
     , (3726,  22, True ) /* Inscribable */;
...
VALUES (3726,   1,   555, 0, 0, 555) /* MaxHealth */;
