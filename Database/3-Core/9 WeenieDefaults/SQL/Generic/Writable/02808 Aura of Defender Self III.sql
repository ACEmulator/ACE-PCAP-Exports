...
VALUES (2808, 'scrolldefender3', 1) /* Generic */;
...
VALUES (2808,   1,       8192) /* ItemType - Writable */
     ...
     , (2808,  19,         20) /* Value */
     , (2808,  65,        101) /* Placement - Resting */
     , (2808,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2808,   1, False) /* Stuck */
     , (2808,  11, True ) /* IgnoreCollisions */
     , (2808,  13, True ) /* Ethereal */
     , (2808,  14, True ) /* GravityStatus */
     , (2808,  19, True ) /* Attackable */
     , (2808,  22, True ) /* Inscribable */;
...
VALUES (2808,   2, 2615238596) /* Container */
     , (2808, 8000, 2615504041) /* PCAPRecordedObjectIID */;
