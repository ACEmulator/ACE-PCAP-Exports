...
VALUES (1673, 'scrolldaggermasteryother', 1) /* Generic */;
...
VALUES (1673,   1,       8192) /* ItemType - Writable */
     ...
     , (1673,  19,          1) /* Value */
     , (1673,  65,        101) /* Placement - Resting */
     , (1673,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1673,   1, False) /* Stuck */
     , (1673,  11, True ) /* IgnoreCollisions */
...
VALUES (1673,   2, 2928703992) /* Container */
     , (1673, 8000, 2928704008) /* PCAPRecordedObjectIID */;
