...
VALUES (3577, 'scrollwarmagicmasteryself6', 1) /* Generic */;
...
VALUES (3577,   1,       8192) /* ItemType - Writable */
     ...
     , (3577,  19,       1000) /* Value */
     , (3577,  65,        101) /* Placement - Resting */
     , (3577,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3577,   1, False) /* Stuck */
     , (3577,  11, True ) /* IgnoreCollisions */
     , (3577,  13, True ) /* Ethereal */
     , (3577,  14, True ) /* GravityStatus */
     , (3577,  19, True ) /* Attackable */
     , (3577,  22, True ) /* Inscribable */;
...
VALUES (3577,   2, 3687865840) /* Container */
     , (3577, 8000, 3690218799) /* PCAPRecordedObjectIID */;
