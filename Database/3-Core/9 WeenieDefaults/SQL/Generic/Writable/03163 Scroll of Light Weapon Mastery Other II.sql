...
VALUES (3163, 'scrollaxemasteryother2', 1) /* Generic */;
...
VALUES (3163,   1,       8192) /* ItemType - Writable */
     ...
     , (3163,  19,          5) /* Value */
     , (3163,  65,        101) /* Placement - Resting */
     , (3163,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3163,   1, False) /* Stuck */
     , (3163,  11, True ) /* IgnoreCollisions */
...
VALUES (3163,   2, 2624588250) /* Container */
     , (3163, 8000, 2623854250) /* PCAPRecordedObjectIID */;
