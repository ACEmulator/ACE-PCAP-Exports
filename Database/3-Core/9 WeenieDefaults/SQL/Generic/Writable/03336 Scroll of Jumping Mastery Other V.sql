...
VALUES (3336, 'scrolljumpmasteryother5', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (3336,   1,       8192) /* ItemType - Writable */
     , (3336,   2,         20) /* CreatureType - Wisp */
...
VALUES (3336,   2, 3703871771) /* Container */
     , (3336, 8000, 3704773694) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (3336,   1,   720, 0, 0, 720) /* MaxHealth */;
