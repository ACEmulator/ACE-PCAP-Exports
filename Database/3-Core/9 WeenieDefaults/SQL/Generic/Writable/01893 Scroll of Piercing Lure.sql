...
VALUES (1893, 'scrollpiercinglure', 1) /* Generic */;
...
VALUES (1893,   1,       8192) /* ItemType - Writable */
     ...
     , (1893,  19,          1) /* Value */
     , (1893,  65,        101) /* Placement - Resting */
     , (1893,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1893,   1, False) /* Stuck */
     , (1893,  11, True ) /* IgnoreCollisions */
     , (1893,  13, True ) /* Ethereal */
     , (1893,  14, True ) /* GravityStatus */
     , (1893,  19, True ) /* Attackable */
     , (1893,  22, True ) /* Inscribable */;
...
VALUES (1893,   2, 2875877210) /* Container */
     , (1893, 8000, 2875999062) /* PCAPRecordedObjectIID */;
