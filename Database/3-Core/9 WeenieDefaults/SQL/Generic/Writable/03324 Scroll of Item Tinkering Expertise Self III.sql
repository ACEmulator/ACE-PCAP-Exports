...
VALUES (3324, 'scrollitemexpertiseself3', 1) /* Generic */;
...
VALUES (3324,   1,       8192) /* ItemType - Writable */
     ...
     , (3324,  19,         20) /* Value */
     , (3324,  65,        101) /* Placement - Resting */
     , (3324,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3324,   1, False) /* Stuck */
     , (3324,  11, True ) /* IgnoreCollisions */
     , (3324,  13, True ) /* Ethereal */
     , (3324,  14, True ) /* GravityStatus */
     , (3324,  19, True ) /* Attackable */
     , (3324,  22, True ) /* Inscribable */;
...
VALUES (3324,   2, 2930738550) /* Container */
     , (3324, 8000, 2930738548) /* PCAPRecordedObjectIID */;
