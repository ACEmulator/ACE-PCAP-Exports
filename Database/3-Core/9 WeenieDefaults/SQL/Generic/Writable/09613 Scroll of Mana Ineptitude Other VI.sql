...
VALUES (9613, 'scrollmanaineptitude6', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (9613,   1,       8192) /* ItemType - Writable */
     , (9613,   2,         20) /* CreatureType - Wisp */
...
VALUES (9613,   2, 3688178303) /* Container */
     , (9613, 8000, 3688259792) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (9613,   1,   720, 0, 0, 720) /* MaxHealth */;
