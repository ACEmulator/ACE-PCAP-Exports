...
VALUES (3069, 'scrollpierceprotectionself3', 1) /* Generic */;
...
VALUES (3069,   1,       8192) /* ItemType - Writable */
     ...
     , (3069,  19,         20) /* Value */
     , (3069,  65,        101) /* Placement - Resting */
     , (3069,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3069,   1, False) /* Stuck */
     , (3069,  11, True ) /* IgnoreCollisions */
     , (3069,  13, True ) /* Ethereal */
     , (3069,  14, True ) /* GravityStatus */
     , (3069,  19, True ) /* Attackable */
     , (3069,  22, True ) /* Inscribable */;
...
VALUES (3069,   2, 2629085476) /* Container */
     , (3069, 8000, 2629085444) /* PCAPRecordedObjectIID */;
