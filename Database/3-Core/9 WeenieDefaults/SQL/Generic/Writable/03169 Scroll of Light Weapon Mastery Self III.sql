...
VALUES (3169, 'scrollaxemasteryself3', 1) /* Generic */;
...
VALUES (3169,   1,       8192) /* ItemType - Writable */
     ...
     , (3169,  19,         20) /* Value */
     , (3169,  65,        101) /* Placement - Resting */
     , (3169,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3169,   1, False) /* Stuck */
     , (3169,  11, True ) /* IgnoreCollisions */
...
VALUES (3169,   2, 3681574081) /* Container */
     , (3169, 8000, 3681321673) /* PCAPRecordedObjectIID */;
