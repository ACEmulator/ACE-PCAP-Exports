...
VALUES (3178, 'scrollbowmasteryother2', 1) /* Generic */;
...
VALUES (3178,   1,       8192) /* ItemType - Writable */
     ...
     , (3178,  19,          5) /* Value */
     , (3178,  65,        101) /* Placement - Resting */
     , (3178,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3178,   1, False) /* Stuck */
     , (3178,  11, True ) /* IgnoreCollisions */
...
VALUES (3178,   2, 2928103302) /* Container */
     , (3178, 8000, 2928766122) /* PCAPRecordedObjectIID */;
