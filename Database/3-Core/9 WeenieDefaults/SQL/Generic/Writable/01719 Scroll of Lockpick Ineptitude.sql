...
VALUES (1719, 'scrolllockpickineptitude', 1) /* Generic */;
...
VALUES (1719,   1,       8192) /* ItemType - Writable */
     ...
     , (1719,  19,          1) /* Value */
     , (1719,  65,        101) /* Placement - Resting */
     , (1719,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1719,   1, False) /* Stuck */
     , (1719,  11, True ) /* IgnoreCollisions */
     , (1719,  13, True ) /* Ethereal */
     , (1719,  14, True ) /* GravityStatus */
     , (1719,  19, True ) /* Attackable */
     , (1719,  22, True ) /* Inscribable */;
...
VALUES (1719,   2, 2924691776) /* Container */
     , (1719, 8000, 2924436596) /* PCAPRecordedObjectIID */;
