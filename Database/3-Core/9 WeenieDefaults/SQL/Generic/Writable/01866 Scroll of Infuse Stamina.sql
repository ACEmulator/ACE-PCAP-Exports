...
VALUES (1866, 'scrollinfusestamina', 1) /* Generic */;
...
VALUES (1866,   1,       8192) /* ItemType - Writable */
     ...
     , (1866,  19,          1) /* Value */
     , (1866,  65,        101) /* Placement - Resting */
     , (1866,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1866,   1, False) /* Stuck */
     , (1866,  11, True ) /* IgnoreCollisions */
     , (1866,  13, True ) /* Ethereal */
     , (1866,  14, True ) /* GravityStatus */
     , (1866,  19, True ) /* Attackable */
     , (1866,  22, True ) /* Inscribable */;
...
VALUES (1866,   2, 2624895986) /* Container */
     , (1866, 8000, 2624896028) /* PCAPRecordedObjectIID */;
