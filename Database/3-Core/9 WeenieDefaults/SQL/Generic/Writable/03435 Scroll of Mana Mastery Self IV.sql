...
VALUES (3435, 'scrollmanaconvertmasteryself4', 1) /* Generic */;
...
VALUES (3435,   1,       8192) /* ItemType - Writable */
     ...
     , (3435,  19,        100) /* Value */
     , (3435,  65,        101) /* Placement - Resting */
     , (3435,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3435,   1, False) /* Stuck */
     , (3435,  11, True ) /* IgnoreCollisions */
     , (3435,  13, True ) /* Ethereal */
     , (3435,  14, True ) /* GravityStatus */
     , (3435,  19, True ) /* Attackable */
     , (3435,  22, True ) /* Inscribable */;
...
VALUES (3435,   1,   33554826) /* Setup */
     ...
     , (3435, 8001,    6307864) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden, Spell */
     , (3435, 8003,         18) /* PCAPRecordedObjectDesc - Inscribable, Attackable */
     , (3435, 8005,     135297) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (3435,   2, 3691172269) /* Container */
     , (3435, 8000, 3691172268) /* PCAPRecordedObjectIID */;
