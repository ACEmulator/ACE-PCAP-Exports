...
VALUES (3054, 'scrolllightningprotectionself3', 1) /* Generic */;
...
VALUES (3054,   1,       8192) /* ItemType - Writable */
     ...
     , (3054,  19,         20) /* Value */
     , (3054,  65,        101) /* Placement - Resting */
     , (3054,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3054,   1, False) /* Stuck */
     , (3054,  11, True ) /* IgnoreCollisions */
     , (3054,  13, True ) /* Ethereal */
     , (3054,  14, True ) /* GravityStatus */
     , (3054,  19, True ) /* Attackable */
     , (3054,  22, True ) /* Inscribable */;
...
VALUES (3054,   2, 2614989708) /* Container */
     , (3054, 8000, 2615114860) /* PCAPRecordedObjectIID */;
