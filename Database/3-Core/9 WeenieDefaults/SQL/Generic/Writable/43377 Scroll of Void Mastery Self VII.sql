...
VALUES (43377, 'ace43377-scrollofvoidmasteryselfvii', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (43377,   1,       8192) /* ItemType - Writable */
     , (43377,   2,         71) /* CreatureType - Margul */
...
VALUES (43377,   2, 3703114180) /* Container */
     , (43377, 8000, 3703114073) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (43377,   1,  2130, 0, 0, 2130) /* MaxHealth */;
