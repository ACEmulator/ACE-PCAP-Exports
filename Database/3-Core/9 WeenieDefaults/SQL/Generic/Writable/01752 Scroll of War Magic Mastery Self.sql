...
VALUES (1752, 'scrollwarmagicmasteryself', 1) /* Generic */;
...
VALUES (1752,   1,       8192) /* ItemType - Writable */
     ...
     , (1752,  19,          1) /* Value */
     , (1752,  65,        101) /* Placement - Resting */
     , (1752,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1752,   1, False) /* Stuck */
     , (1752,  11, True ) /* IgnoreCollisions */
     , (1752,  13, True ) /* Ethereal */
     , (1752,  14, True ) /* GravityStatus */
     , (1752,  19, True ) /* Attackable */
     , (1752,  22, True ) /* Inscribable */;
...
VALUES (1752,   2, 1880641554) /* Container */
     , (1752, 8000, 3528642488) /* PCAPRecordedObjectIID */;
