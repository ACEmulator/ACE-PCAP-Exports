...
VALUES (1569, 'scrollflamebolt', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (1569,   1,       8192) /* ItemType - Writable */
     , (1569,   2,         78) /* CreatureType - Fiun */
     , (1569,   5,         30) /* EncumbranceVal */
     , (1569,  16,          8) /* ItemUseable - Contained */
     , (1569,  19,          1) /* Value */
     , (1569,  25,        115) /* Level */
     , (1569,  65,        101) /* Placement - Resting */
     , (1569,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1569,   1, False) /* Stuck */
     , (1569,  11, True ) /* IgnoreCollisions */
     , (1569,  13, True ) /* Ethereal */
     , (1569,  14, True ) /* GravityStatus */
     , (1569,  19, True ) /* Attackable */
     , (1569,  22, True ) /* Inscribable */;
...
VALUES (1569,   2, 3694169491) /* Container */
     , (1569, 8000, 3694169466) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (1569,   1,   460, 0, 0, 460) /* MaxHealth */;
