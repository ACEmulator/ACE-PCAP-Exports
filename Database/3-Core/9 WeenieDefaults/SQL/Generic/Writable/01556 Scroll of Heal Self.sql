...
VALUES (1556, 'scrollhealself', 1) /* Generic */;
...
VALUES (1556,   1,       8192) /* ItemType - Writable */
     ...
     , (1556,  19,          1) /* Value */
     , (1556,  65,        101) /* Placement - Resting */
     , (1556,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1556,   1, False) /* Stuck */
     , (1556,  11, True ) /* IgnoreCollisions */
     , (1556,  13, True ) /* Ethereal */
     , (1556,  14, True ) /* GravityStatus */
     , (1556,  19, True ) /* Attackable */
     , (1556,  22, True ) /* Inscribable */;
...
VALUES (1556,   2, 3701013168) /* Container */
     , (1556, 8000, 3696052046) /* PCAPRecordedObjectIID */;
