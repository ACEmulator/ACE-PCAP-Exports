...
VALUES (1878, 'scrollbludgeonlure', 1) /* Generic */;
...
VALUES (1878,   1,       8192) /* ItemType - Writable */
     ...
     , (1878,  19,          1) /* Value */
     , (1878,  65,        101) /* Placement - Resting */
     , (1878,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1878,   1, False) /* Stuck */
     , (1878,  11, True ) /* IgnoreCollisions */
     , (1878,  13, True ) /* Ethereal */
     , (1878,  14, True ) /* GravityStatus */
     , (1878,  19, True ) /* Attackable */
     , (1878,  22, True ) /* Inscribable */;
...
VALUES (1878,   2, 3359642308) /* Container */
     , (1878, 8000, 3359642305) /* PCAPRecordedObjectIID */;
