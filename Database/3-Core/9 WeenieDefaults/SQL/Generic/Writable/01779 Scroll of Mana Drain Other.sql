...
VALUES (1779, 'scrollmanadrain', 1) /* Generic */;
...
VALUES (1779,   1,       8192) /* ItemType - Writable */
     ...
     , (1779,  19,          1) /* Value */
     , (1779,  65,        101) /* Placement - Resting */
     , (1779,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1779,   1, False) /* Stuck */
     , (1779,  11, True ) /* IgnoreCollisions */
     , (1779,  13, True ) /* Ethereal */
     , (1779,  14, True ) /* GravityStatus */
     , (1779,  19, True ) /* Attackable */
     , (1779,  22, True ) /* Inscribable */;
...
VALUES (1779,   2, 2629607961) /* Container */
     , (1779, 8000, 2629527646) /* PCAPRecordedObjectIID */;
