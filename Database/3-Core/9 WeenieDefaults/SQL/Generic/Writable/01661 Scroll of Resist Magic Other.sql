...
VALUES (1661, 'scrollresistmagicother', 1) /* Generic */;
...
VALUES (1661,   1,       8192) /* ItemType - Writable */
     ...
     , (1661,  19,          1) /* Value */
     , (1661,  65,        101) /* Placement - Resting */
     , (1661,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1661,   1, False) /* Stuck */
     , (1661,  11, True ) /* IgnoreCollisions */
     , (1661,  13, True ) /* Ethereal */
     , (1661,  14, True ) /* GravityStatus */
     , (1661,  19, True ) /* Attackable */
     , (1661,  22, True ) /* Inscribable */;
...
VALUES (1661,   2, 2924880582) /* Container */
     , (1661, 8000, 2925036194) /* PCAPRecordedObjectIID */;
