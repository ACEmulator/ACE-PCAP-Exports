...
VALUES (9649, 'scrollmanatostaminaself6', 1) /* Generic */;
...
VALUES (9649,   1,       8192) /* ItemType - Writable */
     ...
     , (9649,  19,       1000) /* Value */
     , (9649,  65,        101) /* Placement - Resting */
     , (9649,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9649,   1, False) /* Stuck */
     , (9649,  11, True ) /* IgnoreCollisions */
     , (9649,  13, True ) /* Ethereal */
     , (9649,  14, True ) /* GravityStatus */
     , (9649,  19, True ) /* Attackable */
     , (9649,  22, True ) /* Inscribable */;
...
VALUES (9649,   2, 1343428168) /* Container */
     , (9649, 8000, 2272270050) /* PCAPRecordedObjectIID */;
