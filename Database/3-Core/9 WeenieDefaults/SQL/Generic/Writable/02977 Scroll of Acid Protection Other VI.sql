...
VALUES (2977, 'scrollacidprotectionother6', 1) /* Generic */;
...
VALUES (2977,   1,       8192) /* ItemType - Writable */
     ...
     , (2977,  19,       1000) /* Value */
     , (2977,  65,        101) /* Placement - Resting */
     , (2977,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2977,   1, False) /* Stuck */
     , (2977,  11, True ) /* IgnoreCollisions */
     , (2977,  13, True ) /* Ethereal */
     , (2977,  14, True ) /* GravityStatus */
     , (2977,  19, True ) /* Attackable */
     , (2977,  22, True ) /* Inscribable */;
...
VALUES (2977,   2, 2980862154) /* Container */
     , (2977, 8000, 2980787604) /* PCAPRecordedObjectIID */;
