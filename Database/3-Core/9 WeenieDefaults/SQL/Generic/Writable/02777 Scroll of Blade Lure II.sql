...
VALUES (2777, 'scrollbladelure2', 1) /* Generic */;
...
VALUES (2777,   1,       8192) /* ItemType - Writable */
     ...
     , (2777,  19,          5) /* Value */
     , (2777,  65,        101) /* Placement - Resting */
     , (2777,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2777,   1, False) /* Stuck */
     , (2777,  11, True ) /* IgnoreCollisions */
     , (2777,  13, True ) /* Ethereal */
     , (2777,  14, True ) /* GravityStatus */
     , (2777,  19, True ) /* Attackable */
     , (2777,  22, True ) /* Inscribable */;
...
VALUES (2777,   2, 2624567583) /* Container */
     , (2777, 8000, 2624543153) /* PCAPRecordedObjectIID */;
