...
VALUES (1862, 'scrollhealthtomanaself', 1) /* Generic */;
...
VALUES (1862,   1,       8192) /* ItemType - Writable */
     ...
     , (1862,  19,          1) /* Value */
     , (1862,  65,        101) /* Placement - Resting */
     , (1862,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1862,   1, False) /* Stuck */
     , (1862,  11, True ) /* IgnoreCollisions */
     , (1862,  13, True ) /* Ethereal */
     , (1862,  14, True ) /* GravityStatus */
     , (1862,  19, True ) /* Attackable */
     , (1862,  22, True ) /* Inscribable */;
...
VALUES (1862,   2, 3702063855) /* Container */
     , (1862, 8000, 3702063857) /* PCAPRecordedObjectIID */;
