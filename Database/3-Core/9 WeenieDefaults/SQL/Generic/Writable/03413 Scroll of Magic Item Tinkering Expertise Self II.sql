...
VALUES (3413, 'scrollmagicitemexpertiseself2', 1) /* Generic */;
...
VALUES (3413,   1,       8192) /* ItemType - Writable */
     ...
     , (3413,  19,          5) /* Value */
     , (3413,  65,        101) /* Placement - Resting */
     , (3413,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3413,   1, False) /* Stuck */
     , (3413,  11, True ) /* IgnoreCollisions */
     , (3413,  13, True ) /* Ethereal */
     , (3413,  14, True ) /* GravityStatus */
     , (3413,  19, True ) /* Attackable */
     , (3413,  22, True ) /* Inscribable */;
...
VALUES (3413,   2, 3623498540) /* Container */
     , (3413, 8000, 3623500012) /* PCAPRecordedObjectIID */;
