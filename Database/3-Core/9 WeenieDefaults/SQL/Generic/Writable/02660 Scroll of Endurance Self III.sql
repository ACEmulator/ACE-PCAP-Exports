...
VALUES (2660, 'scrollenduranceself3', 1) /* Generic */;
...
VALUES (2660,   1,       8192) /* ItemType - Writable */
     ...
     , (2660,  19,         20) /* Value */
     , (2660,  65,        101) /* Placement - Resting */
     , (2660,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2660,   1, False) /* Stuck */
     , (2660,  11, True ) /* IgnoreCollisions */
     , (2660,  13, True ) /* Ethereal */
     , (2660,  14, True ) /* GravityStatus */
     , (2660,  19, True ) /* Attackable */
     , (2660,  22, True ) /* Inscribable */;
...
VALUES (2660,   2, 2264331454) /* Container */
     , (2660, 8000, 2264331463) /* PCAPRecordedObjectIID */;
