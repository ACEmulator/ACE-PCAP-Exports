...
VALUES (2756, 'scrollwillpowerother6', 1) /* Generic */;
...
VALUES (2756,   1,       8192) /* ItemType - Writable */
     ...
     , (2756,  19,       1000) /* Value */
     , (2756,  65,        101) /* Placement - Resting */
     , (2756,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2756,   1, False) /* Stuck */
     , (2756,  11, True ) /* IgnoreCollisions */
     , (2756,  13, True ) /* Ethereal */
     , (2756,  14, True ) /* GravityStatus */
     , (2756,  19, True ) /* Attackable */
     , (2756,  22, True ) /* Inscribable */;
...
VALUES (2756,   2, 2868766450) /* Container */
     , (2756, 8000, 2868766457) /* PCAPRecordedObjectIID */;
