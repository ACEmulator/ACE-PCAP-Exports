...
VALUES (3019, 'scrollcoldprotectionother3', 1) /* Generic */;
...
VALUES (3019,   1,       8192) /* ItemType - Writable */
     ...
     , (3019,  19,         20) /* Value */
     , (3019,  65,        101) /* Placement - Resting */
     , (3019,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3019,   1, False) /* Stuck */
     , (3019,  11, True ) /* IgnoreCollisions */
     , (3019,  13, True ) /* Ethereal */
     , (3019,  14, True ) /* GravityStatus */
     , (3019,  19, True ) /* Attackable */
     , (3019,  22, True ) /* Inscribable */;
...
VALUES (3019,   2, 2779641891) /* Container */
     , (3019, 8000, 2780180800) /* PCAPRecordedObjectIID */;
