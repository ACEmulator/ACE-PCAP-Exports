...
VALUES (1768, 'scrollclumsiness', 1) /* Generic */;
...
VALUES (1768,   1,       8192) /* ItemType - Writable */
     ...
     , (1768,  19,          1) /* Value */
     , (1768,  65,        101) /* Placement - Resting */
     , (1768,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1768,   1, False) /* Stuck */
     , (1768,  11, True ) /* IgnoreCollisions */
     , (1768,  13, True ) /* Ethereal */
     , (1768,  14, True ) /* GravityStatus */
     , (1768,  19, True ) /* Attackable */
     , (1768,  22, True ) /* Inscribable */;
...
VALUES (1768,   2, 2624774897) /* Container */
     , (1768, 8000, 2624774898) /* PCAPRecordedObjectIID */;
