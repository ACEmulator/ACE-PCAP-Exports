...
VALUES (1872, 'scrollstaminatohealthself', 1) /* Generic */;
...
VALUES (1872,   1,       8192) /* ItemType - Writable */
     ...
     , (1872,  19,          1) /* Value */
     , (1872,  65,        101) /* Placement - Resting */
     , (1872,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1872,   1, False) /* Stuck */
     , (1872,  11, True ) /* IgnoreCollisions */
     , (1872,  13, True ) /* Ethereal */
     , (1872,  14, True ) /* GravityStatus */
     , (1872,  19, True ) /* Attackable */
     , (1872,  22, True ) /* Inscribable */;
...
VALUES (1872,   2, 2924576145) /* Container */
     , (1872, 8000, 2924461368) /* PCAPRecordedObjectIID */;
