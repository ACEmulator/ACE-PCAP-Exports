...
VALUES (3147, 'scrollarmorexpertiseother6', 1) /* Generic */;
...
VALUES (3147,   1,       8192) /* ItemType - Writable */
     ...
     , (3147,  19,       1000) /* Value */
     , (3147,  65,        101) /* Placement - Resting */
     , (3147,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3147,   1, False) /* Stuck */
     , (3147,  11, True ) /* IgnoreCollisions */
     , (3147,  13, True ) /* Ethereal */
     , (3147,  14, True ) /* GravityStatus */
     , (3147,  19, True ) /* Attackable */
     , (3147,  22, True ) /* Inscribable */;
...
VALUES (3147,   2, 2925391331) /* Container */
     , (3147, 8000, 2925392372) /* PCAPRecordedObjectIID */;
