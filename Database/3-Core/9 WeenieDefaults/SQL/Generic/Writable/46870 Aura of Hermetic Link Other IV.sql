...
VALUES (46870, 'ace46870-auraofhermeticlinkotheriv', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (46870,   1,       8192) /* ItemType - Writable */
     , (46870,   2,         30) /* CreatureType - Skeleton */
...
VALUES (46870,   2, 2965563836) /* Container */
     , (46870, 8000, 3709631340) /* PCAPRecordedObjectIID */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (46870,   1,   146, 0, 0, 146) /* MaxHealth */;
