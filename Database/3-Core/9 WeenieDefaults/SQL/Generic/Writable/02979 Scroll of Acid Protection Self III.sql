...
VALUES (2979, 'scrollacidprotectionself3', 1) /* Generic */;
...
VALUES (2979,   1,       8192) /* ItemType - Writable */
     ...
     , (2979,  19,         20) /* Value */
     , (2979,  65,        101) /* Placement - Resting */
     , (2979,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2979,   1, False) /* Stuck */
     , (2979,  11, True ) /* IgnoreCollisions */
     , (2979,  13, True ) /* Ethereal */
     , (2979,  14, True ) /* GravityStatus */
     , (2979,  19, True ) /* Attackable */
     , (2979,  22, True ) /* Inscribable */;
...
VALUES (2979,   2, 1343690013) /* Container */
     , (2979, 8000, 2240725123) /* PCAPRecordedObjectIID */;
