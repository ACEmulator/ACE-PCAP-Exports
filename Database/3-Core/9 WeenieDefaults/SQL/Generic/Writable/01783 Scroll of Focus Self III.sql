...
VALUES (1783, 'scrollfocusself3', 1) /* Generic */;
...
VALUES (1783,   1,       8192) /* ItemType - Writable */
     ...
     , (1783,  19,         20) /* Value */
     , (1783,  65,        101) /* Placement - Resting */
     , (1783,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1783,   1, False) /* Stuck */
     , (1783,  11, True ) /* IgnoreCollisions */
     , (1783,  13, True ) /* Ethereal */
     , (1783,  14, True ) /* GravityStatus */
     , (1783,  19, True ) /* Attackable */
     , (1783,  22, True ) /* Inscribable */;
...
VALUES (1783,   2, 1880338496) /* Container */
     , (1783, 8000, 2918574761) /* PCAPRecordedObjectIID */;
