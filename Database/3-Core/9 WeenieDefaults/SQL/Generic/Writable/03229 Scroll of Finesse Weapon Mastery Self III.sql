...
VALUES (3229, 'scrolldaggermasteryself3', 1) /* Generic */;
...
VALUES (3229,   1,       8192) /* ItemType - Writable */
     ...
     , (3229,  19,         20) /* Value */
     , (3229,  65,        101) /* Placement - Resting */
     , (3229,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3229,   1, False) /* Stuck */
     , (3229,  11, True ) /* IgnoreCollisions */
...
VALUES (3229,   2, 3624584178) /* Container */
     , (3229, 8000, 3624486650) /* PCAPRecordedObjectIID */;
