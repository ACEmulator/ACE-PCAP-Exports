...
VALUES (3569, 'scrollwarmagicmasteryother3', 1) /* Generic */;
...
VALUES (3569,   1,       8192) /* ItemType - Writable */
     ...
     , (3569,  19,         20) /* Value */
     , (3569,  65,        101) /* Placement - Resting */
     , (3569,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3569,   1, False) /* Stuck */
     , (3569,  11, True ) /* IgnoreCollisions */
     , (3569,  13, True ) /* Ethereal */
     , (3569,  14, True ) /* GravityStatus */
     , (3569,  19, True ) /* Attackable */
     , (3569,  22, True ) /* Inscribable */;
...
VALUES (3569,   2, 2924361769) /* Container */
     , (3569, 8000, 2924817060) /* PCAPRecordedObjectIID */;
