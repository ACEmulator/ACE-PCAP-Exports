...
VALUES (8953, 'scrollwhirlingbladestreak', 1) /* Generic */;
...
VALUES (8953,   1,       8192) /* ItemType - Writable */
     ...
     , (8953,  19,          1) /* Value */
     , (8953,  65,        101) /* Placement - Resting */
     , (8953,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (8953,   1, False) /* Stuck */
     , (8953,  11, True ) /* IgnoreCollisions */
     , (8953,  13, True ) /* Ethereal */
     , (8953,  14, True ) /* GravityStatus */
     , (8953,  19, True ) /* Attackable */
     , (8953,  22, True ) /* Inscribable */;
...
VALUES (8953,   2, 2874927436) /* Container */
     , (8953, 8000, 2874527073) /* PCAPRecordedObjectIID */;
