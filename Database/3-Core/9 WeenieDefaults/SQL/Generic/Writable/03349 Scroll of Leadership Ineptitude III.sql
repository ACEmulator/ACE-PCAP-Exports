...
VALUES (3349, 'scrollleadershipineptitude3', 1) /* Generic */;
...
VALUES (3349,   1,       8192) /* ItemType - Writable */
     ...
     , (3349,  19,         20) /* Value */
     , (3349,  65,        101) /* Placement - Resting */
     , (3349,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3349,   1, False) /* Stuck */
     , (3349,  11, True ) /* IgnoreCollisions */
     , (3349,  13, True ) /* Ethereal */
     , (3349,  14, True ) /* GravityStatus */
     , (3349,  19, True ) /* Attackable */
     , (3349,  22, True ) /* Inscribable */;
...
VALUES (3349,   2, 2617951860) /* Container */
     , (3349, 8000, 2617913031) /* PCAPRecordedObjectIID */;
