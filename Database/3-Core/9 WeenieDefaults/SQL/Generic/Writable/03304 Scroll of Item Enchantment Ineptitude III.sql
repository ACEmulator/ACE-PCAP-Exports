...
VALUES (3304, 'scrollitemenchantmentineptitude3', 1) /* Generic */;
...
VALUES (3304,   1,       8192) /* ItemType - Writable */
     ...
     , (3304,  19,         20) /* Value */
     , (3304,  44,         10) /* Damage */
     , (3304,  45,          4) /* DamageType - Bludgeon */
     , (3304,  48,         47) /* WeaponSkill - MissileWeapons */
     , (3304,  49,         10) /* WeaponTime */
     , (3304,  65,        101) /* Placement - Resting */
     , (3304,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (3304, 105,          7) /* ItemWorkmanship */
     , (3304, 106,        325) /* ItemSpellcraft */
     , (3304, 107,       1051) /* ItemCurMana */
     , (3304, 108,       1051) /* ItemMaxMana */
     , (3304, 109,        325) /* ItemDifficulty */
     , (3304, 110,          0) /* ItemAllegianceRankLimit */
     , (3304, 115,          0) /* ItemSkillLevelLimit */
     , (3304, 131,         16) /* MaterialType - BlackOpal */
     , (3304, 172,          5) /* AppraisalLongDescDecoration */
     , (3304, 177,          4) /* GemCount */
     , (3304, 178,         21) /* GemType */
     , (3304, 353,         10) /* WeaponType - Thrown */
     , (3304, 8030,          0);
...
VALUES (3304,   5, -0.0555555555555556) /* ManaRate */
     , (3304,  21,       0) /* WeaponLength */
     , (3304,  22,    0.25) /* DamageVariance */
     , (3304,  26,       0) /* MaximumVelocity */
     , (3304,  29,       1) /* WeaponDefense */
     , (3304,  39,     1.5) /* DefaultScale */
     , (3304,  62,       1) /* WeaponOffense */
     , (3304,  63,       1) /* DamageMod */;
...
VALUES (3304,   2, 2447665816) /* Container */
     , (3304, 8000, 2447529048) /* PCAPRecordedObjectIID */;
