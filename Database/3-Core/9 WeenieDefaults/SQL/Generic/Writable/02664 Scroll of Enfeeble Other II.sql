...
VALUES (2664, 'scrollenfeeble2', 1) /* Generic */;
...
VALUES (2664,   1,       8192) /* ItemType - Writable */
     ...
     , (2664,  19,          5) /* Value */
     , (2664,  65,        101) /* Placement - Resting */
     , (2664,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2664,   1, False) /* Stuck */
     , (2664,  11, True ) /* IgnoreCollisions */
     , (2664,  13, True ) /* Ethereal */
     , (2664,  14, True ) /* GravityStatus */
     , (2664,  19, True ) /* Attackable */
     , (2664,  22, True ) /* Inscribable */;
...
VALUES (2664,   2, 1880866837) /* Container */
     , (2664, 8000, 2190062671) /* PCAPRecordedObjectIID */;
