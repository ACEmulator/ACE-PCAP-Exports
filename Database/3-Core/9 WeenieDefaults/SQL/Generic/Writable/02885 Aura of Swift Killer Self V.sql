...
VALUES (2885, 'scrollswiftkiller5', 1) /* Generic */;
...
VALUES (2885,   1,       8192) /* ItemType - Writable */
     ...
     , (2885,  19,        200) /* Value */
     , (2885,  65,        101) /* Placement - Resting */
     , (2885,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (2885,   1, False) /* Stuck */
     , (2885,  11, True ) /* IgnoreCollisions */
     , (2885,  13, True ) /* Ethereal */
     , (2885,  14, True ) /* GravityStatus */
     , (2885,  19, True ) /* Attackable */
     , (2885,  22, True ) /* Inscribable */;
...
VALUES (2885,   2, 3624083775) /* Container */
     , (2885, 8000, 3624083752) /* PCAPRecordedObjectIID */;
