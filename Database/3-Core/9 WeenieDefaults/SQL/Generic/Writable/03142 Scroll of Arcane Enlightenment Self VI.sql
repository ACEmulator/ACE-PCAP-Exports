...
VALUES (3142, 'scrollarcaneenlightenmentself6', 1) /* Generic */;
...
VALUES (3142,   1,       8192) /* ItemType - Writable */
     ...
     , (3142,  19,       1000) /* Value */
     , (3142,  65,        101) /* Placement - Resting */
     , (3142,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3142,   1, False) /* Stuck */
     , (3142,  11, True ) /* IgnoreCollisions */
     , (3142,  13, True ) /* Ethereal */
     , (3142,  14, True ) /* GravityStatus */
     , (3142,  19, True ) /* Attackable */
     , (3142,  22, True ) /* Inscribable */;
...
VALUES (3142,   2, 3355032357) /* Container */
     , (3142, 8000, 3355082805) /* PCAPRecordedObjectIID */;
