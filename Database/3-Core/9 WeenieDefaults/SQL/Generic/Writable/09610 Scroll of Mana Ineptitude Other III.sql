...
VALUES (9610, 'scrollmanaineptitude3', 1) /* Generic */;
...
VALUES (9610,   1,       8192) /* ItemType - Writable */
     ...
     , (9610,  19,         20) /* Value */
     , (9610,  65,        101) /* Placement - Resting */
     , (9610,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9610,   1, False) /* Stuck */
     , (9610,  11, True ) /* IgnoreCollisions */
     , (9610,  13, True ) /* Ethereal */
     , (9610,  14, True ) /* GravityStatus */
     , (9610,  19, True ) /* Attackable */
     , (9610,  22, True ) /* Inscribable */;
...
VALUES (9610,   2, 2924671531) /* Container */
     , (9610, 8000, 2924717826) /* PCAPRecordedObjectIID */;
