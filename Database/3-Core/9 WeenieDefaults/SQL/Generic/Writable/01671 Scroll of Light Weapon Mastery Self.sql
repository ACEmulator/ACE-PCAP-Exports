...
VALUES (1671, 'scrollaxemasteryself', 1) /* Generic */;
...
VALUES (1671,   1,       8192) /* ItemType - Writable */
     ...
     , (1671,  19,          1) /* Value */
     , (1671,  65,        101) /* Placement - Resting */
     , (1671,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (1671,   1, False) /* Stuck */
     , (1671,  11, True ) /* IgnoreCollisions */
...
VALUES (1671,   1,   33554826) /* Setup */
     ...
     , (1671,  28,        298) /* Spell - AxeMasterySelf1 */
     , (1671, 8001,    6307864) /* PCAPRecordedWeenieHeader - Value, Usable, Container, Burden, Spell */
     , (1671, 8003,         18) /* PCAPRecordedObjectDesc - Inscribable, Attackable */
     , (1671, 8005,     135297) /* PCAPRecordedPhysicsDesc - CSetup, ObjScale, PeTable, AnimationFrame */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (1671,   2, 2448109381) /* Container */
     , (1671, 8000, 2448101500) /* PCAPRecordedObjectIID */;
