...
VALUES (20184, 'imagingcrystalarcanepedestal', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (20184,   1,        128) /* ItemType - Misc */
     , (20184,   5,        200) /* EncumbranceVal */
     , (20184,  16,          1) /* ItemUseable - No */
     , (20184,  65,        101) /* Placement - Resting */
     , (20184,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (20184,   1, False) /* Stuck */
     , (20184,  11, True ) /* IgnoreCollisions */
     , (20184,  13, True ) /* Ethereal */
     , (20184,  14, True ) /* GravityStatus */
     , (20184,  19, True ) /* Attackable */
     , (20184,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (20184,  39, 1.20000004768372) /* DefaultScale */;
...
VALUES (20184,   2, 1343491108) /* Container */
     , (20184, 8000, 3029920506) /* PCAPRecordedObjectIID */;
