...
VALUES (3672, 'golemheartiron', 1) /* Generic */;
...
VALUES (3672,   1,        128) /* ItemType - Misc */
     ...
     , (3672,  19,         50) /* Value */
     , (3672,  65,        101) /* Placement - Resting */
     , (3672,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (3672,   1, False) /* Stuck */
     , (3672,  11, True ) /* IgnoreCollisions */
     , (3672,  13, True ) /* Ethereal */
     , (3672,  14, True ) /* GravityStatus */
     , (3672,  19, True ) /* Attackable */
     , (3672,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (3672,  39, 0.400000005960464) /* DefaultScale */;
...
VALUES (3672,   2, 3685628565) /* Container */
     , (3672, 8000, 3686180588) /* PCAPRecordedObjectIID */;
