...
VALUES (37525,   1,        128) /* ItemType - Misc */
     ...
     , (37525,  65,        101) /* Placement - Resting */
     , (37525,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (37525,   1, False) /* Stuck */
     , (37525,  11, True ) /* IgnoreCollisions */
     , (37525,  13, True ) /* Ethereal */
     , (37525,  14, True ) /* GravityStatus */
     , (37525,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (37525,  39, 0.370000004768372) /* DefaultScale */;
