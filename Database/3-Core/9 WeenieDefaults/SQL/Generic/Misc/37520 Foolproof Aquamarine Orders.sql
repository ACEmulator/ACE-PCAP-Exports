...
VALUES (37520,   1,        128) /* ItemType - Misc */
     ...
     , (37520,  65,        101) /* Placement - Resting */
     , (37520,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (37520,   1, False) /* Stuck */
     , (37520,  11, True ) /* IgnoreCollisions */
     , (37520,  13, True ) /* Ethereal */
     , (37520,  14, True ) /* GravityStatus */
     , (37520,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (37520,  39, 0.370000004768372) /* DefaultScale */;
