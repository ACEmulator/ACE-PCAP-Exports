...
VALUES (9581,   1,        128) /* ItemType - Misc */
     ...
     , (9581,  19,      10000) /* Value */
     , (9581,  65,        101) /* Placement - Resting */
     , (9581,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9581,   1, False) /* Stuck */
     , (9581,  11, True ) /* IgnoreCollisions */
     , (9581,  13, True ) /* Ethereal */
     , (9581,  14, True ) /* GravityStatus */
     , (9581,  19, True ) /* Attackable */
     , (9581,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (9581,  39, 0.370000004768372) /* DefaultScale */;
