...
VALUES (7528, 'chorizitechunka', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (7528,   1,        128) /* ItemType - Misc */
     , (7528,   5,       1000) /* EncumbranceVal */
     , (7528,  16,          1) /* ItemUseable - No */
     , (7528,  65,        101) /* Placement - Resting */
     , (7528,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7528,   1, False) /* Stuck */
     , (7528,  11, True ) /* IgnoreCollisions */
     , (7528,  13, True ) /* Ethereal */
     , (7528,  14, True ) /* GravityStatus */
     , (7528,  19, True ) /* Attackable */
     , (7528,  22, True ) /* Inscribable */;
...
VALUES (7528,   2, 3268856098) /* Container */
     , (7528, 8000, 2155902994) /* PCAPRecordedObjectIID */;
