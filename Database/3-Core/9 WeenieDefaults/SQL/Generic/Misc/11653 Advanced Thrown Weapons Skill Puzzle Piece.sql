...
VALUES (11653,   1,        128) /* ItemType - Misc */
     ...
     , (11653,  65,        101) /* Placement - Resting */
     , (11653,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (11653,   1, False) /* Stuck */
     , (11653,  11, True ) /* IgnoreCollisions */
     , (11653,  13, True ) /* Ethereal */
     , (11653,  14, True ) /* GravityStatus */
     , (11653,  19, True ) /* Attackable */
     , (11653,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (11653,  39, 0.370000004768372) /* DefaultScale */;
