...
VALUES (37532,   1,        128) /* ItemType - Misc */
     ...
     , (37532,  65,        101) /* Placement - Resting */
     , (37532,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (37532,   1, False) /* Stuck */
     , (37532,  11, True ) /* IgnoreCollisions */
     , (37532,  13, True ) /* Ethereal */
     , (37532,  14, True ) /* GravityStatus */
     , (37532,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (37532,  39, 0.370000004768372) /* DefaultScale */;
