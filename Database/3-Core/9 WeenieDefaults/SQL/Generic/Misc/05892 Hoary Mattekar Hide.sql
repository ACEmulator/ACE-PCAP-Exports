...
VALUES (5892, 'mattekarhoaryhide', 1) /* Generic */;
...
VALUES (5892,   1,        128) /* ItemType - Misc */
     ...
     , (5892,  19,        200) /* Value */
     , (5892,  65,        101) /* Placement - Resting */
     , (5892,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (5892, 151,          1) /* HookType - Floor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5892,   1, False) /* Stuck */
     , (5892,  11, True ) /* IgnoreCollisions */
     , (5892,  13, True ) /* Ethereal */
     , (5892,  14, True ) /* GravityStatus */
     , (5892,  19, True ) /* Attackable */
     , (5892,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5892,  39, 0.899999976158142) /* DefaultScale */;
...
VALUES (5892,   2, 1342814975) /* Container */
     , (5892, 8000, 3681106910) /* PCAPRecordedObjectIID */;
