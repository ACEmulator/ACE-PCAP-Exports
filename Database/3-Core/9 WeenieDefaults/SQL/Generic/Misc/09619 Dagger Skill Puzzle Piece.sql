...
VALUES (9619,   1,        128) /* ItemType - Misc */
     ...
     , (9619,  19,      10000) /* Value */
     , (9619,  65,        101) /* Placement - Resting */
     , (9619,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (9619,   1, False) /* Stuck */
     , (9619,  11, True ) /* IgnoreCollisions */
     , (9619,  13, True ) /* Ethereal */
     , (9619,  14, True ) /* GravityStatus */
     , (9619,  19, True ) /* Attackable */
     , (9619,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (9619,  39, 0.370000004768372) /* DefaultScale */;
