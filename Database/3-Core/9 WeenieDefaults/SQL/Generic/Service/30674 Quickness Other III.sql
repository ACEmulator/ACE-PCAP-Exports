...
VALUES (30674,   1,    1048576) /* ItemType - Service */
     ...
     , (30674,  19,        400) /* Value */
     , (30674,  65,        101) /* Placement - Resting */
     , (30674,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30674,   1, False) /* Stuck */
     , (30674,  11, True ) /* IgnoreCollisions */
     , (30674,  13, True ) /* Ethereal */
     , (30674,  14, True ) /* GravityStatus */
     , (30674,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30674,  39, 0.370000004768372) /* DefaultScale */;
