...
VALUES (4605,   1,    1048576) /* ItemType - Service */
     ...
     , (4605,  19,        200) /* Value */
     , (4605,  65,        101) /* Placement - Resting */
     , (4605,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4605,   1, False) /* Stuck */
     , (4605,  11, True ) /* IgnoreCollisions */
     , (4605,  13, True ) /* Ethereal */
     , (4605,  14, True ) /* GravityStatus */
     , (4605,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4605,  39, 0.370000004768372) /* DefaultScale */;
