...
VALUES (30671,   1,    1048576) /* ItemType - Service */
     ...
     , (30671,  19,        800) /* Value */
     , (30671,  65,        101) /* Placement - Resting */
     , (30671,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30671,   1, False) /* Stuck */
     , (30671,  11, True ) /* IgnoreCollisions */
     , (30671,  13, True ) /* Ethereal */
     , (30671,  14, True ) /* GravityStatus */
     , (30671,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30671,  39, 0.370000004768372) /* DefaultScale */;
