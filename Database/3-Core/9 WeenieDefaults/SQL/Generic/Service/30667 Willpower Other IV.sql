...
VALUES (30667,   1,    1048576) /* ItemType - Service */
     ...
     , (30667,  19,        800) /* Value */
     , (30667,  65,        101) /* Placement - Resting */
     , (30667,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30667,   1, False) /* Stuck */
     , (30667,  11, True ) /* IgnoreCollisions */
     , (30667,  13, True ) /* Ethereal */
     , (30667,  14, True ) /* GravityStatus */
     , (30667,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30667,  39, 0.370000004768372) /* DefaultScale */;
