...
VALUES (4608,   1,    1048576) /* ItemType - Service */
     ...
     , (4608,  19,        100) /* Value */
     , (4608,  65,        101) /* Placement - Resting */
     , (4608,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4608,   1, False) /* Stuck */
     , (4608,  11, True ) /* IgnoreCollisions */
     , (4608,  13, True ) /* Ethereal */
     , (4608,  14, True ) /* GravityStatus */
     , (4608,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4608,  39, 0.370000004768372) /* DefaultScale */;
