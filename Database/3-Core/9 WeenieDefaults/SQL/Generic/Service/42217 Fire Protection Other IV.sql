...
VALUES (42217,   1,    1048576) /* ItemType - Service */
     ...
     , (42217,  19,        200) /* Value */
     , (42217,  65,        101) /* Placement - Resting */
     , (42217,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (42217,   1, False) /* Stuck */
     , (42217,  11, True ) /* IgnoreCollisions */
     , (42217,  13, True ) /* Ethereal */
     , (42217,  14, True ) /* GravityStatus */
     , (42217,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (42217,  39, 0.370000004768372) /* DefaultScale */;
