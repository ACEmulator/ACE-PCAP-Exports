...
VALUES (42212,   1,    1048576) /* ItemType - Service */
     ...
     , (42212,  19,        200) /* Value */
     , (42212,  65,        101) /* Placement - Resting */
     , (42212,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (42212,   1, False) /* Stuck */
     , (42212,  11, True ) /* IgnoreCollisions */
     , (42212,  13, True ) /* Ethereal */
     , (42212,  14, True ) /* GravityStatus */
     , (42212,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (42212,  39, 0.370000004768372) /* DefaultScale */;
