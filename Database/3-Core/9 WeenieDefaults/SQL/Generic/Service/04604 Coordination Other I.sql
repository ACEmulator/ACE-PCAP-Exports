...
VALUES (4604,   1,    1048576) /* ItemType - Service */
     ...
     , (4604,  19,        100) /* Value */
     , (4604,  65,        101) /* Placement - Resting */
     , (4604,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4604,   1, False) /* Stuck */
     , (4604,  11, True ) /* IgnoreCollisions */
     , (4604,  13, True ) /* Ethereal */
     , (4604,  14, True ) /* GravityStatus */
     , (4604,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4604,  39, 0.370000004768372) /* DefaultScale */;
