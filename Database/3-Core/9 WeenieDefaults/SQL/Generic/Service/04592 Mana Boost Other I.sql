...
VALUES (4592,   1,    1048576) /* ItemType - Service */
     ...
     , (4592,  19,         33) /* Value */
     , (4592,  65,        101) /* Placement - Resting */
     , (4592,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4592,   1, False) /* Stuck */
     , (4592,  11, True ) /* IgnoreCollisions */
     , (4592,  13, True ) /* Ethereal */
     , (4592,  14, True ) /* GravityStatus */
     , (4592,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4592,  39, 0.370000004768372) /* DefaultScale */;
