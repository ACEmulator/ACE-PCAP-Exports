...
VALUES (42214,   1,    1048576) /* ItemType - Service */
     ...
     , (42214,  19,        200) /* Value */
     , (42214,  65,        101) /* Placement - Resting */
     , (42214,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (42214,   1, False) /* Stuck */
     , (42214,  11, True ) /* IgnoreCollisions */
     , (42214,  13, True ) /* Ethereal */
     , (42214,  14, True ) /* GravityStatus */
     , (42214,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (42214,  39, 0.370000004768372) /* DefaultScale */;
