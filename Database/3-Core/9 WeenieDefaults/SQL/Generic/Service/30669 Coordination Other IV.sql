...
VALUES (30669,   1,    1048576) /* ItemType - Service */
     ...
     , (30669,  19,        800) /* Value */
     , (30669,  65,        101) /* Placement - Resting */
     , (30669,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30669,   1, False) /* Stuck */
     , (30669,  11, True ) /* IgnoreCollisions */
     , (30669,  13, True ) /* Ethereal */
     , (30669,  14, True ) /* GravityStatus */
     , (30669,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30669,  39, 0.370000004768372) /* DefaultScale */;
