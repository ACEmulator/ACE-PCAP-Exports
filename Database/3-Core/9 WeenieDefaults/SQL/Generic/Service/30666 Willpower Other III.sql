...
VALUES (30666,   1,    1048576) /* ItemType - Service */
     ...
     , (30666,  19,        400) /* Value */
     , (30666,  65,        101) /* Placement - Resting */
     , (30666,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30666,   1, False) /* Stuck */
     , (30666,  11, True ) /* IgnoreCollisions */
     , (30666,  13, True ) /* Ethereal */
     , (30666,  14, True ) /* GravityStatus */
     , (30666,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30666,  39, 0.370000004768372) /* DefaultScale */;
