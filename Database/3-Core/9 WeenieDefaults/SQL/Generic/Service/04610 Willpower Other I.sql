...
VALUES (4610,   1,    1048576) /* ItemType - Service */
     ...
     , (4610,  19,        100) /* Value */
     , (4610,  65,        101) /* Placement - Resting */
     , (4610,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4610,   1, False) /* Stuck */
     , (4610,  11, True ) /* IgnoreCollisions */
     , (4610,  13, True ) /* Ethereal */
     , (4610,  14, True ) /* GravityStatus */
     , (4610,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4610,  39, 0.370000004768372) /* DefaultScale */;
