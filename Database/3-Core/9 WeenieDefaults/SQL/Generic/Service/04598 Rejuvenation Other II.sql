...
VALUES (4598,   1,    1048576) /* ItemType - Service */
     ...
     , (4598,  19,        133) /* Value */
     , (4598,  65,        101) /* Placement - Resting */
     , (4598,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (4598,   1, False) /* Stuck */
     , (4598,  11, True ) /* IgnoreCollisions */
     , (4598,  13, True ) /* Ethereal */
     , (4598,  14, True ) /* GravityStatus */
     , (4598,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (4598,  39, 0.370000004768372) /* DefaultScale */;
