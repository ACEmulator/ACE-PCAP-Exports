...
VALUES (30672,   1,    1048576) /* ItemType - Service */
     ...
     , (30672,  19,        400) /* Value */
     , (30672,  65,        101) /* Placement - Resting */
     , (30672,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (30672,   1, False) /* Stuck */
     , (30672,  11, True ) /* IgnoreCollisions */
     , (30672,  13, True ) /* Ethereal */
     , (30672,  14, True ) /* GravityStatus */
     , (30672,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (30672,  39, 0.370000004768372) /* DefaultScale */;
