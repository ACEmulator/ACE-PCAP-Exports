...
VALUES (8650, 'potdyewinterblue', 1) /* Generic */;

INSERT INTO `weenie_properties_int` (`object_Id`, `type`, `value`)
VALUES (8650,   1,    4194304) /* ItemType - CraftCookingBase */
     , (8650,   5,       3300) /* EncumbranceVal */
     , (8650,  11,        100) /* MaxStackSize */
     , (8650,  12,         22) /* StackSize */
...
VALUES (8650,   2, 2158100492) /* Container */
     , (8650, 8000, 2158100495) /* PCAPRecordedObjectIID */;
