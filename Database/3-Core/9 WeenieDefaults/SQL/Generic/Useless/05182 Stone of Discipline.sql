...
VALUES (5182, 'stoneofdiscipline', 1, '2019-02-10 05:41:14') /* Generic */;
...
VALUES (5182,   1,       1024) /* ItemType - Useless */
     ...
     , (5182,  65,        101) /* Placement - Resting */
     , (5182,  93,       3092) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity, LightingOn */
     , (5182, 114,          1) /* Attuned - Attuned */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (5182,   1, False) /* Stuck */
     , (5182,  11, True ) /* IgnoreCollisions */
     , (5182,  13, True ) /* Ethereal */
     , (5182,  14, True ) /* GravityStatus */
     , (5182,  15, True ) /* LightsStatus */
     , (5182,  19, True ) /* Attackable */
     , (5182,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (5182,  39, 0.300000011920929) /* DefaultScale */
