...
VALUES (7557, 'potiondispel2', 44, '2019-02-10 08:04:04') /* CraftTool */;
...
VALUES (7557,   1,         32) /* ItemType - Food */
     ...
     , (7557,  19,        150) /* Value */
     , (7557,  65,        101) /* Placement - Resting */
     , (7557,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (7557,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (7557,   1, False) /* Stuck */
     , (7557,  11, True ) /* IgnoreCollisions */
     , (7557,  13, True ) /* Ethereal */
     , (7557,  14, True ) /* GravityStatus */
     , (7557,  19, True ) /* Attackable */;
