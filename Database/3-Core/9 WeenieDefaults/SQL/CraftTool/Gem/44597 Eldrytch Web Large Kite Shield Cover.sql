...
VALUES (44597,   1,       2048) /* ItemType - Gem */
     ...
     , (44597,  19,         50) /* Value */
     , (44597,  65,        101) /* Placement - Resting */
     , (44597,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44597,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44597,   1, False) /* Stuck */
     , (44597,  11, True ) /* IgnoreCollisions */
     , (44597,  13, True ) /* Ethereal */
     , (44597,  14, True ) /* GravityStatus */
     , (44597,  19, True ) /* Attackable */
     , (44597,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44597,  39, 0.800000011920929) /* DefaultScale */;
