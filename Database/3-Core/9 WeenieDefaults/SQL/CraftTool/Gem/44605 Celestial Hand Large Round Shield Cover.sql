...
VALUES (44605,   1,       2048) /* ItemType - Gem */
     ...
     , (44605,  19,         50) /* Value */
     , (44605,  65,        101) /* Placement - Resting */
     , (44605,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44605,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44605,   1, False) /* Stuck */
     , (44605,  11, True ) /* IgnoreCollisions */
     , (44605,  13, True ) /* Ethereal */
     , (44605,  14, True ) /* GravityStatus */
     , (44605,  19, True ) /* Attackable */
     , (44605,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44605,  39, 0.800000011920929) /* DefaultScale */;
