...
VALUES (44609,   1,       2048) /* ItemType - Gem */
     ...
     , (44609,  19,         50) /* Value */
     , (44609,  65,        101) /* Placement - Resting */
     , (44609,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44609,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44609,   1, False) /* Stuck */
     , (44609,  11, True ) /* IgnoreCollisions */
     , (44609,  13, True ) /* Ethereal */
     , (44609,  14, True ) /* GravityStatus */
     , (44609,  19, True ) /* Attackable */
     , (44609,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44609,  39, 0.800000011920929) /* DefaultScale */;
