...
VALUES (44603,   1,       2048) /* ItemType - Gem */
     ...
     , (44603,  19,         50) /* Value */
     , (44603,  65,        101) /* Placement - Resting */
     , (44603,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44603,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44603,   1, False) /* Stuck */
     , (44603,  11, True ) /* IgnoreCollisions */
     , (44603,  13, True ) /* Ethereal */
     , (44603,  14, True ) /* GravityStatus */
     , (44603,  19, True ) /* Attackable */
     , (44603,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44603,  39, 0.800000011920929) /* DefaultScale */;
