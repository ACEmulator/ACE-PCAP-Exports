...
VALUES (44601,   1,       2048) /* ItemType - Gem */
     ...
     , (44601,  19,         50) /* Value */
     , (44601,  65,        101) /* Placement - Resting */
     , (44601,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44601,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44601,   1, False) /* Stuck */
     , (44601,  11, True ) /* IgnoreCollisions */
     , (44601,  13, True ) /* Ethereal */
     , (44601,  14, True ) /* GravityStatus */
     , (44601,  19, True ) /* Attackable */
     , (44601,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44601,  39, 0.800000011920929) /* DefaultScale */;
