...
VALUES (44600,   1,       2048) /* ItemType - Gem */
     ...
     , (44600,  19,         50) /* Value */
     , (44600,  65,        101) /* Placement - Resting */
     , (44600,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44600,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44600,   1, False) /* Stuck */
     , (44600,  11, True ) /* IgnoreCollisions */
     , (44600,  13, True ) /* Ethereal */
     , (44600,  14, True ) /* GravityStatus */
     , (44600,  19, True ) /* Attackable */
     , (44600,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44600,  39, 0.800000011920929) /* DefaultScale */;
