...
VALUES (44591,   1,       2048) /* ItemType - Gem */
     ...
     , (44591,  19,         50) /* Value */
     , (44591,  65,        101) /* Placement - Resting */
     , (44591,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44591,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44591,   1, False) /* Stuck */
     , (44591,  11, True ) /* IgnoreCollisions */
     , (44591,  13, True ) /* Ethereal */
     , (44591,  14, True ) /* GravityStatus */
     , (44591,  19, True ) /* Attackable */
     , (44591,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44591,  39, 0.800000011920929) /* DefaultScale */;
