...
VALUES (44610,   1,       2048) /* ItemType - Gem */
     ...
     , (44610,  19,         50) /* Value */
     , (44610,  65,        101) /* Placement - Resting */
     , (44610,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44610,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44610,   1, False) /* Stuck */
     , (44610,  11, True ) /* IgnoreCollisions */
     , (44610,  13, True ) /* Ethereal */
     , (44610,  14, True ) /* GravityStatus */
     , (44610,  19, True ) /* Attackable */
     , (44610,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44610,  39, 0.800000011920929) /* DefaultScale */;
