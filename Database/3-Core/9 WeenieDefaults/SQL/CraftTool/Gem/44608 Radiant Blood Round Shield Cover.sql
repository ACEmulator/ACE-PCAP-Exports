...
VALUES (44608,   1,       2048) /* ItemType - Gem */
     ...
     , (44608,  19,         50) /* Value */
     , (44608,  65,        101) /* Placement - Resting */
     , (44608,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44608,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44608,   1, False) /* Stuck */
     , (44608,  11, True ) /* IgnoreCollisions */
     , (44608,  13, True ) /* Ethereal */
     , (44608,  14, True ) /* GravityStatus */
     , (44608,  19, True ) /* Attackable */
     , (44608,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44608,  39, 0.800000011920929) /* DefaultScale */;
