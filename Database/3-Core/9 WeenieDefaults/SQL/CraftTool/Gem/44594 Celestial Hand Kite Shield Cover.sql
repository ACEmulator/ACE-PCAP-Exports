...
VALUES (44594,   1,       2048) /* ItemType - Gem */
     ...
     , (44594,  19,         50) /* Value */
     , (44594,  65,        101) /* Placement - Resting */
     , (44594,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44594,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44594,   1, False) /* Stuck */
     , (44594,  11, True ) /* IgnoreCollisions */
     , (44594,  13, True ) /* Ethereal */
     , (44594,  14, True ) /* GravityStatus */
     , (44594,  19, True ) /* Attackable */
     , (44594,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44594,  39, 0.800000011920929) /* DefaultScale */;
