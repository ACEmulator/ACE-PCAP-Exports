...
VALUES (44467,   1,       2048) /* ItemType - Gem */
     ...
     , (44467,  19,         50) /* Value */
     , (44467,  65,        101) /* Placement - Resting */
     , (44467,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (44467,  94,          2) /* TargetType - Armor */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (44467,   1, False) /* Stuck */
     , (44467,  11, True ) /* IgnoreCollisions */
     , (44467,  13, True ) /* Ethereal */
     , (44467,  14, True ) /* GravityStatus */
     , (44467,  19, True ) /* Attackable */
     , (44467,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (44467,  39, 0.800000011920929) /* DefaultScale */;
