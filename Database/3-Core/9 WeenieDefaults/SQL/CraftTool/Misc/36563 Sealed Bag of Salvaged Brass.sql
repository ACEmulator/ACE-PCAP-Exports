...
VALUES (36563,   1,        128) /* ItemType - Misc */
     ...
     , (36563,  19,         10) /* Value */
     , (36563,  65,        101) /* Placement - Resting */
     , (36563,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36563,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36563,   1, False) /* Stuck */
     , (36563,  11, True ) /* IgnoreCollisions */
     , (36563,  13, True ) /* Ethereal */
     , (36563,  14, True ) /* GravityStatus */
     , (36563,  19, True ) /* Attackable */
     , (36563,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (36563,  39, 0.800000011920929) /* DefaultScale */;
