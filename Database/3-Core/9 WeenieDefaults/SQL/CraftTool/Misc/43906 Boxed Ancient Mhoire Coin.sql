...
VALUES (43906,   1,        128) /* ItemType - Misc */
     ...
     , (43906,  19,          2) /* Value */
     , (43906,  65,        101) /* Placement - Resting */
     , (43906,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (43906,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (43906,   1, False) /* Stuck */
     , (43906,  11, True ) /* IgnoreCollisions */
     , (43906,  13, True ) /* Ethereal */
     , (43906,  14, True ) /* GravityStatus */
     , (43906,  19, True ) /* Attackable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (43906,  39, 0.800000011920929) /* DefaultScale */;
