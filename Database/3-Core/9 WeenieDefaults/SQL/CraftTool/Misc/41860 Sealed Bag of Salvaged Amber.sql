...
VALUES (41860,   1,        128) /* ItemType - Misc */
     ...
     , (41860,  19,          6) /* Value */
     , (41860,  65,        101) /* Placement - Resting */
     , (41860,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41860,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41860,   1, False) /* Stuck */
     , (41860,  11, True ) /* IgnoreCollisions */
     , (41860,  13, True ) /* Ethereal */
     , (41860,  14, True ) /* GravityStatus */
     , (41860,  19, True ) /* Attackable */
     , (41860,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41860,  39, 0.800000011920929) /* DefaultScale */;
