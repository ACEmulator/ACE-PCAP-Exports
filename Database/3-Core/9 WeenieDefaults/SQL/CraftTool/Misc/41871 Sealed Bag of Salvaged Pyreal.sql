...
VALUES (41871,   1,        128) /* ItemType - Misc */
     ...
     , (41871,  19,         18) /* Value */
     , (41871,  65,        101) /* Placement - Resting */
     , (41871,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41871,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41871,   1, False) /* Stuck */
     , (41871,  11, True ) /* IgnoreCollisions */
     , (41871,  13, True ) /* Ethereal */
     , (41871,  14, True ) /* GravityStatus */
     , (41871,  19, True ) /* Attackable */
     , (41871,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41871,  39, 0.800000011920929) /* DefaultScale */;
