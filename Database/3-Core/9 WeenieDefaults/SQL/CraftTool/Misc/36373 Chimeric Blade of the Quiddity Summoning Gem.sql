...
VALUES (36373,   1,        128) /* ItemType - Misc */
     ...
     , (36373,  19,          3) /* Value */
     , (36373,  65,        101) /* Placement - Resting */
     , (36373,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36373,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36373,   1, False) /* Stuck */
     , (36373,  11, True ) /* IgnoreCollisions */
     , (36373,  13, True ) /* Ethereal */
     , (36373,  14, True ) /* GravityStatus */
     , (36373,  19, True ) /* Attackable */
     , (36373,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (36373,  39, 0.800000011920929) /* DefaultScale */;
