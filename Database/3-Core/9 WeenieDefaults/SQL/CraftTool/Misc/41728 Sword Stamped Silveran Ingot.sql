...
VALUES (41728,   1,        128) /* ItemType - Misc */
     ...
     , (41728,  19,          1) /* Value */
     , (41728,  65,        101) /* Placement - Resting */
     , (41728,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41728,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41728,   1, False) /* Stuck */
     , (41728,  11, True ) /* IgnoreCollisions */
     , (41728,  13, True ) /* Ethereal */
     , (41728,  14, True ) /* GravityStatus */
     , (41728,  19, True ) /* Attackable */
     , (41728,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41728,  39, 0.800000011920929) /* DefaultScale */;
