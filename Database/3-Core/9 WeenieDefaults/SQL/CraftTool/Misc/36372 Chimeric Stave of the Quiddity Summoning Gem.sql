...
VALUES (36372,   1,        128) /* ItemType - Misc */
     ...
     , (36372,  19,          3) /* Value */
     , (36372,  65,        101) /* Placement - Resting */
     , (36372,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36372,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36372,   1, False) /* Stuck */
     , (36372,  11, True ) /* IgnoreCollisions */
     , (36372,  13, True ) /* Ethereal */
     , (36372,  14, True ) /* GravityStatus */
     , (36372,  19, True ) /* Attackable */
     , (36372,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (36372,  39, 0.800000011920929) /* DefaultScale */;
