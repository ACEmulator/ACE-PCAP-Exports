...
VALUES (41873,   1,        128) /* ItemType - Misc */
     ...
     , (41873,  19,         12) /* Value */
     , (41873,  65,        101) /* Placement - Resting */
     , (41873,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41873,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41873,   1, False) /* Stuck */
     , (41873,  11, True ) /* IgnoreCollisions */
     , (41873,  13, True ) /* Ethereal */
     , (41873,  14, True ) /* GravityStatus */
     , (41873,  19, True ) /* Attackable */
     , (41873,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41873,  39, 0.800000011920929) /* DefaultScale */;
