...
VALUES (37250,   1, 0x020017E3) /* Setup */
     ...
     , (37250, 8001,    2633745) /* PCAPRecordedWeenieHeader - PluralName, Usable, StackSize, MaxStackSize, TargetType, Burden */
     , (37250, 8003,         16) /* PCAPRecordedObjectDesc - Attackable */
     , (37250, 8005,     169985) /* PCAPRecordedPhysicsDesc - CSetup, STable, PeTable, Position, AnimationFrame */;

INSERT INTO `weenie_properties_position` (`object_Id`, `position_Type`, `obj_Cell_Id`, `origin_X`, `origin_Y`, `origin_Z`, `angles_W`, `angles_X`, `angles_Y`, `angles_Z`)
VALUES (37250, 8040, 0x016C01C2, 56.60611, -30.85848, 0, 0.380054, 0, 0, -0.924964) /* PCAPRecordedLocation */
/* @teleloc 0x016C01C2 [56.606110 -30.858480 0.000000] 0.380054 0.000000 0.000000 -0.924964 */;

INSERT INTO `weenie_properties_i_i_d` (`object_Id`, `type`, `value`)
VALUES (37250, 8000, 0xDCC83C72) /* PCAPRecordedObjectIID */;
