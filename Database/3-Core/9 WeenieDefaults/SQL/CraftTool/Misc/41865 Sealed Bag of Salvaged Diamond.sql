...
VALUES (41865,   1,        128) /* ItemType - Misc */
     ...
     , (41865,  19,         18) /* Value */
     , (41865,  65,        101) /* Placement - Resting */
     , (41865,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41865,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41865,   1, False) /* Stuck */
     , (41865,  11, True ) /* IgnoreCollisions */
     , (41865,  13, True ) /* Ethereal */
     , (41865,  14, True ) /* GravityStatus */
     , (41865,  19, True ) /* Attackable */
     , (41865,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41865,  39, 0.800000011920929) /* DefaultScale */;
