...
VALUES (41724,   1,        128) /* ItemType - Misc */
     ...
     , (41724,  19,          1) /* Value */
     , (41724,  65,        101) /* Placement - Resting */
     , (41724,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (41724,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (41724,   1, False) /* Stuck */
     , (41724,  11, True ) /* IgnoreCollisions */
     , (41724,  13, True ) /* Ethereal */
     , (41724,  14, True ) /* GravityStatus */
     , (41724,  19, True ) /* Attackable */
     , (41724,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (41724,  39, 0.800000011920929) /* DefaultScale */;
