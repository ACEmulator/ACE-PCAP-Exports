...
VALUES (36365,   1,        128) /* ItemType - Misc */
     ...
     , (36365,  19,          3) /* Value */
     , (36365,  65,        101) /* Placement - Resting */
     , (36365,  93,       1044) /* PhysicsState - Ethereal, IgnoreCollisions, Gravity */
     , (36365,  94,         16) /* TargetType - Creature */;

INSERT INTO `weenie_properties_bool` (`object_Id`, `type`, `value`)
VALUES (36365,   1, False) /* Stuck */
     , (36365,  11, True ) /* IgnoreCollisions */
     , (36365,  13, True ) /* Ethereal */
     , (36365,  14, True ) /* GravityStatus */
     , (36365,  19, True ) /* Attackable */
     , (36365,  22, True ) /* Inscribable */;

INSERT INTO `weenie_properties_float` (`object_Id`, `type`, `value`)
VALUES (36365,  39, 0.800000011920929) /* DefaultScale */;
