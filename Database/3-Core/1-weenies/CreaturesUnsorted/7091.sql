...
VALUES (7091, 2, 3) /* CREATURE_TYPE_INT */
     , (7091, 307, 5) /* DAMAGE_RATING_INT */
     , (7091, 25, 115) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7091, 1, 210) /* STRENGTH_ATTRIBUTE */
     , (7091, 2, 205) /* ENDURANCE_ATTRIBUTE */
     , (7091, 4, 170) /* COORDINATION_ATTRIBUTE */
     , (7091, 8, 240) /* QUICKNESS_ATTRIBUTE */
     , (7091, 16, 120) /* FOCUS_ATTRIBUTE */
     , (7091, 32, 120) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7091, 64, 503) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7091, 128, 705) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7091, 256, 370) /* MAX_MANA_ATTRIBUTE_2ND */;
