...
VALUES (6, 2, 2) /* CREATURE_TYPE_INT */
     , (6, 307, 5) /* DAMAGE_RATING_INT */
     , (6, 25, 8) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (6, 1, 110) /* STRENGTH_ATTRIBUTE */
     , (6, 2, 65) /* ENDURANCE_ATTRIBUTE */
     , (6, 4, 90) /* COORDINATION_ATTRIBUTE */
     , (6, 8, 60) /* QUICKNESS_ATTRIBUTE */
     , (6, 16, 30) /* FOCUS_ATTRIBUTE */
     , (6, 32, 30) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (6, 64, 43) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6, 128, 75) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6, 256, 31) /* MAX_MANA_ATTRIBUTE_2ND */;
