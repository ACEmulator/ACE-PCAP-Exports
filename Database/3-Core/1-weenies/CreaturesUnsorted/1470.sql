...
REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1470, 2, 4) /* CREATURE_TYPE_INT */
     , (1470, 307, 5) /* DAMAGE_RATING_INT */
     , (1470, 25, 8) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1470, 1, 100) /* STRENGTH_ATTRIBUTE */
     , (1470, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (1470, 4, 55) /* COORDINATION_ATTRIBUTE */
     , (1470, 8, 70) /* QUICKNESS_ATTRIBUTE */
     , (1470, 16, 40) /* FOCUS_ATTRIBUTE */
     , (1470, 32, 30) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1470, 64, 47) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1470, 128, 94) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1470, 256, 30) /* MAX_MANA_ATTRIBUTE_2ND */;
