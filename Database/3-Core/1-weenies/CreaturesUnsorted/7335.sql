...
VALUES (7335, 2, 3) /* CREATURE_TYPE_INT */
     , (7335, 307, 5) /* DAMAGE_RATING_INT */
     , (7335, 25, 80) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7335, 1, 190) /* STRENGTH_ATTRIBUTE */
     , (7335, 2, 175) /* ENDURANCE_ATTRIBUTE */
     , (7335, 4, 150) /* COORDINATION_ATTRIBUTE */
     , (7335, 8, 200) /* QUICKNESS_ATTRIBUTE */
     , (7335, 16, 100) /* FOCUS_ATTRIBUTE */
     , (7335, 32, 100) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7335, 64, 258) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7335, 128, 455) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7335, 256, 200) /* MAX_MANA_ATTRIBUTE_2ND */;
