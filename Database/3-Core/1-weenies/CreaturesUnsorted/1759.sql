...
VALUES (1759, 2, 30) /* CREATURE_TYPE_INT */
     , (1759, 307, 5) /* DAMAGE_RATING_INT */
     , (1759, 25, 8) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1759, 1, 25) /* STRENGTH_ATTRIBUTE */
     , (1759, 2, 35) /* ENDURANCE_ATTRIBUTE */
     , (1759, 4, 75) /* COORDINATION_ATTRIBUTE */
     , (1759, 8, 80) /* QUICKNESS_ATTRIBUTE */
     , (1759, 16, 55) /* FOCUS_ATTRIBUTE */
     , (1759, 32, 65) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1759, 64, 43) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1759, 128, 50) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1759, 256, 65) /* MAX_MANA_ATTRIBUTE_2ND */;
