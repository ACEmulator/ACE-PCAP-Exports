...
VALUES (7507, 2, 13) /* CREATURE_TYPE_INT */
     , (7507, 307, 2) /* DAMAGE_RATING_INT */
     , (7507, 25, 100) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7507, 1, 250) /* STRENGTH_ATTRIBUTE */
     , (7507, 2, 250) /* ENDURANCE_ATTRIBUTE */
     , (7507, 4, 150) /* COORDINATION_ATTRIBUTE */
     , (7507, 8, 150) /* QUICKNESS_ATTRIBUTE */
     , (7507, 16, 150) /* FOCUS_ATTRIBUTE */
     , (7507, 32, 150) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7507, 64, 555) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7507, 128, 470) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7507, 256, 425) /* MAX_MANA_ATTRIBUTE_2ND */;
