...
VALUES (6381, 2, 42) /* CREATURE_TYPE_INT */
     , (6381, 307, 2) /* DAMAGE_RATING_INT */
     , (6381, 25, 20) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (6381, 1, 60) /* STRENGTH_ATTRIBUTE */
     , (6381, 2, 80) /* ENDURANCE_ATTRIBUTE */
     , (6381, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (6381, 8, 80) /* QUICKNESS_ATTRIBUTE */
     , (6381, 16, 80) /* FOCUS_ATTRIBUTE */
     , (6381, 32, 100) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (6381, 64, 70) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6381, 128, 180) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6381, 256, 180) /* MAX_MANA_ATTRIBUTE_2ND */;
