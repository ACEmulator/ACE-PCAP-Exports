...
VALUES (5682, 2, 30) /* CREATURE_TYPE_INT */
     , (5682, 307, 5) /* DAMAGE_RATING_INT */
     , (5682, 25, 15) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (5682, 1, 35) /* STRENGTH_ATTRIBUTE */
     , (5682, 2, 45) /* ENDURANCE_ATTRIBUTE */
     , (5682, 4, 85) /* COORDINATION_ATTRIBUTE */
     , (5682, 8, 90) /* QUICKNESS_ATTRIBUTE */
     , (5682, 16, 65) /* FOCUS_ATTRIBUTE */
     , (5682, 32, 75) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (5682, 64, 65) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (5682, 128, 105) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (5682, 256, 75) /* MAX_MANA_ATTRIBUTE_2ND */;
