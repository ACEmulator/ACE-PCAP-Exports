...
REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7112, 2, 26) /* CREATURE_TYPE_INT */
     , (7112, 307, 5) /* DAMAGE_RATING_INT */
     , (7112, 25, 100) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7112, 1, 180) /* STRENGTH_ATTRIBUTE */
     , (7112, 2, 150) /* ENDURANCE_ATTRIBUTE */
     , (7112, 4, 180) /* COORDINATION_ATTRIBUTE */
     , (7112, 8, 170) /* QUICKNESS_ATTRIBUTE */
     , (7112, 16, 130) /* FOCUS_ATTRIBUTE */
     , (7112, 32, 150) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7112, 64, 325) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7112, 128, 450) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7112, 256, 350) /* MAX_MANA_ATTRIBUTE_2ND */;
