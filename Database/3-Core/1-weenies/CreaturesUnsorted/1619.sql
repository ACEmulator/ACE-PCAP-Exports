...
VALUES (1619, 2, 4) /* CREATURE_TYPE_INT */
     , (1619, 307, 2) /* DAMAGE_RATING_INT */
     , (1619, 25, 20) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1619, 1, 110) /* STRENGTH_ATTRIBUTE */
     , (1619, 2, 100) /* ENDURANCE_ATTRIBUTE */
     , (1619, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (1619, 8, 85) /* QUICKNESS_ATTRIBUTE */
     , (1619, 16, 65) /* FOCUS_ATTRIBUTE */
     , (1619, 32, 55) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1619, 64, 90) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1619, 128, 185) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1619, 256, 55) /* MAX_MANA_ATTRIBUTE_2ND */;
