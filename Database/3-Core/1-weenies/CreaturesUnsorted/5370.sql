...
VALUES (5370, 2, 3) /* CREATURE_TYPE_INT */
     , (5370, 307, 5) /* DAMAGE_RATING_INT */
     , (5370, 25, 8) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (5370, 1, 60) /* STRENGTH_ATTRIBUTE */
     , (5370, 2, 55) /* ENDURANCE_ATTRIBUTE */
     , (5370, 4, 80) /* COORDINATION_ATTRIBUTE */
     , (5370, 8, 135) /* QUICKNESS_ATTRIBUTE */
     , (5370, 16, 15) /* FOCUS_ATTRIBUTE */
     , (5370, 32, 15) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (5370, 64, 36) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (5370, 128, 75) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (5370, 256, 15) /* MAX_MANA_ATTRIBUTE_2ND */;
