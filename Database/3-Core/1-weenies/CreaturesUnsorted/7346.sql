...
VALUES (7346, 2, 2) /* CREATURE_TYPE_INT */
     , (7346, 307, 7) /* DAMAGE_RATING_INT */
     , (7346, 25, 100) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7346, 1, 200) /* STRENGTH_ATTRIBUTE */
     , (7346, 2, 175) /* ENDURANCE_ATTRIBUTE */
     , (7346, 4, 185) /* COORDINATION_ATTRIBUTE */
     , (7346, 8, 180) /* QUICKNESS_ATTRIBUTE */
     , (7346, 16, 100) /* FOCUS_ATTRIBUTE */
     , (7346, 32, 100) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7346, 64, 413) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7346, 128, 675) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7346, 256, 300) /* MAX_MANA_ATTRIBUTE_2ND */;
