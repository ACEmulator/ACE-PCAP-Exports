...
VALUES (7089, 2, 3) /* CREATURE_TYPE_INT */
     , (7089, 307, 5) /* DAMAGE_RATING_INT */
     , (7089, 25, 80) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7089, 1, 190) /* STRENGTH_ATTRIBUTE */
     , (7089, 2, 175) /* ENDURANCE_ATTRIBUTE */
     , (7089, 4, 150) /* COORDINATION_ATTRIBUTE */
     , (7089, 8, 200) /* QUICKNESS_ATTRIBUTE */
     , (7089, 16, 100) /* FOCUS_ATTRIBUTE */
     , (7089, 32, 100) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7089, 64, 258) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7089, 128, 455) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7089, 256, 200) /* MAX_MANA_ATTRIBUTE_2ND */;
