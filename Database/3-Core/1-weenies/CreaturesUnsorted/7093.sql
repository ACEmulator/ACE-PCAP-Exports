...
REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7093, 2, 38) /* CREATURE_TYPE_INT */
     , (7093, 307, 5) /* DAMAGE_RATING_INT */
     , (7093, 25, 115) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7093, 1, 150) /* STRENGTH_ATTRIBUTE */
     , (7093, 2, 160) /* ENDURANCE_ATTRIBUTE */
     , (7093, 4, 160) /* COORDINATION_ATTRIBUTE */
     , (7093, 8, 160) /* QUICKNESS_ATTRIBUTE */
     , (7093, 16, 160) /* FOCUS_ATTRIBUTE */
     , (7093, 32, 190) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7093, 64, 780) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7093, 128, 610) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7093, 256, 540) /* MAX_MANA_ATTRIBUTE_2ND */;
