...
REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7822, 2, 30) /* CREATURE_TYPE_INT */
     , (7822, 307, 5) /* DAMAGE_RATING_INT */
     , (7822, 25, 40) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7822, 1, 65) /* STRENGTH_ATTRIBUTE */
     , (7822, 2, 75) /* ENDURANCE_ATTRIBUTE */
     , (7822, 4, 115) /* COORDINATION_ATTRIBUTE */
     , (7822, 8, 120) /* QUICKNESS_ATTRIBUTE */
     , (7822, 16, 120) /* FOCUS_ATTRIBUTE */
     , (7822, 32, 130) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7822, 64, 108) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7822, 128, 165) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7822, 256, 230) /* MAX_MANA_ATTRIBUTE_2ND */;
