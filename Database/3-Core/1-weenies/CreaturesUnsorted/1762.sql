...
VALUES (1762, 2, 30) /* CREATURE_TYPE_INT */
     , (1762, 307, 5) /* DAMAGE_RATING_INT */
     , (1762, 25, 40) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1762, 1, 65) /* STRENGTH_ATTRIBUTE */
     , (1762, 2, 75) /* ENDURANCE_ATTRIBUTE */
     , (1762, 4, 115) /* COORDINATION_ATTRIBUTE */
     , (1762, 8, 120) /* QUICKNESS_ATTRIBUTE */
     , (1762, 16, 120) /* FOCUS_ATTRIBUTE */
     , (1762, 32, 130) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1762, 64, 108) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1762, 128, 165) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1762, 256, 230) /* MAX_MANA_ATTRIBUTE_2ND */;
