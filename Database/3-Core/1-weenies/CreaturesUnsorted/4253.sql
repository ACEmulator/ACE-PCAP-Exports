...
VALUES (4253, 16, 67109565) /* EYES_PALETTE_DID */
     , (4253, 9, 83890281) /* EYES_TEXTURE_DID */
     , (4253, 17, 67109558) /* SKIN_PALETTE_DID */
     , (4253, 10, 83890308) /* NOSE_TEXTURE_DID */
     , (4253, 11, 83890340) /* MOUTH_TEXTURE_DID */
     , (4253, 15, 67117028) /* HAIR_PALETTE_DID */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4253, 113, 2) /* GENDER_INT */
     , (4253, 2, 22) /* CREATURE_TYPE_INT */
     , (4253, 307, 5) /* DAMAGE_RATING_INT */
     , (4253, 25, 80) /* LEVEL_INT */
     , (4253, 188, 1) /* HERITAGE_GROUP_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (4253, 1, 100) /* STRENGTH_ATTRIBUTE */
     , (4253, 2, 120) /* ENDURANCE_ATTRIBUTE */
     , (4253, 4, 140) /* COORDINATION_ATTRIBUTE */
     , (4253, 8, 160) /* QUICKNESS_ATTRIBUTE */
     , (4253, 16, 120) /* FOCUS_ATTRIBUTE */
     , (4253, 32, 70) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (4253, 64, 255) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (4253, 128, 370) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (4253, 256, 330) /* MAX_MANA_ATTRIBUTE_2ND */;
