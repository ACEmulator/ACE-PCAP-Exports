...
VALUES (8, 2, 4) /* CREATURE_TYPE_INT */
     , (8, 307, 5) /* DAMAGE_RATING_INT */
     , (8, 25, 8) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (8, 1, 100) /* STRENGTH_ATTRIBUTE */
     , (8, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (8, 4, 55) /* COORDINATION_ATTRIBUTE */
     , (8, 8, 70) /* QUICKNESS_ATTRIBUTE */
     , (8, 16, 40) /* FOCUS_ATTRIBUTE */
     , (8, 32, 30) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (8, 64, 47) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (8, 128, 94) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (8, 256, 30) /* MAX_MANA_ATTRIBUTE_2ND */;
