...
VALUES (6645, 2, 13) /* CREATURE_TYPE_INT */
     , (6645, 307, 2) /* DAMAGE_RATING_INT */
     , (6645, 25, 100) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (6645, 1, 250) /* STRENGTH_ATTRIBUTE */
     , (6645, 2, 250) /* ENDURANCE_ATTRIBUTE */
     , (6645, 4, 150) /* COORDINATION_ATTRIBUTE */
     , (6645, 8, 150) /* QUICKNESS_ATTRIBUTE */
     , (6645, 16, 150) /* FOCUS_ATTRIBUTE */
     , (6645, 32, 150) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (6645, 64, 455) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6645, 128, 470) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6645, 256, 425) /* MAX_MANA_ATTRIBUTE_2ND */;
