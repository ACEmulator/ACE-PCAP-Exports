...
VALUES (2565, 1, 130) /* STRENGTH_ATTRIBUTE */
     , (2565, 2, 115) /* ENDURANCE_ATTRIBUTE */
     , (2565, 4, 75) /* COORDINATION_ATTRIBUTE */
     , (2565, 8, 70) /* QUICKNESS_ATTRIBUTE */
     , (2565, 16, 70) /* FOCUS_ATTRIBUTE */
     , (2565, 32, 70) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (2565, 64, 98) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (2565, 128, 265) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (2565, 256, 70) /* MAX_MANA_ATTRIBUTE_2ND */;
