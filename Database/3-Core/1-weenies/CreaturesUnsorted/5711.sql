...
VALUES (5711, 2, 38) /* CREATURE_TYPE_INT */
     , (5711, 307, 2) /* DAMAGE_RATING_INT */
     , (5711, 25, 60) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (5711, 1, 110) /* STRENGTH_ATTRIBUTE */
     , (5711, 2, 130) /* ENDURANCE_ATTRIBUTE */
     , (5711, 4, 130) /* COORDINATION_ATTRIBUTE */
     , (5711, 8, 130) /* QUICKNESS_ATTRIBUTE */
     , (5711, 16, 130) /* FOCUS_ATTRIBUTE */
     , (5711, 32, 150) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (5711, 64, 170) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (5711, 128, 330) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (5711, 256, 300) /* MAX_MANA_ATTRIBUTE_2ND */;
