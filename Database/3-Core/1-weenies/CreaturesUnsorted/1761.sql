...
VALUES (1761, 2, 30) /* CREATURE_TYPE_INT */
     , (1761, 307, 5) /* DAMAGE_RATING_INT */
     , (1761, 25, 20) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1761, 1, 45) /* STRENGTH_ATTRIBUTE */
     , (1761, 2, 60) /* ENDURANCE_ATTRIBUTE */
     , (1761, 4, 90) /* COORDINATION_ATTRIBUTE */
     , (1761, 8, 100) /* QUICKNESS_ATTRIBUTE */
     , (1761, 16, 65) /* FOCUS_ATTRIBUTE */
     , (1761, 32, 75) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1761, 64, 95) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1761, 128, 140) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1761, 256, 75) /* MAX_MANA_ATTRIBUTE_2ND */;
