...
VALUES (7085, 2, 2) /* CREATURE_TYPE_INT */
     , (7085, 307, 5) /* DAMAGE_RATING_INT */
     , (7085, 25, 80) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7085, 1, 250) /* STRENGTH_ATTRIBUTE */
     , (7085, 2, 160) /* ENDURANCE_ATTRIBUTE */
     , (7085, 4, 220) /* COORDINATION_ATTRIBUTE */
     , (7085, 8, 130) /* QUICKNESS_ATTRIBUTE */
     , (7085, 16, 70) /* FOCUS_ATTRIBUTE */
     , (7085, 32, 70) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7085, 64, 290) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7085, 128, 440) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7085, 256, 120) /* MAX_MANA_ATTRIBUTE_2ND */;
