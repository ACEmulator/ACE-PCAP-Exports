...
VALUES (1608, 2, 3) /* CREATURE_TYPE_INT */
     , (1608, 307, 7) /* DAMAGE_RATING_INT */
     , (1608, 25, 40) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (1608, 1, 110) /* STRENGTH_ATTRIBUTE */
     , (1608, 2, 100) /* ENDURANCE_ATTRIBUTE */
     , (1608, 4, 120) /* COORDINATION_ATTRIBUTE */
     , (1608, 8, 170) /* QUICKNESS_ATTRIBUTE */
     , (1608, 16, 60) /* FOCUS_ATTRIBUTE */
     , (1608, 32, 60) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (1608, 64, 117) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (1608, 128, 190) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (1608, 256, 185) /* MAX_MANA_ATTRIBUTE_2ND */;
