...
VALUES (6379, 2, 42) /* CREATURE_TYPE_INT */
     , (6379, 307, 5) /* DAMAGE_RATING_INT */
     , (6379, 25, 115) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (6379, 1, 150) /* STRENGTH_ATTRIBUTE */
     , (6379, 2, 160) /* ENDURANCE_ATTRIBUTE */
     , (6379, 4, 160) /* COORDINATION_ATTRIBUTE */
     , (6379, 8, 160) /* QUICKNESS_ATTRIBUTE */
     , (6379, 16, 160) /* FOCUS_ATTRIBUTE */
     , (6379, 32, 190) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (6379, 64, 780) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (6379, 128, 610) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (6379, 256, 540) /* MAX_MANA_ATTRIBUTE_2ND */;
