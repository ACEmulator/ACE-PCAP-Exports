...
VALUES (7099, 2, 13) /* CREATURE_TYPE_INT */
     , (7099, 307, 2) /* DAMAGE_RATING_INT */
     , (7099, 25, 115) /* LEVEL_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (7099, 1, 260) /* STRENGTH_ATTRIBUTE */
     , (7099, 2, 270) /* ENDURANCE_ATTRIBUTE */
     , (7099, 4, 170) /* COORDINATION_ATTRIBUTE */
     , (7099, 8, 160) /* QUICKNESS_ATTRIBUTE */
     , (7099, 16, 160) /* FOCUS_ATTRIBUTE */
     , (7099, 32, 160) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (7099, 64, 465) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (7099, 128, 490) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (7099, 256, 435) /* MAX_MANA_ATTRIBUTE_2ND */;
