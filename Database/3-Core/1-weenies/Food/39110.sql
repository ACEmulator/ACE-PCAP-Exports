...
VALUES (39110, 16, 'A festival treat. A little rat shaped licorice candy. It jumps and squeaks like the real thing! But it''s much safer to eat.') /* LONG_DESC_STRING */
     , (39110, 14, 'Use this item to eat it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (39110, 19, 10) /* VALUE_INT */
     , (39110, 5, 1) /* ENCUMB_VAL_INT */
     , (39110, 106, 300) /* ITEM_SPELLCRAFT_INT */
     , (39110, 108, 50) /* ITEM_MAX_MANA_INT */
     , (39110, 109, 0) /* ITEM_DIFFICULTY_INT */
     , (39110, 110, 0) /* ITEM_ALLEGIANCE_RANK_LIMIT_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (39110, 69, 0) /* IS_SELLABLE_BOOL */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (39110, 4211) /* LicoriceLeap_SpellID */;
