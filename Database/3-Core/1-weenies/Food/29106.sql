...
VALUES (29106, 16, 'A bottle of Bobo''s Stout.') /* LONG_DESC_STRING */
     , (29106, 14, 'Use this item to drink it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (29106, 19, 10) /* VALUE_INT */
     , (29106, 5, 50) /* ENCUMB_VAL_INT */
     , (29106, 106, 250) /* ITEM_SPELLCRAFT_INT */
     , (29106, 108, 100) /* ITEM_MAX_MANA_INT */
     , (29106, 109, 0) /* ITEM_DIFFICULTY_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (29106, 69, 0) /* IS_SELLABLE_BOOL */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (29106, 3531) /* BobosBlessingCoord_SpellID */;
