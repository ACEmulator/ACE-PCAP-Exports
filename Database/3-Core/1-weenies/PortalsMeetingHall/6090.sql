...
VALUES (6090, 262164, 6090, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6090, 1, 'Arwic Meeting Hall Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (6090, 8, 100667499) /* ICON_DID */
     , (6090, 1, 33554867) /* SETUP_DID */
...
VALUES (6090, 13, True) /* ETHEREAL_BOOL */
     , (6090, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (6090, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (6090, 111, 1) /* PORTAL_BITMASK_INT */;
