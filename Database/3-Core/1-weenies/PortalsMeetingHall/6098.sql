...
VALUES (6098, 8, 100667499) /* ICON_DID */
     , (6098, 1, 33554867) /* SETUP_DID */
...
VALUES (6098, 13, True) /* ETHEREAL_BOOL */
     , (6098, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (6098, 14, True) /* GRAVITY_STATUS_BOOL */
     , (6098, 15, True) /* LIGHTS_STATUS_BOOL */
     , (6098, 19, True) /* ATTACKABLE_BOOL */
     , (6098, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6098, 38, 'Lin Meeting Hall Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (6098, 111, 1) /* PORTAL_BITMASK_INT */;
