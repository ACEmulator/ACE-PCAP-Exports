...
VALUES (24374, 65, 101) /* PLACEMENT_INT */
...
VALUES (24374, 16, 'Silken raiment woven together to be worn over the entirety of the body. Simple clasps allow for the item to be cinched along the front.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24374, 160, 60) /* WIELD_DIFFICULTY_INT */
     , (24374, 19, 5000) /* VALUE_INT */
     , (24374, 5, 800) /* ENCUMB_VAL_INT */
     , (24374, 106, 275) /* ITEM_SPELLCRAFT_INT */
     , (24374, 108, 800) /* ITEM_MAX_MANA_INT */
     , (24374, 28, 0) /* ARMOR_LEVEL_INT */
     , (24374, 109, 100) /* ITEM_DIFFICULTY_INT */
     , (24374, 158, 7) /* WIELD_REQUIREMENTS_INT */
     , (24374, 159, 1) /* WIELD_SKILLTYPE_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (24374, 5, -0.025) /* MANA_RATE_FLOAT */
     , (24374, 13, 0.8) /* ARMOR_MOD_VS_SLASH_FLOAT */
     , (24374, 14, 0.8) /* ARMOR_MOD_VS_PIERCE_FLOAT */
     , (24374, 15, 1) /* ARMOR_MOD_VS_BLUDGEON_FLOAT */
     , (24374, 16, 0.2) /* ARMOR_MOD_VS_COLD_FLOAT */
     , (24374, 17, 0.2) /* ARMOR_MOD_VS_FIRE_FLOAT */
     , (24374, 18, 0.1) /* ARMOR_MOD_VS_ACID_FLOAT */
     , (24374, 19, 0.2) /* ARMOR_MOD_VS_ELECTRIC_FLOAT */
     , (24374, 165, 1) /* ARMOR_MOD_VS_NETHER_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (24374, 100, 1) /* DYABLE_BOOL */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (24374, 2583) /* CANTRIPSTRENGTH1_SpellID */
     , (24374, 1120) /* BladeProtectionOther6_SpellID */
     , (24374, 1337) /* StrengthOther6_SpellID */;
