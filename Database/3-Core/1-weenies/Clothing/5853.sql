...
VALUES (5853, 65, 101) /* PLACEMENT_INT */
...
VALUES (5853, 19, 50) /* VALUE_INT */
     , (5853, 5, 200) /* ENCUMB_VAL_INT */
     , (5853, 28, 0) /* ARMOR_LEVEL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (5853, 13, 0.8) /* ARMOR_MOD_VS_SLASH_FLOAT */
     ...
     , (5853, 165, 1) /* ARMOR_MOD_VS_NETHER_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (5853, 100, 1) /* DYABLE_BOOL */;
