...
VALUES (1340, 262164, 1340, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1340, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1340, 8, 100667499) /* ICON_DID */
     , (1340, 1, 33554867) /* SETUP_DID */
...
VALUES (1340, 13, True) /* ETHEREAL_BOOL */
     , (1340, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1340, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1340, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1340, 19, True) /* ATTACKABLE_BOOL */
     , (1340, 1, True) /* STUCK_BOOL */;
