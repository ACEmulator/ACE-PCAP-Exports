...
VALUES (24634, 262164, 24634, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24634, 1, 'Exit portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24634, 8, 100667499) /* ICON_DID */
     , (24634, 1, 33554867) /* SETUP_DID */
...
VALUES (24634, 13, True) /* ETHEREAL_BOOL */
     , (24634, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24634, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24634, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24634, 19, True) /* ATTACKABLE_BOOL */
     , (24634, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24634, 38, 'Exit portal (51.8N, 59.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24634, 111, 49) /* PORTAL_BITMASK_INT */;
