...
VALUES (1311, 262164, 1311, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1311, 1, 'North Glenden Prison') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1311, 8, 100667499) /* ICON_DID */
     , (1311, 1, 33555925) /* SETUP_DID */
...
VALUES (1311, 13, True) /* ETHEREAL_BOOL */
     , (1311, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1311, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (1311, 86, 80) /* MIN_LEVEL_INT */
