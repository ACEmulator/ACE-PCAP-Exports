...
VALUES (14885, 262164, 14885, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14885, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14885, 8, 100667499) /* ICON_DID */
     , (14885, 1, 33554867) /* SETUP_DID */
...
VALUES (14885, 13, True) /* ETHEREAL_BOOL */
     , (14885, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14885, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14885, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14885, 19, True) /* ATTACKABLE_BOOL */
     , (14885, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14885, 38, 'Surface (87.0S, 40.3W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14885, 111, 1) /* PORTAL_BITMASK_INT */;
