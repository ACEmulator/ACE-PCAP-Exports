...
VALUES (4959, 262164, 4959, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4959, 1, 'Empyrean Garrison') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4959, 8, 100667499) /* ICON_DID */
     , (4959, 1, 33555922) /* SETUP_DID */
...
VALUES (4959, 13, True) /* ETHEREAL_BOOL */
     , (4959, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4959, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4959, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4959, 19, True) /* ATTACKABLE_BOOL */
     , (4959, 1, True) /* STUCK_BOOL */;
