...
VALUES (10849, 262164, 10849, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10849, 1, 'Lair of the Eviscerators') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10849, 8, 100667499) /* ICON_DID */
     , (10849, 1, 33555926) /* SETUP_DID */
...
VALUES (10849, 13, True) /* ETHEREAL_BOOL */
     , (10849, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (10849, 14, True) /* GRAVITY_STATUS_BOOL */
     , (10849, 15, True) /* LIGHTS_STATUS_BOOL */
     , (10849, 19, True) /* ATTACKABLE_BOOL */
     , (10849, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10849, 38, 'Lair of the Eviscerators') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10849, 86, 50) /* MIN_LEVEL_INT */
