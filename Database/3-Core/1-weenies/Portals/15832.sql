...
VALUES (15832, 262164, 15832, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15832, 1, 'Alvan Court') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15832, 8, 100667499) /* ICON_DID */
     , (15832, 1, 33554867) /* SETUP_DID */
...
VALUES (15832, 13, True) /* ETHEREAL_BOOL */
     , (15832, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15832, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (15832, 111, 1) /* PORTAL_BITMASK_INT */;
