...
VALUES (14488, 262164, 14488, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14488, 1, 'Empyrean Fire Propylaeum') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14488, 8, 100667499) /* ICON_DID */
     , (14488, 1, 33555926) /* SETUP_DID */
...
VALUES (14488, 13, True) /* ETHEREAL_BOOL */
     , (14488, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14488, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14488, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14488, 19, True) /* ATTACKABLE_BOOL */
     , (14488, 1, True) /* STUCK_BOOL */;
