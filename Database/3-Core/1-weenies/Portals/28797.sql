...
VALUES (28797, 262164, 28797, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28797, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (28797, 8, 100667499) /* ICON_DID */
     , (28797, 1, 33554867) /* SETUP_DID */
...
VALUES (28797, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (28797, 9007, 7) /* Portal_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (28797, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (28797, 13, True) /* ETHEREAL_BOOL */
     , (28797, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (28797, 14, True) /* GRAVITY_STATUS_BOOL */
     , (28797, 15, True) /* LIGHTS_STATUS_BOOL */
     , (28797, 19, True) /* ATTACKABLE_BOOL */
     , (28797, 1, True) /* STUCK_BOOL */;
