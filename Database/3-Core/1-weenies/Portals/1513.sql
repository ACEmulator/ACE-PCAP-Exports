...
VALUES (1513, 262164, 1513, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1513, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1513, 8, 100667499) /* ICON_DID */
     , (1513, 1, 33554867) /* SETUP_DID */
...
VALUES (1513, 13, True) /* ETHEREAL_BOOL */
     , (1513, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1513, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1513, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1513, 19, True) /* ATTACKABLE_BOOL */
     , (1513, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1513, 38, 'Surface (18.7N, 1.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1513, 111, 1) /* PORTAL_BITMASK_INT */;
