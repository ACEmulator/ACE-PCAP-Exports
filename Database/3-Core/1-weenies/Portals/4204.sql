...
VALUES (4204, 262164, 4204, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4204, 1, 'Grievous Vault') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4204, 8, 100667499) /* ICON_DID */
     , (4204, 1, 33555923) /* SETUP_DID */
...
VALUES (4204, 13, True) /* ETHEREAL_BOOL */
     , (4204, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4204, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4204, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4204, 19, True) /* ATTACKABLE_BOOL */
     , (4204, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4204, 38, 'Grievous Vault') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4204, 86, 10) /* MIN_LEVEL_INT */
