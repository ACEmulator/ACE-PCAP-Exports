...
VALUES (24050, 262164, 24050, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24050, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24050, 8, 100667499) /* ICON_DID */
     , (24050, 1, 33558262) /* SETUP_DID */
...
VALUES (24050, 13, True) /* ETHEREAL_BOOL */
     , (24050, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24050, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24050, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24050, 19, True) /* ATTACKABLE_BOOL */
     , (24050, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24050, 38, 'Surface (73.7N, 25.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24050, 111, 49) /* PORTAL_BITMASK_INT */;
