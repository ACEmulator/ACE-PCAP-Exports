...
VALUES (24331, 262164, 24331, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24331, 1, 'Lower Corridor') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24331, 8, 100667499) /* ICON_DID */
     , (24331, 1, 33554867) /* SETUP_DID */
...
VALUES (24331, 13, True) /* ETHEREAL_BOOL */
     , (24331, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24331, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24331, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24331, 19, True) /* ATTACKABLE_BOOL */
     , (24331, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24331, 38, 'Lower Corridor') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24331, 111, 49) /* PORTAL_BITMASK_INT */;
