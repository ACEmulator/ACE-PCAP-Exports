...
VALUES (1328, 262164, 1328, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1328, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1328, 8, 100667499) /* ICON_DID */
     , (1328, 1, 33554867) /* SETUP_DID */
...
VALUES (1328, 13, True) /* ETHEREAL_BOOL */
     , (1328, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1328, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1328, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1328, 19, True) /* ATTACKABLE_BOOL */
     , (1328, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1328, 38, 'Surface (67.2N, 50.8E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1328, 111, 1) /* PORTAL_BITMASK_INT */;
