...
VALUES (8576, 262164, 8576, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8576, 1, 'Rumuba''s Hidey-Hole') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8576, 8, 100667499) /* ICON_DID */
     , (8576, 1, 33554867) /* SETUP_DID */
...
VALUES (8576, 13, True) /* ETHEREAL_BOOL */
     , (8576, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8576, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8576, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8576, 19, True) /* ATTACKABLE_BOOL */
     , (8576, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8576, 38, 'Rumuba''s Hidey-Hole') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8576, 111, 1) /* PORTAL_BITMASK_INT */;
