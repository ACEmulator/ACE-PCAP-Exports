...
VALUES (30692, 262164, 30692, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30692, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30692, 8, 100667499) /* ICON_DID */
     , (30692, 1, 33554867) /* SETUP_DID */
...
VALUES (30692, 13, True) /* ETHEREAL_BOOL */
     , (30692, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (30692, 14, True) /* GRAVITY_STATUS_BOOL */
     , (30692, 15, True) /* LIGHTS_STATUS_BOOL */
     , (30692, 19, True) /* ATTACKABLE_BOOL */
     , (30692, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30692, 38, 'Surface (85.7S, 78.7W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30692, 111, 1) /* PORTAL_BITMASK_INT */;
