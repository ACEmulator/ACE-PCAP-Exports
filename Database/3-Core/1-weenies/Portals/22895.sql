...
VALUES (22895, 262164, 22895, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22895, 1, 'Spirit Cell') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22895, 8, 100667499) /* ICON_DID */
     , (22895, 1, 33554867) /* SETUP_DID */
...
VALUES (22895, 13, True) /* ETHEREAL_BOOL */
     , (22895, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22895, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22895, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22895, 19, True) /* ATTACKABLE_BOOL */
     , (22895, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22895, 38, 'Spirit Cell') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22895, 111, 1) /* PORTAL_BITMASK_INT */;
