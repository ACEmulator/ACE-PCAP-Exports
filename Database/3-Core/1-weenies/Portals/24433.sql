...
VALUES (24433, 262164, 24433, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24433, 1, 'Matron Hive East') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24433, 8, 100667499) /* ICON_DID */
     , (24433, 1, 33556212) /* SETUP_DID */
...
VALUES (24433, 13, True) /* ETHEREAL_BOOL */
     , (24433, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24433, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24433, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24433, 19, True) /* ATTACKABLE_BOOL */
     , (24433, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24433, 38, 'Matron Hive East') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24433, 86, 120) /* MIN_LEVEL_INT */
