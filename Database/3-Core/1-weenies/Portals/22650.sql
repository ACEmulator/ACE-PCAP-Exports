...
VALUES (22650, 262164, 22650, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22650, 1, 'Legend of the Tusker King') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22650, 8, 100667499) /* ICON_DID */
     , (22650, 1, 33555925) /* SETUP_DID */
...
VALUES (22650, 13, True) /* ETHEREAL_BOOL */
     , (22650, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22650, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22650, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22650, 19, True) /* ATTACKABLE_BOOL */
     , (22650, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22650, 38, 'Legend of the Tusker King') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22650, 86, 80) /* MIN_LEVEL_INT */
