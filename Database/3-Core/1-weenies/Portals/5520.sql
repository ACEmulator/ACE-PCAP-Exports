...
VALUES (5520, 262164, 5520, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5520, 1, 'Exit') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5520, 8, 100667499) /* ICON_DID */
     , (5520, 1, 33554867) /* SETUP_DID */
...
VALUES (5520, 13, True) /* ETHEREAL_BOOL */
     , (5520, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5520, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5520, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5520, 19, True) /* ATTACKABLE_BOOL */
     , (5520, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5520, 38, 'Exit (29.0S, 91.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5520, 111, 1) /* PORTAL_BITMASK_INT */;
