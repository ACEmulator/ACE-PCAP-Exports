...
VALUES (12692, 262164, 12692, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12692, 1, 'Hollow Lair near Lytelthorpe') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12692, 8, 100667499) /* ICON_DID */
     , (12692, 1, 33555923) /* SETUP_DID */
...
VALUES (12692, 13, True) /* ETHEREAL_BOOL */
     , (12692, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12692, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12692, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12692, 19, True) /* ATTACKABLE_BOOL */
     , (12692, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12692, 38, 'Hollow Lair near Lytelthorpe') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12692, 86, 20) /* MIN_LEVEL_INT */
