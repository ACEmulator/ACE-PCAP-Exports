...
VALUES (2329, 262164, 2329, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2329, 1, 'Small Black Hill') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2329, 8, 100667499) /* ICON_DID */
     , (2329, 1, 33554867) /* SETUP_DID */
...
VALUES (2329, 13, True) /* ETHEREAL_BOOL */
     , (2329, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2329, 14, True) /* GRAVITY_STATUS_BOOL */
