...
VALUES (1900, 262164, 1900, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1900, 1, 'Heartland') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1900, 8, 100667499) /* ICON_DID */
     , (1900, 1, 33554867) /* SETUP_DID */
...
VALUES (1900, 13, True) /* ETHEREAL_BOOL */
     , (1900, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1900, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (1900, 111, 1) /* PORTAL_BITMASK_INT */;
