...
VALUES (2561, 262164, 2561, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2561, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2561, 8, 100667499) /* ICON_DID */
     , (2561, 1, 33554867) /* SETUP_DID */
...
VALUES (2561, 13, True) /* ETHEREAL_BOOL */
     , (2561, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2561, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2561, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2561, 19, True) /* ATTACKABLE_BOOL */
     , (2561, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2561, 38, 'Surface') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2561, 111, 1) /* PORTAL_BITMASK_INT */;
