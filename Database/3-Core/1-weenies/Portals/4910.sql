...
VALUES (4910, 262164, 4910, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4910, 1, 'Mattekar Cave') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4910, 8, 100667499) /* ICON_DID */
     , (4910, 1, 33554867) /* SETUP_DID */
...
VALUES (4910, 13, True) /* ETHEREAL_BOOL */
     , (4910, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4910, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4910, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4910, 19, True) /* ATTACKABLE_BOOL */
     , (4910, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4910, 38, 'Mattekar Cave') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4910, 111, 1) /* PORTAL_BITMASK_INT */;
