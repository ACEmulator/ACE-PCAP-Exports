...
VALUES (2558, 262164, 2558, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2558, 1, 'Tumerok Post') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2558, 8, 100667499) /* ICON_DID */
     , (2558, 1, 33554867) /* SETUP_DID */
...
VALUES (2558, 13, True) /* ETHEREAL_BOOL */
     , (2558, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2558, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2558, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2558, 19, True) /* ATTACKABLE_BOOL */
     , (2558, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2558, 38, 'Tumerok Post') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2558, 111, 1) /* PORTAL_BITMASK_INT */;
