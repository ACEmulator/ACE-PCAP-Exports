...
VALUES (2559, 262164, 2559, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2559, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2559, 8, 100667499) /* ICON_DID */
     , (2559, 1, 33554867) /* SETUP_DID */
...
VALUES (2559, 13, True) /* ETHEREAL_BOOL */
     , (2559, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2559, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2559, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2559, 19, True) /* ATTACKABLE_BOOL */
     , (2559, 1, True) /* STUCK_BOOL */;
