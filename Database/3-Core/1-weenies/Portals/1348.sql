...
VALUES (1348, 262164, 1348, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1348, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1348, 8, 100667499) /* ICON_DID */
     , (1348, 1, 33554867) /* SETUP_DID */
...
VALUES (1348, 13, True) /* ETHEREAL_BOOL */
     , (1348, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1348, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1348, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1348, 19, True) /* ATTACKABLE_BOOL */
     , (1348, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1348, 38, 'Surface (40.2N, 32.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1348, 111, 1) /* PORTAL_BITMASK_INT */;
