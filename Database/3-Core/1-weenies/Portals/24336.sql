...
VALUES (24336, 262164, 24336, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24336, 1, 'Upper Corridor') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24336, 8, 100667499) /* ICON_DID */
     , (24336, 1, 33554867) /* SETUP_DID */
...
VALUES (24336, 13, True) /* ETHEREAL_BOOL */
     , (24336, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24336, 14, True) /* GRAVITY_STATUS_BOOL */
