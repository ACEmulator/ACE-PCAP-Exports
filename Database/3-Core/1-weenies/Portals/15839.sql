...
VALUES (15839, 262164, 15839, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15839, 1, 'Sigil Veranda') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15839, 8, 100667499) /* ICON_DID */
     , (15839, 1, 33554867) /* SETUP_DID */
...
VALUES (15839, 13, True) /* ETHEREAL_BOOL */
     , (15839, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15839, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15839, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15839, 19, True) /* ATTACKABLE_BOOL */
     , (15839, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15839, 38, 'Sigil Veranda') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15839, 111, 1) /* PORTAL_BITMASK_INT */;
