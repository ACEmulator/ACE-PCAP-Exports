...
VALUES (30718, 262164, 30718, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30718, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30718, 8, 100667499) /* ICON_DID */
     , (30718, 1, 33554867) /* SETUP_DID */
...
VALUES (30718, 13, True) /* ETHEREAL_BOOL */
     , (30718, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (30718, 14, True) /* GRAVITY_STATUS_BOOL */
     , (30718, 15, True) /* LIGHTS_STATUS_BOOL */
     , (30718, 19, True) /* ATTACKABLE_BOOL */
     , (30718, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30718, 38, 'Surface (77.2N, 32.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30718, 111, 49) /* PORTAL_BITMASK_INT */;
