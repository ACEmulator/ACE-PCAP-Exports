...
VALUES (5198, 262164, 5198, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5198, 1, 'Sea Temple Catacombs') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5198, 8, 100667499) /* ICON_DID */
     , (5198, 1, 33555922) /* SETUP_DID */
...
VALUES (5198, 13, True) /* ETHEREAL_BOOL */
     , (5198, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5198, 14, True) /* GRAVITY_STATUS_BOOL */
