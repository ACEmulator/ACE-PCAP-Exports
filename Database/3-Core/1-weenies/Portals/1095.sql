...
VALUES (1095, 262164, 1095, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1095, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1095, 8, 100667499) /* ICON_DID */
     , (1095, 1, 33554867) /* SETUP_DID */
...
VALUES (1095, 13, True) /* ETHEREAL_BOOL */
     , (1095, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1095, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1095, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1095, 19, True) /* ATTACKABLE_BOOL */
     , (1095, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1095, 38, 'Surface (21.5N, 44.1E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1095, 111, 1) /* PORTAL_BITMASK_INT */;
