...
VALUES (25495, 262164, 25495, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (25495, 1, 'Lair of the Ancient Queen') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (25495, 8, 100667499) /* ICON_DID */
     , (25495, 1, 33554867) /* SETUP_DID */
...
VALUES (25495, 13, True) /* ETHEREAL_BOOL */
     , (25495, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (25495, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (25495, 111, 49) /* PORTAL_BITMASK_INT */;
