...
VALUES (7254, 262164, 7254, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7254, 1, 'Olthoi Horde Nest') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7254, 8, 100667499) /* ICON_DID */
     , (7254, 1, 33555923) /* SETUP_DID */
...
VALUES (7254, 13, True) /* ETHEREAL_BOOL */
     , (7254, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7254, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7254, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7254, 19, True) /* ATTACKABLE_BOOL */
     , (7254, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7254, 38, 'Olthoi Horde Nest') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7254, 86, 30) /* MIN_LEVEL_INT */
