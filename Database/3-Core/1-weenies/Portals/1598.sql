...
VALUES (1598, 262164, 1598, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1598, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1598, 8, 100667499) /* ICON_DID */
     , (1598, 1, 33554867) /* SETUP_DID */
...
VALUES (1598, 13, True) /* ETHEREAL_BOOL */
     , (1598, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1598, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1598, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1598, 19, True) /* ATTACKABLE_BOOL */
     , (1598, 1, True) /* STUCK_BOOL */;
