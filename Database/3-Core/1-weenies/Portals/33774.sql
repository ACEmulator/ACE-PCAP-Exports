...
VALUES (33774, 16, 'A Mukkir-infested Ruschk temple, where those who wish to follow the Black Spear prove their worth.') /* LONG_DESC_STRING */
     , (33774, 38, 'Mukkir-Infested Black Spear Temple') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (33774, 86, 151) /* MIN_LEVEL_INT */
     , (33774, 111, 49) /* PORTAL_BITMASK_INT */;
