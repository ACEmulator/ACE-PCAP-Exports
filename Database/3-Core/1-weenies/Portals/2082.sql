...
VALUES (2082, 262164, 2082, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2082, 1, 'Hunter''s Leap') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2082, 8, 100667499) /* ICON_DID */
     , (2082, 1, 33554867) /* SETUP_DID */
...
VALUES (2082, 13, True) /* ETHEREAL_BOOL */
     , (2082, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2082, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2082, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2082, 19, True) /* ATTACKABLE_BOOL */
     , (2082, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2082, 38, 'Hunter''s Leap') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2082, 111, 1) /* PORTAL_BITMASK_INT */;
