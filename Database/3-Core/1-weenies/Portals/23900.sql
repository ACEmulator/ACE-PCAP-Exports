...
VALUES (23900, 262164, 23900, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23900, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23900, 8, 100667499) /* ICON_DID */
     , (23900, 1, 33554867) /* SETUP_DID */
...
VALUES (23900, 13, True) /* ETHEREAL_BOOL */
     , (23900, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (23900, 14, True) /* GRAVITY_STATUS_BOOL */
     , (23900, 15, True) /* LIGHTS_STATUS_BOOL */
     , (23900, 19, True) /* ATTACKABLE_BOOL */
     , (23900, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23900, 38, 'Surface (1.0S, 70.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23900, 111, 1) /* PORTAL_BITMASK_INT */;
