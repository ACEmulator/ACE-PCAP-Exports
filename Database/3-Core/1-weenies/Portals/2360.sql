...
VALUES (2360, 262164, 2360, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2360, 1, 'Cave') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2360, 8, 100667499) /* ICON_DID */
     , (2360, 1, 33554867) /* SETUP_DID */
...
VALUES (2360, 13, True) /* ETHEREAL_BOOL */
     , (2360, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2360, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2360, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2360, 19, True) /* ATTACKABLE_BOOL */
     , (2360, 1, True) /* STUCK_BOOL */;
