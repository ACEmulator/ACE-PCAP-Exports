...
VALUES (22694, 262164, 22694, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22694, 1, 'Tusker Retreat') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22694, 8, 100667499) /* ICON_DID */
     , (22694, 1, 33555922) /* SETUP_DID */
...
VALUES (22694, 13, True) /* ETHEREAL_BOOL */
     , (22694, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22694, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22694, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22694, 19, True) /* ATTACKABLE_BOOL */
     , (22694, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22694, 38, 'Tusker Retreat') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22694, 86, 5) /* MIN_LEVEL_INT */
