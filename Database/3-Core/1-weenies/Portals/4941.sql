...
VALUES (4941, 262164, 4941, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4941, 1, 'Banished Assembly') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4941, 8, 100667499) /* ICON_DID */
     , (4941, 1, 33555925) /* SETUP_DID */
...
VALUES (4941, 13, True) /* ETHEREAL_BOOL */
     , (4941, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4941, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4941, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4941, 19, True) /* ATTACKABLE_BOOL */
     , (4941, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4941, 38, 'Banished Assembly') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4941, 86, 100) /* MIN_LEVEL_INT */
