...
VALUES (5199, 262164, 5199, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5199, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5199, 8, 100667499) /* ICON_DID */
     , (5199, 1, 33554867) /* SETUP_DID */
...
VALUES (5199, 13, True) /* ETHEREAL_BOOL */
     , (5199, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5199, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5199, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5199, 19, True) /* ATTACKABLE_BOOL */
     , (5199, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5199, 38, 'Surface (20.2S, 4.4W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5199, 111, 1) /* PORTAL_BITMASK_INT */;
