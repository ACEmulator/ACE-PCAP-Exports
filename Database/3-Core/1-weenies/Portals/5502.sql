...
VALUES (5502, 262164, 5502, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5502, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5502, 8, 100667499) /* ICON_DID */
     , (5502, 1, 33554867) /* SETUP_DID */
...
VALUES (5502, 13, True) /* ETHEREAL_BOOL */
     , (5502, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5502, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5502, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5502, 19, True) /* ATTACKABLE_BOOL */
     , (5502, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5502, 38, 'Surface (29.5S, 91.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5502, 111, 1) /* PORTAL_BITMASK_INT */;
