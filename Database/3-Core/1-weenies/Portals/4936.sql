...
VALUES (4936, 262164, 4936, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4936, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4936, 8, 100667499) /* ICON_DID */
     , (4936, 1, 33554867) /* SETUP_DID */
...
VALUES (4936, 13, True) /* ETHEREAL_BOOL */
     , (4936, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4936, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4936, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4936, 19, True) /* ATTACKABLE_BOOL */
     , (4936, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4936, 38, 'Surface (40.4N, 34.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4936, 111, 1) /* PORTAL_BITMASK_INT */;
