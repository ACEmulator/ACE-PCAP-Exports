...
VALUES (27477, 262164, 27477, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27477, 1, 'Burun Burrow') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27477, 8, 100667499) /* ICON_DID */
     , (27477, 1, 33555924) /* SETUP_DID */
...
VALUES (27477, 13, True) /* ETHEREAL_BOOL */
     , (27477, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (27477, 14, True) /* GRAVITY_STATUS_BOOL */
     , (27477, 15, True) /* LIGHTS_STATUS_BOOL */
     , (27477, 19, True) /* ATTACKABLE_BOOL */
     , (27477, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27477, 38, 'Burun Burrow') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27477, 111, 49) /* PORTAL_BITMASK_INT */;
