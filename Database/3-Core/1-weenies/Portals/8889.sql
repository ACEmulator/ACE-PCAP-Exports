...
VALUES (8889, 262164, 8889, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8889, 1, 'Chakron Gate') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8889, 8, 100667499) /* ICON_DID */
     , (8889, 1, 33554867) /* SETUP_DID */
...
VALUES (8889, 13, True) /* ETHEREAL_BOOL */
     , (8889, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8889, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8889, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8889, 19, True) /* ATTACKABLE_BOOL */
     , (8889, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8889, 38, 'Chakron Gate') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8889, 111, 17) /* PORTAL_BITMASK_INT */;
