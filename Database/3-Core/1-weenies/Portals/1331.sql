...
VALUES (1331, 262164, 1331, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1331, 1, 'Cave') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1331, 8, 100667499) /* ICON_DID */
     , (1331, 1, 33554867) /* SETUP_DID */
...
VALUES (1331, 13, True) /* ETHEREAL_BOOL */
     , (1331, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1331, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1331, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1331, 19, True) /* ATTACKABLE_BOOL */
     , (1331, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1331, 38, 'Cave') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1331, 111, 1) /* PORTAL_BITMASK_INT */;
