...
VALUES (2083, 262164, 2083, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2083, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2083, 8, 100667499) /* ICON_DID */
     , (2083, 1, 33554867) /* SETUP_DID */
...
VALUES (2083, 1, 65536) /* ITEM_TYPE_INT */
     ...
     , (2083, 9007, 7) /* Portal_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (2083, 54, -0.1) /* USE_RADIUS_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (2083, 13, True) /* ETHEREAL_BOOL */
     , (2083, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2083, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2083, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2083, 19, True) /* ATTACKABLE_BOOL */
     , (2083, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2083, 38, 'Surface (35.7N, 32.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2083, 111, 1) /* PORTAL_BITMASK_INT */;
