...
VALUES (1219, 262164, 1219, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1219, 1, 'Thieves'' Den') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1219, 8, 100667499) /* ICON_DID */
     , (1219, 1, 33555923) /* SETUP_DID */
...
VALUES (1219, 13, True) /* ETHEREAL_BOOL */
     , (1219, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1219, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1219, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1219, 19, True) /* ATTACKABLE_BOOL */
     , (1219, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1219, 38, 'Thieves'' Den') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1219, 111, 1) /* PORTAL_BITMASK_INT */;
