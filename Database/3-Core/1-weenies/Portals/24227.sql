...
VALUES (24227, 262164, 24227, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24227, 1, 'Catacombs of Opposition') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24227, 8, 100667499) /* ICON_DID */
     , (24227, 1, 33554867) /* SETUP_DID */
...
VALUES (24227, 13, True) /* ETHEREAL_BOOL */
     , (24227, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24227, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24227, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24227, 19, True) /* ATTACKABLE_BOOL */
     , (24227, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24227, 38, 'Catacombs of Opposition') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24227, 111, 49) /* PORTAL_BITMASK_INT */;
