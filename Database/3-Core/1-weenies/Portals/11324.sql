...
VALUES (11324, 262164, 11324, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (11324, 1, 'Exit to the Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (11324, 8, 100667499) /* ICON_DID */
     , (11324, 1, 33554867) /* SETUP_DID */
...
VALUES (11324, 13, True) /* ETHEREAL_BOOL */
     , (11324, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (11324, 14, True) /* GRAVITY_STATUS_BOOL */
     , (11324, 15, True) /* LIGHTS_STATUS_BOOL */
     , (11324, 19, True) /* ATTACKABLE_BOOL */
     , (11324, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (11324, 38, 'Exit to the Surface (41.6N, 82.5W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (11324, 111, 49) /* PORTAL_BITMASK_INT */;
