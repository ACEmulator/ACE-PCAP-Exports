...
VALUES (1595, 262164, 1595, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1595, 1, 'Abandoned Mine') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1595, 8, 100667499) /* ICON_DID */
     , (1595, 1, 33554867) /* SETUP_DID */
...
VALUES (1595, 13, True) /* ETHEREAL_BOOL */
     , (1595, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1595, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1595, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1595, 19, True) /* ATTACKABLE_BOOL */
     , (1595, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1595, 38, 'Abandoned Mine') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1595, 111, 1) /* PORTAL_BITMASK_INT */;
