...
VALUES (7320, 262164, 7320, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7320, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7320, 8, 100667499) /* ICON_DID */
     , (7320, 1, 33554867) /* SETUP_DID */
...
VALUES (7320, 13, True) /* ETHEREAL_BOOL */
     , (7320, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7320, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7320, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7320, 19, True) /* ATTACKABLE_BOOL */
     , (7320, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7320, 38, 'Surface (70.2S, 24.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7320, 111, 1) /* PORTAL_BITMASK_INT */;
