...
VALUES (29440, 262164, 29440, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (29440, 1, 'Exit Silver Legion Keep') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (29440, 8, 100667499) /* ICON_DID */
     , (29440, 1, 33554867) /* SETUP_DID */
...
VALUES (29440, 13, True) /* ETHEREAL_BOOL */
     , (29440, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (29440, 14, True) /* GRAVITY_STATUS_BOOL */
     , (29440, 15, True) /* LIGHTS_STATUS_BOOL */
     , (29440, 19, True) /* ATTACKABLE_BOOL */
     , (29440, 1, True) /* STUCK_BOOL */;
