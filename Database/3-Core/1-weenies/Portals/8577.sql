...
VALUES (8577, 262164, 8577, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8577, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8577, 8, 100667499) /* ICON_DID */
     , (8577, 1, 33554867) /* SETUP_DID */
...
VALUES (8577, 13, True) /* ETHEREAL_BOOL */
     , (8577, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8577, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8577, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8577, 19, True) /* ATTACKABLE_BOOL */
     , (8577, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8577, 38, 'Surface (76.2S, 89.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8577, 111, 1) /* PORTAL_BITMASK_INT */;
