...
VALUES (23080, 262164, 23080, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23080, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23080, 8, 100667499) /* ICON_DID */
     , (23080, 1, 33554867) /* SETUP_DID */
...
VALUES (23080, 13, True) /* ETHEREAL_BOOL */
     , (23080, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (23080, 14, True) /* GRAVITY_STATUS_BOOL */
     , (23080, 15, True) /* LIGHTS_STATUS_BOOL */
     , (23080, 19, True) /* ATTACKABLE_BOOL */
     , (23080, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23080, 38, 'Surface (47.9N, 1.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23080, 111, 49) /* PORTAL_BITMASK_INT */;
