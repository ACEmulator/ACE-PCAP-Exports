...
VALUES (28063, 262164, 28063, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28063, 1, 'Coral Tunnels') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (28063, 8, 100667499) /* ICON_DID */
     , (28063, 1, 33555926) /* SETUP_DID */
...
VALUES (28063, 13, True) /* ETHEREAL_BOOL */
     , (28063, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (28063, 14, True) /* GRAVITY_STATUS_BOOL */
     , (28063, 15, True) /* LIGHTS_STATUS_BOOL */
     , (28063, 19, True) /* ATTACKABLE_BOOL */
     , (28063, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28063, 38, 'Coral Tunnels') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28063, 86, 40) /* MIN_LEVEL_INT */
