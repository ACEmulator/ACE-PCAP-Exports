...
VALUES (4046, 262164, 4046, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4046, 1, 'Obsidian Plains') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4046, 8, 100667499) /* ICON_DID */
     , (4046, 1, 33555925) /* SETUP_DID */
...
VALUES (4046, 13, True) /* ETHEREAL_BOOL */
     , (4046, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4046, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4046, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4046, 19, True) /* ATTACKABLE_BOOL */
     , (4046, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4046, 38, 'Obsidian Plains (64.0S, 65.3W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4046, 86, 65) /* MIN_LEVEL_INT */
