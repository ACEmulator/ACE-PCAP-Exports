...
VALUES (2069, 262164, 2069, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2069, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2069, 8, 100667499) /* ICON_DID */
     , (2069, 1, 33554867) /* SETUP_DID */
...
VALUES (2069, 13, True) /* ETHEREAL_BOOL */
     , (2069, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2069, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2069, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2069, 19, True) /* ATTACKABLE_BOOL */
     , (2069, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2069, 38, 'Surface (41.5N, 33.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2069, 111, 1) /* PORTAL_BITMASK_INT */;
