...
VALUES (1902, 262164, 1902, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1902, 1, 'Hilltop') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1902, 8, 100667499) /* ICON_DID */
     , (1902, 1, 33554867) /* SETUP_DID */
...
VALUES (1902, 13, True) /* ETHEREAL_BOOL */
     , (1902, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1902, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1902, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1902, 19, True) /* ATTACKABLE_BOOL */
     , (1902, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1902, 38, 'Hilltop (32.8N, 34.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1902, 111, 1) /* PORTAL_BITMASK_INT */;
