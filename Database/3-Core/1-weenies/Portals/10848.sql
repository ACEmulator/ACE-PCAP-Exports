...
VALUES (10848, 262164, 10848, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10848, 1, 'Surface Exit') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10848, 8, 100667499) /* ICON_DID */
     , (10848, 1, 33554867) /* SETUP_DID */
...
VALUES (10848, 13, True) /* ETHEREAL_BOOL */
     , (10848, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (10848, 14, True) /* GRAVITY_STATUS_BOOL */
     , (10848, 15, True) /* LIGHTS_STATUS_BOOL */
     , (10848, 19, True) /* ATTACKABLE_BOOL */
     , (10848, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10848, 38, 'Surface Exit (53.5N, 76.7W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10848, 111, 49) /* PORTAL_BITMASK_INT */;
