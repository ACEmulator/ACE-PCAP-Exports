...
VALUES (7291, 262164, 7291, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7291, 1, 'Halls of Metos') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7291, 8, 100667499) /* ICON_DID */
     , (7291, 1, 33555923) /* SETUP_DID */
...
VALUES (7291, 13, True) /* ETHEREAL_BOOL */
     , (7291, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7291, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7291, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7291, 19, True) /* ATTACKABLE_BOOL */
     , (7291, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7291, 38, 'Halls of Metos') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7291, 86, 15) /* MIN_LEVEL_INT */
