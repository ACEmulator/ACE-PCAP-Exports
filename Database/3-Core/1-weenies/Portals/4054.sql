...
VALUES (4054, 262164, 4054, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4054, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4054, 8, 100667499) /* ICON_DID */
     , (4054, 1, 33554867) /* SETUP_DID */
...
VALUES (4054, 13, True) /* ETHEREAL_BOOL */
     , (4054, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4054, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4054, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4054, 19, True) /* ATTACKABLE_BOOL */
     , (4054, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4054, 38, 'Surface') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4054, 111, 1) /* PORTAL_BITMASK_INT */;
