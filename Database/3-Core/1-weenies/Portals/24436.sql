...
VALUES (24436, 262164, 24436, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24436, 1, 'Matron Hive North') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24436, 8, 100667499) /* ICON_DID */
     , (24436, 1, 33555926) /* SETUP_DID */
...
VALUES (24436, 13, True) /* ETHEREAL_BOOL */
     , (24436, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24436, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24436, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24436, 19, True) /* ATTACKABLE_BOOL */
     , (24436, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24436, 38, 'Matron Hive North') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24436, 86, 60) /* MIN_LEVEL_INT */
