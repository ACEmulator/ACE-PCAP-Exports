...
VALUES (372, 262164, 372, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (372, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (372, 8, 100667499) /* ICON_DID */
     , (372, 1, 33554867) /* SETUP_DID */
...
VALUES (372, 13, True) /* ETHEREAL_BOOL */
     , (372, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (372, 14, True) /* GRAVITY_STATUS_BOOL */
     , (372, 15, True) /* LIGHTS_STATUS_BOOL */
     , (372, 19, True) /* ATTACKABLE_BOOL */
     , (372, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (372, 38, 'Surface (20.5N, 13.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (372, 111, 1) /* PORTAL_BITMASK_INT */;
