...
VALUES (5201, 262164, 5201, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5201, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5201, 8, 100667499) /* ICON_DID */
     , (5201, 1, 33554867) /* SETUP_DID */
...
VALUES (5201, 13, True) /* ETHEREAL_BOOL */
     , (5201, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5201, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5201, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5201, 19, True) /* ATTACKABLE_BOOL */
     , (5201, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5201, 38, 'Surface (21.5S, 4.1W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5201, 111, 1) /* PORTAL_BITMASK_INT */;
