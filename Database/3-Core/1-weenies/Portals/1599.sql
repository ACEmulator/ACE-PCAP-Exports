...
VALUES (1599, 262164, 1599, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1599, 1, 'Hebian-to Sewers') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1599, 8, 100667499) /* ICON_DID */
     , (1599, 1, 33555922) /* SETUP_DID */
...
VALUES (1599, 13, True) /* ETHEREAL_BOOL */
     , (1599, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1599, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1599, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1599, 19, True) /* ATTACKABLE_BOOL */
     , (1599, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1599, 38, 'Hebian-to Sewers') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1599, 86, 4) /* MIN_LEVEL_INT */
