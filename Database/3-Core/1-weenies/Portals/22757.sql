...
VALUES (22757, 262164, 22757, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22757, 1, 'Inner Sanctum') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22757, 8, 100667499) /* ICON_DID */
     , (22757, 1, 33554867) /* SETUP_DID */
...
VALUES (22757, 13, True) /* ETHEREAL_BOOL */
     , (22757, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22757, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22757, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22757, 19, True) /* ATTACKABLE_BOOL */
     , (22757, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22757, 111, 49) /* PORTAL_BITMASK_INT */;
