...
VALUES (1101, 262164, 1101, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1101, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1101, 8, 100667499) /* ICON_DID */
     , (1101, 1, 33554867) /* SETUP_DID */
...
VALUES (1101, 13, True) /* ETHEREAL_BOOL */
     , (1101, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1101, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1101, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1101, 19, True) /* ATTACKABLE_BOOL */
     , (1101, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1101, 38, 'Surface (25.0S, 1.2W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1101, 111, 1) /* PORTAL_BITMASK_INT */;
