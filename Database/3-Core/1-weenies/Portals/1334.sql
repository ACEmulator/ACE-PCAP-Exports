...
VALUES (1334, 262164, 1334, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1334, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1334, 8, 100667499) /* ICON_DID */
     , (1334, 1, 33554867) /* SETUP_DID */
...
VALUES (1334, 13, True) /* ETHEREAL_BOOL */
     , (1334, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1334, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1334, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1334, 19, True) /* ATTACKABLE_BOOL */
     , (1334, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1334, 38, 'Surface (36.2S, 62.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1334, 111, 1) /* PORTAL_BITMASK_INT */;
