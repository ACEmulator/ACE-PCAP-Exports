...
VALUES (3650, 262164, 3650, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (3650, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3650, 8, 100667499) /* ICON_DID */
     , (3650, 1, 33554867) /* SETUP_DID */
...
VALUES (3650, 13, True) /* ETHEREAL_BOOL */
     , (3650, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (3650, 14, True) /* GRAVITY_STATUS_BOOL */
     , (3650, 15, True) /* LIGHTS_STATUS_BOOL */
     , (3650, 19, True) /* ATTACKABLE_BOOL */
     , (3650, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (3650, 38, 'Surface (48.0N, 53.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3650, 111, 1) /* PORTAL_BITMASK_INT */;
