...
VALUES (14884, 262164, 14884, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14884, 1, 'Convergent Median') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14884, 8, 100667499) /* ICON_DID */
     , (14884, 1, 33555926) /* SETUP_DID */
...
VALUES (14884, 13, True) /* ETHEREAL_BOOL */
     , (14884, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14884, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14884, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14884, 19, True) /* ATTACKABLE_BOOL */
     , (14884, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14884, 38, 'Convergent Median') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14884, 86, 40) /* MIN_LEVEL_INT */
