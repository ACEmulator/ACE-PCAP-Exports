...
VALUES (2381, 262164, 2381, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2381, 1, 'Lightless Catacombs') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2381, 8, 100667499) /* ICON_DID */
     , (2381, 1, 33555923) /* SETUP_DID */
...
VALUES (2381, 13, True) /* ETHEREAL_BOOL */
     , (2381, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2381, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2381, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2381, 19, True) /* ATTACKABLE_BOOL */
     , (2381, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2381, 38, 'Lightless Catacombs') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2381, 86, 14) /* MIN_LEVEL_INT */
