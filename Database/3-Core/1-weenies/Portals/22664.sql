...
VALUES (22664, 262164, 22664, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22664, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22664, 8, 100667499) /* ICON_DID */
     , (22664, 1, 33554867) /* SETUP_DID */
...
VALUES (22664, 13, True) /* ETHEREAL_BOOL */
     , (22664, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22664, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22664, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22664, 19, True) /* ATTACKABLE_BOOL */
     , (22664, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22664, 38, 'Surface (2.1N, 98.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22664, 111, 49) /* PORTAL_BITMASK_INT */;
