...
VALUES (3638, 262164, 3638, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (3638, 1, 'Knath Lair') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3638, 8, 100667499) /* ICON_DID */
     , (3638, 1, 33554867) /* SETUP_DID */
...
VALUES (3638, 13, True) /* ETHEREAL_BOOL */
     , (3638, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (3638, 14, True) /* GRAVITY_STATUS_BOOL */
     , (3638, 15, True) /* LIGHTS_STATUS_BOOL */
     , (3638, 19, True) /* ATTACKABLE_BOOL */
     , (3638, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (3638, 38, 'Knath Lair') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3638, 111, 1) /* PORTAL_BITMASK_INT */;
