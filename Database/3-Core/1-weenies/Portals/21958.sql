...
VALUES (21958, 262164, 21958, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (21958, 1, 'Proving Grounds Low') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (21958, 8, 100667499) /* ICON_DID */
     , (21958, 1, 33555923) /* SETUP_DID */
...
VALUES (21958, 13, True) /* ETHEREAL_BOOL */
     , (21958, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (21958, 14, True) /* GRAVITY_STATUS_BOOL */
     , (21958, 15, True) /* LIGHTS_STATUS_BOOL */
     , (21958, 19, True) /* ATTACKABLE_BOOL */
     , (21958, 1, True) /* STUCK_BOOL */;
