...
VALUES (2093, 262164, 2093, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2093, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2093, 8, 100667499) /* ICON_DID */
     , (2093, 1, 33554867) /* SETUP_DID */
...
VALUES (2093, 13, True) /* ETHEREAL_BOOL */
     , (2093, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2093, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2093, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2093, 19, True) /* ATTACKABLE_BOOL */
     , (2093, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2093, 38, 'Surface (17.4N, 62.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2093, 111, 1) /* PORTAL_BITMASK_INT */;
