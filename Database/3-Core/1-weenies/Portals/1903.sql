...
VALUES (1903, 262164, 1903, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1903, 1, 'Desert Ridge Border') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1903, 8, 100667499) /* ICON_DID */
     , (1903, 1, 33554867) /* SETUP_DID */
...
VALUES (1903, 13, True) /* ETHEREAL_BOOL */
     , (1903, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1903, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1903, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1903, 19, True) /* ATTACKABLE_BOOL */
     , (1903, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1903, 38, 'Desert Ridge Border (5.6S, 40.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1903, 111, 1) /* PORTAL_BITMASK_INT */;
