...
VALUES (27692, 262164, 27692, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27692, 1, 'Renegade Stronghold') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27692, 8, 100667499) /* ICON_DID */
     , (27692, 1, 33555926) /* SETUP_DID */
...
VALUES (27692, 13, True) /* ETHEREAL_BOOL */
     , (27692, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (27692, 14, True) /* GRAVITY_STATUS_BOOL */
     , (27692, 15, True) /* LIGHTS_STATUS_BOOL */
     , (27692, 19, True) /* ATTACKABLE_BOOL */
     , (27692, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27692, 38, 'Renegade Stronghold') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27692, 111, 1) /* PORTAL_BITMASK_INT */;
