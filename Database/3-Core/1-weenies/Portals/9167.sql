...
VALUES (9167, 262164, 9167, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9167, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9167, 8, 100667499) /* ICON_DID */
     , (9167, 1, 33554867) /* SETUP_DID */
...
VALUES (9167, 13, True) /* ETHEREAL_BOOL */
     , (9167, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (9167, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9167, 15, True) /* LIGHTS_STATUS_BOOL */
     , (9167, 19, True) /* ATTACKABLE_BOOL */
     , (9167, 1, True) /* STUCK_BOOL */;
