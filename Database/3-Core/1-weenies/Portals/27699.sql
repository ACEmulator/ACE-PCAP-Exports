...
VALUES (27699, 262164, 27699, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27699, 1, 'Exit to Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27699, 8, 100667499) /* ICON_DID */
     , (27699, 1, 33554867) /* SETUP_DID */
...
VALUES (27699, 13, True) /* ETHEREAL_BOOL */
     , (27699, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (27699, 14, True) /* GRAVITY_STATUS_BOOL */
     , (27699, 15, True) /* LIGHTS_STATUS_BOOL */
     , (27699, 19, True) /* ATTACKABLE_BOOL */
     , (27699, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27699, 38, 'Exit to Surface (17.0S, 5.9E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27699, 111, 1) /* PORTAL_BITMASK_INT */;
