...
VALUES (10797, 262164, 10797, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10797, 1, 'Exit') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10797, 8, 100667499) /* ICON_DID */
     , (10797, 1, 33555925) /* SETUP_DID */
...
VALUES (10797, 13, True) /* ETHEREAL_BOOL */
     , (10797, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (10797, 14, True) /* GRAVITY_STATUS_BOOL */
     , (10797, 15, True) /* LIGHTS_STATUS_BOOL */
     , (10797, 19, True) /* ATTACKABLE_BOOL */
     , (10797, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10797, 38, 'Exit (48.0S, 65.0W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10797, 86, 50) /* MIN_LEVEL_INT */
