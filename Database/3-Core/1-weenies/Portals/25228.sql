...
VALUES (25228, 262164, 25228, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (25228, 1, 'Exit To Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (25228, 8, 100667499) /* ICON_DID */
     , (25228, 1, 33554867) /* SETUP_DID */
...
VALUES (25228, 13, True) /* ETHEREAL_BOOL */
     , (25228, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (25228, 14, True) /* GRAVITY_STATUS_BOOL */
     , (25228, 15, True) /* LIGHTS_STATUS_BOOL */
     , (25228, 19, True) /* ATTACKABLE_BOOL */
     , (25228, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (25228, 38, 'Exit To Surface (18.0S, 50.1E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (25228, 111, 17) /* PORTAL_BITMASK_INT */;
