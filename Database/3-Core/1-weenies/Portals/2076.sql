...
VALUES (2076, 262164, 2076, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2076, 1, 'Dungeon Gallery Tower') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2076, 8, 100667499) /* ICON_DID */
     , (2076, 1, 33554867) /* SETUP_DID */
...
VALUES (2076, 13, True) /* ETHEREAL_BOOL */
     , (2076, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (2076, 14, True) /* GRAVITY_STATUS_BOOL */
     , (2076, 15, True) /* LIGHTS_STATUS_BOOL */
     , (2076, 19, True) /* ATTACKABLE_BOOL */
     , (2076, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (2076, 38, 'Dungeon Gallery Tower') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2076, 111, 1) /* PORTAL_BITMASK_INT */;
