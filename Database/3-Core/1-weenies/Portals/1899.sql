...
VALUES (1899, 262164, 1899, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1899, 1, 'Beachside') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1899, 8, 100667499) /* ICON_DID */
     , (1899, 1, 33554867) /* SETUP_DID */
...
VALUES (1899, 13, True) /* ETHEREAL_BOOL */
     , (1899, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1899, 14, True) /* GRAVITY_STATUS_BOOL */
