...
VALUES (14495, 262164, 14495, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14495, 1, 'Upper Empyrean Acid Cistern') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14495, 8, 100667499) /* ICON_DID */
     , (14495, 1, 33555925) /* SETUP_DID */
...
VALUES (14495, 13, True) /* ETHEREAL_BOOL */
     , (14495, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14495, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14495, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14495, 19, True) /* ATTACKABLE_BOOL */
     , (14495, 1, True) /* STUCK_BOOL */;
