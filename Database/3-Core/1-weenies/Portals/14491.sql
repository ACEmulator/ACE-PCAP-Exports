...
VALUES (14491, 262164, 14491, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14491, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14491, 8, 100667499) /* ICON_DID */
     , (14491, 1, 33554867) /* SETUP_DID */
...
VALUES (14491, 13, True) /* ETHEREAL_BOOL */
     , (14491, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14491, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14491, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14491, 19, True) /* ATTACKABLE_BOOL */
     , (14491, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14491, 38, 'Surface (86.6S, 10.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14491, 111, 49) /* PORTAL_BITMASK_INT */;
