...
VALUES (27587, 262164, 27587, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27587, 1, 'Crumbling Empyrean Mansion') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27587, 8, 100667499) /* ICON_DID */
     , (27587, 1, 33555923) /* SETUP_DID */
...
VALUES (27587, 13, True) /* ETHEREAL_BOOL */
     , (27587, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (27587, 14, True) /* GRAVITY_STATUS_BOOL */
     , (27587, 15, True) /* LIGHTS_STATUS_BOOL */
     , (27587, 19, True) /* ATTACKABLE_BOOL */
     , (27587, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27587, 38, 'Crumbling Empyrean Mansion') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27587, 111, 49) /* PORTAL_BITMASK_INT */;
