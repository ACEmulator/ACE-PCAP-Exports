...
VALUES (28062, 262164, 28062, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28062, 1, 'Eastern Aerlinthe Island') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (28062, 8, 100667499) /* ICON_DID */
     , (28062, 1, 33554867) /* SETUP_DID */
...
VALUES (28062, 13, True) /* ETHEREAL_BOOL */
     , (28062, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (28062, 14, True) /* GRAVITY_STATUS_BOOL */
     , (28062, 15, True) /* LIGHTS_STATUS_BOOL */
     , (28062, 19, True) /* ATTACKABLE_BOOL */
     , (28062, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (28062, 38, 'Eastern Aerlinthe Island') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28062, 111, 49) /* PORTAL_BITMASK_INT */;
