...
VALUES (24334, 262164, 24334, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24334, 1, 'Upper Corridor') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24334, 8, 100667499) /* ICON_DID */
     , (24334, 1, 33554867) /* SETUP_DID */
...
VALUES (24334, 13, True) /* ETHEREAL_BOOL */
     , (24334, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24334, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24334, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24334, 19, True) /* ATTACKABLE_BOOL */
     , (24334, 1, True) /* STUCK_BOOL */;
