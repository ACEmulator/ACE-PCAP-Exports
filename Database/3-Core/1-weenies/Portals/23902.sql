...
VALUES (23902, 262164, 23902, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23902, 1, 'Surface') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23902, 8, 100667499) /* ICON_DID */
     , (23902, 1, 33554867) /* SETUP_DID */
...
VALUES (23902, 13, True) /* ETHEREAL_BOOL */
     , (23902, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (23902, 14, True) /* GRAVITY_STATUS_BOOL */
     , (23902, 15, True) /* LIGHTS_STATUS_BOOL */
     , (23902, 19, True) /* ATTACKABLE_BOOL */
     , (23902, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23902, 38, 'Surface (5.0S, 68.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23902, 111, 1) /* PORTAL_BITMASK_INT */;
