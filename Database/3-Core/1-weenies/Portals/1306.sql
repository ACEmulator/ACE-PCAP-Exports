...
VALUES (1306, 262164, 1306, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1306, 1, 'Bandit Castle Prison') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1306, 8, 100667499) /* ICON_DID */
     , (1306, 1, 33554867) /* SETUP_DID */
...
VALUES (1306, 13, True) /* ETHEREAL_BOOL */
     , (1306, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1306, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1306, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1306, 19, True) /* ATTACKABLE_BOOL */
     , (1306, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1306, 38, 'Bandit Castle Prison') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1306, 111, 1) /* PORTAL_BITMASK_INT */;
