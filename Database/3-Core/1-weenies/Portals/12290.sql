...
VALUES (12290, 262164, 12290, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12290, 1, 'Singular Chorizite Repository') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12290, 8, 100667499) /* ICON_DID */
     , (12290, 1, 33555923) /* SETUP_DID */
...
VALUES (12290, 13, True) /* ETHEREAL_BOOL */
     , (12290, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12290, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (12290, 86, 35) /* MIN_LEVEL_INT */
