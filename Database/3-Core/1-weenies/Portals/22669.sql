...
VALUES (22669, 262164, 22669, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22669, 1, 'Tusker Encampments') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22669, 8, 100667499) /* ICON_DID */
     , (22669, 1, 33555926) /* SETUP_DID */
...
VALUES (22669, 13, True) /* ETHEREAL_BOOL */
     , (22669, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22669, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22669, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22669, 19, True) /* ATTACKABLE_BOOL */
     , (22669, 1, True) /* STUCK_BOOL */;
