...
VALUES (2619, 16, 'A heavy iron chest. There are strange runes carved around the lid.') /* LONG_DESC_STRING */
     , (2619, 14, 'Use this item to open it and see its contents.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2619, 19, 2500) /* VALUE_INT */
     , (2619, 5, 15732) /* ENCUMB_VAL_INT */
     , (2619, 38, 100) /* RESIST_LOCKPICK_INT */
     , (2619, 173, 5) /* APPRAISAL_LOCKPICK_SUCCESS_PERCENT_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (2619, 2, 0) /* OPEN_BOOL */
     , (2619, 3, 1) /* LOCKED_BOOL */;
