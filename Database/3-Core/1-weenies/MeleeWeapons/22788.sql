...
VALUES (22788, 18, 22788, 2327064, NULL, NULL, 170017);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22788, 1, 'Bandit Simi') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22788, 8, 100668996) /* ICON_DID */
     , (22788, 1, 33554751) /* SETUP_DID */
...
VALUES (22788, 53, 1) /* PLACEMENT_POSITION_INT */
     ...
     , (22788, 52, 1) /* PARENT_LOCATION_INT */
     , (22788, 93, 1044) /* PHYSICS_STATE_INT */
     , (22788, 9007, 6) /* MeleeWeapon_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (22788, 13, True) /* ETHEREAL_BOOL */
     , (22788, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (22788, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22788, 19, True) /* ATTACKABLE_BOOL */
     , (22788, 22, True) /* INSCRIBABLE_BOOL */;
