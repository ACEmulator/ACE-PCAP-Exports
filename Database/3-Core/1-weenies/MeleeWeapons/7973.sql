...
VALUES (7973, 18, 7973, 2327192, NULL, NULL, 170017);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7973, 1, 'Flaming Tachi') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7973, 8, 100668916) /* ICON_DID */
     , (7973, 1, 33555732) /* SETUP_DID */
...
VALUES (7973, 53, 1) /* PLACEMENT_POSITION_INT */
     ...
     , (7973, 9, 1048576) /* LOCATIONS_INT */
     , (7973, 19, 1150) /* VALUE_INT */
     , (7973, 52, 1) /* PARENT_LOCATION_INT */
     , (7973, 93, 1044) /* PHYSICS_STATE_INT */
     , (7973, 9007, 6) /* MeleeWeapon_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (7973, 13, True) /* ETHEREAL_BOOL */
     , (7973, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (7973, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7973, 19, True) /* ATTACKABLE_BOOL */
     , (7973, 22, True) /* INSCRIBABLE_BOOL */;
