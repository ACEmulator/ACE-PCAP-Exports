...
VALUES (47495, 53, 1) /* PLACEMENT_POSITION_INT */
...
VALUES (47495, 14, 'Use on a magic item to destroy that item and drain its Mana.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (47495, 19, 7500) /* VALUE_INT */
     , (47495, 5, 50) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (47495, 137, 0.25) /* MANA_STONE_DESTROY_CHANCE_FLOAT */
     , (47495, 87, 3) /* ITEM_EFFICIENCY_FLOAT */;
