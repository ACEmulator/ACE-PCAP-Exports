...
VALUES (22779, 18, 22779, 2327064, NULL, NULL, 170017);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22779, 1, 'Jambiya') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22779, 8, 100668886) /* ICON_DID */
     , (22779, 1, 33554887) /* SETUP_DID */
...
VALUES (22779, 53, 1) /* PLACEMENT_POSITION_INT */
     ...
     , (22779, 52, 1) /* PARENT_LOCATION_INT */
     , (22779, 93, 1044) /* PHYSICS_STATE_INT */
     , (22779, 9007, 6) /* MeleeWeapon_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (22779, 13, True) /* ETHEREAL_BOOL */
     , (22779, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (22779, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22779, 19, True) /* ATTACKABLE_BOOL */
     , (22779, 22, True) /* INSCRIBABLE_BOOL */;
