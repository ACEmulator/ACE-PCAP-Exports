...
VALUES (22778, 14, 'Use on a magic item to destroy that item and drain its Mana.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22778, 19, 500) /* VALUE_INT */
     , (22778, 5, 50) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (22778, 137, 0.05) /* MANA_STONE_DESTROY_CHANCE_FLOAT */
     , (22778, 87, 0.25) /* ITEM_EFFICIENCY_FLOAT */;
