...
VALUES (6147, 18, 6147, 270762648, NULL, NULL, 170017);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6147, 1, 'Peerless Smoldering Atlan Axe') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (6147, 8, 100670515) /* ICON_DID */
     , (6147, 1, 33556353) /* SETUP_DID */
...
VALUES (6147, 53, 1) /* PLACEMENT_POSITION_INT */
     ...
     , (6147, 9, 1048576) /* LOCATIONS_INT */
     , (6147, 19, 5000) /* VALUE_INT */
     , (6147, 52, 1) /* PARENT_LOCATION_INT */
     , (6147, 93, 1044) /* PHYSICS_STATE_INT */
     , (6147, 9007, 6) /* MeleeWeapon_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (6147, 13, True) /* ETHEREAL_BOOL */
     , (6147, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (6147, 14, True) /* GRAVITY_STATUS_BOOL */
     , (6147, 19, True) /* ATTACKABLE_BOOL */
