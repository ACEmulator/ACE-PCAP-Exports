...
VALUES (34197, 65, 101) /* PLACEMENT_INT */
...
VALUES (34197, 16, 'A bright sparkler meant to help commemorate Festival season and the anniversary of Asheron''s Call.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (34197, 19, 10) /* VALUE_INT */
     , (34197, 5, 5) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (34197, 144, 0) /* MANA_CONVERSION_MOD_FLOAT */
     , (34197, 29, 1) /* WEAPON_DEFENSE_FLOAT */;
