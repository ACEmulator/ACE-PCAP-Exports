/* Weenie - PortalsPortal - Surface Portal (7611) */
...
VALUES (7611, 262164, 7611, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7611, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7611, 8, 100667499) /* ICON_DID */
     , (7611, 1, 33554867) /* SETUP_DID */
...
VALUES (7611, 13, True) /* ETHEREAL_BOOL */
     , (7611, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7611, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7611, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7611, 19, True) /* ATTACKABLE_BOOL */
     , (7611, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7611, 38, 'Surface Portal (64.5S, 55.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7611, 111, 1) /* PORTAL_BITMASK_INT */;
