/* Weenie - PortalsPortal - Surface Portal (7609) */
...
VALUES (7609, 262164, 7609, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7609, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7609, 8, 100667499) /* ICON_DID */
     , (7609, 1, 33554867) /* SETUP_DID */
...
VALUES (7609, 13, True) /* ETHEREAL_BOOL */
     , (7609, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7609, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7609, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7609, 19, True) /* ATTACKABLE_BOOL */
     , (7609, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7609, 38, 'Surface Portal (73.8S, 39.1E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7609, 111, 1) /* PORTAL_BITMASK_INT */;
