/* Weenie - PortalsPortal - Surface Portal (1128) */
...
VALUES (1128, 262164, 1128, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1128, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1128, 8, 100667499) /* ICON_DID */
     , (1128, 1, 33554867) /* SETUP_DID */
...
VALUES (1128, 13, True) /* ETHEREAL_BOOL */
     , (1128, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1128, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1128, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1128, 19, True) /* ATTACKABLE_BOOL */
     , (1128, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1128, 38, 'Surface Portal (12.3S, 48.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1128, 111, 1) /* PORTAL_BITMASK_INT */;
