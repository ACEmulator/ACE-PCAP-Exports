/* Weenie - PortalsPortal - Surface Portal (4964) */
...
VALUES (4964, 262164, 4964, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4964, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4964, 8, 100667499) /* ICON_DID */
     , (4964, 1, 33554867) /* SETUP_DID */
...
VALUES (4964, 13, True) /* ETHEREAL_BOOL */
     , (4964, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4964, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4964, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4964, 19, True) /* ATTACKABLE_BOOL */
     , (4964, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4964, 38, 'Surface Portal (2.2N, 48.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4964, 111, 1) /* PORTAL_BITMASK_INT */;
