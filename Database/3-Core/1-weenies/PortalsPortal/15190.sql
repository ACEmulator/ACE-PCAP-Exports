/* Weenie - PortalsPortal - Sliver-of-BlueCottages Portal (15190) */
...
VALUES (15190, 262164, 15190, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15190, 1, 'Sliver-of-BlueCottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15190, 8, 100667499) /* ICON_DID */
     , (15190, 1, 33554867) /* SETUP_DID */
...
VALUES (15190, 13, True) /* ETHEREAL_BOOL */
     , (15190, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15190, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15190, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15190, 19, True) /* ATTACKABLE_BOOL */
     , (15190, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15190, 38, 'Sliver-of-BlueCottages Portal (34.7N, 49.0W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15190, 111, 1) /* PORTAL_BITMASK_INT */;
