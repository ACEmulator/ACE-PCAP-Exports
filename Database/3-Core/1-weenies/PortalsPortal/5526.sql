/* Weenie - PortalsPortal - Mount Lethe Magma Tubes Portal (5526) */
...
VALUES (5526, 262164, 5526, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5526, 1, 'Mount Lethe Magma Tubes Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5526, 8, 100667499) /* ICON_DID */
     , (5526, 1, 33555923) /* SETUP_DID */
...
VALUES (5526, 13, True) /* ETHEREAL_BOOL */
     , (5526, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5526, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5526, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5526, 19, True) /* ATTACKABLE_BOOL */
     , (5526, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5526, 38, 'Mount Lethe Magma Tubes Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5526, 86, 20) /* MIN_LEVEL_INT */
