/* Weenie - PortalsPortal - Desert Northern Edge Portal (8615) */
...
VALUES (8615, 262164, 8615, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8615, 1, 'Desert Northern Edge Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8615, 8, 100667499) /* ICON_DID */
     , (8615, 1, 33554867) /* SETUP_DID */
...
VALUES (8615, 13, True) /* ETHEREAL_BOOL */
     , (8615, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8615, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8615, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8615, 19, True) /* ATTACKABLE_BOOL */
     , (8615, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8615, 38, 'Desert Northern Edge Portal (17.6N, 19.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8615, 111, 1) /* PORTAL_BITMASK_INT */;
