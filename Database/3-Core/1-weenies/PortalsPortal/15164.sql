/* Weenie - PortalsPortal - Mirthless Dale Portal (15164) */
...
VALUES (15164, 262164, 15164, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15164, 1, 'Mirthless Dale Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15164, 8, 100667499) /* ICON_DID */
     , (15164, 1, 33554867) /* SETUP_DID */
...
VALUES (15164, 13, True) /* ETHEREAL_BOOL */
     , (15164, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15164, 14, True) /* GRAVITY_STATUS_BOOL */
