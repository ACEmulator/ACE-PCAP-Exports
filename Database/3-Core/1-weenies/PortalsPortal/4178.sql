/* Weenie - PortalsPortal - Surface Portal (4178) */
...
VALUES (4178, 262164, 4178, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4178, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4178, 8, 100667499) /* ICON_DID */
     , (4178, 1, 33554867) /* SETUP_DID */
...
VALUES (4178, 13, True) /* ETHEREAL_BOOL */
     , (4178, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4178, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4178, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4178, 19, True) /* ATTACKABLE_BOOL */
     , (4178, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4178, 38, 'Surface Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4178, 111, 1) /* PORTAL_BITMASK_INT */;
