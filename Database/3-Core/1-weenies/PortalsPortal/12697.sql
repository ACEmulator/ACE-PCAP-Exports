/* Weenie - PortalsPortal - Surface Portal (12697) */
...
VALUES (12697, 262164, 12697, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12697, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12697, 8, 100667499) /* ICON_DID */
     , (12697, 1, 33554867) /* SETUP_DID */
...
VALUES (12697, 13, True) /* ETHEREAL_BOOL */
     , (12697, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12697, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12697, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12697, 19, True) /* ATTACKABLE_BOOL */
     , (12697, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12697, 38, 'Surface Portal (2.2S, 50.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12697, 111, 1) /* PORTAL_BITMASK_INT */;
