/* Weenie - PortalsPortal - Mage's Pass Portal (14271) */
...
VALUES (14271, 262164, 14271, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14271, 1, 'Mage''s Pass Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14271, 8, 100667499) /* ICON_DID */
     , (14271, 1, 33554867) /* SETUP_DID */
...
VALUES (14271, 13, True) /* ETHEREAL_BOOL */
     , (14271, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14271, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14271, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14271, 19, True) /* ATTACKABLE_BOOL */
     , (14271, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14271, 38, 'Mage''s Pass Portal (52.8S, 52.9E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14271, 111, 1) /* PORTAL_BITMASK_INT */;
