/* Weenie - PortalsPortal - Cragstone Portal (1015) */
...
VALUES (1015, 262164, 1015, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1015, 1, 'Cragstone Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1015, 8, 100667499) /* ICON_DID */
     , (1015, 1, 33554867) /* SETUP_DID */
...
VALUES (1015, 13, True) /* ETHEREAL_BOOL */
     , (1015, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1015, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1015, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1015, 19, True) /* ATTACKABLE_BOOL */
     , (1015, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1015, 38, 'Cragstone Portal (26.0N, 48.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1015, 111, 1) /* PORTAL_BITMASK_INT */;
