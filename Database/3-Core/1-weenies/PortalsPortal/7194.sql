/* Weenie - PortalsPortal - Ayan Baqur Portal (7194) */
...
VALUES (7194, 262164, 7194, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7194, 1, 'Ayan Baqur Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7194, 8, 100667499) /* ICON_DID */
     , (7194, 1, 33554867) /* SETUP_DID */
...
VALUES (7194, 13, True) /* ETHEREAL_BOOL */
     , (7194, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7194, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7194, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7194, 19, True) /* ATTACKABLE_BOOL */
     , (7194, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7194, 38, 'Ayan Baqur Portal (60.5S, 88.0W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7194, 111, 1) /* PORTAL_BITMASK_INT */;
