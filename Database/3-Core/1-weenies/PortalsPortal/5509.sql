/* Weenie - PortalsPortal - Winthura's Garden Portal (5509) */
...
VALUES (5509, 262164, 5509, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5509, 1, 'Winthura''s Garden Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5509, 8, 100667499) /* ICON_DID */
     , (5509, 1, 33555922) /* SETUP_DID */
...
VALUES (5509, 13, True) /* ETHEREAL_BOOL */
     , (5509, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5509, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5509, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5509, 19, True) /* ATTACKABLE_BOOL */
     , (5509, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5509, 38, 'Winthura''s Garden Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5509, 86, 8) /* MIN_LEVEL_INT */
