/* Weenie - PortalsPortal - Surface Portal (4165) */
...
VALUES (4165, 262164, 4165, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4165, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4165, 8, 100667499) /* ICON_DID */
     , (4165, 1, 33554867) /* SETUP_DID */
...
VALUES (4165, 13, True) /* ETHEREAL_BOOL */
     , (4165, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4165, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4165, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4165, 19, True) /* ATTACKABLE_BOOL */
     , (4165, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4165, 38, 'Surface Portal (4.7S, 26.5E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4165, 111, 1) /* PORTAL_BITMASK_INT */;
