/* Weenie - PortalsPortal - Surface Portal (9297) */
...
VALUES (9297, 262164, 9297, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9297, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9297, 8, 100667499) /* ICON_DID */
     , (9297, 1, 33554867) /* SETUP_DID */
...
VALUES (9297, 13, True) /* ETHEREAL_BOOL */
     , (9297, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (9297, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9297, 15, True) /* LIGHTS_STATUS_BOOL */
     , (9297, 19, True) /* ATTACKABLE_BOOL */
     , (9297, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9297, 38, 'Surface Portal (59.1S, 84.1W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9297, 111, 1) /* PORTAL_BITMASK_INT */;
