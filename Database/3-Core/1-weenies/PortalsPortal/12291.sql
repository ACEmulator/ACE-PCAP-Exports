/* Weenie - PortalsPortal - Surface Portal (12291) */
...
VALUES (12291, 262164, 12291, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12291, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12291, 8, 100667499) /* ICON_DID */
     , (12291, 1, 33554867) /* SETUP_DID */
...
VALUES (12291, 13, True) /* ETHEREAL_BOOL */
     , (12291, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12291, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12291, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12291, 19, True) /* ATTACKABLE_BOOL */
     , (12291, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12291, 38, 'Surface Portal (77.3S, 51.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12291, 111, 1) /* PORTAL_BITMASK_INT */;
