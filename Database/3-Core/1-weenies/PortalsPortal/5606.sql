/* Weenie - PortalsPortal - Folthid Cellar Portal (5606) */
...
VALUES (5606, 262164, 5606, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5606, 1, 'Folthid Cellar Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5606, 8, 100667499) /* ICON_DID */
     , (5606, 1, 33555923) /* SETUP_DID */
...
VALUES (5606, 13, True) /* ETHEREAL_BOOL */
     , (5606, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5606, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5606, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5606, 19, True) /* ATTACKABLE_BOOL */
     , (5606, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5606, 38, 'Folthid Cellar Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5606, 86, 10) /* MIN_LEVEL_INT */
