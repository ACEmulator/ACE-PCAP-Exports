/* Weenie - PortalsPortal - Surface Portal (8848) */
...
VALUES (8848, 262164, 8848, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8848, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8848, 8, 100667499) /* ICON_DID */
     , (8848, 1, 33554867) /* SETUP_DID */
...
VALUES (8848, 13, True) /* ETHEREAL_BOOL */
     , (8848, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8848, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8848, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8848, 19, True) /* ATTACKABLE_BOOL */
     , (8848, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8848, 38, 'Surface Portal (73.6N, 0.2W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8848, 111, 17) /* PORTAL_BITMASK_INT */;
