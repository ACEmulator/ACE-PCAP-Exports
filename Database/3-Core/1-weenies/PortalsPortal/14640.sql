/* Weenie - PortalsPortal - Laiti's Villa Portal (14640) */
...
VALUES (14640, 262164, 14640, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14640, 1, 'Laiti''s Villa Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14640, 8, 100667499) /* ICON_DID */
     , (14640, 1, 33554867) /* SETUP_DID */
...
VALUES (14640, 13, True) /* ETHEREAL_BOOL */
     , (14640, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14640, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14640, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14640, 19, True) /* ATTACKABLE_BOOL */
     , (14640, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14640, 38, 'Laiti''s Villa Portal (67.5N, 16.8W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14640, 111, 1) /* PORTAL_BITMASK_INT */;
