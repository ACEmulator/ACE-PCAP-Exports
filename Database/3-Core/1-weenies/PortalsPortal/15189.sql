/* Weenie - PortalsPortal - Shore Vista Cottages Portal (15189) */
...
VALUES (15189, 262164, 15189, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15189, 1, 'Shore Vista Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15189, 8, 100667499) /* ICON_DID */
     , (15189, 1, 33554867) /* SETUP_DID */
...
VALUES (15189, 13, True) /* ETHEREAL_BOOL */
     , (15189, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15189, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15189, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15189, 19, True) /* ATTACKABLE_BOOL */
     , (15189, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15189, 38, 'Shore Vista Cottages Portal (12.0N, 15.9W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15189, 111, 1) /* PORTAL_BITMASK_INT */;
