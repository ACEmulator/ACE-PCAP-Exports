/* Weenie - PortalsPortal - Morntide Ascent Cottages Portal (19153) */
...
VALUES (19153, 262164, 19153, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19153, 1, 'Morntide Ascent Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19153, 8, 100667499) /* ICON_DID */
     , (19153, 1, 33554867) /* SETUP_DID */
...
VALUES (19153, 13, True) /* ETHEREAL_BOOL */
     , (19153, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19153, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19153, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19153, 19, True) /* ATTACKABLE_BOOL */
     , (19153, 1, True) /* STUCK_BOOL */;
