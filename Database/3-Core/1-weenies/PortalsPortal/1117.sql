/* Weenie - PortalsPortal - Dungeon of Shadows Portal (1117) */
...
VALUES (1117, 262164, 1117, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1117, 1, 'Dungeon of Shadows Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1117, 8, 100667499) /* ICON_DID */
     , (1117, 1, 33554867) /* SETUP_DID */
...
VALUES (1117, 13, True) /* ETHEREAL_BOOL */
     , (1117, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1117, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (1117, 111, 1) /* PORTAL_BITMASK_INT */;
