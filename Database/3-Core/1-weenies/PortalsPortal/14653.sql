/* Weenie - PortalsPortal - Northreach Portal (14653) */
...
VALUES (14653, 262164, 14653, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14653, 1, 'Northreach Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14653, 8, 100667499) /* ICON_DID */
     , (14653, 1, 33554867) /* SETUP_DID */
...
VALUES (14653, 13, True) /* ETHEREAL_BOOL */
     , (14653, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14653, 14, True) /* GRAVITY_STATUS_BOOL */
