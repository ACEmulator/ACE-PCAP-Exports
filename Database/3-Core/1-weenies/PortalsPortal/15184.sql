/* Weenie - PortalsPortal - Regina Cottages Portal (15184) */
...
VALUES (15184, 262164, 15184, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15184, 1, 'Regina Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15184, 8, 100667499) /* ICON_DID */
     , (15184, 1, 33554867) /* SETUP_DID */
...
VALUES (15184, 13, True) /* ETHEREAL_BOOL */
     , (15184, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15184, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15184, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15184, 19, True) /* ATTACKABLE_BOOL */
     , (15184, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15184, 38, 'Regina Cottages Portal (54.4N, 19.9W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15184, 111, 1) /* PORTAL_BITMASK_INT */;
