/* Weenie - PortalsPortal - Tia-Leh Homestead Portal (15198) */
...
VALUES (15198, 262164, 15198, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15198, 1, 'Tia-Leh Homestead Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15198, 8, 100667499) /* ICON_DID */
     , (15198, 1, 33554867) /* SETUP_DID */
...
VALUES (15198, 13, True) /* ETHEREAL_BOOL */
     , (15198, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15198, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15198, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15198, 19, True) /* ATTACKABLE_BOOL */
     , (15198, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15198, 38, 'Tia-Leh Homestead Portal (27.9N, 28.8W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15198, 111, 1) /* PORTAL_BITMASK_INT */;
