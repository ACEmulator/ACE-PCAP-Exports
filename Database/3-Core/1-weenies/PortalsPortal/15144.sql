/* Weenie - PortalsPortal - Avatania Cottages Portal (15144) */
...
VALUES (15144, 262164, 15144, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15144, 1, 'Avatania Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15144, 8, 100667499) /* ICON_DID */
     , (15144, 1, 33554867) /* SETUP_DID */
...
VALUES (15144, 13, True) /* ETHEREAL_BOOL */
     , (15144, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15144, 14, True) /* GRAVITY_STATUS_BOOL */
