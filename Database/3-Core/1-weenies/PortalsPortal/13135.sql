/* Weenie - PortalsPortal - Stone Triad Dell Portal (13135) */
...
VALUES (13135, 262164, 13135, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13135, 1, 'Stone Triad Dell Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (13135, 8, 100667499) /* ICON_DID */
     , (13135, 1, 33554867) /* SETUP_DID */
...
VALUES (13135, 13, True) /* ETHEREAL_BOOL */
     , (13135, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (13135, 14, True) /* GRAVITY_STATUS_BOOL */
     , (13135, 15, True) /* LIGHTS_STATUS_BOOL */
     , (13135, 19, True) /* ATTACKABLE_BOOL */
     , (13135, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13135, 38, 'Stone Triad Dell Portal (78.3N, 1.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (13135, 111, 1) /* PORTAL_BITMASK_INT */;
