/* Weenie - PortalsPortal - Shaky Ledge Cottages Portal (19159) */
...
VALUES (19159, 262164, 19159, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19159, 1, 'Shaky Ledge Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19159, 8, 100667499) /* ICON_DID */
     , (19159, 1, 33554867) /* SETUP_DID */
...
VALUES (19159, 13, True) /* ETHEREAL_BOOL */
     , (19159, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19159, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19159, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19159, 19, True) /* ATTACKABLE_BOOL */
     , (19159, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19159, 38, 'Shaky Ledge Cottages Portal (62.5N, 8.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (19159, 111, 1) /* PORTAL_BITMASK_INT */;
