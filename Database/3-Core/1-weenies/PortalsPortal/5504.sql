/* Weenie - PortalsPortal - Surface Portal (5504) */
...
VALUES (5504, 262164, 5504, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5504, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5504, 8, 100667499) /* ICON_DID */
     , (5504, 1, 33554867) /* SETUP_DID */
...
VALUES (5504, 13, True) /* ETHEREAL_BOOL */
     , (5504, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5504, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5504, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5504, 19, True) /* ATTACKABLE_BOOL */
     , (5504, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5504, 38, 'Surface Portal (31.9S, 96.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5504, 111, 1) /* PORTAL_BITMASK_INT */;
