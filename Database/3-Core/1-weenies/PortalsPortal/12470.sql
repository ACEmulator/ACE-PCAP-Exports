/* Weenie - PortalsPortal - Al-Kasan Settlement Portal (12470) */
...
VALUES (12470, 262164, 12470, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12470, 1, 'Al-Kasan Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12470, 8, 100667499) /* ICON_DID */
     , (12470, 1, 33554867) /* SETUP_DID */
...
VALUES (12470, 13, True) /* ETHEREAL_BOOL */
     , (12470, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12470, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12470, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12470, 19, True) /* ATTACKABLE_BOOL */
     , (12470, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12470, 38, 'Al-Kasan Settlement Portal (33.2S, 9.8E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12470, 111, 1) /* PORTAL_BITMASK_INT */;
