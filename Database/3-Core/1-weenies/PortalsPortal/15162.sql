/* Weenie - PortalsPortal - Inquisitor's Dale Cottages Portal (15162) */
...
VALUES (15162, 262164, 15162, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15162, 1, 'Inquisitor''s Dale Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15162, 8, 100667499) /* ICON_DID */
     , (15162, 1, 33554867) /* SETUP_DID */
...
VALUES (15162, 13, True) /* ETHEREAL_BOOL */
     , (15162, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15162, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15162, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15162, 19, True) /* ATTACKABLE_BOOL */
     , (15162, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15162, 38, 'Inquisitor''s Dale Cottages Portal (26.4N, 33.6W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15162, 111, 1) /* PORTAL_BITMASK_INT */;
