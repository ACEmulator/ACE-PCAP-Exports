/* Weenie - PortalsPortal - Ayn Tayan Portal (12475) */
...
VALUES (12475, 262164, 12475, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12475, 1, 'Ayn Tayan Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12475, 8, 100667499) /* ICON_DID */
     , (12475, 1, 33554867) /* SETUP_DID */
...
VALUES (12475, 13, True) /* ETHEREAL_BOOL */
     , (12475, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12475, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12475, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12475, 19, True) /* ATTACKABLE_BOOL */
     , (12475, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12475, 38, 'Ayn Tayan Portal (39.0S, 55.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12475, 111, 1) /* PORTAL_BITMASK_INT */;
