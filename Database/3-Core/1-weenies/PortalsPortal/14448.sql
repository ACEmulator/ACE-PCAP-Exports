/* Weenie - PortalsPortal - Surface Portal (14448) */
...
VALUES (14448, 262164, 14448, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14448, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14448, 8, 100667499) /* ICON_DID */
     , (14448, 1, 33554867) /* SETUP_DID */
...
VALUES (14448, 13, True) /* ETHEREAL_BOOL */
     , (14448, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14448, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14448, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14448, 19, True) /* ATTACKABLE_BOOL */
     , (14448, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14448, 38, 'Surface Portal (24.9N, 37.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14448, 111, 49) /* PORTAL_BITMASK_INT */;
