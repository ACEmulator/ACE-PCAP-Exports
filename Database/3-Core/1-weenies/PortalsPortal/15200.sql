/* Weenie - PortalsPortal - Village Quan Portal (15200) */
...
VALUES (15200, 262164, 15200, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15200, 1, 'Village Quan Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15200, 8, 100667499) /* ICON_DID */
     , (15200, 1, 33554867) /* SETUP_DID */
...
VALUES (15200, 13, True) /* ETHEREAL_BOOL */
     , (15200, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15200, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15200, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15200, 19, True) /* ATTACKABLE_BOOL */
     , (15200, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15200, 38, 'Village Quan Portal (18.2S, 63.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15200, 111, 1) /* PORTAL_BITMASK_INT */;
