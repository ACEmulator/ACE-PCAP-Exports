/* Weenie - PortalsPortal - Janaa Ridge Settlement Portal (12507) */
...
VALUES (12507, 262164, 12507, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12507, 1, 'Janaa Ridge Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12507, 8, 100667499) /* ICON_DID */
     , (12507, 1, 33554867) /* SETUP_DID */
...
VALUES (12507, 13, True) /* ETHEREAL_BOOL */
     , (12507, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12507, 14, True) /* GRAVITY_STATUS_BOOL */
