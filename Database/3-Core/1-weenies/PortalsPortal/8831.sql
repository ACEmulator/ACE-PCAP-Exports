/* Weenie - PortalsPortal - Upper Chakron Flux Portal (8831) */
...
VALUES (8831, 262164, 8831, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8831, 1, 'Upper Chakron Flux Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8831, 8, 100667499) /* ICON_DID */
     , (8831, 1, 33555926) /* SETUP_DID */
...
VALUES (8831, 13, True) /* ETHEREAL_BOOL */
     , (8831, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8831, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8831, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8831, 19, True) /* ATTACKABLE_BOOL */
     , (8831, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8831, 38, 'Upper Chakron Flux Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8831, 86, 41) /* MIN_LEVEL_INT */
