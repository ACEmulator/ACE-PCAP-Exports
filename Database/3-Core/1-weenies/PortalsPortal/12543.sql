/* Weenie - PortalsPortal - Sennon Valley Retreat Portal (12543) */
...
VALUES (12543, 262164, 12543, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12543, 1, 'Sennon Valley Retreat Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12543, 8, 100667499) /* ICON_DID */
     , (12543, 1, 33554867) /* SETUP_DID */
...
VALUES (12543, 13, True) /* ETHEREAL_BOOL */
     , (12543, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12543, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12543, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12543, 19, True) /* ATTACKABLE_BOOL */
     , (12543, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12543, 38, 'Sennon Valley Retreat Portal (52.0N, 64.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12543, 111, 1) /* PORTAL_BITMASK_INT */;
