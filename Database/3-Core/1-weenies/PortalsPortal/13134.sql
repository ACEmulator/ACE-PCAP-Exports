/* Weenie - PortalsPortal - Stoneport Villas Portal (13134) */
...
VALUES (13134, 262164, 13134, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13134, 1, 'Stoneport Villas Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (13134, 8, 100667499) /* ICON_DID */
     , (13134, 1, 33554867) /* SETUP_DID */
...
VALUES (13134, 13, True) /* ETHEREAL_BOOL */
     , (13134, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (13134, 14, True) /* GRAVITY_STATUS_BOOL */
     , (13134, 15, True) /* LIGHTS_STATUS_BOOL */
     , (13134, 19, True) /* ATTACKABLE_BOOL */
     , (13134, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13134, 38, 'Stoneport Villas Portal (25.7S, 79.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (13134, 111, 1) /* PORTAL_BITMASK_INT */;
