/* Weenie - PortalsPortal - Howling Wolf Villas Portal (15160) */
...
VALUES (15160, 262164, 15160, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15160, 1, 'Howling Wolf Villas Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15160, 8, 100667499) /* ICON_DID */
     , (15160, 1, 33554867) /* SETUP_DID */
...
VALUES (15160, 13, True) /* ETHEREAL_BOOL */
     , (15160, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15160, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15160, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15160, 19, True) /* ATTACKABLE_BOOL */
     , (15160, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15160, 38, 'Howling Wolf Villas Portal (28.6N, 17.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15160, 111, 1) /* PORTAL_BITMASK_INT */;
