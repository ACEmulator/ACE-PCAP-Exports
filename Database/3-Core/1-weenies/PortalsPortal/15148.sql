/* Weenie - PortalsPortal - Caerlin Cottages Portal (15148) */
...
VALUES (15148, 262164, 15148, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15148, 1, 'Caerlin Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15148, 8, 100667499) /* ICON_DID */
     , (15148, 1, 33554867) /* SETUP_DID */
...
VALUES (15148, 13, True) /* ETHEREAL_BOOL */
     , (15148, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15148, 14, True) /* GRAVITY_STATUS_BOOL */
