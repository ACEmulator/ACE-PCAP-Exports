/* Weenie - PortalsPortal - Portal (24088) */
...
VALUES (24088, 262164, 24088, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24088, 1, 'Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24088, 8, 100667499) /* ICON_DID */
     , (24088, 1, 33558262) /* SETUP_DID */
...
VALUES (24088, 13, True) /* ETHEREAL_BOOL */
     , (24088, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24088, 14, True) /* GRAVITY_STATUS_BOOL */
     , (24088, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24088, 19, True) /* ATTACKABLE_BOOL */
     , (24088, 1, True) /* STUCK_BOOL */;
