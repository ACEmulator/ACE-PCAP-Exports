/* Weenie - PortalsPortal - Ground Portal (24875) */
...
VALUES (24875, 262164, 24875, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24875, 1, 'Ground Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (24875, 8, 100667499) /* ICON_DID */
     , (24875, 1, 33554867) /* SETUP_DID */
...
VALUES (24875, 13, True) /* ETHEREAL_BOOL */
     , (24875, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (24875, 15, True) /* LIGHTS_STATUS_BOOL */
     , (24875, 19, True) /* ATTACKABLE_BOOL */
     , (24875, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (24875, 38, 'Ground Portal (87.6S, 67.1W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (24875, 111, 49) /* PORTAL_BITMASK_INT */;
