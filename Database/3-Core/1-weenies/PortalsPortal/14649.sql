/* Weenie - PortalsPortal - Lost Realm Cottages Portal (14649) */
...
VALUES (14649, 262164, 14649, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14649, 1, 'Lost Realm Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14649, 8, 100667499) /* ICON_DID */
     , (14649, 1, 33554867) /* SETUP_DID */
...
VALUES (14649, 13, True) /* ETHEREAL_BOOL */
     , (14649, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14649, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14649, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14649, 19, True) /* ATTACKABLE_BOOL */
     , (14649, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14649, 38, 'Lost Realm Cottages Portal (19.3N, 26.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14649, 111, 1) /* PORTAL_BITMASK_INT */;
