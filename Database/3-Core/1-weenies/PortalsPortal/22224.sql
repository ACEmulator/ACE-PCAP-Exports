/* Weenie - PortalsPortal - Celdiseth Court Portal (22224) */
...
VALUES (22224, 262164, 22224, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22224, 1, 'Celdiseth Court Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22224, 8, 100667499) /* ICON_DID */
     , (22224, 1, 33554867) /* SETUP_DID */
...
VALUES (22224, 13, True) /* ETHEREAL_BOOL */
     , (22224, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (22224, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22224, 15, True) /* LIGHTS_STATUS_BOOL */
     , (22224, 19, True) /* ATTACKABLE_BOOL */
     , (22224, 1, True) /* STUCK_BOOL */;
