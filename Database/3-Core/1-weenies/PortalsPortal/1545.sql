/* Weenie - PortalsPortal - Colier Mine Portal (1545) */
...
VALUES (1545, 262164, 1545, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1545, 1, 'Colier Mine Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1545, 8, 100667499) /* ICON_DID */
     , (1545, 1, 33554867) /* SETUP_DID */
...
VALUES (1545, 13, True) /* ETHEREAL_BOOL */
     , (1545, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1545, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1545, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1545, 19, True) /* ATTACKABLE_BOOL */
     , (1545, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1545, 38, 'Colier Mine Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1545, 111, 1) /* PORTAL_BITMASK_INT */;
