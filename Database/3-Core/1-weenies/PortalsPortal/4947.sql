/* Weenie - PortalsPortal - Dry Well Portal (4947) */
...
VALUES (4947, 262164, 4947, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4947, 1, 'Dry Well Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4947, 8, 100667499) /* ICON_DID */
     , (4947, 1, 33555922) /* SETUP_DID */
...
VALUES (4947, 13, True) /* ETHEREAL_BOOL */
     , (4947, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4947, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4947, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4947, 19, True) /* ATTACKABLE_BOOL */
     , (4947, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4947, 38, 'Dry Well Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4947, 86, 1) /* MIN_LEVEL_INT */
