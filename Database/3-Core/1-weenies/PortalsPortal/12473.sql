/* Weenie - PortalsPortal - Arida Butte Portal (12473) */
...
VALUES (12473, 262164, 12473, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12473, 1, 'Arida Butte Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12473, 8, 100667499) /* ICON_DID */
     , (12473, 1, 33554867) /* SETUP_DID */
...
VALUES (12473, 13, True) /* ETHEREAL_BOOL */
     , (12473, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12473, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12473, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12473, 19, True) /* ATTACKABLE_BOOL */
     , (12473, 1, True) /* STUCK_BOOL */;
