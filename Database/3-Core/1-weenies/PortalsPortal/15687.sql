/* Weenie - PortalsPortal - Windrune Cottages Portal (15687) */
...
VALUES (15687, 262164, 15687, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15687, 1, 'Windrune Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15687, 8, 100667499) /* ICON_DID */
     , (15687, 1, 33554867) /* SETUP_DID */
...
VALUES (15687, 13, True) /* ETHEREAL_BOOL */
     , (15687, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15687, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15687, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15687, 19, True) /* ATTACKABLE_BOOL */
     , (15687, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15687, 38, 'Windrune Cottages Portal (62.6N, 3.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15687, 111, 1) /* PORTAL_BITMASK_INT */;
