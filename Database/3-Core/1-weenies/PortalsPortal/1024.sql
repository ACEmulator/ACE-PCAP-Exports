/* Weenie - PortalsPortal - Qalaba'r Portal (1024) */
...
VALUES (1024, 262164, 1024, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1024, 1, 'Qalaba''r Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1024, 8, 100667499) /* ICON_DID */
     , (1024, 1, 33554867) /* SETUP_DID */
...
VALUES (1024, 13, True) /* ETHEREAL_BOOL */
     , (1024, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1024, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (1024, 111, 1) /* PORTAL_BITMASK_INT */;
