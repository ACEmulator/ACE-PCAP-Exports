/* Weenie - PortalsPortal - Celcynd Cottages Portal (14616) */
...
VALUES (14616, 262164, 14616, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14616, 1, 'Celcynd Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14616, 8, 100667499) /* ICON_DID */
     , (14616, 1, 33554867) /* SETUP_DID */
...
VALUES (14616, 13, True) /* ETHEREAL_BOOL */
     , (14616, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14616, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14616, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14616, 19, True) /* ATTACKABLE_BOOL */
     , (14616, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14616, 38, 'Celcynd Cottages Portal (92.2N, 9.9E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14616, 111, 1) /* PORTAL_BITMASK_INT */;
