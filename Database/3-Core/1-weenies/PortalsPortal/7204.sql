/* Weenie - PortalsPortal - Cursed Swamp Portal (7204) */
...
VALUES (7204, 262164, 7204, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7204, 1, 'Cursed Swamp Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7204, 8, 100667499) /* ICON_DID */
     , (7204, 1, 33554867) /* SETUP_DID */
...
VALUES (7204, 13, True) /* ETHEREAL_BOOL */
     , (7204, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7204, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7204, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7204, 19, True) /* ATTACKABLE_BOOL */
     , (7204, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7204, 38, 'Cursed Swamp Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7204, 111, 1) /* PORTAL_BITMASK_INT */;
