/* Weenie - PortalsPortal - Southern Park Portal (14667) */
...
VALUES (14667, 262164, 14667, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14667, 1, 'Southern Park Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14667, 8, 100667499) /* ICON_DID */
     , (14667, 1, 33554867) /* SETUP_DID */
...
VALUES (14667, 13, True) /* ETHEREAL_BOOL */
     , (14667, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14667, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14667, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14667, 19, True) /* ATTACKABLE_BOOL */
     , (14667, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14667, 38, 'Southern Park Portal (75.8S, 37.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14667, 111, 1) /* PORTAL_BITMASK_INT */;
