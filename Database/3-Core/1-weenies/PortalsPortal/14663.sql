/* Weenie - PortalsPortal - Sand Kings Cottages Portal (14663) */
...
VALUES (14663, 262164, 14663, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14663, 1, 'Sand Kings Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14663, 8, 100667499) /* ICON_DID */
     , (14663, 1, 33554867) /* SETUP_DID */
...
VALUES (14663, 13, True) /* ETHEREAL_BOOL */
     , (14663, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14663, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14663, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14663, 19, True) /* ATTACKABLE_BOOL */
     , (14663, 1, True) /* STUCK_BOOL */;
