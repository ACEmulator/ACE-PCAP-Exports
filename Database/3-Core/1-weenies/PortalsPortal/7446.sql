/* Weenie - PortalsPortal - Surface Portal (7446) */
...
VALUES (7446, 262164, 7446, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7446, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7446, 8, 100667499) /* ICON_DID */
     , (7446, 1, 33554867) /* SETUP_DID */
...
VALUES (7446, 13, True) /* ETHEREAL_BOOL */
     , (7446, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7446, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7446, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7446, 19, True) /* ATTACKABLE_BOOL */
     , (7446, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7446, 38, 'Surface Portal (86.4N, 44.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7446, 111, 49) /* PORTAL_BITMASK_INT */;
