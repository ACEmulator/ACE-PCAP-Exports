/* Weenie - PortalsPortal - Mysterious Tunnels Portal (6884) */
...
VALUES (6884, 262164, 6884, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6884, 1, 'Mysterious Tunnels Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (6884, 8, 100667499) /* ICON_DID */
     , (6884, 1, 33555922) /* SETUP_DID */
...
VALUES (6884, 13, True) /* ETHEREAL_BOOL */
     , (6884, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (6884, 14, True) /* GRAVITY_STATUS_BOOL */
     , (6884, 15, True) /* LIGHTS_STATUS_BOOL */
     , (6884, 19, True) /* ATTACKABLE_BOOL */
     , (6884, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6884, 38, 'Mysterious Tunnels Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (6884, 86, 1) /* MIN_LEVEL_INT */
