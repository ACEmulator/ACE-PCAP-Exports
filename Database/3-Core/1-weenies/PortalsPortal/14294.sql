/* Weenie - PortalsPortal - Zatara Portal (14294) */
...
VALUES (14294, 262164, 14294, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14294, 1, 'Zatara Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14294, 8, 100667499) /* ICON_DID */
     , (14294, 1, 33554867) /* SETUP_DID */
...
VALUES (14294, 13, True) /* ETHEREAL_BOOL */
     , (14294, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14294, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14294, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14294, 19, True) /* ATTACKABLE_BOOL */
     , (14294, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14294, 38, 'Zatara Portal (76.0N, 35.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14294, 111, 1) /* PORTAL_BITMASK_INT */;
