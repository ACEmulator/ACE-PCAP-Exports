/* Weenie - PortalsPortal - Colier Mine Portal (1543) */
...
VALUES (1543, 262164, 1543, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1543, 1, 'Colier Mine Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1543, 8, 100667499) /* ICON_DID */
     , (1543, 1, 33554867) /* SETUP_DID */
...
VALUES (1543, 13, True) /* ETHEREAL_BOOL */
     , (1543, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1543, 14, True) /* GRAVITY_STATUS_BOOL */
