/* Weenie - PortalsPortal - Surface Portal (7201) */
...
VALUES (7201, 262164, 7201, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7201, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7201, 8, 100667499) /* ICON_DID */
     , (7201, 1, 33554867) /* SETUP_DID */
...
VALUES (7201, 13, True) /* ETHEREAL_BOOL */
     , (7201, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7201, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7201, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7201, 19, True) /* ATTACKABLE_BOOL */
     , (7201, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7201, 38, 'Surface Portal (88.7S, 25.9W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7201, 111, 1) /* PORTAL_BITMASK_INT */;
