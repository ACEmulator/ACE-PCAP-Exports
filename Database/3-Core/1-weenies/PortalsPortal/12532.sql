/* Weenie - PortalsPortal - North Baishi Cottages Portal (12532) */
...
VALUES (12532, 262164, 12532, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12532, 1, 'North Baishi Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12532, 8, 100667499) /* ICON_DID */
     , (12532, 1, 33554867) /* SETUP_DID */
...
VALUES (12532, 13, True) /* ETHEREAL_BOOL */
     , (12532, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12532, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12532, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12532, 19, True) /* ATTACKABLE_BOOL */
     , (12532, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12532, 38, 'North Baishi Cottages Portal (45.0S, 63.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12532, 111, 1) /* PORTAL_BITMASK_INT */;
