/* Weenie - PortalsPortal - Treacherous Tunnels Portal (8444) */
...
VALUES (8444, 262164, 8444, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8444, 1, 'Treacherous Tunnels Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8444, 8, 100667499) /* ICON_DID */
     , (8444, 1, 33556733) /* SETUP_DID */
...
VALUES (8444, 13, True) /* ETHEREAL_BOOL */
     , (8444, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8444, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8444, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8444, 19, True) /* ATTACKABLE_BOOL */
     , (8444, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8444, 38, 'Treacherous Tunnels Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8444, 111, 17) /* PORTAL_BITMASK_INT */;
