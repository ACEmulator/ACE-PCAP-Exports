/* Weenie - PortalsPortal - Axefall Glen Portal (15666) */
...
VALUES (15666, 262164, 15666, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15666, 1, 'Axefall Glen Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15666, 8, 100667499) /* ICON_DID */
     , (15666, 1, 33554867) /* SETUP_DID */
...
VALUES (15666, 13, True) /* ETHEREAL_BOOL */
     , (15666, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15666, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15666, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15666, 19, True) /* ATTACKABLE_BOOL */
     , (15666, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15666, 38, 'Axefall Glen Portal (30.5N, 40.7W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15666, 111, 1) /* PORTAL_BITMASK_INT */;
