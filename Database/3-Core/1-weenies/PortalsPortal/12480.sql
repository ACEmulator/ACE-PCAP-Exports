/* Weenie - PortalsPortal - Broadacre Cottages Portal (12480) */
...
VALUES (12480, 262164, 12480, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12480, 1, 'Broadacre Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12480, 8, 100667499) /* ICON_DID */
     , (12480, 1, 33554867) /* SETUP_DID */
...
VALUES (12480, 13, True) /* ETHEREAL_BOOL */
     , (12480, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12480, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12480, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12480, 19, True) /* ATTACKABLE_BOOL */
     , (12480, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12480, 38, 'Broadacre Cottages Portal (12.1S, 63.5E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12480, 111, 1) /* PORTAL_BITMASK_INT */;
