/* Weenie - PortalsPortal - Shian-To Cottages Portal (12545) */
...
VALUES (12545, 262164, 12545, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12545, 1, 'Shian-To Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12545, 8, 100667499) /* ICON_DID */
     , (12545, 1, 33554867) /* SETUP_DID */
...
VALUES (12545, 13, True) /* ETHEREAL_BOOL */
     , (12545, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12545, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12545, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12545, 19, True) /* ATTACKABLE_BOOL */
     , (12545, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12545, 38, 'Shian-To Cottages Portal (40.8S, 76.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12545, 111, 1) /* PORTAL_BITMASK_INT */;
