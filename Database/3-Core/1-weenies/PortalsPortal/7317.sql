/* Weenie - PortalsPortal - Hills Citadel Portal (7317) */
...
VALUES (7317, 262164, 7317, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7317, 1, 'Hills Citadel Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7317, 8, 100667499) /* ICON_DID */
     , (7317, 1, 33555923) /* SETUP_DID */
...
VALUES (7317, 13, True) /* ETHEREAL_BOOL */
     , (7317, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7317, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7317, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7317, 19, True) /* ATTACKABLE_BOOL */
     , (7317, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7317, 38, 'Hills Citadel Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7317, 111, 1) /* PORTAL_BITMASK_INT */;
