/* Weenie - PortalsPortal - Arwic Mines Portal (1088) */
...
VALUES (1088, 262164, 1088, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1088, 1, 'Arwic Mines Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1088, 8, 100667499) /* ICON_DID */
     , (1088, 1, 33554867) /* SETUP_DID */
...
VALUES (1088, 13, True) /* ETHEREAL_BOOL */
     , (1088, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1088, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1088, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1088, 19, True) /* ATTACKABLE_BOOL */
     , (1088, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1088, 38, 'Arwic Mines Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1088, 111, 1) /* PORTAL_BITMASK_INT */;
