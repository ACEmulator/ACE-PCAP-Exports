/* Weenie - PortalsPortal - Surface Portal (5203) */
...
VALUES (5203, 262164, 5203, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5203, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5203, 8, 100667499) /* ICON_DID */
     , (5203, 1, 33554867) /* SETUP_DID */
...
VALUES (5203, 13, True) /* ETHEREAL_BOOL */
     , (5203, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5203, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5203, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5203, 19, True) /* ATTACKABLE_BOOL */
     , (5203, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5203, 38, 'Surface Portal (1.0S, 18.8E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5203, 111, 1) /* PORTAL_BITMASK_INT */;
