/* Weenie - PortalsPortal - Central Tuatara Plains Portal (12161) */
...
VALUES (12161, 262164, 12161, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12161, 1, 'Central Tuatara Plains Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12161, 8, 100667499) /* ICON_DID */
     , (12161, 1, 33555926) /* SETUP_DID */
...
VALUES (12161, 13, True) /* ETHEREAL_BOOL */
     , (12161, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12161, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12161, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12161, 19, True) /* ATTACKABLE_BOOL */
     , (12161, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12161, 38, 'Central Tuatara Plains Portal (56.1N, 75.2W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12161, 86, 35) /* MIN_LEVEL_INT */
