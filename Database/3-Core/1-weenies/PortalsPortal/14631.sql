/* Weenie - PortalsPortal - Fearnot Valley Cottages Portal (14631) */
...
VALUES (14631, 262164, 14631, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14631, 1, 'Fearnot Valley Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14631, 8, 100667499) /* ICON_DID */
     , (14631, 1, 33554867) /* SETUP_DID */
...
VALUES (14631, 13, True) /* ETHEREAL_BOOL */
     , (14631, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14631, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14631, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14631, 19, True) /* ATTACKABLE_BOOL */
     , (14631, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14631, 38, 'Fearnot Valley Cottages Portal (24.1N, 19.1W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14631, 111, 1) /* PORTAL_BITMASK_INT */;
