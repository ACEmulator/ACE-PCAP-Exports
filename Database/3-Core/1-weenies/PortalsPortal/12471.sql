/* Weenie - PortalsPortal - Aqalah Portal (12471) */
...
VALUES (12471, 262164, 12471, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12471, 1, 'Aqalah Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12471, 8, 100667499) /* ICON_DID */
     , (12471, 1, 33554867) /* SETUP_DID */
...
VALUES (12471, 13, True) /* ETHEREAL_BOOL */
     , (12471, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12471, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12471, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12471, 19, True) /* ATTACKABLE_BOOL */
     , (12471, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12471, 38, 'Aqalah Portal (7.1S, 2.7W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12471, 111, 1) /* PORTAL_BITMASK_INT */;
