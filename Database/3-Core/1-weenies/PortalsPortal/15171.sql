/* Weenie - PortalsPortal - Mahara Cottages Portal (15171) */
...
VALUES (15171, 262164, 15171, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15171, 1, 'Mahara Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15171, 8, 100667499) /* ICON_DID */
     , (15171, 1, 33554867) /* SETUP_DID */
...
VALUES (15171, 13, True) /* ETHEREAL_BOOL */
     , (15171, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15171, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15171, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15171, 19, True) /* ATTACKABLE_BOOL */
     , (15171, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15171, 38, 'Mahara Cottages Portal (54.4S, 15.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15171, 111, 1) /* PORTAL_BITMASK_INT */;
