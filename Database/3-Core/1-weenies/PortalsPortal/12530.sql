/* Weenie - PortalsPortal - Norstead Portal (12530) */
...
VALUES (12530, 262164, 12530, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12530, 1, 'Norstead Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12530, 8, 100667499) /* ICON_DID */
     , (12530, 1, 33554867) /* SETUP_DID */
...
VALUES (12530, 13, True) /* ETHEREAL_BOOL */
     , (12530, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12530, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12530, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12530, 19, True) /* ATTACKABLE_BOOL */
     , (12530, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12530, 38, 'Norstead Portal (75.6N, 52.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12530, 111, 1) /* PORTAL_BITMASK_INT */;
