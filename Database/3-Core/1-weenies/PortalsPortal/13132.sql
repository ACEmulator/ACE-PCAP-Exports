/* Weenie - PortalsPortal - South Hebian-To Estates Portal (13132) */
...
VALUES (13132, 262164, 13132, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13132, 1, 'South Hebian-To Estates Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (13132, 8, 100667499) /* ICON_DID */
     , (13132, 1, 33554867) /* SETUP_DID */
...
VALUES (13132, 13, True) /* ETHEREAL_BOOL */
     , (13132, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (13132, 14, True) /* GRAVITY_STATUS_BOOL */
     , (13132, 15, True) /* LIGHTS_STATUS_BOOL */
     , (13132, 19, True) /* ATTACKABLE_BOOL */
     , (13132, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13132, 38, 'South Hebian-To Estates Portal (45.4S, 83.1E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (13132, 111, 1) /* PORTAL_BITMASK_INT */;
