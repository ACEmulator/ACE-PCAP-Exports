/* Weenie - PortalsPortal - Liang Chi Settlement Portal (12512) */
...
VALUES (12512, 262164, 12512, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12512, 1, 'Liang Chi Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12512, 8, 100667499) /* ICON_DID */
     , (12512, 1, 33554867) /* SETUP_DID */
...
VALUES (12512, 13, True) /* ETHEREAL_BOOL */
     , (12512, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12512, 14, True) /* GRAVITY_STATUS_BOOL */
