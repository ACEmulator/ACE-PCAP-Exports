/* Weenie - PortalsPortal - Patron's Honor Cottages Portal (15679) */
...
VALUES (15679, 262164, 15679, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15679, 1, 'Patron''s Honor Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15679, 8, 100667499) /* ICON_DID */
     , (15679, 1, 33554867) /* SETUP_DID */
...
VALUES (15679, 13, True) /* ETHEREAL_BOOL */
     , (15679, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15679, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15679, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15679, 19, True) /* ATTACKABLE_BOOL */
     , (15679, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15679, 38, 'Patron''s Honor Cottages Portal (75.3N, 27.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15679, 111, 1) /* PORTAL_BITMASK_INT */;
