/* Weenie - PortalsPortal - Base of the Timaru Plateau Portal (11959) */
...
VALUES (11959, 262164, 11959, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (11959, 1, 'Base of the Timaru Plateau Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (11959, 8, 100667499) /* ICON_DID */
     , (11959, 1, 33554867) /* SETUP_DID */
...
VALUES (11959, 13, True) /* ETHEREAL_BOOL */
     , (11959, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (11959, 14, True) /* GRAVITY_STATUS_BOOL */
...
VALUES (11959, 111, 49) /* PORTAL_BITMASK_INT */;
