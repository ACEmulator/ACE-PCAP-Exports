/* Weenie - PortalsPortal - Unified Heart Villas Portal (19165) */
...
VALUES (19165, 262164, 19165, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19165, 1, 'Unified Heart Villas Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19165, 8, 100667499) /* ICON_DID */
     , (19165, 1, 33554867) /* SETUP_DID */
...
VALUES (19165, 13, True) /* ETHEREAL_BOOL */
     , (19165, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19165, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19165, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19165, 19, True) /* ATTACKABLE_BOOL */
     , (19165, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19165, 38, 'Unified Heart Villas Portal (13.6N, 16.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (19165, 111, 1) /* PORTAL_BITMASK_INT */;
