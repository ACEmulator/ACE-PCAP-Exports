/* Weenie - PortalsPortal - Surface Portal (10719) */
...
VALUES (10719, 262164, 10719, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10719, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10719, 8, 100667499) /* ICON_DID */
     , (10719, 1, 33554867) /* SETUP_DID */
...
VALUES (10719, 13, True) /* ETHEREAL_BOOL */
     , (10719, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (10719, 14, True) /* GRAVITY_STATUS_BOOL */
     , (10719, 15, True) /* LIGHTS_STATUS_BOOL */
     , (10719, 19, True) /* ATTACKABLE_BOOL */
     , (10719, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10719, 38, 'Surface Portal (12.6S, 47.5E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10719, 111, 1) /* PORTAL_BITMASK_INT */;
