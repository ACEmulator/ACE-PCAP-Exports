/* Weenie - PortalsPortal - East Morntide Villas Portal (14623) */
...
VALUES (14623, 262164, 14623, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14623, 1, 'East Morntide Villas Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14623, 8, 100667499) /* ICON_DID */
     , (14623, 1, 33554867) /* SETUP_DID */
...
VALUES (14623, 13, True) /* ETHEREAL_BOOL */
     , (14623, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14623, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14623, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14623, 19, True) /* ATTACKABLE_BOOL */
     , (14623, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14623, 38, 'East Morntide Villas Portal (38.5N, 12.7W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14623, 111, 1) /* PORTAL_BITMASK_INT */;
