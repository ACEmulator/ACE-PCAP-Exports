/* Weenie - PortalsPortal - Villalabar Portal (14289) */
...
VALUES (14289, 262164, 14289, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14289, 1, 'Villalabar Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14289, 8, 100667499) /* ICON_DID */
     , (14289, 1, 33554867) /* SETUP_DID */
...
VALUES (14289, 13, True) /* ETHEREAL_BOOL */
     , (14289, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14289, 14, True) /* GRAVITY_STATUS_BOOL */
