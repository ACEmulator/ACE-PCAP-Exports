/* Weenie - PortalsPortal - Nal Wadi Cottages Portal (14275) */
...
VALUES (14275, 262164, 14275, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14275, 1, 'Nal Wadi Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14275, 8, 100667499) /* ICON_DID */
     , (14275, 1, 33554867) /* SETUP_DID */
...
VALUES (14275, 13, True) /* ETHEREAL_BOOL */
     , (14275, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14275, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14275, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14275, 19, True) /* ATTACKABLE_BOOL */
     , (14275, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14275, 38, 'Nal Wadi Cottages Portal (4.6N, 20.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14275, 111, 1) /* PORTAL_BITMASK_INT */;
