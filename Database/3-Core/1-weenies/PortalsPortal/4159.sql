/* Weenie - PortalsPortal - Surface Portal (4159) */
...
VALUES (4159, 262164, 4159, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4159, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4159, 8, 100667499) /* ICON_DID */
     , (4159, 1, 33554867) /* SETUP_DID */
...
VALUES (4159, 13, True) /* ETHEREAL_BOOL */
     , (4159, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4159, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4159, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4159, 19, True) /* ATTACKABLE_BOOL */
     , (4159, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4159, 38, 'Surface Portal (33.8N, 29.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4159, 111, 1) /* PORTAL_BITMASK_INT */;
