/* Weenie - PortalsPortal - Isle of Tears Portal (1112) */
...
VALUES (1112, 262164, 1112, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1112, 1, 'Isle of Tears Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1112, 8, 100667499) /* ICON_DID */
     , (1112, 1, 33554867) /* SETUP_DID */
...
VALUES (1112, 13, True) /* ETHEREAL_BOOL */
     , (1112, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1112, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1112, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1112, 19, True) /* ATTACKABLE_BOOL */
     , (1112, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1112, 38, 'Isle of Tears Portal (22.5N, 51.9E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1112, 111, 1) /* PORTAL_BITMASK_INT */;
