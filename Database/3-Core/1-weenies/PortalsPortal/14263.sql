/* Weenie - PortalsPortal - Haliana Portal (14263) */
...
VALUES (14263, 262164, 14263, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14263, 1, 'Haliana Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14263, 8, 100667499) /* ICON_DID */
     , (14263, 1, 33554867) /* SETUP_DID */
...
VALUES (14263, 13, True) /* ETHEREAL_BOOL */
     , (14263, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14263, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14263, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14263, 19, True) /* ATTACKABLE_BOOL */
     , (14263, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14263, 38, 'Haliana Portal (73.1N, 61.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14263, 111, 1) /* PORTAL_BITMASK_INT */;
