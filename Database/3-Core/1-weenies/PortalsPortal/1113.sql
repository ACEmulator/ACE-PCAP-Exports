/* Weenie - PortalsPortal - Cragstone Portal (1113) */
...
VALUES (1113, 262164, 1113, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1113, 1, 'Cragstone Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1113, 8, 100667499) /* ICON_DID */
     , (1113, 1, 33554867) /* SETUP_DID */
...
VALUES (1113, 13, True) /* ETHEREAL_BOOL */
     , (1113, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1113, 14, True) /* GRAVITY_STATUS_BOOL */
