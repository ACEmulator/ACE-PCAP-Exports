/* Weenie - PortalsPortal - Upper Shade Stronghold Portal (8847) */
...
VALUES (8847, 262164, 8847, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8847, 1, 'Upper Shade Stronghold Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8847, 8, 100667499) /* ICON_DID */
     , (8847, 1, 33555923) /* SETUP_DID */
...
VALUES (8847, 13, True) /* ETHEREAL_BOOL */
     , (8847, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8847, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8847, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8847, 19, True) /* ATTACKABLE_BOOL */
     , (8847, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8847, 38, 'Upper Shade Stronghold Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8847, 86, 26) /* MIN_LEVEL_INT */
