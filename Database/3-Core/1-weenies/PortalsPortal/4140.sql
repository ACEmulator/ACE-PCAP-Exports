/* Weenie - PortalsPortal - Sclavus Keep Portal (4140) */
...
VALUES (4140, 262164, 4140, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4140, 1, 'Sclavus Keep Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4140, 8, 100667499) /* ICON_DID */
     , (4140, 1, 33555923) /* SETUP_DID */
...
VALUES (4140, 13, True) /* ETHEREAL_BOOL */
     , (4140, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4140, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4140, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4140, 19, True) /* ATTACKABLE_BOOL */
     , (4140, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4140, 38, 'Sclavus Keep Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4140, 86, 15) /* MIN_LEVEL_INT */
