/* Weenie - PortalsPortal - Gajin Dwellings Portal (19362) */
...
VALUES (19362, 262164, 19362, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19362, 1, 'Gajin Dwellings Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19362, 8, 100667499) /* ICON_DID */
     , (19362, 1, 33554867) /* SETUP_DID */
...
VALUES (19362, 13, True) /* ETHEREAL_BOOL */
     , (19362, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19362, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19362, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19362, 19, True) /* ATTACKABLE_BOOL */
     , (19362, 1, True) /* STUCK_BOOL */;
