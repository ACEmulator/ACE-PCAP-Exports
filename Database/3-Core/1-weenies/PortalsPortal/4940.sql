/* Weenie - PortalsPortal - Surface Portal (4940) */
...
VALUES (4940, 262164, 4940, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4940, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4940, 8, 100667499) /* ICON_DID */
     , (4940, 1, 33554867) /* SETUP_DID */
...
VALUES (4940, 13, True) /* ETHEREAL_BOOL */
     , (4940, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (4940, 14, True) /* GRAVITY_STATUS_BOOL */
     , (4940, 15, True) /* LIGHTS_STATUS_BOOL */
     , (4940, 19, True) /* ATTACKABLE_BOOL */
     , (4940, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4940, 38, 'Surface Portal (30.2S, 9.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4940, 111, 1) /* PORTAL_BITMASK_INT */;
