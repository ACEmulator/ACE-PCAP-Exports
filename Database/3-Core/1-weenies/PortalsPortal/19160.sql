/* Weenie - PortalsPortal - Stonerune Cottages Portal (19160) */
...
VALUES (19160, 262164, 19160, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19160, 1, 'Stonerune Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19160, 8, 100667499) /* ICON_DID */
     , (19160, 1, 33554867) /* SETUP_DID */
...
VALUES (19160, 13, True) /* ETHEREAL_BOOL */
     , (19160, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19160, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19160, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19160, 19, True) /* ATTACKABLE_BOOL */
     , (19160, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19160, 38, 'Stonerune Cottages Portal (59.0N, 7.9E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (19160, 111, 1) /* PORTAL_BITMASK_INT */;
