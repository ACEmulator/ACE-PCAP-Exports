/* Weenie - PortalsPortal - Woodsbane Cottages Portal (12566) */
...
VALUES (12566, 262164, 12566, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12566, 1, 'Woodsbane Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12566, 8, 100667499) /* ICON_DID */
     , (12566, 1, 33554867) /* SETUP_DID */
...
VALUES (12566, 13, True) /* ETHEREAL_BOOL */
     , (12566, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12566, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12566, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12566, 19, True) /* ATTACKABLE_BOOL */
     , (12566, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12566, 38, 'Woodsbane Cottages Portal (43.9N, 18.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12566, 111, 1) /* PORTAL_BITMASK_INT */;
