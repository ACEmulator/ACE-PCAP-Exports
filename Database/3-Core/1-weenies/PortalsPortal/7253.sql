/* Weenie - PortalsPortal - Surface Portal (7253) */
...
VALUES (7253, 262164, 7253, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7253, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7253, 8, 100667499) /* ICON_DID */
     , (7253, 1, 33554867) /* SETUP_DID */
...
VALUES (7253, 13, True) /* ETHEREAL_BOOL */
     , (7253, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7253, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7253, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7253, 19, True) /* ATTACKABLE_BOOL */
     , (7253, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7253, 38, 'Surface Portal (43.2S, 67.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7253, 111, 17) /* PORTAL_BITMASK_INT */;
