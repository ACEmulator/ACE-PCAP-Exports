/* Weenie - PortalsPortal - Glenden Hills East Settlement Portal (12501) */
...
VALUES (12501, 262164, 12501, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12501, 1, 'Glenden Hills East Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12501, 8, 100667499) /* ICON_DID */
     , (12501, 1, 33554867) /* SETUP_DID */
...
VALUES (12501, 13, True) /* ETHEREAL_BOOL */
     , (12501, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12501, 14, True) /* GRAVITY_STATUS_BOOL */
