/* Weenie - PortalsPortal - Surface Portal (8844) */
...
VALUES (8844, 262164, 8844, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8844, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8844, 8, 100667499) /* ICON_DID */
     , (8844, 1, 33554867) /* SETUP_DID */
...
VALUES (8844, 13, True) /* ETHEREAL_BOOL */
     , (8844, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8844, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8844, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8844, 19, True) /* ATTACKABLE_BOOL */
     , (8844, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8844, 38, 'Surface Portal (23.3S, 5.8E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8844, 111, 17) /* PORTAL_BITMASK_INT */;
