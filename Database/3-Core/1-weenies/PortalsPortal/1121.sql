/* Weenie - PortalsPortal - Mite Maze Portal (1121) */
...
VALUES (1121, 262164, 1121, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1121, 1, 'Mite Maze Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (1121, 8, 100667499) /* ICON_DID */
     , (1121, 1, 33554867) /* SETUP_DID */
...
VALUES (1121, 13, True) /* ETHEREAL_BOOL */
     , (1121, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (1121, 14, True) /* GRAVITY_STATUS_BOOL */
     , (1121, 15, True) /* LIGHTS_STATUS_BOOL */
     , (1121, 19, True) /* ATTACKABLE_BOOL */
     , (1121, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (1121, 38, 'Mite Maze Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1121, 111, 1) /* PORTAL_BITMASK_INT */;
