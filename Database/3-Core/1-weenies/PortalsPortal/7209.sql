/* Weenie - PortalsPortal - Surface Portal (7209) */
...
VALUES (7209, 262164, 7209, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7209, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7209, 8, 100667499) /* ICON_DID */
     , (7209, 1, 33554867) /* SETUP_DID */
...
VALUES (7209, 13, True) /* ETHEREAL_BOOL */
     , (7209, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7209, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7209, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7209, 19, True) /* ATTACKABLE_BOOL */
     , (7209, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7209, 38, 'Surface Portal (2.8N, 53.4E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7209, 111, 1) /* PORTAL_BITMASK_INT */;
