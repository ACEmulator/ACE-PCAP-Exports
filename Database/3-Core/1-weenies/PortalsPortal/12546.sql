/* Weenie - PortalsPortal - Siege Road Settlement Portal (12546) */
...
VALUES (12546, 262164, 12546, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12546, 1, 'Siege Road Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12546, 8, 100667499) /* ICON_DID */
     , (12546, 1, 33554867) /* SETUP_DID */
...
VALUES (12546, 13, True) /* ETHEREAL_BOOL */
     , (12546, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12546, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12546, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12546, 19, True) /* ATTACKABLE_BOOL */
     , (12546, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12546, 38, 'Siege Road Settlement Portal (0.4S, 68.2E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12546, 111, 1) /* PORTAL_BITMASK_INT */;
