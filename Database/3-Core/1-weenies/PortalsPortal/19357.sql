/* Weenie - PortalsPortal - Alphus Court Portal (19357) */
...
VALUES (19357, 262164, 19357, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19357, 1, 'Alphus Court Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19357, 8, 100667499) /* ICON_DID */
     , (19357, 1, 33554867) /* SETUP_DID */
...
VALUES (19357, 13, True) /* ETHEREAL_BOOL */
     , (19357, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19357, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19357, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19357, 19, True) /* ATTACKABLE_BOOL */
     , (19357, 1, True) /* STUCK_BOOL */;
