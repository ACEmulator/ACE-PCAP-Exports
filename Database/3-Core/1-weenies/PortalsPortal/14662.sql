/* Weenie - PortalsPortal - San-Chin Portal (14662) */
...
VALUES (14662, 262164, 14662, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14662, 1, 'San-Chin Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14662, 8, 100667499) /* ICON_DID */
     , (14662, 1, 33554867) /* SETUP_DID */
...
VALUES (14662, 13, True) /* ETHEREAL_BOOL */
     , (14662, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14662, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14662, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14662, 19, True) /* ATTACKABLE_BOOL */
     , (14662, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14662, 38, 'San-Chin Portal (22.4S, 68.7E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14662, 111, 1) /* PORTAL_BITMASK_INT */;
