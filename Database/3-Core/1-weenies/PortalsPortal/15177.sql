/* Weenie - PortalsPortal - Nalib Cavana Settlement Portal (15177) */
...
VALUES (15177, 262164, 15177, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15177, 1, 'Nalib Cavana Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15177, 8, 100667499) /* ICON_DID */
     , (15177, 1, 33554867) /* SETUP_DID */
...
VALUES (15177, 13, True) /* ETHEREAL_BOOL */
     , (15177, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15177, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15177, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15177, 19, True) /* ATTACKABLE_BOOL */
     , (15177, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15177, 38, 'Nalib Cavana Settlement Portal (31.3N, 25.5W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15177, 111, 1) /* PORTAL_BITMASK_INT */;
