/* Weenie - PortalsPortal - Lower Heart of Darkness Portal (8838) */
...
VALUES (8838, 262164, 8838, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8838, 1, 'Lower Heart of Darkness Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8838, 8, 100667499) /* ICON_DID */
     , (8838, 1, 33555926) /* SETUP_DID */
...
VALUES (8838, 13, True) /* ETHEREAL_BOOL */
     , (8838, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8838, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8838, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8838, 19, True) /* ATTACKABLE_BOOL */
     , (8838, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8838, 38, 'Lower Heart of Darkness Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8838, 86, 31) /* MIN_LEVEL_INT */
