/* Weenie - PortalsPortal - Surface Portal (6780) */
...
VALUES (6780, 262164, 6780, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6780, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (6780, 8, 100667499) /* ICON_DID */
     , (6780, 1, 33554867) /* SETUP_DID */
...
VALUES (6780, 13, True) /* ETHEREAL_BOOL */
     , (6780, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (6780, 14, True) /* GRAVITY_STATUS_BOOL */
     , (6780, 15, True) /* LIGHTS_STATUS_BOOL */
     , (6780, 19, True) /* ATTACKABLE_BOOL */
     , (6780, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (6780, 38, 'Surface Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (6780, 111, 1) /* PORTAL_BITMASK_INT */;
