/* Weenie - PortalsPortal - Surface Portal (9530) */
...
VALUES (9530, 262164, 9530, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9530, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9530, 8, 100667499) /* ICON_DID */
     , (9530, 1, 33554867) /* SETUP_DID */
...
VALUES (9530, 13, True) /* ETHEREAL_BOOL */
     , (9530, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (9530, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9530, 15, True) /* LIGHTS_STATUS_BOOL */
     , (9530, 19, True) /* ATTACKABLE_BOOL */
     , (9530, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9530, 38, 'Surface Portal (2.0N, 41.6E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9530, 111, 17) /* PORTAL_BITMASK_INT */;
