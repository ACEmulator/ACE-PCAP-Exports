/* Weenie - PortalsPortal - Hermit Hill Cottages Portal (14634) */
...
VALUES (14634, 262164, 14634, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14634, 1, 'Hermit Hill Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14634, 8, 100667499) /* ICON_DID */
     , (14634, 1, 33554867) /* SETUP_DID */
...
VALUES (14634, 13, True) /* ETHEREAL_BOOL */
     , (14634, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14634, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14634, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14634, 19, True) /* ATTACKABLE_BOOL */
     , (14634, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14634, 38, 'Hermit Hill Cottages Portal (14.6N, 30.5E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14634, 111, 1) /* PORTAL_BITMASK_INT */;
