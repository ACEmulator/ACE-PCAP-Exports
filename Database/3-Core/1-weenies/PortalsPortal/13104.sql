/* Weenie - PortalsPortal - Far Claw Villas Portal (13104) */
...
VALUES (13104, 262164, 13104, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (13104, 1, 'Far Claw Villas Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (13104, 8, 100667499) /* ICON_DID */
     , (13104, 1, 33554867) /* SETUP_DID */
...
VALUES (13104, 13, True) /* ETHEREAL_BOOL */
     , (13104, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (13104, 14, True) /* GRAVITY_STATUS_BOOL */
