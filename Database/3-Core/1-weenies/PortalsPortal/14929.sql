/* Weenie - PortalsPortal - Surface Portal (14929) */
...
VALUES (14929, 262164, 14929, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14929, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14929, 8, 100667499) /* ICON_DID */
     , (14929, 1, 33554867) /* SETUP_DID */
...
VALUES (14929, 13, True) /* ETHEREAL_BOOL */
     , (14929, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (14929, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14929, 15, True) /* LIGHTS_STATUS_BOOL */
     , (14929, 19, True) /* ATTACKABLE_BOOL */
     , (14929, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14929, 38, 'Surface Portal (32.8N, 55.3E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14929, 111, 1) /* PORTAL_BITMASK_INT */;
