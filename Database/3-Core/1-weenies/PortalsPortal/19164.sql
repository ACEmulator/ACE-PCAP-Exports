/* Weenie - PortalsPortal - Tyrrin Cottages Portal (19164) */
...
VALUES (19164, 262164, 19164, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19164, 1, 'Tyrrin Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19164, 8, 100667499) /* ICON_DID */
     , (19164, 1, 33554867) /* SETUP_DID */
...
VALUES (19164, 13, True) /* ETHEREAL_BOOL */
     , (19164, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19164, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19164, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19164, 19, True) /* ATTACKABLE_BOOL */
     , (19164, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19164, 38, 'Tyrrin Cottages Portal (42.4N, 29.5W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (19164, 111, 1) /* PORTAL_BITMASK_INT */;
