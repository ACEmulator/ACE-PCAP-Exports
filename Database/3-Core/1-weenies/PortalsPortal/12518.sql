/* Weenie - PortalsPortal - Majestic Hill Cottages Portal (12518) */
...
VALUES (12518, 262164, 12518, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12518, 1, 'Majestic Hill Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12518, 8, 100667499) /* ICON_DID */
     , (12518, 1, 33554867) /* SETUP_DID */
...
VALUES (12518, 13, True) /* ETHEREAL_BOOL */
     , (12518, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12518, 14, True) /* GRAVITY_STATUS_BOOL */
