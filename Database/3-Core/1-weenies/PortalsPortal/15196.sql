/* Weenie - PortalsPortal - Thasali Cottages Portal (15196) */
...
VALUES (15196, 262164, 15196, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15196, 1, 'Thasali Cottages Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15196, 8, 100667499) /* ICON_DID */
     , (15196, 1, 33554867) /* SETUP_DID */
...
VALUES (15196, 13, True) /* ETHEREAL_BOOL */
     , (15196, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15196, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15196, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15196, 19, True) /* ATTACKABLE_BOOL */
     , (15196, 1, True) /* STUCK_BOOL */;
