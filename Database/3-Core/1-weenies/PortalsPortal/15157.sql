/* Weenie - PortalsPortal - East Morntide Settlement Portal (15157) */
...
VALUES (15157, 262164, 15157, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15157, 1, 'East Morntide Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15157, 8, 100667499) /* ICON_DID */
     , (15157, 1, 33554867) /* SETUP_DID */
...
VALUES (15157, 13, True) /* ETHEREAL_BOOL */
     , (15157, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15157, 14, True) /* GRAVITY_STATUS_BOOL */
