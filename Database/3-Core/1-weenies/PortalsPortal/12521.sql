/* Weenie - PortalsPortal - Monument Sands Settlement Portal (12521) */
...
VALUES (12521, 262164, 12521, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12521, 1, 'Monument Sands Settlement Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12521, 8, 100667499) /* ICON_DID */
     , (12521, 1, 33554867) /* SETUP_DID */
...
VALUES (12521, 13, True) /* ETHEREAL_BOOL */
     , (12521, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (12521, 14, True) /* GRAVITY_STATUS_BOOL */
     , (12521, 15, True) /* LIGHTS_STATUS_BOOL */
     , (12521, 19, True) /* ATTACKABLE_BOOL */
     , (12521, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12521, 38, 'Monument Sands Settlement Portal (37.9S, 16.0E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12521, 111, 1) /* PORTAL_BITMASK_INT */;
