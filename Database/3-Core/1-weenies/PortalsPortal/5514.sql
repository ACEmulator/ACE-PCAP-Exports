/* Weenie - PortalsPortal - Surface Portal (5514) */
...
VALUES (5514, 262164, 5514, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5514, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (5514, 8, 100667499) /* ICON_DID */
     , (5514, 1, 33554867) /* SETUP_DID */
...
VALUES (5514, 13, True) /* ETHEREAL_BOOL */
     , (5514, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (5514, 14, True) /* GRAVITY_STATUS_BOOL */
     , (5514, 15, True) /* LIGHTS_STATUS_BOOL */
     , (5514, 19, True) /* ATTACKABLE_BOOL */
     , (5514, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (5514, 38, 'Surface Portal (57.7S, 74.1E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5514, 111, 1) /* PORTAL_BITMASK_INT */;
