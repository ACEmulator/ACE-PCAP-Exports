/* Weenie - PortalsPortal - Surface Portal (10720) */
...
VALUES (10720, 262164, 10720, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10720, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10720, 8, 100667499) /* ICON_DID */
     , (10720, 1, 33554867) /* SETUP_DID */
...
VALUES (10720, 13, True) /* ETHEREAL_BOOL */
     , (10720, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (10720, 14, True) /* GRAVITY_STATUS_BOOL */
     , (10720, 15, True) /* LIGHTS_STATUS_BOOL */
     , (10720, 19, True) /* ATTACKABLE_BOOL */
     , (10720, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10720, 38, 'Surface Portal (61.9S, 77.5E).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10720, 111, 1) /* PORTAL_BITMASK_INT */;
