/* Weenie - PortalsPortal - Chakron Gate Portal (8830) */
...
VALUES (8830, 262164, 8830, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8830, 1, 'Chakron Gate Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8830, 8, 100667499) /* ICON_DID */
     , (8830, 1, 33555926) /* SETUP_DID */
...
VALUES (8830, 13, True) /* ETHEREAL_BOOL */
     , (8830, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (8830, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8830, 15, True) /* LIGHTS_STATUS_BOOL */
     , (8830, 19, True) /* ATTACKABLE_BOOL */
     , (8830, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8830, 38, 'Chakron Gate Portal') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8830, 86, 36) /* MIN_LEVEL_INT */
