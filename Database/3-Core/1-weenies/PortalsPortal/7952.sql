/* Weenie - PortalsPortal - Surface Portal (7952) */
...
VALUES (7952, 262164, 7952, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7952, 1, 'Surface Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7952, 8, 100667499) /* ICON_DID */
     , (7952, 1, 33554867) /* SETUP_DID */
...
VALUES (7952, 13, True) /* ETHEREAL_BOOL */
     , (7952, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (7952, 14, True) /* GRAVITY_STATUS_BOOL */
     , (7952, 15, True) /* LIGHTS_STATUS_BOOL */
     , (7952, 19, True) /* ATTACKABLE_BOOL */
     , (7952, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7952, 38, 'Surface Portal (61.3S, 39.5W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7952, 111, 33) /* PORTAL_BITMASK_INT */;
