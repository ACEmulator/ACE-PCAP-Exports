/* Weenie - PortalsPortal - Vesper Gate Portal (19374) */
...
VALUES (19374, 262164, 19374, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19374, 1, 'Vesper Gate Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19374, 8, 100667499) /* ICON_DID */
     , (19374, 1, 33554867) /* SETUP_DID */
...
VALUES (19374, 13, True) /* ETHEREAL_BOOL */
     , (19374, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (19374, 14, True) /* GRAVITY_STATUS_BOOL */
     , (19374, 15, True) /* LIGHTS_STATUS_BOOL */
     , (19374, 19, True) /* ATTACKABLE_BOOL */
     , (19374, 1, True) /* STUCK_BOOL */;
