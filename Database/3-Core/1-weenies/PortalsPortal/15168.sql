/* Weenie - PortalsPortal - Lady Maila Estates Portal (15168) */
...
VALUES (15168, 262164, 15168, 8388656, NULL, 'AAA9AAAAAAA=', 98307);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15168, 1, 'Lady Maila Estates Portal') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15168, 8, 100667499) /* ICON_DID */
     , (15168, 1, 33554867) /* SETUP_DID */
...
VALUES (15168, 13, True) /* ETHEREAL_BOOL */
     , (15168, 12, True) /* REPORT_COLLISIONS_BOOL */
     , (15168, 14, True) /* GRAVITY_STATUS_BOOL */
     , (15168, 15, True) /* LIGHTS_STATUS_BOOL */
     , (15168, 19, True) /* ATTACKABLE_BOOL */
     , (15168, 1, True) /* STUCK_BOOL */;

/* Extended Appraisal Data */

REPLACE INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15168, 38, 'Lady Maila Estates Portal (74.4N, 46.3W).') /* APPRAISAL_PORTAL_DESTINATION_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15168, 111, 1) /* PORTAL_BITMASK_INT */;
