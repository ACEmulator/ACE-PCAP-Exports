...
VALUES (30913, 272, 30913, 2113584, NULL, NULL, 137217);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (30913, 1, 'Halaetan Magic Page 8') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (30913, 8, 100668176) /* ICON_DID */
     , (30913, 1, 33554773) /* SETUP_DID */
     , (30913, 3, 536870932) /* SOUND_TABLE_DID */
     , (30913, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30913, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (30913, 13, True) /* ETHEREAL_BOOL */
     , (30913, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (30913, 14, True) /* GRAVITY_STATUS_BOOL */
     , (30913, 19, True) /* ATTACKABLE_BOOL */;
