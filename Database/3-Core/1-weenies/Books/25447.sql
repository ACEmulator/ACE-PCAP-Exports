...
VALUES (25447, 272, 25447, 2113584, NULL, NULL, 137217);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (25447, 1, 'Untranslated Page #20') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (25447, 8, 100668176) /* ICON_DID */
     , (25447, 1, 33554773) /* SETUP_DID */
     , (25447, 3, 536870932) /* SOUND_TABLE_DID */
     , (25447, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (25447, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (25447, 13, True) /* ETHEREAL_BOOL */
     , (25447, 11, True) /* IGNORE_COLLISIONS_BOOL */
