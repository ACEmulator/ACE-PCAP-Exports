/* Weenie - Books - Singularity Bore (26641) */
...
VALUES (26641, 272, 26641, 2113592, NULL, NULL, 6273);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (26641, 1, 'Singularity Bore') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (26641, 8, 100675748) /* ICON_DID */
     , (26641, 1, 33559084) /* SETUP_DID */
     , (26641, 3, 536870932) /* SOUND_TABLE_DID */
     , (26641, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (26641, 6, 67112626) /* PALETTE_BASE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (26641, 1, 8192) /* ITEM_TYPE_INT */
...
VALUES (26641, 54, 1) /* USE_RADIUS_FLOAT */
     , (26641, 39, 0.4) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (26641, 13, True) /* ETHEREAL_BOOL */
     , (26641, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (26641, 14, True) /* GRAVITY_STATUS_BOOL */
     , (26641, 19, True) /* ATTACKABLE_BOOL */;
