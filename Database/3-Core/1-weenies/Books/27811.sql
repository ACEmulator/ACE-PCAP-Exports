...
VALUES (27811, 272, 27811, 2113592, NULL, NULL, 137217);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (27811, 1, 'A Soggy Note') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (27811, 8, 100668176) /* ICON_DID */
     , (27811, 1, 33554773) /* SETUP_DID */
     , (27811, 3, 536870932) /* SOUND_TABLE_DID */
     , (27811, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (27811, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (27811, 13, True) /* ETHEREAL_BOOL */
     , (27811, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (27811, 14, True) /* GRAVITY_STATUS_BOOL */
     , (27811, 19, True) /* ATTACKABLE_BOOL */;
