...
VALUES (26482, 272, 26482, 2113592, NULL, NULL, 6273);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (26482, 1, 'Mosswart Temple') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (26482, 8, 100675748) /* ICON_DID */
     , (26482, 1, 33559084) /* SETUP_DID */
     , (26482, 3, 536870932) /* SOUND_TABLE_DID */
     , (26482, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (26482, 6, 67112626) /* PALETTE_BASE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (26482, 1, 8192) /* ITEM_TYPE_INT */
...
VALUES (26482, 54, 1) /* USE_RADIUS_FLOAT */
     , (26482, 39, 0.4) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (26482, 13, True) /* ETHEREAL_BOOL */
     , (26482, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (26482, 14, True) /* GRAVITY_STATUS_BOOL */
     , (26482, 19, True) /* ATTACKABLE_BOOL */;
