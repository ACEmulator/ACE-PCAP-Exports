...
VALUES (32933, 65, 101) /* PLACEMENT_INT */
...
VALUES (32933, 16, 'A gem teeming with portal energy.') /* LONG_DESC_STRING */
     , (32933, 14, 'This portal summoning gem works best if used outside in a relatively flat area. (Quest Difficulty: 100+ Group)(Warning: You may not be able to recover your corpse.)') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (32933, 19, 500) /* VALUE_INT */
     , (32933, 5, 10) /* ENCUMB_VAL_INT */
     , (32933, 280, 1000) /* SHARED_COOLDOWN_INT */
     , (32933, 106, 210) /* ITEM_SPELLCRAFT_INT */
     , (32933, 108, 50) /* ITEM_MAX_MANA_INT */
     , (32933, 109, 0) /* ITEM_DIFFICULTY_INT */
     , (32933, 110, 0) /* ITEM_ALLEGIANCE_RANK_LIMIT_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (32933, 167, 15) /* COOLDOWN_DURATION_FLOAT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (32933, 157) /* SummonPortal1_SpellID */;
