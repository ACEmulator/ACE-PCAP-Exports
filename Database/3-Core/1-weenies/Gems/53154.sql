...
VALUES (53154, 65, 101) /* PLACEMENT_INT */
...
VALUES (53154, 16, 'A chunk of amber imbued with the energies of the Deru.') /* LONG_DESC_STRING */
     , (53154, 14, 'Use this on any 8th Tier Paragon Weapon to raise its maximum level to 9.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (53154, 33, 1) /* BONDED_INT */
     , (53154, 19, 25) /* VALUE_INT */
     , (53154, 5, 100) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (53154, 69, 0) /* IS_SELLABLE_BOOL */;
