...
VALUES (53072, 65, 101) /* PLACEMENT_INT */
...
VALUES (53072, 16, 'A chunk of amber imbued with the energies of the Deru.') /* LONG_DESC_STRING */
     , (53072, 14, 'Armor Tinkerers can use this gem on any pauldron-slot armor to give it a Vitality Boost of 1. **This item has a chance of failure and potential armor piece destruction**, and stacks with other tinkering effects.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (53072, 33, 1) /* BONDED_INT */
     , (53072, 19, 25) /* VALUE_INT */
     , (53072, 5, 100) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (53072, 69, 0) /* IS_SELLABLE_BOOL */;
