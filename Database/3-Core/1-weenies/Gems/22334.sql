...
VALUES (22334, 18, 22334, 1075855376, NULL, NULL, 131073);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (22334, 1, 'Loyalty Gem of Forgetfulness') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (22334, 8, 100673789) /* ICON_DID */
     , (22334, 50, 100673773) /* ICON_OVERLAY_DID */
     , (22334, 1, 33558087) /* SETUP_DID */
     , (22334, 6, 67111919) /* PALETTE_BASE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (22334, 53, 101) /* PLACEMENT_POSITION_INT */
     , (22334, 1, 2048) /* ITEM_TYPE_INT */
     , (22334, 5, 10) /* ENCUMB_VAL_INT */
     , (22334, 16, 8) /* ITEM_USEABLE_INT */
     , (22334, 93, 1044) /* PHYSICS_STATE_INT */
     , (22334, 9007, 38) /* Gem_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (22334, 13, True) /* ETHEREAL_BOOL */
     , (22334, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (22334, 14, True) /* GRAVITY_STATUS_BOOL */
     , (22334, 19, True) /* ATTACKABLE_BOOL */
     , (22334, 22, True) /* INSCRIBABLE_BOOL */;
