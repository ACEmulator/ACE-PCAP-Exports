...
VALUES (53157, 65, 101) /* PLACEMENT_INT */
...
VALUES (53157, 16, 'A chunk of amber imbued with the energies of the Deru.') /* LONG_DESC_STRING */
     , (53157, 14, 'Use this on any 11th Tier Paragon Weapon to raise its maximum level to 12.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (53157, 33, 1) /* BONDED_INT */
     , (53157, 19, 25) /* VALUE_INT */
     , (53157, 5, 100) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (53157, 69, 0) /* IS_SELLABLE_BOOL */;
