...
VALUES (8740, 18, 8740, 2650136, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (8740, 1, 'Shoushi Town Stamp') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8740, 8, 100671218) /* ICON_DID */
     , (8740, 1, 33556922) /* SETUP_DID */
     , (8740, 3, 536870932) /* SOUND_TABLE_DID */
     , (8740, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8740, 53, 101) /* PLACEMENT_POSITION_INT */
     ...
     , (8740, 9007, 38) /* Gem_WeenieType */;

INSERT INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (8740, 39, 3) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (8740, 13, True) /* ETHEREAL_BOOL */
     , (8740, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (8740, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8740, 19, True) /* ATTACKABLE_BOOL */
     , (8740, 22, True) /* INSCRIBABLE_BOOL */;
...
REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8740, 5, 10) /* ENCUMB_VAL_INT */
     , (8740, 11, 1) /* MAX_STACK_SIZE_INT */
     , (8740, 12, 1) /* STACK_SIZE_INT */
     , (8740, 19, 1) /* VALUE_INT */;
