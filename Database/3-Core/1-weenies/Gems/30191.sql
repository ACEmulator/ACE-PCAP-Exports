...
VALUES (30191, 16, 'Using this gem will increase your equipped melee or missile weapon''s damage by 50 for 15 minutes.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30191, 33, -1) /* BONDED_INT */
     , (30191, 17, 53) /* RARE_ID_INT */
     , (30191, 19, 0) /* VALUE_INT */
     , (30191, 5, 485) /* ENCUMB_VAL_INT */
     , (30191, 106, 325) /* ITEM_SPELLCRAFT_INT */
     , (30191, 26, 1) /* ACCOUNT_REQUIREMENTS_INT */
     , (30191, 108, 10000) /* ITEM_MAX_MANA_INT */
     , (30191, 109, 0) /* ITEM_DIFFICULTY_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (30191, 108, 1) /* RARE_USES_TIMER_BOOL */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (30191, 3688) /* BloodDrinkerRare_SpellID */;
