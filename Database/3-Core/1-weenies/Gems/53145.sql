...
VALUES (53145, 65, 101) /* PLACEMENT_INT */
...
VALUES (53145, 16, 'A chunk of amber imbued with the energies of the Deru.') /* LONG_DESC_STRING */
     , (53145, 14, 'Use this on any weapon, missile weapon or magic caster to imbue it with the magics of the Paragon Spell Set with a maximum item level of one.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (53145, 33, 1) /* BONDED_INT */
     , (53145, 19, 25) /* VALUE_INT */
     , (53145, 5, 100) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (53145, 69, 0) /* IS_SELLABLE_BOOL */;
