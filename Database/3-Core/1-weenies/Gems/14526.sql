...
VALUES (14526, 18, 14526, 2125840, NULL, NULL, 6145);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14526, 1, 'Fragment of the Lightning Prism') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14526, 8, 100672512) /* ICON_DID */
     , (14526, 1, 33557506) /* SETUP_DID */
     , (14526, 3, 536870932) /* SOUND_TABLE_DID */
     , (14526, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14526, 1, 2048) /* ITEM_TYPE_INT */
...
VALUES (14526, 13, True) /* ETHEREAL_BOOL */
     , (14526, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (14526, 14, True) /* GRAVITY_STATUS_BOOL */
     , (14526, 19, True) /* ATTACKABLE_BOOL */
     , (14526, 22, True) /* INSCRIBABLE_BOOL */;
...
VALUES (14526, 5, 1) /* ENCUMB_VAL_INT */
     , (14526, 11, 1) /* MAX_STACK_SIZE_INT */
     , (14526, 12, 1) /* STACK_SIZE_INT */;
