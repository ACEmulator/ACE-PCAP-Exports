...
VALUES (30810, 14, 'Double Click on this item to summon a portal to the burning tower of the Singularity Caul.') /* USE_STRING */
     , (30810, 15, 'A small Dericost totem, touched by the black madness. ') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (30810, 33, 0) /* BONDED_INT */
...
VALUES (30810, 157) /* SummonPortal1_SpellID */;
