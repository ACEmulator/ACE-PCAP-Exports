...
VALUES (53159, 65, 101) /* PLACEMENT_INT */
...
VALUES (53159, 16, 'A chunk of amber imbued with the energies of the Deru.') /* LONG_DESC_STRING */
     , (53159, 14, 'Use this on any 13th Tier Paragon Weapon to raise its maximum level to 14.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (53159, 33, 1) /* BONDED_INT */
     , (53159, 19, 25) /* VALUE_INT */
     , (53159, 5, 100) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (53159, 69, 0) /* IS_SELLABLE_BOOL */;
