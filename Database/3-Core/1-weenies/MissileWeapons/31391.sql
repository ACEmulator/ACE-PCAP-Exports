...
VALUES (31391, 14, 'Use this item on a locked door or chest to pick the lock.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (31391, 19, 3000) /* VALUE_INT */
     , (31391, 5, 50) /* ENCUMB_VAL_INT */
     , (31391, 91, 50) /* MAX_STRUCTURE_INT */
     , (31391, 173, 100) /* APPRAISAL_LOCKPICK_SUCCESS_PERCENT_INT */;
