...
VALUES (8250, 65, 101) /* PLACEMENT_INT */
...
VALUES (8250, 15, 'A finely crafted jack o'' lantern, made with a whittling knife.') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8250, 353, 10) /* WEAPON_TYPE_INT */
     , (8250, 19, 50) /* VALUE_INT */
     , (8250, 5, 20) /* ENCUMB_VAL_INT */
     , (8250, 45, 4) /* DAMAGE_TYPE_INT */
     , (8250, 49, 10) /* WEAPON_TIME_INT */
     , (8250, 48, 47) /* WEAPON_SKILL_INT */
     , (8250, 44, 14) /* DAMAGE_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (8250, 29, 1) /* WEAPON_DEFENSE_FLOAT */
     , (8250, 22, 0.25) /* DAMAGE_VARIANCE_FLOAT */
     , (8250, 63, 1) /* DAMAGE_MOD_FLOAT */
     , (8250, 21, 0) /* WEAPON_LENGTH_FLOAT */
     , (8250, 26, 0) /* MAXIMUM_VELOCITY_FLOAT */
     , (8250, 62, 1) /* WEAPON_OFFENSE_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (8250, 69, 0) /* IS_SELLABLE_BOOL */;
