...
VALUES (38568, 5, 'Society Armorsmith') /* TEMPLATE_STRING */;

REPLACE INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (38568, 16, 67110065) /* EYES_PALETTE_DID */
     , (38568, 9, 83890434) /* EYES_TEXTURE_DID */
     , (38568, 17, 67115908) /* SKIN_PALETTE_DID */
     , (38568, 10, 83890549) /* NOSE_TEXTURE_DID */
     , (38568, 11, 83890614) /* MOUTH_TEXTURE_DID */
     , (38568, 15, 67117070) /* HAIR_PALETTE_DID */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (38568, 113, 1) /* GENDER_INT */
     , (38568, 2, 31) /* CREATURE_TYPE_INT */
     , (38568, 134, 16) /* PLAYER_KILLER_STATUS_INT */
     , (38568, 25, 185) /* LEVEL_INT */
     , (38568, 188, 4) /* HERITAGE_GROUP_INT */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (38568, 64, 296) /* MAX_HEALTH_ATTRIBUTE_2ND */;
...
REPLACE INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (38568, 16, 67110064) /* EYES_PALETTE_DID */
     , (38568, 9, 83890506) /* EYES_TEXTURE_DID */
     , (38568, 17, 67115904) /* SKIN_PALETTE_DID */
     , (38568, 10, 83890551) /* NOSE_TEXTURE_DID */
     , (38568, 11, 83890662) /* MOUTH_TEXTURE_DID */
     , (38568, 15, 67117021) /* HAIR_PALETTE_DID */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (38568, 113, 1) /* GENDER_INT */
     , (38568, 289, 101) /* SOCIETY_RANK_RADBLO_INT */
     , (38568, 2, 31) /* CREATURE_TYPE_INT */
     , (38568, 134, 16) /* PLAYER_KILLER_STATUS_INT */
     , (38568, 25, 185) /* LEVEL_INT */
     , (38568, 281, 4) /* FACTION1_BITS_INT */
     , (38568, 188, 4) /* HERITAGE_GROUP_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (38568, 1, 290) /* STRENGTH_ATTRIBUTE */
     , (38568, 2, 200) /* ENDURANCE_ATTRIBUTE */
     , (38568, 4, 290) /* COORDINATION_ATTRIBUTE */
     , (38568, 8, 290) /* QUICKNESS_ATTRIBUTE */
     , (38568, 16, 200) /* FOCUS_ATTRIBUTE */
     , (38568, 32, 200) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (38568, 64, 296) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (38568, 128, 396) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (38568, 256, 396) /* MAX_MANA_ATTRIBUTE_2ND */;
