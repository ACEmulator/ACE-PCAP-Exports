...
VALUES (41075, 16, 67110063) /* EYES_PALETTE_DID */
     , (41075, 9, 83890487) /* EYES_TEXTURE_DID */
     , (41075, 17, 67110045) /* SKIN_PALETTE_DID */
     , (41075, 10, 83890550) /* NOSE_TEXTURE_DID */
     , (41075, 11, 83890614) /* MOUTH_TEXTURE_DID */
     , (41075, 15, 67117077) /* HAIR_PALETTE_DID */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41075, 113, 1) /* GENDER_INT */
     , (41075, 2, 31) /* CREATURE_TYPE_INT */
     , (41075, 307, 5) /* DAMAGE_RATING_INT */
     , (41075, 134, 16) /* PLAYER_KILLER_STATUS_INT */
     , (41075, 25, 8) /* LEVEL_INT */
     , (41075, 188, 3) /* HERITAGE_GROUP_INT */;

REPLACE INTO `ace_object_properties_attribute` (`aceObjectId`, `attributeId`, `attributeBase`)
VALUES (41075, 1, 110) /* STRENGTH_ATTRIBUTE */
     , (41075, 2, 90) /* ENDURANCE_ATTRIBUTE */
     , (41075, 4, 65) /* COORDINATION_ATTRIBUTE */
     , (41075, 8, 50) /* QUICKNESS_ATTRIBUTE */
     , (41075, 16, 40) /* FOCUS_ATTRIBUTE */
     , (41075, 32, 45) /* SELF_ATTRIBUTE */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (41075, 64, 55) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (41075, 128, 110) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (41075, 256, 55) /* MAX_MANA_ATTRIBUTE_2ND */;
