...
REPLACE INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3917, 16, 67109567) /* EYES_PALETTE_DID */
     , (3917, 9, 83890482) /* EYES_TEXTURE_DID */
     , (3917, 17, 67109560) /* SKIN_PALETTE_DID */
     , (3917, 10, 83890550) /* NOSE_TEXTURE_DID */
     , (3917, 11, 83890660) /* MOUTH_TEXTURE_DID */
     , (3917, 15, 67116996) /* HAIR_PALETTE_DID */;
...
REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (3917, 64, 110) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (3917, 128, 180) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (3917, 256, 105) /* MAX_MANA_ATTRIBUTE_2ND */;
