...
VALUES (31839, 5, 'Prisoner') /* TEMPLATE_STRING */;

REPLACE INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (31839, 16, 67109566) /* EYES_PALETTE_DID */
     , (31839, 9, 83890482) /* EYES_TEXTURE_DID */
     , (31839, 17, 67109559) /* SKIN_PALETTE_DID */
     , (31839, 10, 83890549) /* NOSE_TEXTURE_DID */
     , (31839, 11, 83890655) /* MOUTH_TEXTURE_DID */
     , (31839, 15, 67116994) /* HAIR_PALETTE_DID */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (31839, 113, 1) /* GENDER_INT */
     , (31839, 2, 31) /* CREATURE_TYPE_INT */
     , (31839, 134, 16) /* PLAYER_KILLER_STATUS_INT */
     , (31839, 25, 10) /* LEVEL_INT */
     , (31839, 188, 1) /* HERITAGE_GROUP_INT */;

REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (31839, 64, 45) /* MAX_HEALTH_ATTRIBUTE_2ND */;
