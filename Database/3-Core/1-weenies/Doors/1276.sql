...
VALUES (1276, 14, 'Use this item to open it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1276, 19, 0) /* VALUE_INT */
     , (1276, 38, 300) /* RESIST_LOCKPICK_INT */
     , (1276, 173, 99) /* APPRAISAL_LOCKPICK_SUCCESS_PERCENT_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (1276, 2, 0) /* OPEN_BOOL */
     , (1276, 3, 1) /* LOCKED_BOOL */;
