...
VALUES (7269, 16, 'This key has seen better days.') /* LONG_DESC_STRING */
     , (7269, 14, 'Use this key to open a Legendary Chest.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7269, 33, 0) /* BONDED_INT */
     , (7269, 369, 150) /* USE_REQUIRES_LEVEL_INT */
     , (7269, 114, 0) /* ATTUNED_INT */
     , (7269, 19, 10000) /* VALUE_INT */
     , (7269, 5, 30) /* ENCUMB_VAL_INT */
     , (7269, 91, 1) /* MAX_STRUCTURE_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (7269, 99, 0) /* IVORYABLE_BOOL */
     , (7269, 69, 0) /* IS_SELLABLE_BOOL */;
