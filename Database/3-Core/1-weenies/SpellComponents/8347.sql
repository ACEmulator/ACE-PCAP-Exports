...
VALUES (8347, 1, 'Brown Pea') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (8347, 8, 100671103) /* ICON_DID */
     , (8347, 1, 33555445) /* SETUP_DID */
     , (8347, 3, 536870932) /* SOUND_TABLE_DID */
     , (8347, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8347, 53, 101) /* PLACEMENT_POSITION_INT */
     , (8347, 1, 4096) /* ITEM_TYPE_INT */
     , (8347, 5, 50) /* ENCUMB_VAL_INT */
     , (8347, 11, 100) /* MAX_STACK_SIZE_INT */
     , (8347, 12, 5) /* STACK_SIZE_INT */
     , (8347, 16, 1) /* ITEM_USEABLE_INT */
     , (8347, 19, 15625) /* VALUE_INT */
...
VALUES (8347, 13, True) /* ETHEREAL_BOOL */
     , (8347, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (8347, 14, True) /* GRAVITY_STATUS_BOOL */
     , (8347, 19, True) /* ATTACKABLE_BOOL */;
...
VALUES (8347, 5, 10) /* ENCUMB_VAL_INT */
     , (8347, 11, 100) /* MAX_STACK_SIZE_INT */
