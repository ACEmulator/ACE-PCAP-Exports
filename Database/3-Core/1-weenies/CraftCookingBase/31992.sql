...
VALUES (31992, 65, 101) /* PLACEMENT_INT */
...
VALUES (31992, 16, 'An odd contraption used to modify the pigmentation of a piece of Ancient Falatacot Armor.') /* LONG_DESC_STRING */
     , (31992, 14, 'Use this on a piece of Ancient Armor.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (31992, 19, 70000) /* VALUE_INT */
     , (31992, 5, 350) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (31992, 69, 0) /* IS_SELLABLE_BOOL */;
