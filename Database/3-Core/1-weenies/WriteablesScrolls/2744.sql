...
VALUES (2744, 16, 'Inscribed spell: Strength Self IV
Increases the caster''s Strength by 25 points.') /* LONG_DESC_STRING */
     , (2744, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2744, 19, 100) /* VALUE_INT */
     , (2744, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2744, 1330) /* StrengthSelf4_SpellID */;
