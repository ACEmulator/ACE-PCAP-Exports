...
VALUES (20548, 65, 101) /* PLACEMENT_INT */
...
VALUES (20548, 16, 'Inscribed spell: Gears Unwound
Decreases the target''s Run skill by 40 points.') /* LONG_DESC_STRING */
     , (20548, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20548, 19, 2000) /* VALUE_INT */
     , (20548, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20548, 2258) /* LeadenFeetOther7_SpellID */;
