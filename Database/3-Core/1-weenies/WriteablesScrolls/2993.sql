...
VALUES (2993, 65, 101) /* PLACEMENT_INT */
...
VALUES (2993, 16, 'Inscribed spell: Blade Protection Self II
Reduces damage the caster takes from Slashing by 20%.') /* LONG_DESC_STRING */
     , (2993, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2993, 19, 5) /* VALUE_INT */
     , (2993, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2993, 1110) /* BladeProtectionSelf2_SpellID */;
