...
VALUES (2649, 65, 101) /* PLACEMENT_INT */
...
VALUES (2649, 16, 'Inscribed spell: Coordination Self II
Increases the caster''s Coordination by 15 points.') /* LONG_DESC_STRING */
     , (2649, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2649, 19, 5) /* VALUE_INT */
     , (2649, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2649, 1374) /* CoordinationSelf2_SpellID */;
