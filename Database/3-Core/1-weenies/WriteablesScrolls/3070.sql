...
VALUES (3070, 16, 'Inscribed spell: Piercing Protection Self IV
Reduces damage the caster takes from Piercing by 43%.') /* LONG_DESC_STRING */
     , (3070, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3070, 19, 100) /* VALUE_INT */
     , (3070, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3070, 1136) /* PiercingProtectionSelf4_SpellID */;
