...
VALUES (21328, 65, 101) /* PLACEMENT_INT */
...
VALUES (21328, 16, 'Inscribed spell: Lightning Arc VI
Shoots a bolt of lighting at the target. The bolt does 84-168 points of electrical damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21328, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21328, 19, 1000) /* VALUE_INT */
     , (21328, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21328, 2737) /* LightningArc6_SpellID */;
