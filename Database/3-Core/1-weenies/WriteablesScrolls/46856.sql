...
VALUES (46856, 65, 101) /* PLACEMENT_INT */
...
VALUES (46856, 16, 'Inscribed spell: Aura of Defender Other VI
Increases the Melee Defense skill modifier of a weapon or magic caster by 15%.') /* LONG_DESC_STRING */
     , (46856, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46856, 19, 1000) /* VALUE_INT */
     , (46856, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46856, 6004) /* defenderOther6_SpellID */;
