...
VALUES (3200, 65, 101) /* PLACEMENT_INT */
...
VALUES (3200, 16, 'Inscribed spell: Creature Enchantment Mastery Self IV
Increases the caster''s Creature Enchantment skill by 25 points.') /* LONG_DESC_STRING */
     , (3200, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3200, 19, 100) /* VALUE_INT */
     , (3200, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3200, 560) /* CreatureEnchantmentMasterySelf4_SpellID */;
