...
VALUES (21330, 65, 101) /* PLACEMENT_INT */
...
VALUES (21330, 16, 'Inscribed spell: Shock Arc I
Shoots a shock wave at the target. The wave does 16-30 points of bludgeoning damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21330, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21330, 19, 1) /* VALUE_INT */
     , (21330, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21330, 2746) /* ShockArc1_SpellID */;
