...
VALUES (3569, 65, 101) /* PLACEMENT_INT */
...
VALUES (3569, 16, 'Inscribed spell: War Magic Mastery Other III
Increases the target''s War Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3569, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3569, 19, 20) /* VALUE_INT */
     , (3569, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3569, 637) /* WarMagicMasteryOther3_SpellID */;
