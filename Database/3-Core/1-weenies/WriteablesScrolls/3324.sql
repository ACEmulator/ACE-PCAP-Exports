...
VALUES (3324, 16, 'Inscribed spell: Item Tinkering Expertise Self III
Increases the caster''s Item Tinkering skill by 20 points.') /* LONG_DESC_STRING */
     , (3324, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3324, 19, 20) /* VALUE_INT */
     , (3324, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3324, 728) /* ItemExpertiseSelf3_SpellID */;
