...
VALUES (3355, 65, 101) /* PLACEMENT_INT */
...
VALUES (3355, 16, 'Inscribed spell: Leadership Mastery Other IV
Increases the target''s Leadership skill by 25 points.') /* LONG_DESC_STRING */
     , (3355, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3355, 19, 100) /* VALUE_INT */
     , (3355, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3355, 907) /* LeadershipMasteryOther4_SpellID */;
