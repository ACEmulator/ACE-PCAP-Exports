...
VALUES (2650, 65, 101) /* PLACEMENT_INT */
...
VALUES (2650, 16, 'Inscribed spell: Coordination Self III
Increases the caster''s Coordination by 20 points.') /* LONG_DESC_STRING */
     , (2650, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2650, 19, 20) /* VALUE_INT */
     , (2650, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2650, 1375) /* CoordinationSelf3_SpellID */;
