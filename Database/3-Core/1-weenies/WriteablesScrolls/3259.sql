...
VALUES (3259, 65, 101) /* PLACEMENT_INT */
...
VALUES (3259, 16, 'Inscribed spell: Fealty Other III
Increases the target''s Loyalty skill by 20 points.') /* LONG_DESC_STRING */
     , (3259, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3259, 19, 20) /* VALUE_INT */
     , (3259, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3259, 954) /* FealtyOther3_SpellID */;
