...
VALUES (3470, 65, 101) /* PLACEMENT_INT */
...
VALUES (3470, 16, 'Inscribed spell: Magic Resistance Self IV
Increases the caster''s Magic Defense skill by 25 points.') /* LONG_DESC_STRING */
     , (3470, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3470, 19, 100) /* VALUE_INT */
     , (3470, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3470, 277) /* MagicResistanceSelf4_SpellID */;
