...
VALUES (3562, 65, 101) /* PLACEMENT_INT */
...
VALUES (3562, 16, 'Inscribed spell: Vulnerability Other VI
Decrease the target''s Melee Defense skill by 35 points.') /* LONG_DESC_STRING */
     , (3562, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3562, 19, 1000) /* VALUE_INT */
     , (3562, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3562, 234) /* VulnerabilityOther6_SpellID */;
