...
VALUES (2786, 65, 101) /* PLACEMENT_INT */
...
VALUES (2786, 16, 'Inscribed spell: Aura of Blood Drinker Self VI
Increases a weapon''s damage value by 20 points.') /* LONG_DESC_STRING */
     , (2786, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2786, 19, 1000) /* VALUE_INT */
     , (2786, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2786, 1616) /* BloodDrinker6_SpellID */;
