...
VALUES (28005, 65, 101) /* PLACEMENT_INT */
...
VALUES (28005, 16, 'Inscribed spell: Aura of Spirit Drinker Self IV
Increases the elemental damage bonus of an elemental magic caster by 4%.') /* LONG_DESC_STRING */
     , (28005, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28005, 19, 100) /* VALUE_INT */
     , (28005, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (28005, 3256) /* SpiritDrinker4_SpellID */;
