...
VALUES (3587, 65, 101) /* PLACEMENT_INT */
...
VALUES (3587, 16, 'Inscribed spell: Weapon Tinkering Expertise Self VI
Increases the caster''s Weapon Tinkering skill by 35 points.') /* LONG_DESC_STRING */
     , (3587, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3587, 19, 1000) /* VALUE_INT */
     , (3587, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3587, 779) /* WeaponExpertiseSelf6_SpellID */;
