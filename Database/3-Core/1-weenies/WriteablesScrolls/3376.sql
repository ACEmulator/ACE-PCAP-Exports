...
VALUES (3376, 65, 101) /* PLACEMENT_INT */
...
VALUES (3376, 16, 'Inscribed spell: Life Magic Mastery Self V
Increases the caster''s Life Magic skill by 30 points.') /* LONG_DESC_STRING */
     , (3376, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3376, 19, 200) /* VALUE_INT */
     , (3376, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3376, 609) /* LifeMagicMasterySelf5_SpellID */;
