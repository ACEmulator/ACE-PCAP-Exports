...
VALUES (43363, 65, 101) /* PLACEMENT_INT */
...
VALUES (43363, 16, 'Inscribed spell: Void Magic Mastery Self V
Increases the caster''s Void Magic skill by 30 points.') /* LONG_DESC_STRING */
     , (43363, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43363, 19, 200) /* VALUE_INT */
     , (43363, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43363, 5415) /* VoidMagicMasterySelf5_SpellID */;
