...
VALUES (3426, 65, 101) /* PLACEMENT_INT */
...
VALUES (3426, 16, 'Inscribed spell: Magic Yield Other V
Decreases the target''s Magic Defense skill by 30 points.') /* LONG_DESC_STRING */
     , (3426, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3426, 19, 200) /* VALUE_INT */
     , (3426, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3426, 284) /* MagicYieldOther5_SpellID */;
