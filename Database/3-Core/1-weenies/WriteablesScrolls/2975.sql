...
VALUES (2975, 65, 101) /* PLACEMENT_INT */
...
VALUES (2975, 16, 'Inscribed spell: Acid Protection Other IV
Reduces damage the target takes from acid by 43%.') /* LONG_DESC_STRING */
     , (2975, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2975, 19, 100) /* VALUE_INT */
     , (2975, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2975, 512) /* AcidProtectionOther4_SpellID */;
