...
VALUES (3154, 65, 101) /* PLACEMENT_INT */
...
VALUES (3154, 16, 'Inscribed spell: Armor Tinkering Ignorance Other III
Decreases the target''s Armor Tinkering skill by 20 points.') /* LONG_DESC_STRING */
     , (3154, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3154, 19, 20) /* VALUE_INT */
     , (3154, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3154, 722) /* ArmorIgnoranceOther3_SpellID */;
