...
VALUES (3246, 65, 101) /* PLACEMENT_INT */
...
VALUES (3246, 16, 'Inscribed spell: Deception Mastery Self V
Increases the caster''s Deception skill by 30 points.') /* LONG_DESC_STRING */
     , (3246, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3246, 19, 200) /* VALUE_INT */
     , (3246, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3246, 854) /* DeceptionMasterySelf5_SpellID */;
