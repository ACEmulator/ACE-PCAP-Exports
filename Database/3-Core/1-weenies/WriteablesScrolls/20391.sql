...
VALUES (20391, 65, 101) /* PLACEMENT_INT */
...
VALUES (20391, 16, 'Inscribed spell: Extinguish Life Magic Other
Dispels 3-6 negative Life Magic enchantments of level 2 or lower from the target.') /* LONG_DESC_STRING */
     , (20391, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20391, 19, 5) /* VALUE_INT */
     , (20391, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20391, 1963) /* DispelLifeBadOther2_SpellID */;
