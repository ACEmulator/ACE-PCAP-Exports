...
VALUES (43369, 65, 101) /* PLACEMENT_INT */
...
VALUES (43369, 16, 'Inscribed spell: Void Magic Mastery Self III
Increases the caster''s Void Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (43369, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43369, 19, 20) /* VALUE_INT */
     , (43369, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43369, 5413) /* VoidMagicMasterySelf3_SpellID */;
