...
VALUES (1896, 65, 101) /* PLACEMENT_INT */
...
VALUES (1896, 16, 'Inscribed spell: Aura of Hermetic Link Self I
Increases a magic casting implement''s mana conversion bonus by 10%.') /* LONG_DESC_STRING */
     , (1896, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1896, 19, 1) /* VALUE_INT */
     , (1896, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1896, 1475) /* TrueValue1_SpellID */;
