...
VALUES (20358, 65, 101) /* PLACEMENT_INT */
...
VALUES (20358, 16, 'Inscribed spell: Purge Item Magic
Dispels 3-6 negative Item Magic enchantments of level 5 or lower from the target.') /* LONG_DESC_STRING */
     , (20358, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20358, 19, 200) /* VALUE_INT */
     , (20358, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20358, 1945) /* DispelItemBadOther5_SpellID */;
