...
VALUES (2751, 65, 101) /* PLACEMENT_INT */
...
VALUES (2751, 16, 'Inscribed spell: Weakness Other VI
Decreases the target''s Strength by 35 points.') /* LONG_DESC_STRING */
     , (2751, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2751, 19, 1000) /* VALUE_INT */
     , (2751, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2751, 1343) /* WeaknessOther6_SpellID */;
