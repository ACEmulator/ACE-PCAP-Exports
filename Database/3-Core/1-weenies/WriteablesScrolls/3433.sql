...
VALUES (3433, 65, 101) /* PLACEMENT_INT */
...
VALUES (3433, 16, 'Inscribed spell: Mana Conversion Mastery Self II
Increases the caster''s Mana Conversion skill by 15 points.') /* LONG_DESC_STRING */
     , (3433, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3433, 19, 5) /* VALUE_INT */
     , (3433, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3433, 654) /* ManaMasterySelf2_SpellID */;
