...
VALUES (5970, 65, 101) /* PLACEMENT_INT */
...
VALUES (5970, 16, 'Inscribed spell: Fletching Mastery Other III
Increases the target''s Fletching skill by 20 points.') /* LONG_DESC_STRING */
     , (5970, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5970, 19, 20) /* VALUE_INT */
     , (5970, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5970, 1735) /* FletchingMasteryOther3_SpellID */;
