...
VALUES (43371, 65, 101) /* PLACEMENT_INT */
...
VALUES (43371, 16, 'Inscribed spell: Void Magic Mastery Other IV
Increases the target''s Void Magic skill by 25 points.') /* LONG_DESC_STRING */
     , (43371, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43371, 19, 100) /* VALUE_INT */
     , (43371, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43371, 5406) /* VoidMagicMasteryOther4_SpellID */;
