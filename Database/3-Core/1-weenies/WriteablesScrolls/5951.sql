...
VALUES (5951, 65, 101) /* PLACEMENT_INT */
...
VALUES (5951, 16, 'Inscribed spell: Cooking Mastery Other II
Increases the target''s Cooking skill by 15 points.') /* LONG_DESC_STRING */
     , (5951, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5951, 19, 5) /* VALUE_INT */
     , (5951, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5951, 1710) /* CookingMasteryOther2_SpellID */;
