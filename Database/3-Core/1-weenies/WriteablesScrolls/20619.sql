...
VALUES (20619, 16, 'Inscribed spell: Secondary Portal Tie
Links the caster to a targeted portal.') /* LONG_DESC_STRING */
     , (20619, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20619, 19, 100) /* VALUE_INT */
     , (20619, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20619, 2646) /* PortalTie2_SpellID */;
