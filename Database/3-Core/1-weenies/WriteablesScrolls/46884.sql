...
VALUES (46884, 65, 101) /* PLACEMENT_INT */
...
VALUES (46884, 16, 'Inscribed spell: Aura of Hermetic Link Other VII
Increases a magic casting implement''s mana conversion bonus by 70%.') /* LONG_DESC_STRING */
     , (46884, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46884, 19, 2000) /* VALUE_INT */
     , (46884, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46884, 5988) /* truevalueOther7_SpellID */;
