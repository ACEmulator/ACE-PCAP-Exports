...
VALUES (3256, 65, 101) /* PLACEMENT_INT */
...
VALUES (3256, 16, 'Inscribed spell: Faithlessness Other V
Decreases the target''s Loyalty skill by 30 points.') /* LONG_DESC_STRING */
     , (3256, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3256, 19, 200) /* VALUE_INT */
     , (3256, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3256, 968) /* FaithlessnessOther5_SpellID */;
