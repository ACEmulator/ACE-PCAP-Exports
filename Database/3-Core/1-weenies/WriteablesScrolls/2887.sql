...
VALUES (2887, 65, 101) /* PLACEMENT_INT */
...
VALUES (2887, 16, 'Inscribed spell: Aura of Hermetic Link Self II
Increases a magic casting implement''s mana conversion bonus by 20%.') /* LONG_DESC_STRING */
     , (2887, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2887, 19, 5) /* VALUE_INT */
     , (2887, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2887, 1476) /* TrueValue2_SpellID */;
