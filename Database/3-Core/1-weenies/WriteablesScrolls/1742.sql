...
VALUES (1742, 65, 101) /* PLACEMENT_INT */
...
VALUES (1742, 16, 'Inscribed spell: Heavy Weapon Mastery Other I
Increases the target''s Heavy Weapons skill by 10 points.') /* LONG_DESC_STRING */
     , (1742, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1742, 19, 1) /* VALUE_INT */
     , (1742, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1742, 412) /* SwordMasteryOther1_SpellID */;
