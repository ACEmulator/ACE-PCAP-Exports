...
VALUES (20538, 16, 'Inscribed spell: Aura of Defense
Increases the caster''s Melee Defense skill by 40 points.') /* LONG_DESC_STRING */
     , (20538, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20538, 19, 2000) /* VALUE_INT */
     , (20538, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20538, 2245) /* InvulnerabilitySelf7_SpellID */;
