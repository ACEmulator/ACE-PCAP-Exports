...
VALUES (20579, 65, 101) /* PLACEMENT_INT */
...
VALUES (20579, 16, 'Inscribed spell: Saladur''s Boon
Increases the target''s Run skill by 40 points.') /* LONG_DESC_STRING */
     , (20579, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20579, 19, 2000) /* VALUE_INT */
     , (20579, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20579, 2300) /* SprintOther7_SpellID */;
