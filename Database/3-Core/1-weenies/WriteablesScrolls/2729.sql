...
VALUES (2729, 65, 101) /* PLACEMENT_INT */
...
VALUES (2729, 16, 'Inscribed spell: Revitalize Self IV
Restores 40-80 points of the caster''s Stamina.') /* LONG_DESC_STRING */
     , (2729, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2729, 19, 100) /* VALUE_INT */
     , (2729, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2729, 1180) /* RevitalizeSelf4_SpellID */;
