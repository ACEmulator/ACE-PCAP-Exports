...
VALUES (3366, 65, 101) /* PLACEMENT_INT */
...
VALUES (3366, 16, 'Inscribed spell: Life Magic Ineptitude Other V
Decreases the target''s Life Magic skill by 30 points.') /* LONG_DESC_STRING */
     , (3366, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3366, 19, 200) /* VALUE_INT */
     , (3366, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3366, 627) /* LifeMagicIneptitudeOther5_SpellID */;
