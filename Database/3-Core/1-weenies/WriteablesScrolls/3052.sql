...
VALUES (3052, 65, 101) /* PLACEMENT_INT */
...
VALUES (3052, 16, 'Inscribed spell: Lightning Protection Other VI
Reduces damage the target takes from Lightning by 60%.') /* LONG_DESC_STRING */
     , (3052, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3052, 19, 1000) /* VALUE_INT */
     , (3052, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3052, 1077) /* LightningProtectionOther6_SpellID */;
