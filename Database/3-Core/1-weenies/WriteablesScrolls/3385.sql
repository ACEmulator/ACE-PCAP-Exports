...
VALUES (3385, 65, 101) /* PLACEMENT_INT */
...
VALUES (3385, 16, 'Inscribed spell: Lockpick Mastery Other IV
Increases the target''s Lockpick skill by 25 points.') /* LONG_DESC_STRING */
     , (3385, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3385, 19, 100) /* VALUE_INT */
     , (3385, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3385, 931) /* LockpickMasteryOther4_SpellID */;
