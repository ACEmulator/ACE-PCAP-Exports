...
VALUES (3740, 16, 'Inscribed spell: Infuse Mana Other VI
Drains one-quarter of the caster''s Mana and gives 150% of that to the target.') /* LONG_DESC_STRING */
     , (3740, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3740, 19, 1000) /* VALUE_INT */
     , (3740, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3740, 1259) /* InfuseMana6_SpellID */;
