...
VALUES (45294, 65, 101) /* PLACEMENT_INT */
...
VALUES (45294, 16, 'Inscribed spell: Recklessness Mastery Other III
Increases the target''s Recklessness skill by 20 points.') /* LONG_DESC_STRING */
     , (45294, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45294, 19, 20) /* VALUE_INT */
     , (45294, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45294, 5821) /* recklessnessmasteryother3_SpellID */;
