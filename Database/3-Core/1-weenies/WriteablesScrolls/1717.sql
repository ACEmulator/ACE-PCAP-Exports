...
VALUES (1717, 65, 101) /* PLACEMENT_INT */
...
VALUES (1717, 16, 'Inscribed spell: Life Magic Mastery Other I
Increases the target''s Life Magic skill by 10 points.') /* LONG_DESC_STRING */
     , (1717, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1717, 19, 1) /* VALUE_INT */
     , (1717, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1717, 611) /* LifeMagicMasteryOther1_SpellID */;
