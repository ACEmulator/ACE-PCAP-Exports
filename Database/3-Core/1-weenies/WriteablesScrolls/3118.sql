...
VALUES (3118, 16, 'Inscribed spell: Rejuvenation Other II
Increases the rate at which the target regains Stamina by 25%.') /* LONG_DESC_STRING */
     , (3118, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3118, 19, 5) /* VALUE_INT */
     , (3118, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3118, 184) /* RejuvenationOther2_SpellID */;
