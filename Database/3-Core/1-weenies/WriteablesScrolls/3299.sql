...
VALUES (3299, 65, 101) /* PLACEMENT_INT */
...
VALUES (3299, 16, 'Inscribed spell: Invulnerability Self III
Increases the caster''s Melee Defense skill by 20 points.') /* LONG_DESC_STRING */
     , (3299, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3299, 19, 20) /* VALUE_INT */
     , (3299, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3299, 246) /* InvulnerabilitySelf3_SpellID */;
