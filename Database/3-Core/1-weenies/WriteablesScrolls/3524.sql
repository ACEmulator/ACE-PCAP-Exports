...
VALUES (3524, 16, 'Inscribed spell: Heavy Weapon Mastery Self III
Increases the caster''s Heavy Weapons skill by 20 points.') /* LONG_DESC_STRING */
     , (3524, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3524, 19, 20) /* VALUE_INT */
     , (3524, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3524, 420) /* SwordMasterySelf3_SpellID */;
