...
VALUES (5977, 65, 101) /* PLACEMENT_INT */
...
VALUES (5977, 16, 'Inscribed spell: Fletching Mastery Self IV
Increases the caster''s Fletching skill by 25 points.') /* LONG_DESC_STRING */
     , (5977, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5977, 19, 100) /* VALUE_INT */
     , (5977, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5977, 1742) /* FletchingMasterySelf4_SpellID */;
