...
VALUES (3334, 65, 101) /* PLACEMENT_INT */
...
VALUES (3334, 16, 'Inscribed spell: Jumping Mastery Other III
Increases the target''s Jump skill by 20 points.') /* LONG_DESC_STRING */
     , (3334, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3334, 19, 20) /* VALUE_INT */
     , (3334, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3334, 978) /* JumpingMasteryOther3_SpellID */;
