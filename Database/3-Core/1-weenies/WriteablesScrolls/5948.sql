...
VALUES (5948, 65, 101) /* PLACEMENT_INT */
...
VALUES (5948, 16, 'Inscribed spell: Cooking Ineptitude Other V
Decreases the target''s Cooking skill by 30 points.') /* LONG_DESC_STRING */
     , (5948, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5948, 19, 200) /* VALUE_INT */
     , (5948, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5948, 1725) /* CookingIneptitudeOther5_SpellID */;
