...
VALUES (2846, 16, 'Inscribed spell: Impenetrability VI
Improves a shield or piece of armor''s armor value by 200 points. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (2846, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2846, 19, 1000) /* VALUE_INT */
     , (2846, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2846, 1486) /* Impenetrability6_SpellID */;
