...
VALUES (5993, 16, 'Inscribed spell: Alchemy Mastery Self II
Increases the caster''s Alchemy skill by 15 points.') /* LONG_DESC_STRING */
     , (5993, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5993, 19, 5) /* VALUE_INT */
     , (5993, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5993, 1764) /* AlchemyMasterySelf2_SpellID */;
