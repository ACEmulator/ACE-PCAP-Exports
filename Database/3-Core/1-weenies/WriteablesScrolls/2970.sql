...
VALUES (2970, 65, 101) /* PLACEMENT_INT */
...
VALUES (2970, 16, 'Inscribed spell: Whirling Blade IV
Shoots a magical blade at the target. The bolt does 52-105 points of slashing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2970, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2970, 19, 100) /* VALUE_INT */
     , (2970, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2970, 95) /* WhirlingBlade4_SpellID */;
