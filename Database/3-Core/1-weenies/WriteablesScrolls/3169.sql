...
VALUES (3169, 65, 101) /* PLACEMENT_INT */
...
VALUES (3169, 16, 'Inscribed spell: Light Weapon Mastery Self III
Increases the caster''s Light Weapons skill by 20 points.') /* LONG_DESC_STRING */
     , (3169, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3169, 19, 20) /* VALUE_INT */
     , (3169, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3169, 300) /* AxeMasterySelf3_SpellID */;
