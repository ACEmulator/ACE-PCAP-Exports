...
VALUES (2746, 65, 101) /* PLACEMENT_INT */
...
VALUES (2746, 16, 'Inscribed spell: Strength Self VI
Increases the caster''s Strength by 35 points.') /* LONG_DESC_STRING */
     , (2746, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2746, 19, 1000) /* VALUE_INT */
     , (2746, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2746, 1332) /* StrengthSelf6_SpellID */;
