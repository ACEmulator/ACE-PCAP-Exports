...
VALUES (3269, 65, 101) /* PLACEMENT_INT */
...
VALUES (3269, 16, 'Inscribed spell: Healing Ineptitude Other III
Decreases the target''s Healing skill by 20 points.') /* LONG_DESC_STRING */
     , (3269, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3269, 19, 20) /* VALUE_INT */
     , (3269, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3269, 894) /* HealingIneptitudeOther3_SpellID */;
