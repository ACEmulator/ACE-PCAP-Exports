...
VALUES (45354, 65, 101) /* PLACEMENT_INT */
...
VALUES (45354, 16, 'Inscribed spell: Sneak Attack Mastery Self VII
Increases the caster''s Sneak Attack skill by 40 points.') /* LONG_DESC_STRING */
     , (45354, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45354, 19, 2000) /* VALUE_INT */
     , (45354, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45354, 5881) /* sneakattackmasteryself7_SpellID */;
