...
VALUES (43360, 65, 101) /* PLACEMENT_INT */
...
VALUES (43360, 16, 'Inscribed spell: Void Magic Mastery Self II
Increases the caster''s Void Magic skill by 15 points.') /* LONG_DESC_STRING */
     , (43360, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43360, 19, 5) /* VALUE_INT */
     , (43360, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43360, 5412) /* VoidMagicMasterySelf2_SpellID */;
