...
VALUES (3585, 65, 101) /* PLACEMENT_INT */
...
VALUES (3585, 16, 'Inscribed spell: Weapon Tinkering Expertise Self IV
Increases the caster''s Weapon Tinkering skill by 25 points.') /* LONG_DESC_STRING */
     , (3585, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3585, 19, 100) /* VALUE_INT */
     , (3585, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3585, 777) /* WeaponExpertiseSelf4_SpellID */;
