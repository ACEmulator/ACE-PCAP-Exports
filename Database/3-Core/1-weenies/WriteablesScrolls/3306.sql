...
VALUES (3306, 65, 101) /* PLACEMENT_INT */
...
VALUES (3306, 16, 'Inscribed spell: Item Enchantment Ineptitude Other V
Decreases the target''s Item Enchantment skill by 30 points.') /* LONG_DESC_STRING */
     , (3306, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3306, 19, 200) /* VALUE_INT */
     , (3306, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3306, 597) /* ItemEnchantmentIneptitudeOther5_SpellID */;
