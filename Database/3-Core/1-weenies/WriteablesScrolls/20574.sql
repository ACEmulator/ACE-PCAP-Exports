...
VALUES (20574, 65, 101) /* PLACEMENT_INT */
...
VALUES (20574, 16, 'Inscribed spell: Web of Resistance
Increases the target''s Magic Defense skill by 40 points.') /* LONG_DESC_STRING */
     , (20574, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20574, 19, 2000) /* VALUE_INT */
     , (20574, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20574, 2280) /* MagicResistanceOther7_SpellID */;
