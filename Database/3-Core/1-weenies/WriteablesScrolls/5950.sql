...
VALUES (5950, 65, 101) /* PLACEMENT_INT */
...
VALUES (5950, 16, 'Inscribed spell: Cooking Mastery Other I
Increases the target''s Cooking skill by 10 points.') /* LONG_DESC_STRING */
     , (5950, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5950, 19, 1) /* VALUE_INT */
     , (5950, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5950, 1709) /* CookingMasteryOther1_SpellID */;
