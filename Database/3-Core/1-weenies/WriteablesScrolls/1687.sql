...
VALUES (1687, 65, 101) /* PLACEMENT_INT */
...
VALUES (1687, 16, 'Inscribed spell: Missile Weapon Mastery Self I
Increases the caster''s Missile Weapons skill by 10 points.') /* LONG_DESC_STRING */
     , (1687, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1687, 19, 1) /* VALUE_INT */
     , (1687, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1687, 467) /* BowMasterySelf1_SpellID */;
