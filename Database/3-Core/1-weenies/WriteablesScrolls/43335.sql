...
VALUES (43335, 65, 101) /* PLACEMENT_INT */
...
VALUES (43335, 16, 'Inscribed spell: Festering Curse VII
The heal rating of the target is decreased by 35.') /* LONG_DESC_STRING */
     , (43335, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43335, 19, 2000) /* VALUE_INT */
     , (43335, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43335, 5377) /* CurseFestering7_SpellID */;
