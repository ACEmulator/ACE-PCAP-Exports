...
VALUES (1559, 65, 101) /* PLACEMENT_INT */
...
VALUES (1559, 16, 'Inscribed spell: Weakness Other I
Decreases the target''s Strength by 10 points.') /* LONG_DESC_STRING */
     , (1559, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1559, 19, 1) /* VALUE_INT */
     , (1559, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1559, 3) /* WeaknessOther1_SpellID */;
