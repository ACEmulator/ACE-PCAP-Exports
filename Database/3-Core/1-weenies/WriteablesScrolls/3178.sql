...
VALUES (3178, 65, 101) /* PLACEMENT_INT */
...
VALUES (3178, 16, 'Inscribed spell: Missile Weapon Mastery Other II
Increases the target''s Missile Weapons skill by 15 points.') /* LONG_DESC_STRING */
     , (3178, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3178, 19, 5) /* VALUE_INT */
     , (3178, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3178, 462) /* BowMasteryOther2_SpellID */;
