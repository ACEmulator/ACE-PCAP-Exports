...
VALUES (3030, 65, 101) /* PLACEMENT_INT */
...
VALUES (3030, 16, 'Inscribed spell: Cold Vulnerability Other IV
Increases damage the target takes from Cold by 75%.') /* LONG_DESC_STRING */
     , (3030, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3030, 19, 100) /* VALUE_INT */
     , (3030, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3030, 1063) /* ColdVulnerabilityOther4_SpellID */;
