...
VALUES (1857, 65, 101) /* PLACEMENT_INT */
...
VALUES (1857, 16, 'Inscribed spell: Fester Other I
Decrease target''s natural healing rate by 9%.') /* LONG_DESC_STRING */
     , (1857, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1857, 19, 1) /* VALUE_INT */
     , (1857, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1857, 171) /* FesterOther1_SpellID */;
