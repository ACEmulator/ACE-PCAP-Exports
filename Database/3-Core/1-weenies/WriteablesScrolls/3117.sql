...
VALUES (3117, 65, 101) /* PLACEMENT_INT */
...
VALUES (3117, 16, 'Inscribed spell: Regeneration Self VI
Increase caster''s natural healing rate by 85%.') /* LONG_DESC_STRING */
     , (3117, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3117, 19, 1000) /* VALUE_INT */
     , (3117, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3117, 170) /* RegenerationSelf6_SpellID */;
