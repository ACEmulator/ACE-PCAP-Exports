...
VALUES (9641, 65, 101) /* PLACEMENT_INT */
...
VALUES (9641, 16, 'Inscribed spell: Mana to Health Self III
Drains one-half of the caster''s Mana and gives 110% of that to his/her Health (maximum of 150).') /* LONG_DESC_STRING */
     , (9641, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9641, 19, 20) /* VALUE_INT */
     , (9641, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9641, 1292) /* ManatoHealthSelf3_SpellID */;
