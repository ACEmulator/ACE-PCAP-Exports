...
VALUES (3471, 65, 101) /* PLACEMENT_INT */
...
VALUES (3471, 16, 'Inscribed spell: Magic Resistance Self V
Increases the caster''s Magic Defense skill by 30 points.') /* LONG_DESC_STRING */
     , (3471, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3471, 19, 200) /* VALUE_INT */
     , (3471, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3471, 278) /* MagicResistanceSelf5_SpellID */;
