...
VALUES (7522, 18, 7522, 6307864, NULL, NULL, 135297);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7522, 1, 'Scroll of Hammering Crawler') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7522, 8, 100677009) /* ICON_DID */
     , (7522, 1, 33554826) /* SETUP_DID */
     , (7522, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (7522, 28, 1845) /* SPELL_DID - ShockwaveWall_SpellID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7522, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (7522, 13, True) /* ETHEREAL_BOOL */
     , (7522, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (7522, 14, True) /* GRAVITY_STATUS_BOOL */
