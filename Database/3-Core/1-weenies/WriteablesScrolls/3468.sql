...
VALUES (3468, 65, 101) /* PLACEMENT_INT */
...
VALUES (3468, 16, 'Inscribed spell: Magic Resistance Self II
Increases the caster''s Magic Defense skill by 15 points.') /* LONG_DESC_STRING */
     , (3468, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3468, 19, 5) /* VALUE_INT */
     , (3468, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3468, 275) /* MagicResistanceSelf2_SpellID */;
