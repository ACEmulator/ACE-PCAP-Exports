...
VALUES (20440, 65, 101) /* PLACEMENT_INT */
...
VALUES (20440, 16, 'Inscribed spell: Ilservian''s Flame
Shoots a bolt of flame at the target.  The bolt does 115-189 points of fire damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (20440, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20440, 19, 2000) /* VALUE_INT */
     , (20440, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20440, 2128) /* FlameBolt7_SpellID */;
