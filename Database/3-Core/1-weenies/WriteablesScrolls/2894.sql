...
VALUES (2894, 65, 101) /* PLACEMENT_INT */
...
VALUES (2894, 16, 'Inscribed spell: Turn Blade III
Decreases a weapon''s Attack Skill modifier by 7.5 percentage points.') /* LONG_DESC_STRING */
     , (2894, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2894, 19, 20) /* VALUE_INT */
     , (2894, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2894, 1595) /* TurnBlade3_SpellID */;
