...
VALUES (3076, 65, 101) /* PLACEMENT_INT */
...
VALUES (3076, 16, 'Inscribed spell: Piercing Vulnerability Other V
Increases damage the target takes from Piercing by 100%.') /* LONG_DESC_STRING */
     , (3076, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3076, 19, 200) /* VALUE_INT */
     , (3076, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3076, 1155) /* PiercingVulnerabilityOther5_SpellID */;
