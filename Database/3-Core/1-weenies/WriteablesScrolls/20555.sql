...
VALUES (20555, 65, 101) /* PLACEMENT_INT */
...
VALUES (20555, 16, 'Inscribed spell: Fat Fingers
Decreases the target''s Lockpick skill by 40 points.') /* LONG_DESC_STRING */
     , (20555, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20555, 19, 2000) /* VALUE_INT */
     , (20555, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20555, 2268) /* LockpickIneptitudeOther7_SpellID */;
