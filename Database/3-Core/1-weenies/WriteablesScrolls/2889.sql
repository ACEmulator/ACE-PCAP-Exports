...
VALUES (2889, 65, 101) /* PLACEMENT_INT */
...
VALUES (2889, 16, 'Inscribed spell: Aura of Hermetic Link Self IV
Increases a magic casting implement''s mana conversion bonus by 40%.') /* LONG_DESC_STRING */
     , (2889, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2889, 19, 100) /* VALUE_INT */
     , (2889, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2889, 1478) /* TrueValue4_SpellID */;
