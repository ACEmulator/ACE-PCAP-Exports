...
VALUES (3339, 65, 101) /* PLACEMENT_INT */
...
VALUES (3339, 16, 'Inscribed spell: Jumping Mastery Self III
Increases the caster''s Jump skill by 20 points.') /* LONG_DESC_STRING */
     , (3339, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3339, 19, 20) /* VALUE_INT */
     , (3339, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3339, 972) /* JumpingMasterySelf3_SpellID */;
