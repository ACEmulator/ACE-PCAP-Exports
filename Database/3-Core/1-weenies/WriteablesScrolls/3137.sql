...
VALUES (3137, 65, 101) /* PLACEMENT_INT */
...
VALUES (3137, 16, 'Inscribed spell: Arcane Enlightenment Other VI
Increases the target''s Arcane Lore skill by 35 points.') /* LONG_DESC_STRING */
     , (3137, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3137, 19, 1000) /* VALUE_INT */
     , (3137, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3137, 689) /* ArcaneEnlightenmentOther6_SpellID */;
