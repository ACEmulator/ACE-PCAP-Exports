...
VALUES (3430, 65, 101) /* PLACEMENT_INT */
...
VALUES (3430, 16, 'Inscribed spell: Mana Conversion Mastery Other IV
Increases the target''s Mana Conversion skill by 25 points.') /* LONG_DESC_STRING */
     , (3430, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3430, 19, 100) /* VALUE_INT */
     , (3430, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3430, 662) /* ManaMasteryOther4_SpellID */;
