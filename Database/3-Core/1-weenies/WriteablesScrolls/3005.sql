...
VALUES (3005, 65, 101) /* PLACEMENT_INT */
...
VALUES (3005, 16, 'Inscribed spell: Bludgeoning Protection Other IV
Reduces damage the target takes from Bludgeoning by 43%.') /* LONG_DESC_STRING */
     , (3005, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3005, 19, 100) /* VALUE_INT */
     , (3005, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3005, 1027) /* BludgeonProtectionOther4_SpellID */;
