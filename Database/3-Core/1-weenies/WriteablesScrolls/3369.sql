...
Increases the target''s Life Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3369, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3369, 19, 20) /* VALUE_INT */
     , (3369, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3369, 613) /* LifeMagicMasteryOther3_SpellID */;
