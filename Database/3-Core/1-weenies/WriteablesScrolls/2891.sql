...
VALUES (2891, 65, 101) /* PLACEMENT_INT */
...
VALUES (2891, 16, 'Inscribed spell: Aura of Hermetic Link Self V
Increases a magic casting implement''s mana conversion bonus by 50%.') /* LONG_DESC_STRING */
     , (2891, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2891, 19, 200) /* VALUE_INT */
     , (2891, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2891, 1479) /* TrueValue5_SpellID */;
