...
VALUES (20470, 65, 101) /* PLACEMENT_INT */
...
VALUES (20470, 16, 'Inscribed spell: Swordsman''s Gift
Increases damage the target takes from Slashing by 185%.') /* LONG_DESC_STRING */
     , (20470, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20470, 19, 2000) /* VALUE_INT */
     , (20470, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20470, 2164) /* BladeVulnerabilityOther7_SpellID */;
