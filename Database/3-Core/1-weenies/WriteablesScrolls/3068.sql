...
VALUES (3068, 65, 101) /* PLACEMENT_INT */
...
VALUES (3068, 16, 'Inscribed spell: Piercing Protection Self II
Reduces damage the caster takes from Piercing by 20%.') /* LONG_DESC_STRING */
     , (3068, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3068, 19, 5) /* VALUE_INT */
     , (3068, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3068, 1134) /* PiercingProtectionSelf2_SpellID */;
