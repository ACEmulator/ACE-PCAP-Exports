...
VALUES (2911, 65, 101) /* PLACEMENT_INT */
...
VALUES (2911, 16, 'Inscribed spell: Acid Stream VI
Shoots a stream of acid at the target. The stream does 84-168 points of acid damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2911, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2911, 19, 1000) /* VALUE_INT */
     , (2911, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2911, 63) /* AcidStream6_SpellID */;
