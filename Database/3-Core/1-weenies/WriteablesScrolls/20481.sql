...
VALUES (20481, 65, 101) /* PLACEMENT_INT */
...
VALUES (20481, 16, 'Inscribed spell: Storm''s Blessing
Reduces damage the caster takes from Lightning by 65%.') /* LONG_DESC_STRING */
     , (20481, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20481, 19, 2000) /* VALUE_INT */
     , (20481, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20481, 2159) /* LightningProtectionSelf7_SpellID */;
