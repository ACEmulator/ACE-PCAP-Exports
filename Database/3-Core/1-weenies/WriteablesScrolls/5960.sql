...
VALUES (5960, 65, 101) /* PLACEMENT_INT */
...
VALUES (5960, 16, 'Inscribed spell: Cooking Mastery Self V
Increases the caster''s Cooking skill by 30 points.') /* LONG_DESC_STRING */
     , (5960, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5960, 19, 200) /* VALUE_INT */
     , (5960, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5960, 1719) /* CookingMasterySelf5_SpellID */;
