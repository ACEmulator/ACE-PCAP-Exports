...
VALUES (20247, 65, 101) /* PLACEMENT_INT */
...
VALUES (20247, 16, 'Inscribed spell: Void''s Call
Drains 42-79 points of the target''s Mana.') /* LONG_DESC_STRING */
     , (20247, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20247, 19, 2000) /* VALUE_INT */
     , (20247, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20247, 2078) /* ManaDrainOther7_SpellID */;
