...
VALUES (21319, 65, 101) /* PLACEMENT_INT */
...
VALUES (21319, 16, 'Inscribed spell: Frost Arc IV
Shoots a bolt of cold at the target. The bolt does 52-105 points of cold damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21319, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21319, 19, 100) /* VALUE_INT */
     , (21319, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21319, 2728) /* FrostArc4_SpellID */;
