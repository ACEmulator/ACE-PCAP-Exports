...
VALUES (41264, 65, 101) /* PLACEMENT_INT */
...
VALUES (41264, 16, 'Inscribed spell: Two Handed Combat Mastery Self I
Increases the caster''s Two Handed Combat skill by 10 points.') /* LONG_DESC_STRING */
     , (41264, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41264, 19, 1) /* VALUE_INT */
     , (41264, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (41264, 5099) /* twohandedmasteryself1_SpellID */;
