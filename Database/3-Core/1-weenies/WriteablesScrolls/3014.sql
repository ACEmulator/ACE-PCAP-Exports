...
VALUES (3014, 65, 101) /* PLACEMENT_INT */
...
VALUES (3014, 16, 'Inscribed spell: Bludgeoning Vulnerability Other III
Increases damage the target takes from Bludgeoning by 50%.') /* LONG_DESC_STRING */
     , (3014, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3014, 19, 20) /* VALUE_INT */
     , (3014, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3014, 1050) /* BludgeonVulnerabilityOther3_SpellID */;
