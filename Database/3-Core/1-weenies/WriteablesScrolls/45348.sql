...
VALUES (45348, 65, 101) /* PLACEMENT_INT */
...
VALUES (45348, 16, 'Inscribed spell: Sneak Attack Mastery Self I
Increases the caster''s Sneak Attack skill by 10 points.') /* LONG_DESC_STRING */
     , (45348, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45348, 19, 1) /* VALUE_INT */
     , (45348, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45348, 5875) /* sneakattackmasteryself1_SpellID */;
