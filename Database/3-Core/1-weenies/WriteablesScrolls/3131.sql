...
VALUES (3131, 65, 101) /* PLACEMENT_INT */
...
VALUES (3131, 16, 'Inscribed spell: Arcane Benightedness Other V
Decreases the target''s Arcane Lore skill by 30 points.') /* LONG_DESC_STRING */
     , (3131, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3131, 19, 200) /* VALUE_INT */
     , (3131, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3131, 700) /* ArcaneBenightednessOther5_SpellID */;
