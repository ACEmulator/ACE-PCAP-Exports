...
VALUES (20465, 65, 101) /* PLACEMENT_INT */
...
VALUES (20465, 16, 'Inscribed spell: Caustic Boon
Reduces damage the target takes from acid by 65%.') /* LONG_DESC_STRING */
     , (20465, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20465, 19, 2000) /* VALUE_INT */
     , (20465, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20465, 2148) /* AcidProtectionOther7_SpellID */;
