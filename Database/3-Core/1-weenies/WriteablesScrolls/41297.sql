...
VALUES (41297, 65, 101) /* PLACEMENT_INT */
...
VALUES (41297, 16, 'Inscribed spell: Two Handed Combat Mastery Other II
Increases the target''s Two Handed Combat skill by 15 points.') /* LONG_DESC_STRING */
     , (41297, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41297, 19, 5) /* VALUE_INT */
     , (41297, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (41297, 5092) /* twohandedmastery2_SpellID */;
