...
VALUES (3315, 65, 101) /* PLACEMENT_INT */
...
VALUES (3315, 16, 'Inscribed spell: Item Enchantment Mastery Self IV
Increases the caster''s Item Enchantment skill by 25 points.') /* LONG_DESC_STRING */
     , (3315, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3315, 19, 100) /* VALUE_INT */
     , (3315, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3315, 584) /* ItemEnchantmentMasterySelf4_SpellID */;
