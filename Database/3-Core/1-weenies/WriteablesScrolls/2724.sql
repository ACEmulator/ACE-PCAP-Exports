...
VALUES (2724, 65, 101) /* PLACEMENT_INT */
...
VALUES (2724, 16, 'Inscribed spell: Revitalize Other IV
Restores 40-80 points of the target''s Stamina.') /* LONG_DESC_STRING */
     , (2724, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2724, 19, 100) /* VALUE_INT */
     , (2724, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2724, 1186) /* RevitalizeOther4_SpellID */;
