...
VALUES (46852, 16, 'Inscribed spell: Aura of Hermetic Link Other V
Increases a magic casting implement''s mana conversion bonus by 50%.') /* LONG_DESC_STRING */
     , (46852, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46852, 19, 200) /* VALUE_INT */
     , (46852, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46852, 5986) /* truevalueOther5_SpellID */;
