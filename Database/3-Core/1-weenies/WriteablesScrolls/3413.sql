...
VALUES (3413, 65, 101) /* PLACEMENT_INT */
...
VALUES (3413, 16, 'Inscribed spell: Magic Item Tinkering Expertise Self II
Increases the caster''s Magic Item Tinkering skill by 15 points.') /* LONG_DESC_STRING */
     , (3413, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3413, 19, 5) /* VALUE_INT */
     , (3413, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3413, 751) /* MagicItemExpertiseSelf2_SpellID */;
