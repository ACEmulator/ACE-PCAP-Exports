...
VALUES (3488, 65, 101) /* PLACEMENT_INT */
...
VALUES (3488, 16, 'Inscribed spell: Sprint Other II
Increases the target''s Run skill by 15 points.') /* LONG_DESC_STRING */
     , (3488, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3488, 19, 5) /* VALUE_INT */
     , (3488, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3488, 989) /* SprintOther2_SpellID */;
