...
VALUES (2661, 65, 101) /* PLACEMENT_INT */
...
VALUES (2661, 16, 'Inscribed spell: Endurance Self IV
Increases the caster''s Endurance by 25 points.') /* LONG_DESC_STRING */
     , (2661, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2661, 19, 100) /* VALUE_INT */
     , (2661, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2661, 1352) /* EnduranceSelf4_SpellID */;
