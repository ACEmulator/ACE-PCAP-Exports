...
VALUES (3156, 65, 101) /* PLACEMENT_INT */
...
VALUES (3156, 16, 'Inscribed spell: Armor Tinkering Ignorance Other V
Decreases the target''s Armor Tinkering skill by 30 points.') /* LONG_DESC_STRING */
     , (3156, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3156, 19, 200) /* VALUE_INT */
     , (3156, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3156, 724) /* ArmorIgnoranceOther5_SpellID */;
