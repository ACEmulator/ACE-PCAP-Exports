...
VALUES (20500, 16, 'Inscribed spell: Aliester''s Blessing
Increases the caster''s Arcane Lore skill by 40 points.') /* LONG_DESC_STRING */
     , (20500, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20500, 19, 2000) /* VALUE_INT */
     , (20500, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20500, 2195) /* ArcaneEnlightenmentSelf7_SpellID */;
