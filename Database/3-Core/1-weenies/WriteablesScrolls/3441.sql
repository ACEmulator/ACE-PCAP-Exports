...
VALUES (3441, 65, 101) /* PLACEMENT_INT */
...
VALUES (3441, 16, 'Inscribed spell: Monster Attunement Other V
Increases the target''s Assess Monster skill by 30 points.') /* LONG_DESC_STRING */
     , (3441, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3441, 19, 200) /* VALUE_INT */
     , (3441, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3441, 808) /* MonsterAttunementOther5_SpellID */;
