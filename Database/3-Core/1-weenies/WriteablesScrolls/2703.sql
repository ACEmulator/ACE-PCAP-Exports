...
VALUES (2703, 65, 101) /* PLACEMENT_INT */
...
VALUES (2703, 16, 'Inscribed spell: Imperil Other III
Decreases the target''s natural armor by 75 points.') /* LONG_DESC_STRING */
     , (2703, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2703, 19, 20) /* VALUE_INT */
     , (2703, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2703, 1324) /* ImperilOther3_SpellID */;
