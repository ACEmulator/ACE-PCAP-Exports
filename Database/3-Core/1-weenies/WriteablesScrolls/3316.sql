...
VALUES (3316, 65, 101) /* PLACEMENT_INT */
...
VALUES (3316, 16, 'Inscribed spell: Item Enchantment Mastery Self V
Increases the caster''s Item Enchantment skill by 30 points.') /* LONG_DESC_STRING */
     , (3316, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3316, 19, 200) /* VALUE_INT */
     , (3316, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3316, 585) /* ItemEnchantmentMasterySelf5_SpellID */;
