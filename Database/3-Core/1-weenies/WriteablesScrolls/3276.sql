...
VALUES (3276, 65, 101) /* PLACEMENT_INT */
...
VALUES (3276, 16, 'Inscribed spell: Healing Mastery Other V
Increases the target''s Healing skill by 30 points.') /* LONG_DESC_STRING */
     , (3276, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3276, 19, 200) /* VALUE_INT */
     , (3276, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3276, 884) /* HealingMasteryOther5_SpellID */;
