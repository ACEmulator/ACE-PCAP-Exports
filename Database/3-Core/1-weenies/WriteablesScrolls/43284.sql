...
VALUES (43284, 65, 101) /* PLACEMENT_INT */
...
VALUES (43284, 16, 'Inscribed spell: Corrosion VII
Sends a bolt of corrosion towards the target. The bolt does 360 points of damage over 15 seconds.') /* LONG_DESC_STRING */
     , (43284, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43284, 19, 2000) /* VALUE_INT */
     , (43284, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43284, 5393) /* Corrosion7_SpellID */;
