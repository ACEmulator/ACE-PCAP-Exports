...
VALUES (21307, 65, 101) /* PLACEMENT_INT */
...
VALUES (21307, 16, 'Inscribed spell: Flame Arc VI
Shoots a bolt of flame at the target.  The bolt does 84-168 points of fire damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21307, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21307, 19, 1000) /* VALUE_INT */
     , (21307, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21307, 2744) /* FlameArc6_SpellID */;
