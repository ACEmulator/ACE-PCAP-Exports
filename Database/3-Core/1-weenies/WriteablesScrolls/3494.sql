...
VALUES (3494, 65, 101) /* PLACEMENT_INT */
...
VALUES (3494, 16, 'Inscribed spell: Sprint Self III
Increases the caster''s Run skill by 20 points.') /* LONG_DESC_STRING */
     , (3494, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3494, 19, 20) /* VALUE_INT */
     , (3494, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3494, 984) /* SprintSelf3_SpellID */;
