...
VALUES (3274, 65, 101) /* PLACEMENT_INT */
...
VALUES (3274, 16, 'Inscribed spell: Healing Mastery Other III
Increases the target''s Healing skill by 20 points.') /* LONG_DESC_STRING */
     , (3274, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3274, 19, 20) /* VALUE_INT */
     , (3274, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3274, 882) /* HealingMasteryOther3_SpellID */;
