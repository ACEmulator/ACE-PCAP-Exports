...
VALUES (2669, 65, 101) /* PLACEMENT_INT */
...
VALUES (2669, 16, 'Inscribed spell: Feeblemind Other II
Decreases the target''s Self by 15 points.') /* LONG_DESC_STRING */
     , (2669, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2669, 19, 5) /* VALUE_INT */
     , (2669, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2669, 1464) /* FeeblemindOther2_SpellID */;
