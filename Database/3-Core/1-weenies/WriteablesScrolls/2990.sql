...
VALUES (2990, 65, 101) /* PLACEMENT_INT */
...
VALUES (2990, 16, 'Inscribed spell: Blade Protection Other IV
Reduces damage the target takes from Slashing by 43%.') /* LONG_DESC_STRING */
     , (2990, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2990, 19, 100) /* VALUE_INT */
     , (2990, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2990, 1118) /* BladeProtectionOther4_SpellID */;
