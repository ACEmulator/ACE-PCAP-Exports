...
VALUES (3045, 65, 101) /* PLACEMENT_INT */
...
VALUES (3045, 16, 'Inscribed spell: Fire Vulnerability Other IV
Increases damage the target takes from Fire by 75%.') /* LONG_DESC_STRING */
     , (3045, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3045, 19, 100) /* VALUE_INT */
     , (3045, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3045, 1106) /* FireVulnerabilityOther4_SpellID */;
