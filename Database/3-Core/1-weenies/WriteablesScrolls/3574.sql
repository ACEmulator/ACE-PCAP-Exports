...
VALUES (3574, 65, 101) /* PLACEMENT_INT */
...
VALUES (3574, 16, 'Inscribed spell: War Magic Mastery Self III
Increases the caster''s War Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3574, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3574, 19, 20) /* VALUE_INT */
     , (3574, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3574, 631) /* WarMagicMasterySelf3_SpellID */;
