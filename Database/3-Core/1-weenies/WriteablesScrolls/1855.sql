...
VALUES (1855, 65, 101) /* PLACEMENT_INT */
...
VALUES (1855, 16, 'Inscribed spell: Piercing Vulnerability Other I
Increases damage the target takes from Piercing by 10%.') /* LONG_DESC_STRING */
     , (1855, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1855, 19, 1) /* VALUE_INT */
     , (1855, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1855, 1151) /* PiercingVulnerabilityOther1_SpellID */;
