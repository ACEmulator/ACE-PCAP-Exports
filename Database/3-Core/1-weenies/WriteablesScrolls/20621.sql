...
VALUES (20621, 65, 101) /* PLACEMENT_INT */
...
VALUES (20621, 16, 'Inscribed spell: Secondary Portal Recall
Transports the caster to the destination of the portal last successfully linked to with Secondary Portal Tie.') /* LONG_DESC_STRING */
     , (20621, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20621, 19, 20) /* VALUE_INT */
     , (20621, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20621, 2647) /* PortalTieRecall2_SpellID */;
