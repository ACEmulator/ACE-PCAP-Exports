...
VALUES (3364, 65, 101) /* PLACEMENT_INT */
...
VALUES (3364, 16, 'Inscribed spell: Life Magic Ineptitude Other III
Decreases the target''s Life Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3364, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3364, 19, 20) /* VALUE_INT */
     , (3364, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3364, 625) /* LifeMagicIneptitudeOther3_SpellID */;
