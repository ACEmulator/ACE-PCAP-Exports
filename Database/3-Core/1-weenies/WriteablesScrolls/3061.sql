...
VALUES (3061, 65, 101) /* PLACEMENT_INT */
...
VALUES (3061, 16, 'Inscribed spell: Lightning Vulnerability Other V
Increases damage the target takes from Lightning by 100%.') /* LONG_DESC_STRING */
     , (3061, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3061, 19, 200) /* VALUE_INT */
     , (3061, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3061, 1088) /* LightningVulnerabilityOther5_SpellID */;
