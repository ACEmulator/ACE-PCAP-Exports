...
VALUES (3337, 65, 101) /* PLACEMENT_INT */
...
VALUES (3337, 16, 'Inscribed spell: Jumping Mastery Other VI
Increases the target''s Jump skill by 35 points.') /* LONG_DESC_STRING */
     , (3337, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3337, 19, 1000) /* VALUE_INT */
     , (3337, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3337, 981) /* JumpingMasteryOther6_SpellID */;
