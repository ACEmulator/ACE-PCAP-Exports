...
VALUES (3564, 65, 101) /* PLACEMENT_INT */
...
VALUES (3564, 16, 'Inscribed spell: War Magic Ineptitude Other III
Decreases the target''s War Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3564, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3564, 19, 20) /* VALUE_INT */
     , (3564, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3564, 649) /* WarMagicIneptitudeOther3_SpellID */;
