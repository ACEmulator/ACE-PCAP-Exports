...
VALUES (3189, 16, 'Inscribed spell: Creature Enchantment Ineptitude Other III
Decreases the target''s Creature Enchantment skill by 20 points.') /* LONG_DESC_STRING */
     , (3189, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3189, 19, 20) /* VALUE_INT */
     , (3189, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3189, 571) /* CreatureEnchantmentIneptitudeOther3_SpellID */;
