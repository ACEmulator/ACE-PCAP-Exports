...
VALUES (2743, 65, 101) /* PLACEMENT_INT */
...
VALUES (2743, 16, 'Inscribed spell: Strength Self III
Increases the caster''s Strength by 20 points.') /* LONG_DESC_STRING */
     , (2743, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2743, 19, 20) /* VALUE_INT */
     , (2743, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2743, 1329) /* StrengthSelf3_SpellID */;
