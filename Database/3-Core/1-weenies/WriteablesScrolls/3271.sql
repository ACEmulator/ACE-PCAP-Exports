...
VALUES (3271, 65, 101) /* PLACEMENT_INT */
...
VALUES (3271, 16, 'Inscribed spell: Healing Ineptitude Other V
Decreases the target''s Healing skill by 30 points.') /* LONG_DESC_STRING */
     , (3271, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3271, 19, 200) /* VALUE_INT */
     , (3271, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3271, 896) /* HealingIneptitudeOther5_SpellID */;
