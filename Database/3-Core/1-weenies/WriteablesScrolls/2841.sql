...
VALUES (2841, 65, 101) /* PLACEMENT_INT */
...
VALUES (2841, 16, 'Inscribed spell: Hermetic Void VI
Decreases a magic casting implement''s mana conversion bonus by 60%.') /* LONG_DESC_STRING */
     , (2841, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2841, 19, 1000) /* VALUE_INT */
     , (2841, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2841, 1474) /* HideValue6_SpellID */;
