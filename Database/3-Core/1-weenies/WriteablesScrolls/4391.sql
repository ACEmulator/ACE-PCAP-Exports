...
VALUES (4391, 65, 101) /* PLACEMENT_INT */
...
VALUES (4391, 16, 'Inscribed spell: Armor Self III
Increases the caster''s natural armor by 75 points.') /* LONG_DESC_STRING */
     , (4391, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4391, 19, 20) /* VALUE_INT */
     , (4391, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (4391, 1309) /* ArmorSelf3_SpellID */;
