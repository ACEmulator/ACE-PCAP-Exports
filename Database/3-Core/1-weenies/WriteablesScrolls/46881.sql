...
VALUES (46881, 65, 101) /* PLACEMENT_INT */
...
VALUES (46881, 16, 'Inscribed spell: Aura of Heart Seeker Other VII
Increases a weapon''s Attack Skill modifier by 17.0 percentage points.') /* LONG_DESC_STRING */
     , (46881, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46881, 19, 2000) /* VALUE_INT */
     , (46881, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46881, 6013) /* heartseekerOther7_SpellID */;
