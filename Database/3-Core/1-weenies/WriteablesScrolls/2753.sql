...
VALUES (2753, 65, 101) /* PLACEMENT_INT */
...
VALUES (2753, 16, 'Inscribed spell: Willpower Other III
Increases the target''s Self by 20 points.') /* LONG_DESC_STRING */
     , (2753, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2753, 19, 20) /* VALUE_INT */
     , (2753, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2753, 1453) /* WillpowerOther3_SpellID */;
