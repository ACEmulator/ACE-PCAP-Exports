...
VALUES (3103, 65, 101) /* PLACEMENT_INT */
...
VALUES (3103, 16, 'Inscribed spell: Mana Renewal Self II
Increases the caster''s natural mana rate by 25%.') /* LONG_DESC_STRING */
     , (3103, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3103, 19, 5) /* VALUE_INT */
     , (3103, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3103, 213) /* ManaRenewalSelf2_SpellID */;
