...
VALUES (2900, 65, 101) /* PLACEMENT_INT */
...
VALUES (2900, 16, 'Inscribed spell: Weaken Lock IV
Decreases a lock''s resistance to picking by 75 points.') /* LONG_DESC_STRING */
     , (2900, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2900, 19, 100) /* VALUE_INT */
     , (2900, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2900, 1584) /* WeakenLock4_SpellID */;
