...
VALUES (3452, 65, 101) /* PLACEMENT_INT */
...
VALUES (3452, 16, 'Inscribed spell: Person Attunement Other VI
Increases the target''s Assess Person skill by 35 points.') /* LONG_DESC_STRING */
     , (3452, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3452, 19, 1000) /* VALUE_INT */
     , (3452, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3452, 835) /* PersonAttunementOther6_SpellID */;
