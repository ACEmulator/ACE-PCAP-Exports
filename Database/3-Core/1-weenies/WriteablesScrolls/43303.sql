...
VALUES (43303, 16, 'Inscribed spell: Nether Bolt II
Shoots a bolt of nether at the target. The bolt does 42-84 points of nether damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (43303, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43303, 19, 5) /* VALUE_INT */
     , (43303, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43303, 5350) /* netherbolt2_SpellID */;
