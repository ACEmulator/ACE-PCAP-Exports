...
VALUES (9634, 65, 101) /* PLACEMENT_INT */
...
VALUES (9634, 16, 'Inscribed spell: Health to Mana Self VI
Drains one-half of the caster''s Health and gives 150% of that to his/her Mana.') /* LONG_DESC_STRING */
     , (9634, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9634, 19, 1000) /* VALUE_INT */
     , (9634, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9634, 1704) /* HealthtoManaSelf6_SpellID */;
