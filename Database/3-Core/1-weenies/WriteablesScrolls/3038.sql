...
VALUES (3038, 65, 101) /* PLACEMENT_INT */
...
VALUES (3038, 16, 'Inscribed spell: Fire Protection Self II
Reduces damage the caster takes from Fire by 20%.') /* LONG_DESC_STRING */
     , (3038, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3038, 19, 5) /* VALUE_INT */
     , (3038, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3038, 1090) /* FireProtectionSelf2_SpellID */;
