...
VALUES (2660, 65, 101) /* PLACEMENT_INT */
...
VALUES (2660, 16, 'Inscribed spell: Endurance Self III
Increases the caster''s Endurance by 20 points.') /* LONG_DESC_STRING */
     , (2660, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2660, 19, 20) /* VALUE_INT */
     , (2660, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2660, 1351) /* EnduranceSelf3_SpellID */;
