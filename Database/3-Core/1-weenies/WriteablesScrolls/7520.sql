...
VALUES (7520, 18, 7520, 6307864, NULL, NULL, 135297);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (7520, 1, 'Scroll of Foon-Ki''s Glacial Floe') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (7520, 8, 100677014) /* ICON_DID */
     , (7520, 1, 33554826) /* SETUP_DID */
     , (7520, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (7520, 28, 1843) /* SPELL_DID - FrostWall_SpellID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (7520, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (7520, 13, True) /* ETHEREAL_BOOL */
     , (7520, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (7520, 14, True) /* GRAVITY_STATUS_BOOL */
