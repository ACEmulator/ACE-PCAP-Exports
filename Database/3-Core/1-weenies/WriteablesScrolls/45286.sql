...
VALUES (45286, 65, 101) /* PLACEMENT_INT */
...
VALUES (45286, 16, 'Inscribed spell: Recklessness Ineptitude Other III
Decreases the target''s Recklessness skill by 20 points.') /* LONG_DESC_STRING */
     , (45286, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45286, 19, 20) /* VALUE_INT */
     , (45286, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45286, 5813) /* recklessnessineptitudeother3_SpellID */;
