...
VALUES (2738, 65, 101) /* PLACEMENT_INT */
...
VALUES (2738, 16, 'Inscribed spell: Strength Other III
Increases the target''s Strength by 20 points.') /* LONG_DESC_STRING */
     , (2738, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2738, 19, 20) /* VALUE_INT */
     , (2738, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2738, 1334) /* StrengthOther3_SpellID */;
