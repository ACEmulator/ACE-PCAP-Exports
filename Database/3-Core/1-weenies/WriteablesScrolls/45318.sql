...
VALUES (45318, 65, 101) /* PLACEMENT_INT */
...
VALUES (45318, 16, 'Inscribed spell: Shield Mastery Other III
Increases the target''s Shield skill by 20 points.') /* LONG_DESC_STRING */
     , (45318, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45318, 19, 20) /* VALUE_INT */
     , (45318, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45318, 5845) /* shieldmasteryother3_SpellID */;
