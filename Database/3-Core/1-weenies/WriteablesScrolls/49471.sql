...
VALUES (49471, 65, 101) /* PLACEMENT_INT */
...
VALUES (49471, 16, 'Inscribed spell: Summoning Mastery Self II
Increases the caster''s Summoning skill by 15 points.') /* LONG_DESC_STRING */
     , (49471, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (49471, 19, 5) /* VALUE_INT */
     , (49471, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (49471, 6117) /* SummoningMasterySelf2_SpellID */;
