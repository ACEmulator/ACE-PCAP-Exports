...
VALUES (3257, 65, 101) /* PLACEMENT_INT */
...
VALUES (3257, 16, 'Inscribed spell: Faithlessness Other VI
Decreases the target''s Loyalty skill by 35 points.') /* LONG_DESC_STRING */
     , (3257, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3257, 19, 1000) /* VALUE_INT */
     , (3257, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3257, 969) /* FaithlessnessOther6_SpellID */;
