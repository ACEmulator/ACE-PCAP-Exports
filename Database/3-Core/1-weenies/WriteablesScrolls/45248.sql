...
VALUES (45248, 65, 101) /* PLACEMENT_INT */
...
VALUES (45248, 16, 'Inscribed spell: Dirty Fighting Mastery Other V
Increases the target''s Dirty Fighting skill by 30 points.') /* LONG_DESC_STRING */
     , (45248, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45248, 19, 200) /* VALUE_INT */
     , (45248, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45248, 5775) /* dirtyfightingmasteryother5_SpellID */;
