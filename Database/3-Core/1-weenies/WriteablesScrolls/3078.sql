...
VALUES (3078, 65, 101) /* PLACEMENT_INT */
...
VALUES (3078, 16, 'Inscribed spell: Exhaustion Other II
Decreases the rate at which the target regains Stamina by 20%.') /* LONG_DESC_STRING */
     , (3078, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3078, 19, 5) /* VALUE_INT */
     , (3078, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3078, 195) /* ExhaustionOther2_SpellID */;
