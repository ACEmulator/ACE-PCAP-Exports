...
VALUES (4395, 18, 4395, 6307864, NULL, NULL, 135297);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (4395, 1, 'Scroll of Force Bolt II') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4395, 8, 100677019) /* ICON_DID */
     , (4395, 1, 33554826) /* SETUP_DID */
     , (4395, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */
     , (4395, 28, 87) /* SPELL_DID - ForceBolt2_SpellID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4395, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (4395, 13, True) /* ETHEREAL_BOOL */
     , (4395, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (4395, 14, True) /* GRAVITY_STATUS_BOOL */
