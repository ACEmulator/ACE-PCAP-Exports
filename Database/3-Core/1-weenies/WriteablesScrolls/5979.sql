...
VALUES (5979, 16, 'Inscribed spell: Fletching Mastery Self VI
Increases the caster''s Fletching skill by 35 points.') /* LONG_DESC_STRING */
     , (5979, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5979, 19, 1000) /* VALUE_INT */
     , (5979, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5979, 1744) /* FletchingMasterySelf6_SpellID */;
