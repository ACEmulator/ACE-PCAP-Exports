...
VALUES (3193, 65, 101) /* PLACEMENT_INT */
...
VALUES (3193, 16, 'Inscribed spell: Creature Enchantment Mastery Other II
Increases the target''s Creature Enchantment skill by 15 points.') /* LONG_DESC_STRING */
     , (3193, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3193, 19, 5) /* VALUE_INT */
     , (3193, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3193, 564) /* CreatureEnchantmentMasteryOther2_SpellID */;
