...
VALUES (2996, 65, 101) /* PLACEMENT_INT */
...
VALUES (2996, 16, 'Inscribed spell: Blade Protection Self V
Reduces damage the caster takes from Slashing by 50%.') /* LONG_DESC_STRING */
     , (2996, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2996, 19, 200) /* VALUE_INT */
     , (2996, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2996, 1113) /* BladeProtectionSelf5_SpellID */;
