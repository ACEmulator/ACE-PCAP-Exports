...
VALUES (2666, 65, 101) /* PLACEMENT_INT */
...
VALUES (2666, 16, 'Inscribed spell: Enfeeble Other IV
Drains 24-47 points of the target''s Stamina.') /* LONG_DESC_STRING */
     , (2666, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2666, 19, 100) /* VALUE_INT */
     , (2666, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2666, 1198) /* EnfeebleOther4_SpellID */;
