...
VALUES (43364, 65, 101) /* PLACEMENT_INT */
...
VALUES (43364, 16, 'Inscribed spell: Void Magic Ineptitude Other VI
Decreases the target''s Void Magic skill by 35 points.') /* LONG_DESC_STRING */
     , (43364, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43364, 19, 1000) /* VALUE_INT */
     , (43364, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43364, 5424) /* VoidMagicIneptitudeOther6_SpellID */;
