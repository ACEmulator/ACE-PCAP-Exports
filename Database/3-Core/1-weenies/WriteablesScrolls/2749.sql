...
VALUES (2749, 65, 101) /* PLACEMENT_INT */
...
VALUES (2749, 16, 'Inscribed spell: Weakness Other IV
Decreases the target''s Strength by 25 points.') /* LONG_DESC_STRING */
     , (2749, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2749, 19, 100) /* VALUE_INT */
     , (2749, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2749, 1341) /* WeaknessOther4_SpellID */;
