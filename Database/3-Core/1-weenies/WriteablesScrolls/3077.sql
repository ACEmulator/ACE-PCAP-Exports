...
VALUES (3077, 65, 101) /* PLACEMENT_INT */
...
VALUES (3077, 16, 'Inscribed spell: Piercing Vulnerability Other VI
Increases damage the target takes from Piercing by 150%.') /* LONG_DESC_STRING */
     , (3077, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3077, 19, 1000) /* VALUE_INT */
     , (3077, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3077, 1156) /* PiercingVulnerabilityOther6_SpellID */;
