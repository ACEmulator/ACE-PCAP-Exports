...
VALUES (5954, 65, 101) /* PLACEMENT_INT */
...
VALUES (5954, 16, 'Inscribed spell: Cooking Mastery Other V
Increases the target''s Cooking skill by 30 points.') /* LONG_DESC_STRING */
     , (5954, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5954, 19, 200) /* VALUE_INT */
     , (5954, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5954, 1713) /* CookingMasteryOther5_SpellID */;
