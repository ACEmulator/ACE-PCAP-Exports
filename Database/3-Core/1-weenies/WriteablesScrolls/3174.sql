...
VALUES (3174, 65, 101) /* PLACEMENT_INT */
...
VALUES (3174, 16, 'Inscribed spell: Missile Weapon Ineptitude Other III
Decreases the target''s Missile Weapons skill by 20 points.') /* LONG_DESC_STRING */
     , (3174, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3174, 19, 20) /* VALUE_INT */
     , (3174, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3174, 475) /* BowIneptitudeOther3_SpellID */;
