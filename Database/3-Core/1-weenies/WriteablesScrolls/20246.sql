...
VALUES (20246, 16, 'Inscribed spell: Gossamer Flesh
Decreases the target''s natural armor by 225 points.') /* LONG_DESC_STRING */
     , (20246, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20246, 19, 2000) /* VALUE_INT */
     , (20246, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20246, 2074) /* ImperilOther7_SpellID */;
