...
VALUES (45250, 65, 101) /* PLACEMENT_INT */
...
VALUES (45250, 16, 'Inscribed spell: Dirty Fighting Mastery Other VII
Increases the target''s Dirty Fighting skill by 40 points.') /* LONG_DESC_STRING */
     , (45250, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45250, 19, 2000) /* VALUE_INT */
     , (45250, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45250, 5777) /* dirtyfightingmasteryother7_SpellID */;
