...
VALUES (3436, 16, 'Inscribed spell: Mana Conversion Mastery Self V
Increases the caster''s Mana Conversion skill by 30 points.') /* LONG_DESC_STRING */
     , (3436, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3436, 19, 200) /* VALUE_INT */
     , (3436, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3436, 657) /* ManaMasterySelf5_SpellID */;
