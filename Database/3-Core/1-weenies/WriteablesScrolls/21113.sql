...
VALUES (21113, 65, 101) /* PLACEMENT_INT */
...
VALUES (21113, 16, 'Inscribed spell: Martyr''s Tenacity V
Drains one-quarter of the caster''s stamina into a bolt of energy.  When struck by the bolt, the target''s stamina is reduced by 150% of the amount drained.') /* LONG_DESC_STRING */
     , (21113, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21113, 19, 200) /* VALUE_INT */
     , (21113, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21113, 2771) /* StaminaBolt5_SpellID */;
