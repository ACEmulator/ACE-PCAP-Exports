...
VALUES (43332, 16, 'Inscribed spell: Festering Curse IV
The heal rating of the target is decreased by 20.') /* LONG_DESC_STRING */
     , (43332, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43332, 19, 100) /* VALUE_INT */
     , (43332, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43332, 5374) /* CurseFestering4_SpellID */;
