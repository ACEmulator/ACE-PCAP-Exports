...
VALUES (1673, 16, 'Inscribed spell: Finesse Weapon Mastery Other I
Increases the target''s Finesse Weapons skill by 10 points.') /* LONG_DESC_STRING */
     , (1673, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1673, 19, 1) /* VALUE_INT */
     , (1673, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1673, 316) /* DaggerMasteryOther1_SpellID */;
