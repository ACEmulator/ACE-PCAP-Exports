...
VALUES (20490, 65, 101) /* PLACEMENT_INT */
...
VALUES (20490, 16, 'Inscribed spell: Battlemage''s Blessing
Increases the caster''s natural mana rate by 115%.') /* LONG_DESC_STRING */
     , (20490, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20490, 19, 2000) /* VALUE_INT */
     , (20490, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20490, 2183) /* ManaRenewalSelf7_SpellID */;
