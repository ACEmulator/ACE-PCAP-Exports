...
VALUES (3383, 65, 101) /* PLACEMENT_INT */
...
VALUES (3383, 16, 'Inscribed spell: Lockpick Mastery Other II
Increases the target''s Lockpick skill by 15 points.') /* LONG_DESC_STRING */
     , (3383, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3383, 19, 5) /* VALUE_INT */
     , (3383, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3383, 929) /* LockpickMasteryOther2_SpellID */;
