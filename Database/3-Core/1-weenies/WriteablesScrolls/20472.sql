...
VALUES (20472, 16, 'Inscribed spell: Blessing of the Mace Turner
Reduces damage the caster takes from Bludgeoning by 65%.') /* LONG_DESC_STRING */
     , (20472, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20472, 19, 2000) /* VALUE_INT */
     , (20472, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20472, 2153) /* BludgeonProtectionSelf7_SpellID */;
