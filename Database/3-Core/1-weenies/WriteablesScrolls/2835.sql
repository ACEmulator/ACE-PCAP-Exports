...
VALUES (2835, 65, 101) /* PLACEMENT_INT */
...
VALUES (2835, 16, 'Inscribed spell: Aura of Heart Seeker Self V
Increases a weapon''s Attack Skill modifier by 12.5 percentage points.') /* LONG_DESC_STRING */
     , (2835, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2835, 19, 200) /* VALUE_INT */
     , (2835, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2835, 1591) /* HeartSeeker5_SpellID */;
