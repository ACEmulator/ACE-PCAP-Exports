...
VALUES (9635, 65, 101) /* PLACEMENT_INT */
...
VALUES (9635, 16, 'Inscribed spell: Health to Stamina Self II
Drains one-half of the caster''s Health and gives 100% of that to his/her Stamina (maximum of 100).') /* LONG_DESC_STRING */
     , (9635, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9635, 19, 5) /* VALUE_INT */
     , (9635, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9635, 1273) /* HealthtoStaminaSelf2_SpellID */;
