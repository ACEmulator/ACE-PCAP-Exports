...
VALUES (2782, 65, 101) /* PLACEMENT_INT */
...
VALUES (2782, 16, 'Inscribed spell: Aura of Blood Drinker Self II
Increases a weapon''s damage value by 4 points.') /* LONG_DESC_STRING */
     , (2782, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2782, 19, 5) /* VALUE_INT */
     , (2782, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2782, 1612) /* BloodDrinker2_SpellID */;
