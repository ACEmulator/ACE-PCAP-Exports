...
VALUES (28013, 65, 101) /* PLACEMENT_INT */
...
VALUES (28013, 16, 'Inscribed spell: Spirit Loather V
Decreases the elemental damage bonus of an elemental magic caster by 5%.') /* LONG_DESC_STRING */
     , (28013, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28013, 19, 200) /* VALUE_INT */
     , (28013, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (28013, 3264) /* SpiritLoather5_SpellID */;
