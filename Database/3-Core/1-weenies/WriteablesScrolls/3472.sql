...
VALUES (3472, 65, 101) /* PLACEMENT_INT */
...
VALUES (3472, 16, 'Inscribed spell: Magic Resistance Self VI
Increases the caster''s Magic Defense skill by 35 points.') /* LONG_DESC_STRING */
     , (3472, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3472, 19, 1000) /* VALUE_INT */
     , (3472, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3472, 279) /* MagicResistanceSelf6_SpellID */;
