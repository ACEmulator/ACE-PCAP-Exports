...
VALUES (3098, 65, 101) /* PLACEMENT_INT */
...
VALUES (3098, 16, 'Inscribed spell: Mana Renewal Other II
Increases the target''s natural mana rate by 25%.') /* LONG_DESC_STRING */
     , (3098, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3098, 19, 5) /* VALUE_INT */
     , (3098, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3098, 207) /* ManaRenewalOther2_SpellID */;
