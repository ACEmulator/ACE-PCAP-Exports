...
VALUES (2850, 65, 101) /* PLACEMENT_INT */
...
VALUES (2850, 16, 'Inscribed spell: Leaden Weapon V
Worsens a weapon''s speed by 50 points.') /* LONG_DESC_STRING */
     , (2850, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2850, 19, 200) /* VALUE_INT */
     , (2850, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2850, 1632) /* LeadenWeapon5_SpellID */;
