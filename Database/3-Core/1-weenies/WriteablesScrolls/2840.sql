...
VALUES (2840, 16, 'Inscribed spell: Hermetic Void V
Decreases a magic casting implement''s mana conversion bonus by 50%.') /* LONG_DESC_STRING */
     , (2840, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2840, 19, 200) /* VALUE_INT */
     , (2840, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2840, 1473) /* HideValue5_SpellID */;
