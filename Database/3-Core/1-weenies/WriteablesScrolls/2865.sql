...
VALUES (2865, 65, 101) /* PLACEMENT_INT */
...
VALUES (2865, 16, 'Inscribed spell: Lure Blade V
Decreases the Melee Defense skill modifier of a weapon or magic caster by 13%.') /* LONG_DESC_STRING */
     , (2865, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2865, 19, 200) /* VALUE_INT */
     , (2865, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2865, 1610) /* LureBlade5_SpellID */;
