...
VALUES (20521, 65, 101) /* PLACEMENT_INT */
...
VALUES (20521, 16, 'Inscribed spell: Finesse Weapon Mastery Self VII
Increases the caster''s Finesse Weapons skill by 40 points.') /* LONG_DESC_STRING */
     , (20521, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20521, 19, 2000) /* VALUE_INT */
     , (20521, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20521, 2223) /* DaggerMasterySelf7_SpellID */;
