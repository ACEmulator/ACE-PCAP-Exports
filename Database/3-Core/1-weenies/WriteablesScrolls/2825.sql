...
VALUES (2825, 65, 101) /* PLACEMENT_INT */
...
VALUES (2825, 16, 'Inscribed spell: Frost Bane V
Increases a shield or piece of armor''s resistance to cold damage by 100%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (2825, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2825, 19, 200) /* VALUE_INT */
     , (2825, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2825, 1527) /* FrostBane5_SpellID */;
