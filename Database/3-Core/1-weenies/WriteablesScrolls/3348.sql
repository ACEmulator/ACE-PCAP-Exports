...
VALUES (3348, 65, 101) /* PLACEMENT_INT */
...
VALUES (3348, 16, 'Inscribed spell: Leadership Ineptitude Other II
Decreases the target''s Leadership skill by 15 points.') /* LONG_DESC_STRING */
     , (3348, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3348, 19, 5) /* VALUE_INT */
     , (3348, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3348, 917) /* LeadershipIneptitudeOther2_SpellID */;
