...
VALUES (3226, 65, 101) /* PLACEMENT_INT */
...
VALUES (3226, 16, 'Inscribed spell: Finesse Weapon Mastery Other V
Increases the target''s Finesse Weapons skill by 30 points.') /* LONG_DESC_STRING */
     , (3226, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3226, 19, 200) /* VALUE_INT */
     , (3226, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3226, 320) /* DaggerMasteryOther5_SpellID */;
