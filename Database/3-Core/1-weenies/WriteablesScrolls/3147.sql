...
VALUES (3147, 65, 101) /* PLACEMENT_INT */
...
VALUES (3147, 16, 'Inscribed spell: Armor Tinkering Expertise Other VI
Increases the target''s Armor Tinkering skill by 35 points.') /* LONG_DESC_STRING */
     , (3147, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3147, 19, 1000) /* VALUE_INT */
     , (3147, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3147, 713) /* ArmorExpertiseOther6_SpellID */;
