...
VALUES (2756, 65, 101) /* PLACEMENT_INT */
...
VALUES (2756, 16, 'Inscribed spell: Willpower Other VI
Increases the target''s Self by 35 points.') /* LONG_DESC_STRING */
     , (2756, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2756, 19, 1000) /* VALUE_INT */
     , (2756, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2756, 1456) /* WillpowerOther6_SpellID */;
