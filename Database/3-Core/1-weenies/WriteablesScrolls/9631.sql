...
VALUES (9631, 65, 101) /* PLACEMENT_INT */
...
VALUES (9631, 16, 'Inscribed spell: Health to Mana Self III
Drains one-half of the caster''s Health and gives 110% of that to his/her Mana (maximum of 150).') /* LONG_DESC_STRING */
     , (9631, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9631, 19, 20) /* VALUE_INT */
     , (9631, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9631, 1280) /* HealthtoManaSelf3_SpellID */;
