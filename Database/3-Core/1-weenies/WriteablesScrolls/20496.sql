...
VALUES (20496, 65, 101) /* PLACEMENT_INT */
...
VALUES (20496, 16, 'Inscribed spell: Silencia''s Boon
Increases the target''s Alchemy skill by 40 points.') /* LONG_DESC_STRING */
     , (20496, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20496, 19, 2000) /* VALUE_INT */
     , (20496, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20496, 2190) /* AlchemyMasteryOther7_SpellID */;
