...
VALUES (3062, 65, 101) /* PLACEMENT_INT */
...
VALUES (3062, 16, 'Inscribed spell: Lightning Vulnerability Other VI
Increases damage the target takes from Lightning by 150%.') /* LONG_DESC_STRING */
     , (3062, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3062, 19, 1000) /* VALUE_INT */
     , (3062, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3062, 1089) /* LightningVulnerabilityOther6_SpellID */;
