...
VALUES (28945, 65, 101) /* PLACEMENT_INT */
...
VALUES (28945, 16, 'Inscribed spell: Arcanum Enlightenment VI
Increases the target''s Salvaging skill by 35 points.') /* LONG_DESC_STRING */
     , (28945, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28945, 19, 1000) /* VALUE_INT */
     , (28945, 5, 10) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (28945, 3511) /* ArcanumSalvagingOther6_SpellID */;
