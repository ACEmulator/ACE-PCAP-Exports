...
VALUES (2998, 65, 101) /* PLACEMENT_INT */
...
VALUES (2998, 16, 'Inscribed spell: Blade Vulnerability Other II
Increases damage the target takes from Slashing by 25%.') /* LONG_DESC_STRING */
     , (2998, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2998, 19, 5) /* VALUE_INT */
     , (2998, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2998, 1128) /* BladeVulnerabilityOther2_SpellID */;
