...
VALUES (2709, 65, 101) /* PLACEMENT_INT */
...
VALUES (2709, 16, 'Inscribed spell: Mana Drain Other IV
Drains 16-31 points of the target''s Mana.') /* LONG_DESC_STRING */
     , (2709, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2709, 19, 100) /* VALUE_INT */
     , (2709, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2709, 1222) /* ManaDrainOther4_SpellID */;
