...
VALUES (2880, 65, 101) /* PLACEMENT_INT */
...
VALUES (2880, 16, 'Inscribed spell: Strengthen Lock V
Increases a lock''s resistance to picking by 100 points.') /* LONG_DESC_STRING */
     , (2880, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2880, 19, 200) /* VALUE_INT */
     , (2880, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2880, 1579) /* StrengthenLock5_SpellID */;
