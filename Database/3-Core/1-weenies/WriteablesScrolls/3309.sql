...
VALUES (3309, 65, 101) /* PLACEMENT_INT */
...
VALUES (3309, 16, 'Inscribed spell: Item Enchantment Mastery Other III
Increases the target''s Item Enchantment skill by 20 points.') /* LONG_DESC_STRING */
     , (3309, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3309, 19, 20) /* VALUE_INT */
     , (3309, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3309, 589) /* ItemEnchantmentMasteryOther3_SpellID */;
