...
VALUES (20487, 65, 101) /* PLACEMENT_INT */
...
VALUES (20487, 16, 'Inscribed spell: Decrepitude''s Grasp
Decrease target''s natural healing rate by 60%.') /* LONG_DESC_STRING */
     , (20487, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20487, 19, 2000) /* VALUE_INT */
     , (20487, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20487, 2178) /* FesterOther7_SpellID */;
