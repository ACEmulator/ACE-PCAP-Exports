...
VALUES (1883, 65, 101) /* PLACEMENT_INT */
...
VALUES (1883, 16, 'Inscribed spell: Frost Bane I
Increases a shield or piece of armor''s resistance to cold damage by 10%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (1883, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1883, 19, 1) /* VALUE_INT */
     , (1883, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1883, 1523) /* FrostBane1_SpellID */;
