...
VALUES (2969, 65, 101) /* PLACEMENT_INT */
...
VALUES (2969, 16, 'Inscribed spell: Whirling Blade III
Shoots a magical blade at the target. The bolt does 42-84 points of slashing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2969, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2969, 19, 20) /* VALUE_INT */
     , (2969, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2969, 94) /* WhirlingBlade3_SpellID */;
