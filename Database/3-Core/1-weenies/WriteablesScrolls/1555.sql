...
VALUES (1555, 16, 'Inscribed spell: Heal Other I
Restores 10-25 points of the target''s Health.') /* LONG_DESC_STRING */
     , (1555, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1555, 19, 1) /* VALUE_INT */
     , (1555, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1555, 5) /* HealOther1_SpellID */;
