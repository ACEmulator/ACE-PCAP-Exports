...
VALUES (3409, 65, 101) /* PLACEMENT_INT */
...
VALUES (3409, 16, 'Inscribed spell: Magic Item Tinkering Expertise Other III
Increases the target''s Magic Item Tinkering skill by 20 points.') /* LONG_DESC_STRING */
     , (3409, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3409, 19, 20) /* VALUE_INT */
     , (3409, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3409, 758) /* MagicItemExpertiseOther3_SpellID */;
