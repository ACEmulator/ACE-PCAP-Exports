...
VALUES (45255, 65, 101) /* PLACEMENT_INT */
...
VALUES (45255, 16, 'Inscribed spell: Dirty Fighting Mastery Self IV
Increases the caster''s Dirty Fighting skill by 25 points.') /* LONG_DESC_STRING */
     , (45255, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45255, 19, 100) /* VALUE_INT */
     , (45255, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45255, 5782) /* dirtyfightingmasteryself4_SpellID */;
