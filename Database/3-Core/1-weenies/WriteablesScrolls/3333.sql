...
VALUES (3333, 65, 101) /* PLACEMENT_INT */
...
VALUES (3333, 16, 'Inscribed spell: Jumping Mastery Other II
Increases the target''s Jump skill by 15 points.') /* LONG_DESC_STRING */
     , (3333, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3333, 19, 5) /* VALUE_INT */
     , (3333, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3333, 977) /* JumpingMasteryOther2_SpellID */;
