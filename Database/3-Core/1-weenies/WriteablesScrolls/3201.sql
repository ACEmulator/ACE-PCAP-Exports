...
VALUES (3201, 65, 101) /* PLACEMENT_INT */
...
VALUES (3201, 16, 'Inscribed spell: Creature Enchantment Mastery Self V
Increases the caster''s Creature Enchantment skill by 30 points.') /* LONG_DESC_STRING */
     , (3201, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3201, 19, 200) /* VALUE_INT */
     , (3201, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3201, 561) /* CreatureEnchantmentMasterySelf5_SpellID */;
