...
VALUES (3340, 65, 101) /* PLACEMENT_INT */
...
VALUES (3340, 16, 'Inscribed spell: Jumping Mastery Self IV
Increases the caster''s Jump skill by 25 points.') /* LONG_DESC_STRING */
     , (3340, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3340, 19, 100) /* VALUE_INT */
     , (3340, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3340, 973) /* JumpingMasterySelf4_SpellID */;
