...
VALUES (2719, 65, 101) /* PLACEMENT_INT */
...
VALUES (2719, 16, 'Inscribed spell: Quickness Self IV
Increases the caster''s Quickness by 25 points.') /* LONG_DESC_STRING */
     , (2719, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2719, 19, 100) /* VALUE_INT */
     , (2719, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2719, 1400) /* QuicknessSelf4_SpellID */;
