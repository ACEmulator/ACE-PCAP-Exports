...
VALUES (3374, 65, 101) /* PLACEMENT_INT */
...
VALUES (3374, 16, 'Inscribed spell: Life Magic Mastery Self III
Increases the caster''s Life Magic skill by 20 points.') /* LONG_DESC_STRING */
     , (3374, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3374, 19, 20) /* VALUE_INT */
     , (3374, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3374, 607) /* LifeMagicMasterySelf3_SpellID */;
