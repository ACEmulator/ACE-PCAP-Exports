...
VALUES (46879, 16, 'Inscribed spell: Aura of Blood Drinker Other VII
Increases a weapon''s damage value by 22 points.') /* LONG_DESC_STRING */
     , (46879, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46879, 19, 2000) /* VALUE_INT */
     , (46879, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46879, 5996) /* blooddrinkerOther7_SpellID */;
