...
VALUES (3432, 16, 'Inscribed spell: Mana Conversion Mastery Other VI
Increases the target''s Mana Conversion skill by 35 points.') /* LONG_DESC_STRING */
     , (3432, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3432, 19, 1000) /* VALUE_INT */
     , (3432, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3432, 664) /* ManaMasteryOther6_SpellID */;
