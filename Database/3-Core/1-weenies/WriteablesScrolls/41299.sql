...
VALUES (41299, 65, 101) /* PLACEMENT_INT */
...
VALUES (41299, 16, 'Inscribed spell: Two Handed Combat Mastery Other IV
Increases the target''s Two Handed Combat skill by 25 points.') /* LONG_DESC_STRING */
     , (41299, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41299, 19, 100) /* VALUE_INT */
     , (41299, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (41299, 5094) /* twohandedmastery4_SpellID */;
