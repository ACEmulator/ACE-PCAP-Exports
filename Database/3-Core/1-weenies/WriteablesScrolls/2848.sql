...
VALUES (2848, 65, 101) /* PLACEMENT_INT */
...
VALUES (2848, 16, 'Inscribed spell: Leaden Weapon III
Worsens a weapon''s speed by 30 points.') /* LONG_DESC_STRING */
     , (2848, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2848, 19, 20) /* VALUE_INT */
     , (2848, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2848, 1630) /* LeadenWeapon3_SpellID */;
