...
VALUES (2768, 65, 101) /* PLACEMENT_INT */
...
VALUES (2768, 16, 'Inscribed spell: Acid Lure III
Decreases a shield or piece of armor''s resistance to acid damage by 50%.') /* LONG_DESC_STRING */
     , (2768, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2768, 19, 20) /* VALUE_INT */
     , (2768, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2768, 1501) /* AcidLure3_SpellID */;
