...
VALUES (20547, 65, 101) /* PLACEMENT_INT */
...
VALUES (20547, 16, 'Inscribed spell: Jahannan''s Blessing
Increases the caster''s Jump skill by 40 points.') /* LONG_DESC_STRING */
     , (20547, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20547, 19, 2000) /* VALUE_INT */
     , (20547, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20547, 2257) /* JumpingMasterySelf7_SpellID */;
