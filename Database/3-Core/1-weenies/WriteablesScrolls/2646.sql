...
VALUES (2646, 16, 'Inscribed spell: Coordination Other IV
Increases the target''s Coordination by 25 points.') /* LONG_DESC_STRING */
     , (2646, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2646, 19, 100) /* VALUE_INT */
     , (2646, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2646, 1382) /* CoordinationOther4_SpellID */;
