...
VALUES (2651, 65, 101) /* PLACEMENT_INT */
...
VALUES (2651, 16, 'Inscribed spell: Coordination Self IV
Increases the caster''s Coordination by 25 points.') /* LONG_DESC_STRING */
     , (2651, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2651, 19, 100) /* VALUE_INT */
     , (2651, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2651, 1376) /* CoordinationSelf4_SpellID */;
