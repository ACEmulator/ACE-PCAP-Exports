...
VALUES (8931, 65, 101) /* PLACEMENT_INT */
...
VALUES (8931, 16, 'Inscribed spell: Force Streak III
Sends a bolt of force streaking towards the target. The bolt does 21-42 points of piercing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (8931, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8931, 19, 20) /* VALUE_INT */
     , (8931, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (8931, 1804) /* ForceStreak3_SpellID */;
