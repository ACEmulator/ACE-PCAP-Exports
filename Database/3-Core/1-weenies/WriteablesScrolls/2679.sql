...
VALUES (2679, 65, 101) /* PLACEMENT_INT */
...
VALUES (2679, 16, 'Inscribed spell: Focus Self IV
Increases the caster''s Focus by 25 points.') /* LONG_DESC_STRING */
     , (2679, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2679, 19, 100) /* VALUE_INT */
     , (2679, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2679, 1424) /* FocusSelf4_SpellID */;
