...
VALUES (46883, 65, 101) /* PLACEMENT_INT */
...
VALUES (46883, 16, 'Inscribed spell: Aura of Swift Killer Other VII
Improves a weapon''s speed by 70 points.') /* LONG_DESC_STRING */
     , (46883, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46883, 19, 2000) /* VALUE_INT */
     , (46883, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46883, 6030) /* swiftkillerOther7_SpellID */;
