...
VALUES (2665, 16, 'Inscribed spell: Enfeeble Other III
Drains 16-31 points of the target''s Stamina.') /* LONG_DESC_STRING */
     , (2665, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2665, 19, 20) /* VALUE_INT */
     , (2665, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2665, 1197) /* EnfeebleOther3_SpellID */;
