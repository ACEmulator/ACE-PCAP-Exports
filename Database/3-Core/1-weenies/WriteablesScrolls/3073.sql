...
VALUES (3073, 65, 101) /* PLACEMENT_INT */
...
VALUES (3073, 16, 'Inscribed spell: Piercing Vulnerability Other II
Increases damage the target takes from Piercing by 25%.') /* LONG_DESC_STRING */
     , (3073, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3073, 19, 5) /* VALUE_INT */
     , (3073, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3073, 1152) /* PiercingVulnerabilityOther2_SpellID */;
