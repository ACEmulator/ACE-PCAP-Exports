...
VALUES (41259, 65, 101) /* PLACEMENT_INT */
...
VALUES (41259, 16, 'Inscribed spell: Two Handed Combat Mastery Self IV
Increases the caster''s Two Handed Combat skill by 25 points.') /* LONG_DESC_STRING */
     , (41259, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41259, 19, 100) /* VALUE_INT */
     , (41259, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (41259, 5102) /* twohandedmasteryself4_SpellID */;
