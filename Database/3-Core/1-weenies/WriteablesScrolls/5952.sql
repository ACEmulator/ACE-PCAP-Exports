...
VALUES (5952, 65, 101) /* PLACEMENT_INT */
...
VALUES (5952, 16, 'Inscribed spell: Cooking Mastery Other III
Increases the target''s Cooking skill by 20 points.') /* LONG_DESC_STRING */
     , (5952, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5952, 19, 20) /* VALUE_INT */
     , (5952, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5952, 1711) /* CookingMasteryOther3_SpellID */;
