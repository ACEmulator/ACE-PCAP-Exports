...
VALUES (4387, 65, 101) /* PLACEMENT_INT */
...
VALUES (4387, 16, 'Inscribed spell: Armor Other IV
Increases the target''s natural armor by 100 points.') /* LONG_DESC_STRING */
     , (4387, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4387, 19, 100) /* VALUE_INT */
     , (4387, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (4387, 1315) /* ArmorOther4_SpellID */;
