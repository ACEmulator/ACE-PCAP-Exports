...
VALUES (2712, 65, 101) /* PLACEMENT_INT */
...
VALUES (2712, 16, 'Inscribed spell: Quickness Other II
Increases the target''s Quickness by 15 points.') /* LONG_DESC_STRING */
     , (2712, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2712, 19, 5) /* VALUE_INT */
     , (2712, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2712, 1404) /* QuicknessOther2_SpellID */;
