...
VALUES (3019, 65, 101) /* PLACEMENT_INT */
...
VALUES (3019, 16, 'Inscribed spell: Cold Protection Other III
Reduces damage the target takes from Cold by 33%.') /* LONG_DESC_STRING */
     , (3019, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3019, 19, 20) /* VALUE_INT */
     , (3019, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3019, 1038) /* ColdProtectionOther3_SpellID */;
