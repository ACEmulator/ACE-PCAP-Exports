...
VALUES (3110, 16, 'Inscribed spell: Regeneration Other IV
Increase target''s natural healing rate by 55%.') /* LONG_DESC_STRING */
     , (3110, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3110, 19, 100) /* VALUE_INT */
     , (3110, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3110, 162) /* RegenerationOther4_SpellID */;
