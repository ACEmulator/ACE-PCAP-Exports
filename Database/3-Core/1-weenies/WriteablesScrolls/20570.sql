...
VALUES (20570, 65, 101) /* PLACEMENT_INT */
...
VALUES (20570, 16, 'Inscribed spell: Ignorance''s Bliss
Decreases the target''s Assess Monster skill by 40 points.') /* LONG_DESC_STRING */
     , (20570, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20570, 19, 2000) /* VALUE_INT */
     , (20570, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20570, 2290) /* MonsterUnfamiliarityOther7_SpellID */;
