...
VALUES (2934, 65, 101) /* PLACEMENT_INT */
...
VALUES (2934, 16, 'Inscribed spell: Force Bolt VI
Shoots a bolt of force at the target. The bolt does 84-168 points of piercing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2934, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2934, 19, 1000) /* VALUE_INT */
     , (2934, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2934, 91) /* ForceBolt6_SpellID */;
