...
VALUES (3341, 16, 'Inscribed spell: Jumping Mastery Self V
Increases the caster''s Jump skill by 30 points.') /* LONG_DESC_STRING */
     , (3341, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3341, 19, 200) /* VALUE_INT */
     , (3341, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3341, 974) /* JumpingMasterySelf5_SpellID */;
