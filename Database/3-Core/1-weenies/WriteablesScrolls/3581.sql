...
VALUES (3581, 65, 101) /* PLACEMENT_INT */
...
VALUES (3581, 16, 'Inscribed spell: Weapon Tinkering Expertise Other V
Increases the target''s Weapon Tinkering skill by 30 points.') /* LONG_DESC_STRING */
     , (3581, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3581, 19, 200) /* VALUE_INT */
     , (3581, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3581, 784) /* WeaponExpertiseOther5_SpellID */;
