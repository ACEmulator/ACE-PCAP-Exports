...
VALUES (3010, 65, 101) /* PLACEMENT_INT */
...
VALUES (3010, 16, 'Inscribed spell: Bludgeoning Protection Self IV
Reduces damage the caster takes from Bludgeoning by 43%.') /* LONG_DESC_STRING */
     , (3010, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3010, 19, 100) /* VALUE_INT */
     , (3010, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3010, 1021) /* BludgeonProtectionSelf4_SpellID */;
