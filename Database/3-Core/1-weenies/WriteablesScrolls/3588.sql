...
VALUES (3588, 65, 101) /* PLACEMENT_INT */
...
VALUES (3588, 16, 'Inscribed spell: Weapon Tinkering Ignorance Other II
Decreases the target''s Weapon Tinkering skill by 15 points.') /* LONG_DESC_STRING */
     , (3588, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3588, 19, 5) /* VALUE_INT */
     , (3588, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3588, 793) /* WeaponIgnoranceOther2_SpellID */;
