...
VALUES (3289, 65, 101) /* PLACEMENT_INT */
...
VALUES (3289, 16, 'Inscribed spell: Impregnability Self III
Increases the caster''s Missile Defense skill by 20 points.') /* LONG_DESC_STRING */
     , (3289, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3289, 19, 20) /* VALUE_INT */
     , (3289, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3289, 258) /* ImpregnabilitySelf3_SpellID */;
