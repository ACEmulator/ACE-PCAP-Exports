...
VALUES (3227, 65, 101) /* PLACEMENT_INT */
...
VALUES (3227, 16, 'Inscribed spell: Finesse Weapon Mastery Other VI
Increases the target''s Finesse Weapons skill by 35 points.') /* LONG_DESC_STRING */
     , (3227, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3227, 19, 1000) /* VALUE_INT */
     , (3227, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3227, 321) /* DaggerMasteryOther6_SpellID */;
