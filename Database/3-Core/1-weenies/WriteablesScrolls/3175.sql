...
VALUES (3175, 65, 101) /* PLACEMENT_INT */
...
VALUES (3175, 16, 'Inscribed spell: Missile Weapon Ineptitude Other IV
Decreases the target''s Missile Weapons skill by 25 points.') /* LONG_DESC_STRING */
     , (3175, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3175, 19, 100) /* VALUE_INT */
     , (3175, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3175, 476) /* BowIneptitudeOther4_SpellID */;
