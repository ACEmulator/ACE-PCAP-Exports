...
VALUES (45268, 65, 101) /* PLACEMENT_INT */
...
VALUES (45268, 16, 'Inscribed spell: Dual Wield Mastery Other I
Increases the target''s Dual Wield skill by 10 points.') /* LONG_DESC_STRING */
     , (45268, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45268, 19, 1) /* VALUE_INT */
     , (45268, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45268, 5795) /* dualwieldmasteryother1_SpellID */;
