...
VALUES (5987, 65, 101) /* PLACEMENT_INT */
...
VALUES (5987, 16, 'Inscribed spell: Alchemy Mastery Other II
Increases the target''s Alchemy skill by 15 points.') /* LONG_DESC_STRING */
     , (5987, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5987, 19, 5) /* VALUE_INT */
     , (5987, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5987, 1758) /* AlchemyMasteryOther2_SpellID */;
