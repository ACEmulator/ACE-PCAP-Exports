...
VALUES (1696, 65, 101) /* PLACEMENT_INT */
...
VALUES (1696, 16, 'Inscribed spell: Deception Mastery Self I
Increases the caster''s Deception skill by 10 points.') /* LONG_DESC_STRING */
     , (1696, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1696, 19, 1) /* VALUE_INT */
     , (1696, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1696, 850) /* DeceptionMasterySelf1_SpellID */;
