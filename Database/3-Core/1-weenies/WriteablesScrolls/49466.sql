...
VALUES (49466, 65, 101) /* PLACEMENT_INT */
...
VALUES (49466, 16, 'Inscribed spell: Summoning Mastery Other IV
Increases the target''s Summoning skill by 25 points.') /* LONG_DESC_STRING */
     , (49466, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (49466, 19, 100) /* VALUE_INT */
     , (49466, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (49466, 6111) /* SummoningMasteryOther4_SpellID */;
