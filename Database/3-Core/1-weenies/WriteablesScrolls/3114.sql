...
VALUES (3114, 65, 101) /* PLACEMENT_INT */
...
VALUES (3114, 16, 'Inscribed spell: Regeneration Self III
Increase caster''s natural healing rate by 40%.') /* LONG_DESC_STRING */
     , (3114, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3114, 19, 20) /* VALUE_INT */
     , (3114, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3114, 167) /* RegenerationSelf3_SpellID */;
