...
VALUES (20486, 65, 101) /* PLACEMENT_INT */
...
VALUES (20486, 16, 'Inscribed spell: Enervation
Decreases the rate at which the target regains Stamina by 60%.') /* LONG_DESC_STRING */
     , (20486, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20486, 19, 2000) /* VALUE_INT */
     , (20486, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20486, 2176) /* ExhaustionOther7_SpellID */;
