...
VALUES (2731, 65, 101) /* PLACEMENT_INT */
...
VALUES (2731, 16, 'Inscribed spell: Revitalize Self VI
Restores 80-160 points of the caster''s Stamina.') /* LONG_DESC_STRING */
     , (2731, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2731, 19, 1000) /* VALUE_INT */
     , (2731, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2731, 1182) /* RevitalizeSelf6_SpellID */;
