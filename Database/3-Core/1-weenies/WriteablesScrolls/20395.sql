...
VALUES (20395, 65, 101) /* PLACEMENT_INT */
...
VALUES (20395, 16, 'Inscribed spell: Nullify Life Magic Other
Dispels 3-6 negative Life Magic enchantments of level 6 or lower from the target.') /* LONG_DESC_STRING */
     , (20395, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20395, 19, 1000) /* VALUE_INT */
     , (20395, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20395, 1987) /* DispelLifeBadOther6_SpellID */;
