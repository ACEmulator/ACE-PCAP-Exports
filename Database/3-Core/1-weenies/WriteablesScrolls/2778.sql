...
VALUES (2778, 65, 101) /* PLACEMENT_INT */
...
VALUES (2778, 16, 'Inscribed spell: Blade Lure III
Decreases a shield or piece of armor''s resistance to slashing damage by 50%.') /* LONG_DESC_STRING */
     , (2778, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2778, 19, 20) /* VALUE_INT */
     , (2778, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2778, 1554) /* BladeLure3_SpellID */;
