...
VALUES (2737, 65, 101) /* PLACEMENT_INT */
...
VALUES (2737, 16, 'Inscribed spell: Strength Other II
Increases the target''s Strength by 15 points.') /* LONG_DESC_STRING */
     , (2737, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2737, 19, 5) /* VALUE_INT */
     , (2737, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2737, 1333) /* StrengthOther2_SpellID */;
