...
VALUES (3392, 65, 101) /* PLACEMENT_INT */
...
Increases the caster''s Lockpick skill by 35 points.') /* LONG_DESC_STRING */
     , (3392, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3392, 19, 1000) /* VALUE_INT */
     , (3392, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3392, 927) /* LockpickMasterySelf6_SpellID */;
