...
VALUES (3149, 65, 101) /* PLACEMENT_INT */
...
VALUES (3149, 16, 'Inscribed spell: Armor Tinkering Expertise Self III
Increases the caster''s Armor Tinkering skill by 20 points.') /* LONG_DESC_STRING */
     , (3149, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3149, 19, 20) /* VALUE_INT */
     , (3149, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3149, 704) /* ArmorExpertiseSelf3_SpellID */;
