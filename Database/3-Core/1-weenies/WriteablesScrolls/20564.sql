...
VALUES (20564, 16, 'Inscribed spell: Futility
Decreases the target''s Magic Defense skill by 40 points.') /* LONG_DESC_STRING */
     , (20564, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20564, 19, 2000) /* VALUE_INT */
     , (20564, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20564, 2282) /* MagicYieldOther7_SpellID */;
