...
VALUES (43300, 65, 101) /* PLACEMENT_INT */
...
VALUES (43300, 16, 'Inscribed spell: Nether Arc VII
Shoots a bolt of nether at the target. The bolt does 168-262 points of nether damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (43300, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43300, 19, 2000) /* VALUE_INT */
     , (43300, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43300, 5367) /* NetherArc7_SpellID */;
