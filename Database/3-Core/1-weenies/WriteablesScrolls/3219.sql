...
VALUES (3219, 65, 101) /* PLACEMENT_INT */
...
VALUES (3219, 16, 'Inscribed spell: Finesse Weapon Ineptitude Other III
Decreases the target''s Finesse Weapons skill by 20 points.') /* LONG_DESC_STRING */
     , (3219, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3219, 19, 20) /* VALUE_INT */
     , (3219, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3219, 330) /* DaggerIneptitudeOther3_SpellID */;
