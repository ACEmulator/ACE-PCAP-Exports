...
VALUES (3112, 65, 101) /* PLACEMENT_INT */
...
VALUES (3112, 16, 'Inscribed spell: Regeneration Other VI
Increase target''s natural healing rate by 85%.') /* LONG_DESC_STRING */
     , (3112, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3112, 19, 1000) /* VALUE_INT */
     , (3112, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3112, 164) /* RegenerationOther6_SpellID */;
