...
VALUES (1846, 65, 101) /* PLACEMENT_INT */
...
VALUES (1846, 16, 'Inscribed spell: Bludgeoning Vulnerability Other I
Increases damage the target takes from Bludgeoning by 10%.') /* LONG_DESC_STRING */
     , (1846, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1846, 19, 1) /* VALUE_INT */
     , (1846, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1846, 1048) /* BludgeonVulnerabilityOther1_SpellID */;
