...
VALUES (1713, 65, 101) /* PLACEMENT_INT */
...
VALUES (1713, 16, 'Inscribed spell: Leadership Ineptitude Other I
Decreases the target''s Leadership skill by 10 points.') /* LONG_DESC_STRING */
     , (1713, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1713, 19, 1) /* VALUE_INT */
     , (1713, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1713, 916) /* LeadershipIneptitudeOther1_SpellID */;
