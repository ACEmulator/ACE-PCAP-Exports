...
VALUES (3290, 16, 'Inscribed spell: Impregnability Self IV
Increases the caster''s Missile Defense skill by 25 points.') /* LONG_DESC_STRING */
     , (3290, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3290, 19, 100) /* VALUE_INT */
     , (3290, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3290, 259) /* ImpregnabilitySelf4_SpellID */;
