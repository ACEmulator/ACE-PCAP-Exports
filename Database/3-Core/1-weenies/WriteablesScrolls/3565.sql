...
VALUES (3565, 16, 'Inscribed spell: War Magic Ineptitude Other IV
Decreases the target''s War Magic skill by 25 points.') /* LONG_DESC_STRING */
     , (3565, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3565, 19, 100) /* VALUE_INT */
     , (3565, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3565, 650) /* WarMagicIneptitudeOther4_SpellID */;
