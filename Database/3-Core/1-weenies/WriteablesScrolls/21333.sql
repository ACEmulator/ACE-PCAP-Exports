...
VALUES (21333, 65, 101) /* PLACEMENT_INT */
...
VALUES (21333, 16, 'Inscribed spell: Shock Arc IV
Shoots a shock wave at the target. The wave does 52-105 points of bludgeoning damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21333, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21333, 19, 100) /* VALUE_INT */
     , (21333, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21333, 2749) /* ShockArc4_SpellID */;
