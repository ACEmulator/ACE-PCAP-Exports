...
VALUES (2883, 65, 101) /* PLACEMENT_INT */
...
VALUES (2883, 16, 'Inscribed spell: Aura of Swift Killer Self III
Improves a weapon''s speed by 30 points.') /* LONG_DESC_STRING */
     , (2883, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2883, 19, 20) /* VALUE_INT */
     , (2883, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2883, 1624) /* SwiftKiller3_SpellID */;
