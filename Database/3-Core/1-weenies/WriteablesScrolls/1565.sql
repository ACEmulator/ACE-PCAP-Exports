...
VALUES (1565, 65, 101) /* PLACEMENT_INT */
...
VALUES (1565, 16, 'Inscribed spell: Primary Portal Tie
Links the caster to a targeted portal.') /* LONG_DESC_STRING */
     , (1565, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1565, 19, 100) /* VALUE_INT */
     , (1565, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1565, 47) /* PortalTie1_SpellID */;
