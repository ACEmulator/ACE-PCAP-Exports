...
VALUES (46857, 65, 101) /* PLACEMENT_INT */
...
VALUES (46857, 16, 'Inscribed spell: Aura of Heart Seeker Other VI
Increases a weapon''s Attack Skill modifier by 15.0 percentage points.') /* LONG_DESC_STRING */
     , (46857, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46857, 19, 1000) /* VALUE_INT */
     , (46857, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (46857, 6012) /* heartseekerOther6_SpellID */;
