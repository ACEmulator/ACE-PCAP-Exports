...
VALUES (21327, 65, 101) /* PLACEMENT_INT */
...
VALUES (21327, 16, 'Inscribed spell: Lightning Arc V
Shoots a bolt of lighting at the target. The bolt does 68-136 points of electrical damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21327, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21327, 19, 200) /* VALUE_INT */
     , (21327, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21327, 2736) /* LightningArc5_SpellID */;
