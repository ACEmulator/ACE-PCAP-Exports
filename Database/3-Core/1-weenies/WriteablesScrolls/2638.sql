...
VALUES (2638, 65, 101) /* PLACEMENT_INT */
...
VALUES (2638, 16, 'Inscribed spell: Bafflement Other VI
Decreases the target''s Focus by 35 points.') /* LONG_DESC_STRING */
     , (2638, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2638, 19, 1000) /* VALUE_INT */
     , (2638, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2638, 1444) /* BafflementOther6_SpellID */;
