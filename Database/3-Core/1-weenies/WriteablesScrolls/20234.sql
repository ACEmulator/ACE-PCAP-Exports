...
VALUES (20234, 16, 'Inscribed spell: Boon of Refinement
Increases the target''s Coordination by 40 points.') /* LONG_DESC_STRING */
     , (20234, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20234, 19, 2000) /* VALUE_INT */
     , (20234, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20234, 2058) /* CoordinationOther7_SpellID */;
