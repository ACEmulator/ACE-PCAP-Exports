...
VALUES (2808, 65, 101) /* PLACEMENT_INT */
...
VALUES (2808, 16, 'Inscribed spell: Aura of Defender Self III
Increases the Melee Defense skill modifier of a weapon or magic caster by 7.5%.') /* LONG_DESC_STRING */
     , (2808, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2808, 19, 20) /* VALUE_INT */
     , (2808, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2808, 1602) /* Defender3_SpellID */;
