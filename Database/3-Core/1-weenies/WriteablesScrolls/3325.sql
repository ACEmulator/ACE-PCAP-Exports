...
VALUES (3325, 65, 101) /* PLACEMENT_INT */
...
VALUES (3325, 16, 'Inscribed spell: Item Tinkering Expertise Self IV
Increases the caster''s Item Tinkering skill by 25 points.') /* LONG_DESC_STRING */
     , (3325, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3325, 19, 100) /* VALUE_INT */
     , (3325, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3325, 729) /* ItemExpertiseSelf4_SpellID */;
