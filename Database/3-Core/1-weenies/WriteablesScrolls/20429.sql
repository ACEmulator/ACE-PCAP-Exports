...
VALUES (20429, 65, 101) /* PLACEMENT_INT */
...
VALUES (20429, 16, 'Inscribed spell: Vagabond''s Gift
Decreases a lock''s resistance to picking by 200 points.') /* LONG_DESC_STRING */
     , (20429, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20429, 19, 2000) /* VALUE_INT */
     , (20429, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20429, 2119) /* Weakenlock7_SpellID */;
