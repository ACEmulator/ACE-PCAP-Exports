...
VALUES (3135, 65, 101) /* PLACEMENT_INT */
...
VALUES (3135, 16, 'Inscribed spell: Arcane Enlightenment Other IV
Increases the target''s Arcane Lore skill by 25 points.') /* LONG_DESC_STRING */
     , (3135, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3135, 19, 100) /* VALUE_INT */
     , (3135, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3135, 687) /* ArcaneEnlightenmentOther4_SpellID */;
