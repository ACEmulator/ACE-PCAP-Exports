...
VALUES (3230, 65, 101) /* PLACEMENT_INT */
...
VALUES (3230, 16, 'Inscribed spell: Finesse Weapon Mastery Self IV
Increases the caster''s Finesse Weapons skill by 25 points.') /* LONG_DESC_STRING */
     , (3230, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3230, 19, 100) /* VALUE_INT */
     , (3230, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3230, 325) /* DaggerMasterySelf4_SpellID */;
