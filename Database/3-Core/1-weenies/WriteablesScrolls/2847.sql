...
VALUES (2847, 65, 101) /* PLACEMENT_INT */
...
VALUES (2847, 16, 'Inscribed spell: Leaden Weapon II
Worsens a weapon''s speed by 20 points.') /* LONG_DESC_STRING */
     , (2847, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2847, 19, 5) /* VALUE_INT */
     , (2847, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2847, 1629) /* LeadenWeapon2_SpellID */;
