...
VALUES (3934, 65, 101) /* PLACEMENT_INT */
...
VALUES (3934, 16, 'Inscribed spell: Drain Health Other III
Drains 25% of the target''s Health and gives 133% of it to the caster.') /* LONG_DESC_STRING */
     , (3934, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3934, 19, 20) /* VALUE_INT */
     , (3934, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3934, 1239) /* DrainHealth3_SpellID */;
