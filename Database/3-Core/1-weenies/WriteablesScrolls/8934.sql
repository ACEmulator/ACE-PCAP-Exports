...
VALUES (8934, 65, 101) /* PLACEMENT_INT */
...
VALUES (8934, 16, 'Inscribed spell: Force Streak VI
Sends a bolt of force streaking towards the target. The bolt does 36-71 points of piercing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (8934, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (8934, 19, 1000) /* VALUE_INT */
     , (8934, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (8934, 1807) /* ForceStreak6_SpellID */;
