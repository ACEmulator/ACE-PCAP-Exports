...
VALUES (20455, 65, 101) /* PLACEMENT_INT */
...
VALUES (20455, 16, 'Inscribed spell: Alset''s Coil
Shoots a bolt of lighting at the target. The bolt does 115-189 points of electrical damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (20455, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20455, 19, 2000) /* VALUE_INT */
     , (20455, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20455, 2140) /* Lightningbolt7_SpellID */;
