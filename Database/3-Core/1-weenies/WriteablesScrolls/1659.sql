...
VALUES (1659, 16, 'Inscribed spell: Mana Renewal Self I
Increases the caster''s natural mana rate by 10%.') /* LONG_DESC_STRING */
     , (1659, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1659, 19, 1) /* VALUE_INT */
     , (1659, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1659, 212) /* ManaRenewalSelf1_SpellID */;
