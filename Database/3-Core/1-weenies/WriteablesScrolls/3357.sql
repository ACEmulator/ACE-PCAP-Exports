...
VALUES (3357, 65, 101) /* PLACEMENT_INT */
...
VALUES (3357, 16, 'Inscribed spell: Leadership Mastery Other VI
Increases the target''s Leadership skill by 35 points.') /* LONG_DESC_STRING */
     , (3357, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3357, 19, 1000) /* VALUE_INT */
     , (3357, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3357, 909) /* LeadershipMasteryOther6_SpellID */;
