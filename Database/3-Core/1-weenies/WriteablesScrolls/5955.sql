...
VALUES (5955, 16, 'Inscribed spell: Cooking Mastery Other VI
Increases the target''s Cooking skill by 35 points.') /* LONG_DESC_STRING */
     , (5955, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5955, 19, 1000) /* VALUE_INT */
     , (5955, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5955, 1714) /* CookingMasteryOther6_SpellID */;
