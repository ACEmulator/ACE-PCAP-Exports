...
VALUES (2708, 65, 101) /* PLACEMENT_INT */
...
VALUES (2708, 16, 'Inscribed spell: Mana Drain Other III
Drains 10-19 points of the target''s Mana.') /* LONG_DESC_STRING */
     , (2708, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2708, 19, 20) /* VALUE_INT */
     , (2708, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2708, 1221) /* ManaDrainOther3_SpellID */;
