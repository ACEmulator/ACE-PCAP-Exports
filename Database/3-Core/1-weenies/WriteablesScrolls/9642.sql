...
VALUES (9642, 65, 101) /* PLACEMENT_INT */
...
VALUES (9642, 16, 'Inscribed spell: Mana to Health Self IV
Drains one-half of the caster''s Mana and gives 120% of that to his/her Health (maximum of 200).') /* LONG_DESC_STRING */
     , (9642, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9642, 19, 100) /* VALUE_INT */
     , (9642, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9642, 1293) /* ManatoHealthSelf4_SpellID */;
