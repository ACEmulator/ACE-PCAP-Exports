...
VALUES (2983, 65, 101) /* PLACEMENT_INT */
...
VALUES (2983, 16, 'Inscribed spell: Acid Vulnerability Other II
Increases damage the target takes from acid by 25%') /* LONG_DESC_STRING */
     , (2983, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2983, 19, 5) /* VALUE_INT */
     , (2983, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2983, 522) /* AcidVulnerabilityOther2_SpellID */;
