...
VALUES (2663, 65, 101) /* PLACEMENT_INT */
...
VALUES (2663, 16, 'Inscribed spell: Endurance Self VI
Increases the caster''s Endurance by 35 points.') /* LONG_DESC_STRING */
     , (2663, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2663, 19, 1000) /* VALUE_INT */
     , (2663, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2663, 1354) /* EnduranceSelf6_SpellID */;
