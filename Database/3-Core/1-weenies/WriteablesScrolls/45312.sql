...
VALUES (45312, 65, 101) /* PLACEMENT_INT */
...
VALUES (45312, 16, 'Inscribed spell: Shield Ineptitude Other V
Decreases the target''s Shield skill by 30 points.') /* LONG_DESC_STRING */
     , (45312, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45312, 19, 200) /* VALUE_INT */
     , (45312, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45312, 5839) /* shieldineptitudeother5_SpellID */;
