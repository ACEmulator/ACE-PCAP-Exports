...
VALUES (45296, 65, 101) /* PLACEMENT_INT */
...
VALUES (45296, 16, 'Inscribed spell: Recklessness Mastery Other V
Increases the target''s Recklessness skill by 30 points.') /* LONG_DESC_STRING */
     , (45296, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45296, 19, 200) /* VALUE_INT */
     , (45296, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45296, 5823) /* recklessnessmasteryother5_SpellID */;
