...
VALUES (20428, 65, 101) /* PLACEMENT_INT */
...
VALUES (20428, 16, 'Inscribed spell: Clouded Motives
Decreases a weapon''s Attack Skill modifier by 17.0 percentage points.') /* LONG_DESC_STRING */
     , (20428, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20428, 19, 2000) /* VALUE_INT */
     , (20428, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20428, 2118) /* TurnBlade7_SpellID */;
