...
VALUES (3097, 65, 101) /* PLACEMENT_INT */
...
VALUES (3097, 16, 'Inscribed spell: Mana Depletion Other VI
Decreases target''s natural mana rate by 46%.') /* LONG_DESC_STRING */
     , (3097, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3097, 19, 1000) /* VALUE_INT */
     , (3097, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3097, 223) /* ManaDepletionOther6_SpellID */;
