...
VALUES (3173, 65, 101) /* PLACEMENT_INT */
...
VALUES (3173, 16, 'Inscribed spell: Missile Weapon Ineptitude Other II
Decreases the target''s Missile Weapons skill by 15 points.') /* LONG_DESC_STRING */
     , (3173, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3173, 19, 5) /* VALUE_INT */
     , (3173, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3173, 474) /* BowIneptitudeOther2_SpellID */;
