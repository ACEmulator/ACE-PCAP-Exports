...
VALUES (1865, 65, 101) /* PLACEMENT_INT */
...
VALUES (1865, 16, 'Inscribed spell: Infuse Health Other I
Drains one-quarter of the caster''s Health and gives 75% of that to the target.') /* LONG_DESC_STRING */
     , (1865, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1865, 19, 1) /* VALUE_INT */
     , (1865, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1865, 1225) /* InfuseHealth1_SpellID */;
