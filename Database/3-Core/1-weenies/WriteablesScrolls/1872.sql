...
VALUES (1872, 65, 101) /* PLACEMENT_INT */
...
VALUES (1872, 16, 'Inscribed spell: Stamina to Health Self I
Drains one-half of the caster''s Stamina and gives 90% of that to his/her Health (maximum of 50).') /* LONG_DESC_STRING */
     , (1872, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1872, 19, 1) /* VALUE_INT */
     , (1872, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1872, 1664) /* StaminatoHealthSelf1_SpellID */;
