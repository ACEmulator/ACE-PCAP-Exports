...
VALUES (3525, 65, 101) /* PLACEMENT_INT */
...
VALUES (3525, 16, 'Inscribed spell: Heavy Weapon Mastery Self IV
Increases the caster''s Heavy Weapons skill by 25 points.') /* LONG_DESC_STRING */
     , (3525, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3525, 19, 100) /* VALUE_INT */
     , (3525, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3525, 421) /* SwordMasterySelf4_SpellID */;
