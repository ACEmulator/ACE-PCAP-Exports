...
VALUES (9646, 65, 101) /* PLACEMENT_INT */
...
VALUES (9646, 16, 'Inscribed spell: Mana to Stamina Self III
Drains one-half of the caster''s Mana and gives 110% of that to his/her Stamina (maximum of 150).') /* LONG_DESC_STRING */
     , (9646, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9646, 19, 20) /* VALUE_INT */
     , (9646, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9646, 1298) /* ManatoStaminaSelf3_SpellID */;
