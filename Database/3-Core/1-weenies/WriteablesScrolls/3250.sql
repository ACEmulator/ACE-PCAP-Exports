...
VALUES (3250, 65, 101) /* PLACEMENT_INT */
...
VALUES (3250, 16, 'Inscribed spell: Defenselessness Other IV
Decreases the target''s Missile Defense skill by 25 points.') /* LONG_DESC_STRING */
     , (3250, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3250, 19, 100) /* VALUE_INT */
     , (3250, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3250, 265) /* DefenselessnessOther4_SpellID */;
