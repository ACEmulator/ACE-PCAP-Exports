...
VALUES (2643, 65, 101) /* PLACEMENT_INT */
...
VALUES (2643, 16, 'Inscribed spell: Clumsiness Other VI
Decreases the target''s Coordination by 35 points.') /* LONG_DESC_STRING */
     , (2643, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2643, 19, 1000) /* VALUE_INT */
     , (2643, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2643, 1396) /* ClumsinessOther6_SpellID */;
