...
VALUES (3373, 16, 'Inscribed spell: Life Magic Mastery Self II
Increases the caster''s Life Magic skill by 15 points.') /* LONG_DESC_STRING */
     , (3373, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3373, 19, 5) /* VALUE_INT */
     , (3373, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3373, 606) /* LifeMagicMasterySelf2_SpellID */;
