...
VALUES (2642, 16, 'Inscribed spell: Clumsiness Other V
Decreases the target''s Coordination by 30 points.') /* LONG_DESC_STRING */
     , (2642, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2642, 19, 200) /* VALUE_INT */
     , (2642, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2642, 1395) /* ClumsinessOther5_SpellID */;
