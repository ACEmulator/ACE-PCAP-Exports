...
VALUES (45285, 65, 101) /* PLACEMENT_INT */
...
VALUES (45285, 16, 'Inscribed spell: Recklessness Ineptitude Other II
Decreases the target''s Recklessness skill by 15 points.') /* LONG_DESC_STRING */
     , (45285, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45285, 19, 5) /* VALUE_INT */
     , (45285, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45285, 5812) /* recklessnessineptitudeother2_SpellID */;
