...
VALUES (43305, 65, 101) /* PLACEMENT_INT */
...
VALUES (43305, 16, 'Inscribed spell: Nether Bolt IV
Shoots a bolt of nether at the target. The bolt does 73-146 points of nether damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (43305, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43305, 19, 100) /* VALUE_INT */
     , (43305, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43305, 5352) /* netherbolt4_SpellID */;
