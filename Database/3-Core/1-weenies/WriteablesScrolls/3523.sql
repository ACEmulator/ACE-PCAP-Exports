...
VALUES (3523, 65, 101) /* PLACEMENT_INT */
...
VALUES (3523, 16, 'Inscribed spell: Heavy Weapon Mastery Self II
Increases the caster''s Heavy Weapons skill by 15 points.') /* LONG_DESC_STRING */
     , (3523, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3523, 19, 5) /* VALUE_INT */
     , (3523, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3523, 419) /* SwordMasterySelf2_SpellID */;
