...
VALUES (2730, 65, 101) /* PLACEMENT_INT */
...
VALUES (2730, 16, 'Inscribed spell: Revitalize Self V
Restores 60-120 points of the caster''s Stamina.') /* LONG_DESC_STRING */
     , (2730, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2730, 19, 200) /* VALUE_INT */
     , (2730, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2730, 1181) /* RevitalizeSelf5_SpellID */;
