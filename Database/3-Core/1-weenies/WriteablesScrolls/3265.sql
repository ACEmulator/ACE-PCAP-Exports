...
VALUES (3265, 65, 101) /* PLACEMENT_INT */
...
VALUES (3265, 16, 'Inscribed spell: Fealty Self IV
Increases the caster''s Loyalty skill by 25 points.') /* LONG_DESC_STRING */
     , (3265, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3265, 19, 100) /* VALUE_INT */
     , (3265, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3265, 949) /* FealtySelf4_SpellID */;
