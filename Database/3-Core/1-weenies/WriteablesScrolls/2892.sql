...
VALUES (2892, 65, 101) /* PLACEMENT_INT */
...
VALUES (2892, 16, 'Inscribed spell: Aura of Hermetic Link Self VI
Increases a magic casting implement''s mana conversion bonus by 60%.') /* LONG_DESC_STRING */
     , (2892, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2892, 19, 1000) /* VALUE_INT */
     , (2892, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2892, 1480) /* TrueValue6_SpellID */;
