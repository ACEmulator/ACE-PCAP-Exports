...
VALUES (2689, 65, 101) /* PLACEMENT_INT */
...
VALUES (2689, 16, 'Inscribed spell: Harm Other IV
Drains 16-33 points of the target''s Health.') /* LONG_DESC_STRING */
     , (2689, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2689, 19, 100) /* VALUE_INT */
     , (2689, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2689, 1174) /* HarmOther4_SpellID */;
