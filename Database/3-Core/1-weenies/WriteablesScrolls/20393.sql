...
VALUES (20393, 65, 101) /* PLACEMENT_INT */
...
VALUES (20393, 16, 'Inscribed spell: Devour Life Magic Other
Dispels 3-6 negative Life Magic enchantments of level 4 or lower from the target.') /* LONG_DESC_STRING */
     , (20393, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20393, 19, 100) /* VALUE_INT */
     , (20393, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20393, 1975) /* DispelLifeBadOther4_SpellID */;
