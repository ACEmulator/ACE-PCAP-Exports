...
VALUES (3359, 65, 101) /* PLACEMENT_INT */
...
VALUES (3359, 16, 'Inscribed spell: Leadership Mastery Self III
Increases the caster''s Leadership skill by 20 points.') /* LONG_DESC_STRING */
     , (3359, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3359, 19, 20) /* VALUE_INT */
     , (3359, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3359, 900) /* LeadershipMasterySelf3_SpellID */;
