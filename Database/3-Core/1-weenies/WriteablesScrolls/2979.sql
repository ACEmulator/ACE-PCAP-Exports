...
VALUES (2979, 65, 101) /* PLACEMENT_INT */
...
VALUES (2979, 16, 'Inscribed spell: Acid Protection Self III
Reduces damage the caster takes from acid by 33%.') /* LONG_DESC_STRING */
     , (2979, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2979, 19, 20) /* VALUE_INT */
     , (2979, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2979, 517) /* AcidProtectionSelf3_SpellID */;
