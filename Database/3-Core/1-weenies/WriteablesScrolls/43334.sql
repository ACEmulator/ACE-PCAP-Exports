...
VALUES (43334, 65, 101) /* PLACEMENT_INT */
...
VALUES (43334, 16, 'Inscribed spell: Festering Curse VI
The heal rating of the target is decreased by 30.') /* LONG_DESC_STRING */
     , (43334, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43334, 19, 1000) /* VALUE_INT */
     , (43334, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43334, 5376) /* CurseFestering6_SpellID */;
