...
VALUES (2750, 65, 101) /* PLACEMENT_INT */
...
VALUES (2750, 16, 'Inscribed spell: Weakness Other V
Decreases the target''s Strength by 30 points.') /* LONG_DESC_STRING */
     , (2750, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2750, 19, 200) /* VALUE_INT */
     , (2750, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2750, 1342) /* WeaknessOther5_SpellID */;
