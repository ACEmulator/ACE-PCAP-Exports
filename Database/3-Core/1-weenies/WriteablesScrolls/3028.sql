...
VALUES (3028, 16, 'Inscribed spell: Cold Vulnerability Other II
Increases damage the target takes from Cold by 25%.') /* LONG_DESC_STRING */
     , (3028, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3028, 19, 5) /* VALUE_INT */
     , (3028, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3028, 1061) /* ColdVulnerabilityOther2_SpellID */;
