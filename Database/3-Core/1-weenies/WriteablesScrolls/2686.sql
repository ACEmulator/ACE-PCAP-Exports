...
VALUES (2686, 65, 101) /* PLACEMENT_INT */
...
VALUES (2686, 16, 'Inscribed spell: Frailty Other VI
Decreases the target''s Endurance by 35 points.') /* LONG_DESC_STRING */
     , (2686, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2686, 19, 1000) /* VALUE_INT */
     , (2686, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2686, 1372) /* FrailtyOther6_SpellID */;
