...
VALUES (3145, 65, 101) /* PLACEMENT_INT */
...
VALUES (3145, 16, 'Inscribed spell: Armor Tinkering Expertise Other IV
Increases the target''s Armor Tinkering skill by 25 points.') /* LONG_DESC_STRING */
     , (3145, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3145, 19, 100) /* VALUE_INT */
     , (3145, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3145, 711) /* ArmorExpertiseOther4_SpellID */;
