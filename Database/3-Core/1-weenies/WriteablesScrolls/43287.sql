...
VALUES (43287, 65, 101) /* PLACEMENT_INT */
...
VALUES (43287, 16, 'Inscribed spell: Corruption II
Sends 3 bolts of corruption outward from the caster. Each bolt does 91 points of damage over 30 seconds.') /* LONG_DESC_STRING */
     , (43287, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43287, 19, 5) /* VALUE_INT */
     , (43287, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43287, 5396) /* Corruption2_SpellID */;
