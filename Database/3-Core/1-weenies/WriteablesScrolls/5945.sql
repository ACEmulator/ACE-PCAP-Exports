...
VALUES (5945, 65, 101) /* PLACEMENT_INT */
...
VALUES (5945, 16, 'Inscribed spell: Cooking Ineptitude Other II
Decreases the target''s Cooking skill by 15 points.') /* LONG_DESC_STRING */
     , (5945, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5945, 19, 5) /* VALUE_INT */
     , (5945, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5945, 1722) /* CookingIneptitudeOther2_SpellID */;
