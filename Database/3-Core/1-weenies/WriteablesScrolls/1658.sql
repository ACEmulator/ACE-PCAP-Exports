...
VALUES (1658, 65, 101) /* PLACEMENT_INT */
...
VALUES (1658, 16, 'Inscribed spell: Regeneration Self I
Increase caster''s natural healing rate by 10%.') /* LONG_DESC_STRING */
     , (1658, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1658, 19, 1) /* VALUE_INT */
     , (1658, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1658, 165) /* RegenerationSelf1_SpellID */;
