...
VALUES (3239, 65, 101) /* PLACEMENT_INT */
...
VALUES (3239, 16, 'Inscribed spell: Deception Mastery Other III
Increases the target''s Deception skill by 20 points.') /* LONG_DESC_STRING */
     , (3239, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3239, 19, 20) /* VALUE_INT */
     , (3239, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3239, 858) /* DeceptionMasteryOther3_SpellID */;
