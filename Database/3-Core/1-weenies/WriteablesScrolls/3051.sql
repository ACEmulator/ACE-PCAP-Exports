...
VALUES (3051, 65, 101) /* PLACEMENT_INT */
...
VALUES (3051, 16, 'Inscribed spell: Lightning Protection Other V
Reduces damage the target takes from Lightning by 50%.') /* LONG_DESC_STRING */
     , (3051, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3051, 19, 200) /* VALUE_INT */
     , (3051, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3051, 1076) /* LightningProtectionOther5_SpellID */;
