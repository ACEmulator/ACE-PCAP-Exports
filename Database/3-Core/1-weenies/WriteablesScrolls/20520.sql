...
VALUES (20520, 65, 101) /* PLACEMENT_INT */
...
VALUES (20520, 16, 'Inscribed spell: Finesse Weapon Mastery Other VII
Increases the target''s Finesse Weapons skill by 40 points.') /* LONG_DESC_STRING */
     , (20520, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20520, 19, 2000) /* VALUE_INT */
     , (20520, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20520, 2222) /* DaggerMasteryOther7_SpellID */;
