...
VALUES (3188, 65, 101) /* PLACEMENT_INT */
...
VALUES (3188, 16, 'Inscribed spell: Creature Enchantment Ineptitude Other II
Decreases the target''s Creature Enchantment skill by 15 points.') /* LONG_DESC_STRING */
     , (3188, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3188, 19, 5) /* VALUE_INT */
     , (3188, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3188, 570) /* CreatureEnchantmentIneptitudeOther2_SpellID */;
