...
VALUES (3041, 65, 101) /* PLACEMENT_INT */
...
VALUES (3041, 16, 'Inscribed spell: Fire Protection Self V
Reduces damage the caster takes from Fire by 50%.') /* LONG_DESC_STRING */
     , (3041, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3041, 19, 200) /* VALUE_INT */
     , (3041, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3041, 1093) /* FireProtectionSelf5_SpellID */;
