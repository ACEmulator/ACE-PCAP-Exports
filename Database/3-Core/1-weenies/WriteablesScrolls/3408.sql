...
VALUES (3408, 65, 101) /* PLACEMENT_INT */
...
VALUES (3408, 16, 'Inscribed spell: Magic Item Tinkering Expertise Other II
Increases the target''s Magic Item Tinkering skill by 15 points.') /* LONG_DESC_STRING */
     , (3408, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3408, 19, 5) /* VALUE_INT */
     , (3408, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3408, 757) /* MagicItemExpertiseOther2_SpellID */;
