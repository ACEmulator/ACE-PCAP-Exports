...
VALUES (3386, 65, 101) /* PLACEMENT_INT */
...
VALUES (3386, 16, 'Inscribed spell: Lockpick Mastery Other V
Increases the target''s Lockpick skill by 30 points.') /* LONG_DESC_STRING */
     , (3386, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3386, 19, 200) /* VALUE_INT */
     , (3386, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3386, 932) /* LockpickMasteryOther5_SpellID */;
