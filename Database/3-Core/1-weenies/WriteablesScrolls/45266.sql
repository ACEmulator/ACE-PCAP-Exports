...
VALUES (45266, 65, 101) /* PLACEMENT_INT */
...
VALUES (45266, 16, 'Inscribed spell: Dual Wield Ineptitude Other VII
Decreases the target''s Dual Wield skill by 40 points.') /* LONG_DESC_STRING */
     , (45266, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45266, 19, 2000) /* VALUE_INT */
     , (45266, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45266, 5793) /* dualwieldineptitudeother7_SpellID */;
