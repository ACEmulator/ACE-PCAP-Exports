...
VALUES (3381, 65, 101) /* PLACEMENT_INT */
...
VALUES (3381, 16, 'Inscribed spell: Lockpick Ineptitude Other V
Decreases the target''s Lockpick skill by 30 points.') /* LONG_DESC_STRING */
     , (3381, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3381, 19, 200) /* VALUE_INT */
     , (3381, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3381, 944) /* LockpickIneptitudeOther5_SpellID */;
