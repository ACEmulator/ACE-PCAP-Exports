...
VALUES (3443, 65, 101) /* PLACEMENT_INT */
...
VALUES (3443, 16, 'Inscribed spell: Monster Unfamiliarity Other II
Decreases the target''s Assess Monster skill by 15 points.') /* LONG_DESC_STRING */
     , (3443, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3443, 19, 5) /* VALUE_INT */
     , (3443, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3443, 818) /* MonsterUnfamiliarityOther2_SpellID */;
