...
VALUES (3218, 65, 101) /* PLACEMENT_INT */
...
VALUES (3218, 16, 'Inscribed spell: Finesse Weapon Ineptitude Other II
Decreases the target''s Finesse Weapons skill by 15 points.') /* LONG_DESC_STRING */
     , (3218, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3218, 19, 5) /* VALUE_INT */
     , (3218, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3218, 329) /* DaggerIneptitudeOther2_SpellID */;
