...
VALUES (20553, 65, 101) /* PLACEMENT_INT */
...
VALUES (20553, 16, 'Inscribed spell: Harlune''s Boon
Increases the target''s Life Magic skill by 40 points.') /* LONG_DESC_STRING */
     , (20553, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20553, 19, 2000) /* VALUE_INT */
     , (20553, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20553, 2266) /* LifeMagicMasteryOther7_SpellID */;
