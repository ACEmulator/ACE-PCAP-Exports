...
VALUES (3249, 65, 101) /* PLACEMENT_INT */
...
VALUES (3249, 16, 'Inscribed spell: Defenselessness Other III
Decreases the target''s Missile Defense skill by 20 points.') /* LONG_DESC_STRING */
     , (3249, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3249, 19, 20) /* VALUE_INT */
     , (3249, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3249, 264) /* DefenselessnessOther3_SpellID */;
