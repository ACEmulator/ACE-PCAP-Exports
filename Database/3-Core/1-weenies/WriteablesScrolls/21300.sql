...
VALUES (21300, 65, 101) /* PLACEMENT_INT */
...
VALUES (21300, 16, 'Inscribed spell: Blade Arc VI
Shoots a magical blade at the target. The bolt does 84-168 points of slashing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21300, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21300, 19, 1000) /* VALUE_INT */
     , (21300, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21300, 2758) /* BladeArc6_SpellID */;
