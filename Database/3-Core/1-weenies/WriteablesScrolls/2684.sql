...
VALUES (2684, 65, 101) /* PLACEMENT_INT */
...
VALUES (2684, 16, 'Inscribed spell: Frailty Other IV
Decreases the target''s Endurance by 25 points.') /* LONG_DESC_STRING */
     , (2684, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2684, 19, 100) /* VALUE_INT */
     , (2684, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2684, 1370) /* FrailtyOther4_SpellID */;
