...
VALUES (2963, 65, 101) /* PLACEMENT_INT */
...
VALUES (2963, 16, 'Inscribed spell: Shock Wave II
Shoots a shock wave at the target. The wave does 26-52 points of bludgeoning damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2963, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2963, 19, 5) /* VALUE_INT */
     , (2963, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2963, 65) /* ShockWave2_SpellID */;
