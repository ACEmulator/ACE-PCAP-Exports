...
VALUES (3287, 65, 101) /* PLACEMENT_INT */
...
VALUES (3287, 16, 'Inscribed spell: Impregnability Other VI
Increases the target''s Missile Defense skill by 35 points.') /* LONG_DESC_STRING */
     , (3287, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3287, 19, 1000) /* VALUE_INT */
     , (3287, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3287, 255) /* ImpregnabilityOther6_SpellID */;
