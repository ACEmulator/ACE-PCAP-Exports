...
VALUES (45271, 65, 101) /* PLACEMENT_INT */
...
VALUES (45271, 16, 'Inscribed spell: Dual Wield Mastery Other IV
Increases the target''s Dual Wield skill by 25 points.') /* LONG_DESC_STRING */
     , (45271, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45271, 19, 100) /* VALUE_INT */
     , (45271, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45271, 5798) /* dualwieldmasteryother4_SpellID */;
