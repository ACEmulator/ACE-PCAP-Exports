...
VALUES (43341, 16, 'Inscribed spell: Weakening Curse IV
Decreases the target''s damage rating by 6.') /* LONG_DESC_STRING */
     , (43341, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43341, 19, 100) /* VALUE_INT */
     , (43341, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43341, 5382) /* CurseWeakness4_SpellID */;
