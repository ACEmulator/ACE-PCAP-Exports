...
VALUES (3567, 65, 101) /* PLACEMENT_INT */
...
VALUES (3567, 16, 'Inscribed spell: War Magic Ineptitude Other VI
Decreases the target''s War Magic skill by 35 points.') /* LONG_DESC_STRING */
     , (3567, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3567, 19, 1000) /* VALUE_INT */
     , (3567, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3567, 652) /* WarMagicIneptitudeOther6_SpellID */;
