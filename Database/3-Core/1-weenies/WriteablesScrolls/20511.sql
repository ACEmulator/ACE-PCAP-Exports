...
VALUES (20511, 65, 101) /* PLACEMENT_INT */
...
VALUES (20511, 16, 'Inscribed spell: Morimoto''s Boon
Increases the target''s Cooking skill by 40 points.') /* LONG_DESC_STRING */
     , (20511, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20511, 19, 2000) /* VALUE_INT */
     , (20511, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20511, 2210) /* CookingMasteryOther7_SpellID */;
