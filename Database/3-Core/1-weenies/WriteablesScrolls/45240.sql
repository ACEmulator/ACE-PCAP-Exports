...
VALUES (45240, 16, 'Inscribed spell: Dirty Fighting Ineptitude Other V
Decreases the target''s Dirty Fighting skill by 30 points.') /* LONG_DESC_STRING */
     , (45240, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45240, 19, 200) /* VALUE_INT */
     , (45240, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45240, 5767) /* dirtyfightingineptitudeother5_SpellID */;
