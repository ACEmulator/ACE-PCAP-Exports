...
VALUES (3039, 16, 'Inscribed spell: Fire Protection Self III
Reduces damage the caster takes from Fire by 33%.') /* LONG_DESC_STRING */
     , (3039, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3039, 19, 20) /* VALUE_INT */
     , (3039, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3039, 1091) /* FireProtectionSelf3_SpellID */;
