...
VALUES (2977, 65, 101) /* PLACEMENT_INT */
...
VALUES (2977, 16, 'Inscribed spell: Acid Protection Other VI
Reduces damage the target takes from acid by 60%.') /* LONG_DESC_STRING */
     , (2977, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2977, 19, 1000) /* VALUE_INT */
     , (2977, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2977, 514) /* AcidProtectionOther6_SpellID */;
