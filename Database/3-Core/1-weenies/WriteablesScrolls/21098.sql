...
VALUES (21098, 65, 101) /* PLACEMENT_INT */
...
VALUES (21098, 16, 'Inscribed spell: Martyr''s Hecatomb IV
Drains one-quarter of the caster''s health into a bolt of energy.  When struck by the bolt, the target''s health is reduced by 125% of the amount drained.') /* LONG_DESC_STRING */
     , (21098, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21098, 19, 100) /* VALUE_INT */
     , (21098, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21098, 2763) /* HealthBolt4_SpellID */;
