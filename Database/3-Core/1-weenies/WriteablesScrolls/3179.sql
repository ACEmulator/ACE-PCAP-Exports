...
VALUES (3179, 65, 101) /* PLACEMENT_INT */
...
VALUES (3179, 16, 'Inscribed spell: Missile Weapon Mastery Other III
Increases the target''s Missile Weapons skill by 20 points.') /* LONG_DESC_STRING */
     , (3179, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3179, 19, 20) /* VALUE_INT */
     , (3179, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3179, 463) /* BowMasteryOther3_SpellID */;
