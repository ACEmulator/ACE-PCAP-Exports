...
VALUES (2834, 65, 101) /* PLACEMENT_INT */
...
VALUES (2834, 16, 'Inscribed spell: Aura of Heart Seeker Self IV
Increases a weapon''s Attack Skill modifier by 10.0 percentage points.') /* LONG_DESC_STRING */
     , (2834, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2834, 19, 100) /* VALUE_INT */
     , (2834, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2834, 1590) /* HeartSeeker4_SpellID */;
