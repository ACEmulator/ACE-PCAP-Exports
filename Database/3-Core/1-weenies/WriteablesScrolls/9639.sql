...
VALUES (9639, 65, 101) /* PLACEMENT_INT */
...
VALUES (9639, 16, 'Inscribed spell: Health to Stamina Self VI
Drains one-half of the caster''s Health and gives 150% of that to his/her Stamina.') /* LONG_DESC_STRING */
     , (9639, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9639, 19, 1000) /* VALUE_INT */
     , (9639, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9639, 1277) /* HealthtoStaminaSelf6_SpellID */;
