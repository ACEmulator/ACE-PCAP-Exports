...
VALUES (3009, 16, 'Inscribed spell: Bludgeoning Protection Self III
Reduces damage the caster takes from Bludgeoning by 33%.') /* LONG_DESC_STRING */
     , (3009, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3009, 19, 20) /* VALUE_INT */
     , (3009, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3009, 1020) /* BludgeonProtectionSelf3_SpellID */;
