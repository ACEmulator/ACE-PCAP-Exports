...
VALUES (9652, 16, 'Inscribed spell: Stamina to Health Self IV
Drains one-half of the caster''s Stamina and gives 120% of that to his/her Health (maximum of 200).') /* LONG_DESC_STRING */
     , (9652, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9652, 19, 100) /* VALUE_INT */
     , (9652, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (9652, 1667) /* StaminatoHealthSelf4_SpellID */;
