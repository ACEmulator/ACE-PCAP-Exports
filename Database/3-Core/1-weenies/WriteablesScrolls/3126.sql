...
VALUES (3126, 65, 101) /* PLACEMENT_INT */
...
VALUES (3126, 16, 'Inscribed spell: Rejuvenation Self V
Increases the rate at which the caster regains Stamina by 70%.') /* LONG_DESC_STRING */
     , (3126, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3126, 19, 200) /* VALUE_INT */
     , (3126, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3126, 192) /* RejuvenationSelf5_SpellID */;
