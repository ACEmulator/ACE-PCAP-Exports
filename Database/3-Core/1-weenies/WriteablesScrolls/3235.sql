...
VALUES (3235, 65, 101) /* PLACEMENT_INT */
...
VALUES (3235, 16, 'Inscribed spell: Deception Ineptitude Other IV
Decreases the target''s Deception skill by 25 points.') /* LONG_DESC_STRING */
     , (3235, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3235, 19, 100) /* VALUE_INT */
     , (3235, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3235, 871) /* DeceptionIneptitudeOther4_SpellID */;
