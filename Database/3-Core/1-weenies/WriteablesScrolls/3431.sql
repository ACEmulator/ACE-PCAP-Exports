...
VALUES (3431, 65, 101) /* PLACEMENT_INT */
...
VALUES (3431, 16, 'Inscribed spell: Mana Conversion Mastery Other V
Increases the target''s Mana Conversion skill by 30 points.') /* LONG_DESC_STRING */
     , (3431, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3431, 19, 200) /* VALUE_INT */
     , (3431, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3431, 663) /* ManaMasteryOther5_SpellID */;
