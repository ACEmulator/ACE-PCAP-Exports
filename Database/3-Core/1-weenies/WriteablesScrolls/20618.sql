...
VALUES (20618, 65, 101) /* PLACEMENT_INT */
...
VALUES (20618, 16, 'Inscribed spell: Lifestone Tie
Links the caster to a targeted Lifestone.') /* LONG_DESC_STRING */
     , (20618, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20618, 19, 20) /* VALUE_INT */
     , (20618, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20618, 2644) /* LifestoneTie1_SpellID */;
