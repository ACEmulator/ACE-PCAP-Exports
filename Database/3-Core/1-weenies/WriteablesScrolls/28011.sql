...
VALUES (28011, 65, 101) /* PLACEMENT_INT */
...
VALUES (28011, 16, 'Inscribed spell: Spirit Loather III
Decreases the elemental damage bonus of an elemental magic caster by 3%.') /* LONG_DESC_STRING */
     , (28011, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28011, 19, 20) /* VALUE_INT */
     , (28011, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (28011, 3262) /* SpiritLoather3_SpellID */;
