...
VALUES (45328, 65, 101) /* PLACEMENT_INT */
...
VALUES (45328, 16, 'Inscribed spell: Shield Mastery Self V
Increases the caster''s Shield skill by 30 points.') /* LONG_DESC_STRING */
     , (45328, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45328, 19, 200) /* VALUE_INT */
     , (45328, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45328, 5855) /* shieldmasteryself5_SpellID */;
