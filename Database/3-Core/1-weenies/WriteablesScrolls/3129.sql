...
VALUES (3129, 65, 101) /* PLACEMENT_INT */
...
VALUES (3129, 16, 'Inscribed spell: Arcane Benightedness Other III
Decreases the target''s Arcane Lore skill by 20 points.') /* LONG_DESC_STRING */
     , (3129, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3129, 19, 20) /* VALUE_INT */
     , (3129, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3129, 698) /* ArcaneBenightednessOther3_SpellID */;
