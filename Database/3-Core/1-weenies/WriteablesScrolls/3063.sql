...
VALUES (3063, 65, 101) /* PLACEMENT_INT */
...
VALUES (3063, 16, 'Inscribed spell: Piercing Protection Other II
Reduces damage the target takes from Piercing by 20%.') /* LONG_DESC_STRING */
     , (3063, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3063, 19, 5) /* VALUE_INT */
     , (3063, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3063, 1140) /* PiercingProtectionOther2_SpellID */;
