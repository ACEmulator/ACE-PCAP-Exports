...
VALUES (1588, 65, 101) /* PLACEMENT_INT */
...
VALUES (1588, 16, 'Inscribed spell: Aura of Blood Drinker Self I
Increases a weapon''s damage value by 2 points.') /* LONG_DESC_STRING */
     , (1588, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1588, 19, 1) /* VALUE_INT */
     , (1588, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1588, 35) /* BloodDrinker1_SpellID */;
