...
VALUES (2675, 16, 'Inscribed spell: Focus Other III
Increases the target''s Focus by 20 points.') /* LONG_DESC_STRING */
     , (2675, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2675, 19, 20) /* VALUE_INT */
     , (2675, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2675, 1429) /* FocusOther3_SpellID */;
