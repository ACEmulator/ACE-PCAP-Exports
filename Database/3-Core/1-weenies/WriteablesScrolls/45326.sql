...
VALUES (45326, 65, 101) /* PLACEMENT_INT */
...
VALUES (45326, 16, 'Inscribed spell: Shield Mastery Self III
Increases the caster''s Shield skill by 20 points.') /* LONG_DESC_STRING */
     , (45326, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45326, 19, 20) /* VALUE_INT */
     , (45326, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45326, 5853) /* shieldmasteryself3_SpellID */;
