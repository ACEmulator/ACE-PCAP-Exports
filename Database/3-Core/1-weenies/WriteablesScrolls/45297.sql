...
VALUES (45297, 65, 101) /* PLACEMENT_INT */
...
VALUES (45297, 16, 'Inscribed spell: Recklessness Mastery Other VI
Increases the target''s Recklessness skill by 35 points.') /* LONG_DESC_STRING */
     , (45297, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45297, 19, 1000) /* VALUE_INT */
     , (45297, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45297, 5824) /* recklessnessmasteryother6_SpellID */;
