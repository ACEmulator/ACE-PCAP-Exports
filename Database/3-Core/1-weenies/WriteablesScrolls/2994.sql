...
VALUES (2994, 65, 101) /* PLACEMENT_INT */
...
VALUES (2994, 16, 'Inscribed spell: Blade Protection Self III
Reduces damage the caster takes from Slashing by 33%.') /* LONG_DESC_STRING */
     , (2994, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2994, 19, 20) /* VALUE_INT */
     , (2994, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2994, 1111) /* BladeProtectionSelf3_SpellID */;
