...
VALUES (45256, 65, 101) /* PLACEMENT_INT */
...
VALUES (45256, 16, 'Inscribed spell: Dirty Fighting Mastery Self V
Increases the caster''s Dirty Fighting skill by 30 points.') /* LONG_DESC_STRING */
     , (45256, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45256, 19, 200) /* VALUE_INT */
     , (45256, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45256, 5783) /* dirtyfightingmasteryself5_SpellID */;
