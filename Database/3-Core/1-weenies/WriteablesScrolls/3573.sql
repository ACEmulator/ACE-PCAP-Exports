...
VALUES (3573, 16, 'Inscribed spell: War Magic Mastery Self II
Increases the caster''s War Magic skill by 15 points.') /* LONG_DESC_STRING */
     , (3573, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3573, 19, 5) /* VALUE_INT */
     , (3573, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3573, 630) /* WarMagicMasterySelf2_SpellID */;
