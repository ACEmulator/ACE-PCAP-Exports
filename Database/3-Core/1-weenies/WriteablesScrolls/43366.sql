...
VALUES (43366, 65, 101) /* PLACEMENT_INT */
...
VALUES (43366, 16, 'Inscribed spell: Void Magic Mastery Self VI
Increases the caster''s Void Magic skill by 35 points.') /* LONG_DESC_STRING */
     , (43366, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43366, 19, 1000) /* VALUE_INT */
     , (43366, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43366, 5416) /* VoidMagicMasterySelf6_SpellID */;
