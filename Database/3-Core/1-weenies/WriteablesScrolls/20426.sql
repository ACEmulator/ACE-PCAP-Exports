...
VALUES (20426, 16, 'Inscribed spell: Aura of Atlan''s Alacrity
Improves a weapon''s speed by 70 points.') /* LONG_DESC_STRING */
     , (20426, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20426, 19, 2000) /* VALUE_INT */
     , (20426, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20426, 2116) /* Swiftkiller7_SpellID */;
