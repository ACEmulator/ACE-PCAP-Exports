...
VALUES (3302, 65, 101) /* PLACEMENT_INT */
...
VALUES (3302, 16, 'Inscribed spell: Invulnerability Self VI
Increases the caster''s Melee Defense skill by 35 points.') /* LONG_DESC_STRING */
     , (3302, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3302, 19, 1000) /* VALUE_INT */
     , (3302, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3302, 249) /* InvulnerabilitySelf6_SpellID */;
