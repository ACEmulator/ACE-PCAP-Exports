...
VALUES (3082, 65, 101) /* PLACEMENT_INT */
...
VALUES (3082, 16, 'Inscribed spell: Exhaustion Other VI
Decreases the rate at which the target regains Stamina by 46%.') /* LONG_DESC_STRING */
     , (3082, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3082, 19, 1000) /* VALUE_INT */
     , (3082, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3082, 199) /* ExhaustionOther6_SpellID */;
