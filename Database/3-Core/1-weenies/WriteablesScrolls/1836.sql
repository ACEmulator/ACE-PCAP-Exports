...
VALUES (1836, 65, 101) /* PLACEMENT_INT */
...
VALUES (1836, 16, 'Inscribed spell: Willpower Other I
Increases the target''s Self by 10 points.') /* LONG_DESC_STRING */
     , (1836, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1836, 19, 1) /* VALUE_INT */
     , (1836, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1836, 1451) /* WillpowerOther1_SpellID */;
