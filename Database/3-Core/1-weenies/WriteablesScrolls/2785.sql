...
VALUES (2785, 65, 101) /* PLACEMENT_INT */
...
VALUES (2785, 16, 'Inscribed spell: Aura of Blood Drinker Self V
Increases a weapon''s damage value by 16 points.') /* LONG_DESC_STRING */
     , (2785, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2785, 19, 200) /* VALUE_INT */
     , (2785, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2785, 1615) /* BloodDrinker5_SpellID */;
