...
VALUES (3566, 65, 101) /* PLACEMENT_INT */
...
VALUES (3566, 16, 'Inscribed spell: War Magic Ineptitude Other V
Decreases the target''s War Magic skill by 30 points.') /* LONG_DESC_STRING */
     , (3566, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3566, 19, 200) /* VALUE_INT */
     , (3566, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3566, 651) /* WarMagicIneptitudeOther5_SpellID */;
