...
VALUES (3074, 65, 101) /* PLACEMENT_INT */
...
VALUES (3074, 16, 'Inscribed spell: Piercing Vulnerability Other III
Increases damage the target takes from Piercing by 50%.') /* LONG_DESC_STRING */
     , (3074, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3074, 19, 20) /* VALUE_INT */
     , (3074, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3074, 1153) /* PiercingVulnerabilityOther3_SpellID */;
