...
VALUES (3491, 65, 101) /* PLACEMENT_INT */
...
VALUES (3491, 16, 'Inscribed spell: Sprint Other V
Increases the target''s Run skill by 30 points.') /* LONG_DESC_STRING */
     , (3491, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3491, 19, 200) /* VALUE_INT */
     , (3491, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3491, 992) /* SprintOther5_SpellID */;
