...
VALUES (3326, 65, 101) /* PLACEMENT_INT */
...
VALUES (3326, 16, 'Inscribed spell: Item Tinkering Expertise Self V
Increases the caster''s Item Tinkering skill by 30 points.') /* LONG_DESC_STRING */
     , (3326, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3326, 19, 200) /* VALUE_INT */
     , (3326, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3326, 730) /* ItemExpertiseSelf5_SpellID */;
