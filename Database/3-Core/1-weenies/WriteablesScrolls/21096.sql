...
VALUES (21096, 65, 101) /* PLACEMENT_INT */
...
VALUES (21096, 16, 'Inscribed spell: Martyr''s Hecatomb II
Drains one-quarter of the caster''s health into a bolt of energy.  When struck by the bolt, the target''s health is reduced by 90% of the amount drained.') /* LONG_DESC_STRING */
     , (21096, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21096, 19, 5) /* VALUE_INT */
     , (21096, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21096, 2761) /* HealthBolt2_SpellID */;
