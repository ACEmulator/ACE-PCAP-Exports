...
VALUES (41298, 65, 101) /* PLACEMENT_INT */
...
VALUES (41298, 16, 'Inscribed spell: Two Handed Combat Mastery Other III
Increases the target''s Two Handed Combat skill by 20 points.') /* LONG_DESC_STRING */
     , (41298, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (41298, 19, 20) /* VALUE_INT */
     , (41298, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (41298, 5093) /* twohandedmastery3_SpellID */;
