...
VALUES (3155, 65, 101) /* PLACEMENT_INT */
...
VALUES (3155, 16, 'Inscribed spell: Armor Tinkering Ignorance Other IV
Decreases the target''s Armor Tinkering skill by 25 points.') /* LONG_DESC_STRING */
     , (3155, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3155, 19, 100) /* VALUE_INT */
     , (3155, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3155, 723) /* ArmorIgnoranceOther4_SpellID */;
