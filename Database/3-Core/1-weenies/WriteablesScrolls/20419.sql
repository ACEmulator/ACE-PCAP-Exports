...
VALUES (20419, 65, 101) /* PLACEMENT_INT */
...
VALUES (20419, 16, 'Inscribed spell: Lugian''s Speed
Worsens a weapon''s speed by 70 points.') /* LONG_DESC_STRING */
     , (20419, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20419, 19, 2000) /* VALUE_INT */
     , (20419, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20419, 2109) /* Leadenweapon7_SpellID */;
