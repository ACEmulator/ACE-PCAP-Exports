...
VALUES (2853, 65, 101) /* PLACEMENT_INT */
...
VALUES (2853, 16, 'Inscribed spell: Lightning Bane III
Increases a shield or piece of armor''s resistance to electric damage by 50%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (2853, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2853, 19, 20) /* VALUE_INT */
     , (2853, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2853, 1537) /* LightningBane3_SpellID */;
