...
VALUES (2909, 65, 101) /* PLACEMENT_INT */
...
VALUES (2909, 16, 'Inscribed spell: Acid Stream IV
Shoots a stream of acid at the target. The stream does 52-105 points of acid damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2909, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2909, 19, 100) /* VALUE_INT */
     , (2909, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2909, 61) /* AcidStream4_SpellID */;
