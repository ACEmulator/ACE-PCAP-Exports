...
VALUES (2982, 65, 101) /* PLACEMENT_INT */
...
VALUES (2982, 16, 'Inscribed spell: Acid Protection Self VI
Reduces damage the caster takes from acid by 60%.') /* LONG_DESC_STRING */
     , (2982, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2982, 19, 1000) /* VALUE_INT */
     , (2982, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2982, 520) /* AcidProtectionSelf6_SpellID */;
