...
VALUES (20423, 65, 101) /* PLACEMENT_INT */
...
Increases a shield or piece of armor''s resistance to piercing damage by 170%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (20423, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20423, 19, 2000) /* VALUE_INT */
     , (20423, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20423, 2113) /* PiercingBane7_SpellID */;
