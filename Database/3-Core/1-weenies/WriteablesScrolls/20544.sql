...
VALUES (20544, 65, 101) /* PLACEMENT_INT */
...
VALUES (20544, 16, 'Inscribed spell: Unfortunate Appraisal
Decreases the target''s Item Tinkering skill by 40 points.') /* LONG_DESC_STRING */
     , (20544, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20544, 19, 2000) /* VALUE_INT */
     , (20544, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20544, 2252) /* ItemIgnoranceOther7_SpellID */;
