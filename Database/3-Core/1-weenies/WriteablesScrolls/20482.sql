...
VALUES (20482, 65, 101) /* PLACEMENT_INT */
...
VALUES (20482, 16, 'Inscribed spell: Astyrrian''s Gift
Increases damage the target takes from Lightning by 185%.') /* LONG_DESC_STRING */
     , (20482, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20482, 19, 2000) /* VALUE_INT */
     , (20482, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20482, 2172) /* LightningVulnerabilityOther7_SpellID */;
