...
VALUES (3170, 65, 101) /* PLACEMENT_INT */
...
VALUES (3170, 16, 'Inscribed spell: Light Weapon Mastery Self IV
Increases the caster''s Light Weapons skill by 25 points.') /* LONG_DESC_STRING */
     , (3170, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3170, 19, 100) /* VALUE_INT */
     , (3170, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3170, 301) /* AxeMasterySelf4_SpellID */;
