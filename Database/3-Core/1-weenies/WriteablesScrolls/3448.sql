...
VALUES (3448, 65, 101) /* PLACEMENT_INT */
...
VALUES (3448, 16, 'Inscribed spell: Person Attunement Other II
Increases the target''s Assess Person skill by 15 points.') /* LONG_DESC_STRING */
     , (3448, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3448, 19, 5) /* VALUE_INT */
     , (3448, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3448, 831) /* PersonAttunementOther2_SpellID */;
