...
VALUES (3004, 65, 101) /* PLACEMENT_INT */
...
VALUES (3004, 16, 'Inscribed spell: Bludgeoning Protection Other III
Reduces damage the target takes from Bludgeoning by 33%.') /* LONG_DESC_STRING */
     , (3004, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3004, 19, 20) /* VALUE_INT */
     , (3004, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3004, 1026) /* BludgeonProtectionOther3_SpellID */;
