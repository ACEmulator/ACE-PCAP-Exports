...
VALUES (3307, 65, 101) /* PLACEMENT_INT */
...
VALUES (3307, 16, 'Inscribed spell: Item Enchantment Ineptitude Other VI
Decreases the target''s Item Enchantment skill by 35 points.') /* LONG_DESC_STRING */
     , (3307, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3307, 19, 1000) /* VALUE_INT */
     , (3307, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3307, 598) /* ItemEnchantmentIneptitudeOther6_SpellID */;
