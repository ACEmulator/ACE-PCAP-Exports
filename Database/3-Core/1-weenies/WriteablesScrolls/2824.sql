...
VALUES (2824, 65, 101) /* PLACEMENT_INT */
...
VALUES (2824, 16, 'Inscribed spell: Frost Bane IV
Increases a shield or piece of armor''s resistance to cold damage by 75%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (2824, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2824, 19, 100) /* VALUE_INT */
     , (2824, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2824, 1526) /* FrostBane4_SpellID */;
