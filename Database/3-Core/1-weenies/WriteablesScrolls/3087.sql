...
VALUES (3087, 65, 101) /* PLACEMENT_INT */
...
VALUES (3087, 16, 'Inscribed spell: Fester Other VI
Decrease target''s natural healing rate by 46%.') /* LONG_DESC_STRING */
     , (3087, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3087, 19, 1000) /* VALUE_INT */
     , (3087, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3087, 176) /* FesterOther6_SpellID */;
