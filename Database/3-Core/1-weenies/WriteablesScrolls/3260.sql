...
VALUES (3260, 65, 101) /* PLACEMENT_INT */
...
VALUES (3260, 16, 'Inscribed spell: Fealty Other IV
Increases the target''s Loyalty skill by 25 points.') /* LONG_DESC_STRING */
     , (3260, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3260, 19, 100) /* VALUE_INT */
     , (3260, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3260, 955) /* FealtyOther4_SpellID */;
