...
VALUES (2662, 16, 'Inscribed spell: Endurance Self V
Increases the caster''s Endurance by 30 points.') /* LONG_DESC_STRING */
     , (2662, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2662, 19, 200) /* VALUE_INT */
     , (2662, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2662, 1353) /* EnduranceSelf5_SpellID */;
