...
VALUES (3449, 65, 101) /* PLACEMENT_INT */
...
VALUES (3449, 16, 'Inscribed spell: Person Attunement Other III
Increases the target''s Assess Person skill by 20 points.') /* LONG_DESC_STRING */
     , (3449, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3449, 19, 20) /* VALUE_INT */
     , (3449, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3449, 832) /* PersonAttunementOther3_SpellID */;
