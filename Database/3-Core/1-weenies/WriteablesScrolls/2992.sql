...
VALUES (2992, 65, 101) /* PLACEMENT_INT */
...
VALUES (2992, 16, 'Inscribed spell: Blade Protection Other VI
Reduces damage the target takes from Slashing by 60%.') /* LONG_DESC_STRING */
     , (2992, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2992, 19, 1000) /* VALUE_INT */
     , (2992, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2992, 1120) /* BladeProtectionOther6_SpellID */;
