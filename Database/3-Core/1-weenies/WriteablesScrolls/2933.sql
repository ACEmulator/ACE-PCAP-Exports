...
VALUES (2933, 65, 101) /* PLACEMENT_INT */
...
VALUES (2933, 16, 'Inscribed spell: Force Bolt V
Shoots a bolt of force at the target. The bolt does 68-136 points of piercing damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2933, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2933, 19, 200) /* VALUE_INT */
     , (2933, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2933, 90) /* ForceBolt5_SpellID */;
