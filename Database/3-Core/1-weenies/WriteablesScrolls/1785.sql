...
VALUES (1785, 65, 101) /* PLACEMENT_INT */
...
VALUES (1785, 16, 'Inscribed spell: Revitalize Self I
Restores 15-35 points of the caster''s Stamina.') /* LONG_DESC_STRING */
     , (1785, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1785, 19, 1) /* VALUE_INT */
     , (1785, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1785, 1177) /* RevitalizeSelf1_SpellID */;
