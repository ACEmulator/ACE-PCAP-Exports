...
VALUES (45281, 65, 101) /* PLACEMENT_INT */
...
VALUES (45281, 16, 'Inscribed spell: Dual Wield Mastery Self VI
Increases the caster''s Dual Wield skill by 35 points.') /* LONG_DESC_STRING */
     , (45281, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (45281, 19, 1000) /* VALUE_INT */
     , (45281, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (45281, 5808) /* dualwieldmasteryself6_SpellID */;
