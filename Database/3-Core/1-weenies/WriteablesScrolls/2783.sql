...
VALUES (2783, 65, 101) /* PLACEMENT_INT */
...
VALUES (2783, 16, 'Inscribed spell: Aura of Blood Drinker Self III
Increases a weapon''s damage value by 8 points.') /* LONG_DESC_STRING */
     , (2783, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2783, 19, 20) /* VALUE_INT */
     , (2783, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2783, 1613) /* BloodDrinker3_SpellID */;
