...
VALUES (49467, 65, 101) /* PLACEMENT_INT */
...
VALUES (49467, 16, 'Inscribed spell: Summoning Mastery Other V
Increases the target''s Summoning skill by 30 points.') /* LONG_DESC_STRING */
     , (49467, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (49467, 19, 200) /* VALUE_INT */
     , (49467, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (49467, 6112) /* SummoningMasteryOther5_SpellID */;
