...
VALUES (3424, 65, 101) /* PLACEMENT_INT */
...
VALUES (3424, 16, 'Inscribed spell: Magic Yield Other III
Decreases the target''s Magic Defense skill by 20 points.') /* LONG_DESC_STRING */
     , (3424, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3424, 19, 20) /* VALUE_INT */
     , (3424, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3424, 282) /* MagicYieldOther3_SpellID */;
