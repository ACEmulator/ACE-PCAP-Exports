...
VALUES (1843, 16, 'Inscribed spell: Blade Vulnerability Other I
Increases damage the target takes from Slashing by 10%.') /* LONG_DESC_STRING */
     , (1843, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1843, 19, 1) /* VALUE_INT */
     , (1843, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1843, 1127) /* BladeVulnerabilityOther1_SpellID */;
