...
VALUES (3033, 65, 101) /* PLACEMENT_INT */
...
VALUES (3033, 16, 'Inscribed spell: Fire Protection Other II
Reduces damage the target takes from fire by 20%.') /* LONG_DESC_STRING */
     , (3033, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3033, 19, 5) /* VALUE_INT */
     , (3033, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3033, 810) /* FireProtectionOther2_SpellID */;
