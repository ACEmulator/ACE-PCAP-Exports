...
VALUES (1854, 65, 101) /* PLACEMENT_INT */
...
VALUES (1854, 16, 'Inscribed spell: Piercing Protection Self I
Reduces damage the caster takes from Piercing by 9%.') /* LONG_DESC_STRING */
     , (1854, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (1854, 19, 1) /* VALUE_INT */
     , (1854, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (1854, 1133) /* PiercingProtectionSelf1_SpellID */;
