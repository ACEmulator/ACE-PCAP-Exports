...
VALUES (21320, 65, 101) /* PLACEMENT_INT */
...
VALUES (21320, 16, 'Inscribed spell: Frost Arc V
Shoots a bolt of cold at the target. The bolt does 68-136 points of cold damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (21320, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (21320, 19, 200) /* VALUE_INT */
     , (21320, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (21320, 2729) /* FrostArc5_SpellID */;
