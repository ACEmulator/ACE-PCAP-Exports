...
VALUES (2707, 16, 'Inscribed spell: Mana Drain Other II
Drains 7-12 points of the target''s Mana.') /* LONG_DESC_STRING */
     , (2707, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2707, 19, 5) /* VALUE_INT */
     , (2707, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2707, 1220) /* ManaDrainOther2_SpellID */;
