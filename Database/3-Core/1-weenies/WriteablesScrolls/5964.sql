...
VALUES (5964, 65, 101) /* PLACEMENT_INT */
...
VALUES (5964, 16, 'Inscribed spell: Fletching Ineptitude Other III
Decreases the target''s Fletching skill by 20 points.') /* LONG_DESC_STRING */
     , (5964, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (5964, 19, 20) /* VALUE_INT */
     , (5964, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (5964, 1747) /* FletchingIneptitudeOther3_SpellID */;
