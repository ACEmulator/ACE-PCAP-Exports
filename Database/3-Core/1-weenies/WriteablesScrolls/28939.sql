...
VALUES (28939, 65, 101) /* PLACEMENT_INT */
...
VALUES (28939, 16, 'Inscribed spell: Arcanum Salvaging VII
Increases the caster''s Salvaging skill by 40 points.') /* LONG_DESC_STRING */
     , (28939, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (28939, 19, 2000) /* VALUE_INT */
     , (28939, 5, 10) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (28939, 3505) /* ArcanumSalvaging7_SpellID */;
