...
VALUES (2966, 65, 101) /* PLACEMENT_INT */
...
VALUES (2966, 16, 'Inscribed spell: Shock Wave V
Shoots a shock wave at the target. The wave does 68-136 points of bludgeoning damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (2966, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2966, 19, 200) /* VALUE_INT */
     , (2966, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2966, 68) /* ShockWave5_SpellID */;
