...
VALUES (3124, 65, 101) /* PLACEMENT_INT */
...
VALUES (3124, 16, 'Inscribed spell: Rejuvenation Self III
Increases the rate at which the caster regains Stamina by 40%.') /* LONG_DESC_STRING */
     , (3124, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3124, 19, 20) /* VALUE_INT */
     , (3124, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3124, 190) /* RejuvenationSelf3_SpellID */;
