...
VALUES (2796, 16, 'Inscribed spell: Bludgeon Bane VI
Increases a shield or piece of armor''s resistance to bludgeoning damage by 150%. Target yourself to cast this spell on all of your equipped armor.') /* LONG_DESC_STRING */
     , (2796, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2796, 19, 1000) /* VALUE_INT */
     , (2796, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (2796, 1516) /* BludgeonBane6_SpellID */;
