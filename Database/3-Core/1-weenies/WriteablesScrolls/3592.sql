...
VALUES (3592, 65, 101) /* PLACEMENT_INT */
...
VALUES (3592, 16, 'Inscribed spell: Weapon Tinkering Ignorance Other VI
Decreases the target''s Weapon Tinkering skill by 35 points.') /* LONG_DESC_STRING */
     , (3592, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3592, 19, 1000) /* VALUE_INT */
     , (3592, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3592, 797) /* WeaponIgnoranceOther6_SpellID */;
