...
VALUES (20599, 65, 101) /* PLACEMENT_INT */
...
VALUES (20599, 16, 'Inscribed spell: Eye of the Grunt
Decreases the target''s Weapon Tinkering skill by 40 points.') /* LONG_DESC_STRING */
     , (20599, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20599, 19, 2000) /* VALUE_INT */
     , (20599, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20599, 2326) /* WeaponIgnoranceOther7_SpellID */;
