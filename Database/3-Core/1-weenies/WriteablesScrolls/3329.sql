...
VALUES (3329, 65, 101) /* PLACEMENT_INT */
...
VALUES (3329, 16, 'Inscribed spell: Item Tinkering Ignorance Other III
Decreases the target''s Item Tinkering skill by 20 points.') /* LONG_DESC_STRING */
     , (3329, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3329, 19, 20) /* VALUE_INT */
     , (3329, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3329, 746) /* ItemIgnoranceOther3_SpellID */;
