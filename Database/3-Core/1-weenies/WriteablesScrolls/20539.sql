...
VALUES (20539, 65, 101) /* PLACEMENT_INT */
...
VALUES (20539, 16, 'Inscribed spell: Wrath of Celcynd
Decreases the target''s Item Enchantment skill by 40 points.') /* LONG_DESC_STRING */
     , (20539, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20539, 19, 2000) /* VALUE_INT */
     , (20539, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20539, 2246) /* ItemEnchantmentIneptitudeOther7_SpellID */;
