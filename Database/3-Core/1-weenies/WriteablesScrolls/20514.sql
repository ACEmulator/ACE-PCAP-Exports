...
VALUES (20514, 16, 'Inscribed spell: Adja''s Boon
Increases the target''s Creature Enchantment skill by 40 points.') /* LONG_DESC_STRING */
     , (20514, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20514, 19, 2000) /* VALUE_INT */
     , (20514, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20514, 2214) /* CreatureEnchantmentMasteryOther7_SpellID */;
