...
VALUES (3138, 65, 101) /* PLACEMENT_INT */
...
VALUES (3138, 16, 'Inscribed spell: Arcane Enlightenment Self II
Increases the caster''s Arcane Lore skill by 15 points.') /* LONG_DESC_STRING */
     , (3138, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3138, 19, 5) /* VALUE_INT */
     , (3138, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3138, 679) /* ArcaneEnlightenmentSelf2_SpellID */;
