...
VALUES (43307, 65, 101) /* PLACEMENT_INT */
...
VALUES (43307, 16, 'Inscribed spell: Nether Bolt VI
Shoots a bolt of nether at the target. The bolt does 105-210 points of nether damage to the first thing it hits.') /* LONG_DESC_STRING */
     , (43307, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (43307, 19, 1000) /* VALUE_INT */
     , (43307, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (43307, 5354) /* netherbolt6_SpellID */;
