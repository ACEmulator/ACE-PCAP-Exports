...
VALUES (3935, 18, 3935, 6307864, NULL, NULL, 135297);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (3935, 1, 'Scroll of Drain Health Other V') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (3935, 8, 100676934) /* ICON_DID */
     , (3935, 1, 33554826) /* SETUP_DID */
...
VALUES (3935, 13, True) /* ETHEREAL_BOOL */
     , (3935, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (3935, 14, True) /* GRAVITY_STATUS_BOOL */
     , (3935, 19, True) /* ATTACKABLE_BOOL */
     , (3935, 22, True) /* INSCRIBABLE_BOOL */;
