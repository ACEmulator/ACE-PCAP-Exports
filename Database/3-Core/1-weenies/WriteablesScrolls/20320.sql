...
VALUES (20320, 65, 101) /* PLACEMENT_INT */
...
VALUES (20320, 16, 'Inscribed spell: Cleanse Creature Magic Other
Dispels 3-6 negative Creature Magic enchantments of level 3 or lower from the target.') /* LONG_DESC_STRING */
     , (20320, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20320, 19, 20) /* VALUE_INT */
     , (20320, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20320, 1897) /* DispelCreatureBadOther3_SpellID */;
