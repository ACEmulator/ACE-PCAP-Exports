...
VALUES (20497, 65, 101) /* PLACEMENT_INT */
...
VALUES (20497, 16, 'Inscribed spell: Silencia''s Blessing
Increases the caster''s Alchemy skill by 40 points.') /* LONG_DESC_STRING */
     , (20497, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20497, 19, 2000) /* VALUE_INT */
     , (20497, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (20497, 2191) /* AlchemyMasterySelf7_SpellID */;
