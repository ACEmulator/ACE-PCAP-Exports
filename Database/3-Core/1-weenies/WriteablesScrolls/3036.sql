...
VALUES (3036, 65, 101) /* PLACEMENT_INT */
...
VALUES (3036, 16, 'Inscribed spell: Fire Protection Other V
Reduces damage the target takes from fire by 50%.') /* LONG_DESC_STRING */
     , (3036, 14, 'Use this item to attempt to learn its spell.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (3036, 19, 200) /* VALUE_INT */
     , (3036, 5, 30) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_spell` (`aceObjectId`, `spellId`)
VALUES (3036, 1095) /* FireProtectionOther5_SpellID */;
