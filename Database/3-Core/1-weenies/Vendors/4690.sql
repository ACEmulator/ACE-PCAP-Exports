...
REPLACE INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (4690, 16, 67110063) /* EYES_PALETTE_DID */
     , (4690, 9, 83890277) /* EYES_TEXTURE_DID */
     , (4690, 17, 67109551) /* SKIN_PALETTE_DID */
     , (4690, 10, 83890306) /* NOSE_TEXTURE_DID */
     , (4690, 11, 83890357) /* MOUTH_TEXTURE_DID */
     , (4690, 15, 67117020) /* HAIR_PALETTE_DID */;
...
REPLACE INTO `ace_object_properties_attribute2nd` (`aceObjectId`, `attribute2ndId`, `attribute2ndValue`)
VALUES (4690, 64, 60) /* MAX_HEALTH_ATTRIBUTE_2ND */
     , (4690, 128, 110) /* MAX_STAMINA_ATTRIBUTE_2ND */
     , (4690, 256, 40) /* MAX_MANA_ATTRIBUTE_2ND */;
