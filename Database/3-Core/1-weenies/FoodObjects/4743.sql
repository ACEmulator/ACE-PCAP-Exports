...
VALUES (4743, 65, 101) /* PLACEMENT_INT */
...
VALUES (4743, 14, 'Use this item to eat it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (4743, 19, 36) /* VALUE_INT */
     , (4743, 5, 150) /* ENCUMB_VAL_INT */
     , (4743, 89, 4) /* BOOSTER_ENUM_INT */
     , (4743, 90, 9) /* BOOST_VALUE_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (4743, 69, 0) /* IS_SELLABLE_BOOL */;
