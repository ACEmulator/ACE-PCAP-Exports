...
VALUES (9590, 18, 9590, 2113560, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9590, 1, 'Thrown Weapons Skill Puzzle Piece') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9590, 8, 100671550) /* ICON_DID */
     , (9590, 1, 33556223) /* SETUP_DID */
...
VALUES (9590, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9590, 39, 0.8) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (9590, 13, True) /* ETHEREAL_BOOL */
     , (9590, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9590, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9590, 19, True) /* ATTACKABLE_BOOL */
     , (9590, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_palette_change` (`aceObjectId`, `subPaletteId`, `offset`, `length`)
VALUES (9590, 67112642, 0, 0);

INSERT INTO `ace_object_texture_map_change` (`aceObjectId`, `index`, `oldId`, `newId`)
VALUES (9590, 0, 83888861, 83892342);
