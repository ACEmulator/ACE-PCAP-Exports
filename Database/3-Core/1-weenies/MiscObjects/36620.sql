...
VALUES (36620, 65, 101) /* PLACEMENT_INT */
...
VALUES (36620, 14, 'Apply this material to a treasure-generated weapon or magic-casting implement to imbue the target with Pierce Rending. Pierce Rending gives the weapon the ability to make its opponent vulnerable to piercing attacks. The amount of vulnerability depends on the attack skill of the wielder. This effect does not stack with Piercing Vulnerability spells. ') /* USE_STRING */
     , (36620, 15, 'Chips of black garnet. This material is of such exquisite quality that using it to imbue an item is guaranteed to succeed.') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (36620, 33, 1) /* BONDED_INT */
     , (36620, 131, 15) /* MATERIAL_TYPE_INT */
     , (36620, 19, 30) /* VALUE_INT */
     , (36620, 5, 5) /* ENCUMB_VAL_INT */
     , (36620, 105, 100) /* ITEM_WORKMANSHIP_INT */
     , (36620, 170, 10) /* NUM_ITEMS_IN_MATERIAL_INT */
     , (36620, 26, 1) /* ACCOUNT_REQUIREMENTS_INT */;
