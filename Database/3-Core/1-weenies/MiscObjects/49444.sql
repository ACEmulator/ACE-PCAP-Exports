...
VALUES (49444, 14, 'Use this essence to summon or dismiss your Frost Spectre.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (49444, 33, 0) /* BONDED_INT */
     , (49444, 369, 90) /* USE_REQUIRES_LEVEL_INT */
     , (49444, 114, 0) /* ATTUNED_INT */
     , (49444, 19, 6000) /* VALUE_INT */
     , (49444, 371, 12) /* GEAR_DAMAGE_RESIST_INT */
     , (49444, 372, 11) /* GEAR_CRIT_INT */
     , (49444, 5, 50) /* ENCUMB_VAL_INT */
     , (49444, 374, 15) /* GEAR_CRIT_DAMAGE_INT */
     , (49444, 280, 213) /* SHARED_COOLDOWN_INT */
     , (49444, 105, 3) /* ITEM_WORKMANSHIP_INT */
     , (49444, 91, 50) /* MAX_STRUCTURE_INT */
     , (49444, 366, 54) /* USE_REQUIRES_SKILL_INT */
     , (49444, 367, 400) /* USE_REQUIRES_SKILL_LEVEL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (49444, 167, 45) /* COOLDOWN_DURATION_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (49444, 69, 1) /* IS_SELLABLE_BOOL */;
