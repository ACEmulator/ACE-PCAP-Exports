...
VALUES (15771, 65, 101) /* PLACEMENT_INT */
...
VALUES (15771, 16, 'An Amulet crafted in pyreal that bears the symbol of heavy weapons. The amulet is damaged, seemingly beyond repair.') /* LONG_DESC_STRING */
     , (15771, 14, 'This might fit into a setting created for it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15771, 33, 1) /* BONDED_INT */
