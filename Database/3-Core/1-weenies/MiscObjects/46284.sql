...
VALUES (46284, 14, 'Lady Sherath Trianna may be interested in this.') /* USE_STRING */
     , (46284, 15, 'A small, spiky vine with blood-red roots, found only in the Valley of Death.') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (46284, 33, 1) /* BONDED_INT */
     , (46284, 114, 1) /* ATTUNED_INT */
     , (46284, 19, 1) /* VALUE_INT */
     , (46284, 5, 1) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (46284, 69, 0) /* IS_SELLABLE_BOOL */;
