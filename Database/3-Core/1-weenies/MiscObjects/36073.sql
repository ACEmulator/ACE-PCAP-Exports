...
VALUES (36073, 16, 'Give this to the Master Arbitor for a new Title.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (36073, 33, 1) /* BONDED_INT */
     , (36073, 114, 1) /* ATTUNED_INT */
     , (36073, 19, 0) /* VALUE_INT */
     , (36073, 5, 10) /* ENCUMB_VAL_INT */;
