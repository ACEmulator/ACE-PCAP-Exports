...
VALUES (23069, 18, 23069, 2113552, NULL, NULL, 131073);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (23069, 1, 'Self To Strength Gem') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (23069, 8, 100673957) /* ICON_DID */
     , (23069, 1, 33558087) /* SETUP_DID */
     , (23069, 6, 67111919) /* PALETTE_BASE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (23069, 53, 101) /* PLACEMENT_POSITION_INT */
     , (23069, 1, 128) /* ITEM_TYPE_INT */
     , (23069, 5, 10) /* ENCUMB_VAL_INT */
     , (23069, 16, 8) /* ITEM_USEABLE_INT */
     , (23069, 93, 1044) /* PHYSICS_STATE_INT */
     , (23069, 9007, 1) /* Generic_WeenieType */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (23069, 13, True) /* ETHEREAL_BOOL */
     , (23069, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (23069, 14, True) /* GRAVITY_STATUS_BOOL */
     , (23069, 19, True) /* ATTACKABLE_BOOL */
