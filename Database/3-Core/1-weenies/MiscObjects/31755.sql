...
VALUES (31755, 65, 101) /* PLACEMENT_INT */
...
VALUES (31755, 15, 'A *MONSTER* Sundew. It twitches gently as you watch it, but it seems ... sated. Thank goodness for that -- it could eat you whole!') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (31755, 19, 100) /* VALUE_INT */
     , (31755, 5, 100) /* ENCUMB_VAL_INT */;
