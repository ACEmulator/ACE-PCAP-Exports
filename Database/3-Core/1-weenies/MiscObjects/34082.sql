...
VALUES (34082, 16, 'A small pumpkin seed. This one appears to have been untouched by the Pumpkin Lord''s anger and hatred. It looks as if it might sprout right in your hand.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (34082, 19, 0) /* VALUE_INT */
     , (34082, 5, 1) /* ENCUMB_VAL_INT */;
