...
VALUES (15768, 65, 101) /* PLACEMENT_INT */
...
VALUES (15768, 16, 'An Amulet crafted in pyreal that bears the symbol of light weapons. The amulet is damaged, seemingly beyond repair.') /* LONG_DESC_STRING */
     , (15768, 14, 'This might fit into a setting created for it.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15768, 33, 1) /* BONDED_INT */
