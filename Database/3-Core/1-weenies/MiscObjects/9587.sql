...
VALUES (9587, 18, 9587, 2113560, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9587, 1, 'Spear Skill Puzzle Piece') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9587, 8, 100671547) /* ICON_DID */
     , (9587, 1, 33556223) /* SETUP_DID */
...
VALUES (9587, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9587, 39, 0.8) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (9587, 13, True) /* ETHEREAL_BOOL */
     , (9587, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9587, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9587, 19, True) /* ATTACKABLE_BOOL */
     , (9587, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_palette_change` (`aceObjectId`, `subPaletteId`, `offset`, `length`)
VALUES (9587, 67112642, 0, 0);

INSERT INTO `ace_object_texture_map_change` (`aceObjectId`, `index`, `oldId`, `newId`)
VALUES (9587, 0, 83888861, 83892342);
