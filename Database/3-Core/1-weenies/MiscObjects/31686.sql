...
VALUES (31686, 65, 101) /* PLACEMENT_INT */
...
VALUES (31686, 15, 'This is a large, ugly, hairy seed. What could possibly grow from this monster? Perhaps that kooky old plant lover in Mayoi will know what to do with this thing.') /* SHORT_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (31686, 19, 100) /* VALUE_INT */
     , (31686, 5, 5) /* ENCUMB_VAL_INT */;
