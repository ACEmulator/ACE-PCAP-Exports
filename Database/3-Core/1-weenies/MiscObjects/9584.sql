...
VALUES (9584, 18, 9584, 2113560, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9584, 1, 'Item Enchantment Skill Puzzle Piece') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9584, 8, 100671544) /* ICON_DID */
     , (9584, 1, 33554669) /* SETUP_DID */
     , (9584, 3, 536870932) /* SOUND_TABLE_DID */
     , (9584, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9584, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9584, 13, True) /* ETHEREAL_BOOL */
     , (9584, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9584, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9584, 19, True) /* ATTACKABLE_BOOL */
...
VALUES (9584, 33, 4294967294) /* BONDED_INT */
     , (9584, 114, 1) /* ATTUNED_INT */
     , (9584, 19, 10000) /* VALUE_INT */
     , (9584, 5, 10) /* ENCUMB_VAL_INT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (9584, 69, 0) /* IS_SELLABLE_BOOL */;
