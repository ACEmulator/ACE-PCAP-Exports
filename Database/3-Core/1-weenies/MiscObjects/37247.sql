...
VALUES (37247, 65, 101) /* PLACEMENT_INT */
...
VALUES (37247, 16, 'One card from the Deck of Eyes. Combine it with the other cards to complete the deck.') /* LONG_DESC_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (37247, 19, 0) /* VALUE_INT */
     , (37247, 5, 1) /* ENCUMB_VAL_INT */;
