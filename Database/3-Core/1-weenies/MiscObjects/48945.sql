...
VALUES (48945, 14, 'Use this essence to summon or dismiss your Fire Skeleton Minion.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (48945, 33, 0) /* BONDED_INT */
     , (48945, 369, 90) /* USE_REQUIRES_LEVEL_INT */
     , (48945, 114, 0) /* ATTUNED_INT */
     , (48945, 19, 6000) /* VALUE_INT */
     , (48945, 372, 12) /* GEAR_CRIT_INT */
     , (48945, 5, 50) /* ENCUMB_VAL_INT */
     , (48945, 374, 11) /* GEAR_CRIT_DAMAGE_INT */
     , (48945, 375, 11) /* GEAR_CRIT_DAMAGE_RESIST_INT */
     , (48945, 280, 213) /* SHARED_COOLDOWN_INT */
     , (48945, 105, 7) /* ITEM_WORKMANSHIP_INT */
     , (48945, 91, 50) /* MAX_STRUCTURE_INT */
     , (48945, 366, 54) /* USE_REQUIRES_SKILL_INT */
     , (48945, 367, 400) /* USE_REQUIRES_SKILL_LEVEL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (48945, 167, 45) /* COOLDOWN_DURATION_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (48945, 69, 1) /* IS_SELLABLE_BOOL */;
