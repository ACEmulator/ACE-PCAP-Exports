...
VALUES (49353, 14, 'Use this essence to summon or dismiss your Fire Moar.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (49353, 369, 70) /* USE_REQUIRES_LEVEL_INT */
     , (49353, 33, 0) /* BONDED_INT */
     , (49353, 114, 0) /* ATTUNED_INT */
     , (49353, 371, 9) /* GEAR_DAMAGE_RESIST_INT */
     , (49353, 19, 5000) /* VALUE_INT */
     , (49353, 373, 11) /* GEAR_CRIT_RESIST_INT */
     , (49353, 5, 50) /* ENCUMB_VAL_INT */
     , (49353, 375, 13) /* GEAR_CRIT_DAMAGE_RESIST_INT */
     , (49353, 280, 213) /* SHARED_COOLDOWN_INT */
     , (49353, 105, 7) /* ITEM_WORKMANSHIP_INT */
     , (49353, 91, 50) /* MAX_STRUCTURE_INT */
     , (49353, 366, 54) /* USE_REQUIRES_SKILL_INT */
     , (49353, 367, 370) /* USE_REQUIRES_SKILL_LEVEL_INT */;

REPLACE INTO `ace_object_properties_double` (`aceObjectId`, `dblPropertyId`, `propertyValue`)
VALUES (49353, 167, 45) /* COOLDOWN_DURATION_FLOAT */;

REPLACE INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (49353, 69, 1) /* IS_SELLABLE_BOOL */;
