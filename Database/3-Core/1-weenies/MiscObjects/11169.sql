...
VALUES (11169, 18, 11169, 270549016, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (11169, 1, 'Healing Tessera') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (11169, 8, 100672009) /* ICON_DID */
     , (11169, 1, 33557218) /* SETUP_DID */
     , (11169, 3, 536870932) /* SOUND_TABLE_DID */
     , (11169, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (11169, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (11169, 13, True) /* ETHEREAL_BOOL */
     , (11169, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (11169, 14, True) /* GRAVITY_STATUS_BOOL */
     , (11169, 19, True) /* ATTACKABLE_BOOL */
     , (11169, 22, True) /* INSCRIBABLE_BOOL */;
