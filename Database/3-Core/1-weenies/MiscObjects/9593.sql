...
VALUES (9593, 18, 9593, 2113560, NULL, NULL, 137345);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9593, 1, 'Crossbow Skill Puzzle Piece') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9593, 8, 100671541) /* ICON_DID */
     , (9593, 1, 33556223) /* SETUP_DID */
...
VALUES (9593, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9593, 39, 0.8) /* DEFAULT_SCALE_FLOAT */;

INSERT INTO `ace_object_properties_bool` (`aceObjectId`, `boolPropertyId`, `propertyValue`)
VALUES (9593, 13, True) /* ETHEREAL_BOOL */
     , (9593, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9593, 14, True) /* GRAVITY_STATUS_BOOL */
     , (9593, 19, True) /* ATTACKABLE_BOOL */
     , (9593, 22, True) /* INSCRIBABLE_BOOL */;

INSERT INTO `ace_object_palette_change` (`aceObjectId`, `subPaletteId`, `offset`, `length`)
VALUES (9593, 67112642, 0, 0);

INSERT INTO `ace_object_texture_map_change` (`aceObjectId`, `index`, `oldId`, `newId`)
VALUES (9593, 0, 83888861, 83892342);
