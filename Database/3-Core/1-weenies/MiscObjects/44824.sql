...
VALUES (44824, 14, 'Use this item on a locked door or chest to pick the lock.') /* USE_STRING */;

REPLACE INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (44824, 19, 1200) /* VALUE_INT */
     , (44824, 5, 50) /* ENCUMB_VAL_INT */
     , (44824, 91, 50) /* MAX_STRUCTURE_INT */
     , (44824, 173, 100) /* APPRAISAL_LOCKPICK_SUCCESS_PERCENT_INT */;
