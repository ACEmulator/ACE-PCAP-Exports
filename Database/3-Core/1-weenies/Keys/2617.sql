...
VALUES (2617, 1, 'Carved Key') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (2617, 8, 100668441) /* ICON_DID */
     , (2617, 1, 33554784) /* SETUP_DID */
     , (2617, 22, 872415275) /* PHYSICS_EFFECT_TABLE_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (2617, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (2617, 13, True) /* ETHEREAL_BOOL */
     , (2617, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (2617, 14, True) /* GRAVITY_STATUS_BOOL */
