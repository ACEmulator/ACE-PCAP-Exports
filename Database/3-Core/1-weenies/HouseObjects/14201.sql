/* Weenie - HouseObjects - Villa (14201) */
...
VALUES (14201, 148, 14201, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14201, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14201, 8, 100671886) /* ICON_DID */
     , (14201, 1, 33557058) /* SETUP_DID */
     , (14201, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14201, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (14201, 13, True) /* ETHEREAL_BOOL */
     , (14201, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (14201, 71, True) /* NODRAW_BOOL */
     , (14201, 19, True) /* ATTACKABLE_BOOL */
     , (14201, 1, True) /* STUCK_BOOL */
