/* Weenie - HouseObjects - Cottage (9989) */
...
VALUES (9989, 148, 9989, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9989, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9989, 8, 100671873) /* ICON_DID */
     , (9989, 1, 33557058) /* SETUP_DID */
     , (9989, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9989, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9989, 13, True) /* ETHEREAL_BOOL */
     , (9989, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9989, 71, True) /* NODRAW_BOOL */
     , (9989, 19, True) /* ATTACKABLE_BOOL */
     , (9989, 1, True) /* STUCK_BOOL */
