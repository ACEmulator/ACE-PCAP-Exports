/* Weenie - HouseObjects - Cottage (9757) */
...
VALUES (9757, 148, 9757, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9757, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9757, 8, 100671873) /* ICON_DID */
     , (9757, 1, 33557058) /* SETUP_DID */
     , (9757, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9757, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9757, 13, True) /* ETHEREAL_BOOL */
     , (9757, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9757, 71, True) /* NODRAW_BOOL */
     , (9757, 19, True) /* ATTACKABLE_BOOL */
     , (9757, 1, True) /* STUCK_BOOL */
