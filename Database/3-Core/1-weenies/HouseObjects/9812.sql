/* Weenie - HouseObjects - Cottage (9812) */
...
VALUES (9812, 148, 9812, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9812, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9812, 8, 100671873) /* ICON_DID */
     , (9812, 1, 33557058) /* SETUP_DID */
     , (9812, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9812, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9812, 13, True) /* ETHEREAL_BOOL */
     , (9812, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9812, 71, True) /* NODRAW_BOOL */
     , (9812, 19, True) /* ATTACKABLE_BOOL */
     , (9812, 1, True) /* STUCK_BOOL */
