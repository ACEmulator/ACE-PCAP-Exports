/* Weenie - HouseObjects - Villa (10535) */
...
VALUES (10535, 148, 10535, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10535, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10535, 8, 100671886) /* ICON_DID */
     , (10535, 1, 33557058) /* SETUP_DID */
     , (10535, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10535, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (10535, 13, True) /* ETHEREAL_BOOL */
     , (10535, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (10535, 71, True) /* NODRAW_BOOL */
     , (10535, 19, True) /* ATTACKABLE_BOOL */
     , (10535, 1, True) /* STUCK_BOOL */
