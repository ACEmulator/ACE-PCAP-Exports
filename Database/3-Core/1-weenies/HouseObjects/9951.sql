/* Weenie - HouseObjects - Cottage (9951) */
...
VALUES (9951, 148, 9951, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9951, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9951, 8, 100671873) /* ICON_DID */
     , (9951, 1, 33557058) /* SETUP_DID */
     , (9951, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9951, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9951, 13, True) /* ETHEREAL_BOOL */
     , (9951, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9951, 71, True) /* NODRAW_BOOL */
     , (9951, 19, True) /* ATTACKABLE_BOOL */
     , (9951, 1, True) /* STUCK_BOOL */
