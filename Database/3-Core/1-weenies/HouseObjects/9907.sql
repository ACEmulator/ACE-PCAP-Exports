/* Weenie - HouseObjects - Cottage (9907) */
...
VALUES (9907, 148, 9907, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9907, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9907, 8, 100671873) /* ICON_DID */
     , (9907, 1, 33557058) /* SETUP_DID */
     , (9907, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9907, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9907, 13, True) /* ETHEREAL_BOOL */
     , (9907, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9907, 71, True) /* NODRAW_BOOL */
     , (9907, 19, True) /* ATTACKABLE_BOOL */
     , (9907, 1, True) /* STUCK_BOOL */
