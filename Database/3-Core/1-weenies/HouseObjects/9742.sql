/* Weenie - HouseObjects - Cottage (9742) */
...
VALUES (9742, 148, 9742, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9742, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9742, 8, 100671873) /* ICON_DID */
     , (9742, 1, 33557058) /* SETUP_DID */
     , (9742, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9742, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9742, 13, True) /* ETHEREAL_BOOL */
     , (9742, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9742, 71, True) /* NODRAW_BOOL */
     , (9742, 19, True) /* ATTACKABLE_BOOL */
     , (9742, 1, True) /* STUCK_BOOL */
