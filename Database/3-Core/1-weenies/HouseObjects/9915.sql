/* Weenie - HouseObjects - Cottage (9915) */
...
VALUES (9915, 148, 9915, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9915, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9915, 8, 100671873) /* ICON_DID */
     , (9915, 1, 33557058) /* SETUP_DID */
     , (9915, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9915, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9915, 13, True) /* ETHEREAL_BOOL */
     , (9915, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9915, 71, True) /* NODRAW_BOOL */
     , (9915, 19, True) /* ATTACKABLE_BOOL */
     , (9915, 1, True) /* STUCK_BOOL */
