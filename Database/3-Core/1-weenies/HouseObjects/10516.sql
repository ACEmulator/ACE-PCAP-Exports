/* Weenie - HouseObjects - Villa (10516) */
...
VALUES (10516, 148, 10516, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10516, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10516, 8, 100671886) /* ICON_DID */
     , (10516, 1, 33557058) /* SETUP_DID */
     , (10516, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10516, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (10516, 13, True) /* ETHEREAL_BOOL */
     , (10516, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (10516, 71, True) /* NODRAW_BOOL */
     , (10516, 19, True) /* ATTACKABLE_BOOL */
     , (10516, 1, True) /* STUCK_BOOL */
