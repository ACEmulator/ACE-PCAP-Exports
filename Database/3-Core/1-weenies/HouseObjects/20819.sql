/* Weenie - HouseObjects - Villa (20819) */
...
VALUES (20819, 148, 20819, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20819, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20819, 8, 100671886) /* ICON_DID */
     , (20819, 1, 33557058) /* SETUP_DID */
     , (20819, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20819, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (20819, 13, True) /* ETHEREAL_BOOL */
     , (20819, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (20819, 71, True) /* NODRAW_BOOL */
     , (20819, 19, True) /* ATTACKABLE_BOOL */
     , (20819, 1, True) /* STUCK_BOOL */
