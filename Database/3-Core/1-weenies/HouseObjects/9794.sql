/* Weenie - HouseObjects - Cottage (9794) */
...
VALUES (9794, 148, 9794, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9794, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9794, 8, 100671873) /* ICON_DID */
     , (9794, 1, 33557058) /* SETUP_DID */
     , (9794, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9794, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9794, 13, True) /* ETHEREAL_BOOL */
     , (9794, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9794, 71, True) /* NODRAW_BOOL */
     , (9794, 19, True) /* ATTACKABLE_BOOL */
     , (9794, 1, True) /* STUCK_BOOL */
