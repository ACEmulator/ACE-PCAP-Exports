/* Weenie - HouseObjects - Cottage (9899) */
...
VALUES (9899, 148, 9899, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9899, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9899, 8, 100671873) /* ICON_DID */
     , (9899, 1, 33557058) /* SETUP_DID */
     , (9899, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9899, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9899, 13, True) /* ETHEREAL_BOOL */
     , (9899, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9899, 71, True) /* NODRAW_BOOL */
     , (9899, 19, True) /* ATTACKABLE_BOOL */
     , (9899, 1, True) /* STUCK_BOOL */
