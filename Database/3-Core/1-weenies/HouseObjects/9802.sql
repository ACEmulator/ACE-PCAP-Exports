/* Weenie - HouseObjects - Cottage (9802) */
...
VALUES (9802, 148, 9802, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9802, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9802, 8, 100671873) /* ICON_DID */
     , (9802, 1, 33557058) /* SETUP_DID */
     , (9802, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9802, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9802, 13, True) /* ETHEREAL_BOOL */
     , (9802, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9802, 71, True) /* NODRAW_BOOL */
     , (9802, 19, True) /* ATTACKABLE_BOOL */
     , (9802, 1, True) /* STUCK_BOOL */
