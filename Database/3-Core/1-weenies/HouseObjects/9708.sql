/* Weenie - HouseObjects - Cottage (9708) */
...
VALUES (9708, 148, 9708, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9708, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9708, 8, 100671873) /* ICON_DID */
     , (9708, 1, 33557058) /* SETUP_DID */
     , (9708, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9708, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9708, 13, True) /* ETHEREAL_BOOL */
     , (9708, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9708, 71, True) /* NODRAW_BOOL */
     , (9708, 19, True) /* ATTACKABLE_BOOL */
     , (9708, 1, True) /* STUCK_BOOL */
