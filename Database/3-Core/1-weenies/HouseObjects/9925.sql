/* Weenie - HouseObjects - Cottage (9925) */
...
VALUES (9925, 148, 9925, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9925, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9925, 8, 100671873) /* ICON_DID */
     , (9925, 1, 33557058) /* SETUP_DID */
     , (9925, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9925, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9925, 13, True) /* ETHEREAL_BOOL */
     , (9925, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9925, 71, True) /* NODRAW_BOOL */
     , (9925, 19, True) /* ATTACKABLE_BOOL */
     , (9925, 1, True) /* STUCK_BOOL */
