/* Weenie - HouseObjects - Villa (20822) */
...
VALUES (20822, 148, 20822, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20822, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20822, 8, 100671886) /* ICON_DID */
     , (20822, 1, 33557058) /* SETUP_DID */
     , (20822, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20822, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (20822, 13, True) /* ETHEREAL_BOOL */
     , (20822, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (20822, 71, True) /* NODRAW_BOOL */
     , (20822, 19, True) /* ATTACKABLE_BOOL */
     , (20822, 1, True) /* STUCK_BOOL */
