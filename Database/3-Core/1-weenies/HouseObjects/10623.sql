/* Weenie - HouseObjects - Villa (10623) */
...
VALUES (10623, 148, 10623, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10623, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10623, 8, 100671886) /* ICON_DID */
     , (10623, 1, 33557058) /* SETUP_DID */
     , (10623, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10623, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (10623, 13, True) /* ETHEREAL_BOOL */
     , (10623, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (10623, 71, True) /* NODRAW_BOOL */
     , (10623, 19, True) /* ATTACKABLE_BOOL */
     , (10623, 1, True) /* STUCK_BOOL */
