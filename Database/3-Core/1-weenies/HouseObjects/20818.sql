/* Weenie - HouseObjects - Villa (20818) */
...
VALUES (20818, 148, 20818, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20818, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20818, 8, 100671886) /* ICON_DID */
     , (20818, 1, 33557058) /* SETUP_DID */
     , (20818, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20818, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (20818, 13, True) /* ETHEREAL_BOOL */
     , (20818, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (20818, 71, True) /* NODRAW_BOOL */
     , (20818, 19, True) /* ATTACKABLE_BOOL */
     , (20818, 1, True) /* STUCK_BOOL */
