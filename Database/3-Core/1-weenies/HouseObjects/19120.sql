/* Weenie - HouseObjects - Villa (19120) */
...
VALUES (19120, 148, 19120, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (19120, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (19120, 8, 100671886) /* ICON_DID */
     , (19120, 1, 33557058) /* SETUP_DID */
     , (19120, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (19120, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (19120, 13, True) /* ETHEREAL_BOOL */
     , (19120, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (19120, 71, True) /* NODRAW_BOOL */
     , (19120, 19, True) /* ATTACKABLE_BOOL */
     , (19120, 1, True) /* STUCK_BOOL */
