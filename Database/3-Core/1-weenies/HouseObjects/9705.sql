/* Weenie - HouseObjects - Cottage (9705) */
...
VALUES (9705, 148, 9705, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9705, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9705, 8, 100671873) /* ICON_DID */
     , (9705, 1, 33557058) /* SETUP_DID */
     , (9705, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9705, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9705, 13, True) /* ETHEREAL_BOOL */
     , (9705, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9705, 71, True) /* NODRAW_BOOL */
     , (9705, 19, True) /* ATTACKABLE_BOOL */
     , (9705, 1, True) /* STUCK_BOOL */
