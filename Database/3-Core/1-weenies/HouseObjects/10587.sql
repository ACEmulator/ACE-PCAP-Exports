/* Weenie - HouseObjects - Villa (10587) */
...
VALUES (10587, 148, 10587, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10587, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10587, 8, 100671886) /* ICON_DID */
     , (10587, 1, 33557058) /* SETUP_DID */
     , (10587, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10587, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (10587, 13, True) /* ETHEREAL_BOOL */
     , (10587, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (10587, 71, True) /* NODRAW_BOOL */
     , (10587, 19, True) /* ATTACKABLE_BOOL */
     , (10587, 1, True) /* STUCK_BOOL */
