/* Weenie - HouseObjects - Cottage (9980) */
...
VALUES (9980, 148, 9980, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9980, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9980, 8, 100671873) /* ICON_DID */
     , (9980, 1, 33557058) /* SETUP_DID */
     , (9980, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9980, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9980, 13, True) /* ETHEREAL_BOOL */
     , (9980, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9980, 71, True) /* NODRAW_BOOL */
     , (9980, 19, True) /* ATTACKABLE_BOOL */
     , (9980, 1, True) /* STUCK_BOOL */
