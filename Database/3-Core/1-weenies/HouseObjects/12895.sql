/* Weenie - HouseObjects - Cottage (12895) */
...
VALUES (12895, 148, 12895, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (12895, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (12895, 8, 100671873) /* ICON_DID */
     , (12895, 1, 33557058) /* SETUP_DID */
     , (12895, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (12895, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (12895, 13, True) /* ETHEREAL_BOOL */
     , (12895, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (12895, 71, True) /* NODRAW_BOOL */
     , (12895, 19, True) /* ATTACKABLE_BOOL */
     , (12895, 1, True) /* STUCK_BOOL */
