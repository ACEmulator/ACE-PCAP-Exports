/* Weenie - HouseObjects - Villa (14128) */
...
VALUES (14128, 148, 14128, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14128, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14128, 8, 100671886) /* ICON_DID */
     , (14128, 1, 33557058) /* SETUP_DID */
     , (14128, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14128, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (14128, 13, True) /* ETHEREAL_BOOL */
     , (14128, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (14128, 71, True) /* NODRAW_BOOL */
     , (14128, 19, True) /* ATTACKABLE_BOOL */
     , (14128, 1, True) /* STUCK_BOOL */
