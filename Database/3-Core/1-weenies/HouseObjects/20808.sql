/* Weenie - HouseObjects - Villa (20808) */
...
VALUES (20808, 148, 20808, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20808, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20808, 8, 100671886) /* ICON_DID */
     , (20808, 1, 33557058) /* SETUP_DID */
     , (20808, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20808, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (20808, 13, True) /* ETHEREAL_BOOL */
     , (20808, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (20808, 71, True) /* NODRAW_BOOL */
     , (20808, 19, True) /* ATTACKABLE_BOOL */
     , (20808, 1, True) /* STUCK_BOOL */
