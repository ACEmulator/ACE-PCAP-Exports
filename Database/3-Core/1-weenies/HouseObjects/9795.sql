/* Weenie - HouseObjects - Cottage (9795) */
...
VALUES (9795, 148, 9795, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9795, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9795, 8, 100671873) /* ICON_DID */
     , (9795, 1, 33557058) /* SETUP_DID */
     , (9795, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9795, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9795, 13, True) /* ETHEREAL_BOOL */
     , (9795, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9795, 71, True) /* NODRAW_BOOL */
     , (9795, 19, True) /* ATTACKABLE_BOOL */
     , (9795, 1, True) /* STUCK_BOOL */
