/* Weenie - HouseObjects - Villa (20812) */
...
VALUES (20812, 148, 20812, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (20812, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (20812, 8, 100671886) /* ICON_DID */
     , (20812, 1, 33557058) /* SETUP_DID */
     , (20812, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (20812, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (20812, 13, True) /* ETHEREAL_BOOL */
     , (20812, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (20812, 71, True) /* NODRAW_BOOL */
     , (20812, 19, True) /* ATTACKABLE_BOOL */
     , (20812, 1, True) /* STUCK_BOOL */
