/* Weenie - HouseObjects - Cottage (9743) */
...
VALUES (9743, 148, 9743, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9743, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9743, 8, 100671873) /* ICON_DID */
     , (9743, 1, 33557058) /* SETUP_DID */
     , (9743, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9743, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9743, 13, True) /* ETHEREAL_BOOL */
     , (9743, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9743, 71, True) /* NODRAW_BOOL */
     , (9743, 19, True) /* ATTACKABLE_BOOL */
     , (9743, 1, True) /* STUCK_BOOL */
