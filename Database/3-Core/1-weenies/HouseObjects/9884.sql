/* Weenie - HouseObjects - Cottage (9884) */
...
VALUES (9884, 148, 9884, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9884, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9884, 8, 100671873) /* ICON_DID */
     , (9884, 1, 33557058) /* SETUP_DID */
     , (9884, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9884, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9884, 13, True) /* ETHEREAL_BOOL */
     , (9884, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9884, 71, True) /* NODRAW_BOOL */
     , (9884, 19, True) /* ATTACKABLE_BOOL */
     , (9884, 1, True) /* STUCK_BOOL */
