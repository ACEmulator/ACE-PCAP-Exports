/* Weenie - HouseObjects - Cottage (9761) */
...
VALUES (9761, 148, 9761, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9761, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9761, 8, 100671873) /* ICON_DID */
     , (9761, 1, 33557058) /* SETUP_DID */
     , (9761, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9761, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9761, 13, True) /* ETHEREAL_BOOL */
     , (9761, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9761, 71, True) /* NODRAW_BOOL */
     , (9761, 19, True) /* ATTACKABLE_BOOL */
     , (9761, 1, True) /* STUCK_BOOL */
