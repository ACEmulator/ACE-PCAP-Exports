/* Weenie - HouseObjects - Villa (15657) */
...
VALUES (15657, 148, 15657, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (15657, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (15657, 8, 100671886) /* ICON_DID */
     , (15657, 1, 33557058) /* SETUP_DID */
     , (15657, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (15657, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (15657, 13, True) /* ETHEREAL_BOOL */
     , (15657, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (15657, 71, True) /* NODRAW_BOOL */
     , (15657, 19, True) /* ATTACKABLE_BOOL */
     , (15657, 1, True) /* STUCK_BOOL */
