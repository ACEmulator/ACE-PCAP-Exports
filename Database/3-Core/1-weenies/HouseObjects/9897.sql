/* Weenie - HouseObjects - Cottage (9897) */
...
VALUES (9897, 148, 9897, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9897, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9897, 8, 100671873) /* ICON_DID */
     , (9897, 1, 33557058) /* SETUP_DID */
     , (9897, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9897, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9897, 13, True) /* ETHEREAL_BOOL */
     , (9897, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9897, 71, True) /* NODRAW_BOOL */
     , (9897, 19, True) /* ATTACKABLE_BOOL */
     , (9897, 1, True) /* STUCK_BOOL */
