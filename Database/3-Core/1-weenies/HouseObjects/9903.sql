/* Weenie - HouseObjects - Cottage (9903) */
...
VALUES (9903, 148, 9903, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9903, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9903, 8, 100671873) /* ICON_DID */
     , (9903, 1, 33557058) /* SETUP_DID */
     , (9903, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9903, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9903, 13, True) /* ETHEREAL_BOOL */
     , (9903, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9903, 71, True) /* NODRAW_BOOL */
     , (9903, 19, True) /* ATTACKABLE_BOOL */
     , (9903, 1, True) /* STUCK_BOOL */
