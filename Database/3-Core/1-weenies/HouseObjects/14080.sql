/* Weenie - HouseObjects - Villa (14080) */
...
VALUES (14080, 148, 14080, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14080, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14080, 8, 100671886) /* ICON_DID */
     , (14080, 1, 33557058) /* SETUP_DID */
     , (14080, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14080, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (14080, 13, True) /* ETHEREAL_BOOL */
     , (14080, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (14080, 71, True) /* NODRAW_BOOL */
     , (14080, 19, True) /* ATTACKABLE_BOOL */
     , (14080, 1, True) /* STUCK_BOOL */
