/* Weenie - HouseObjects - Cottage (9813) */
...
VALUES (9813, 148, 9813, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9813, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9813, 8, 100671873) /* ICON_DID */
     , (9813, 1, 33557058) /* SETUP_DID */
     , (9813, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9813, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9813, 13, True) /* ETHEREAL_BOOL */
     , (9813, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9813, 71, True) /* NODRAW_BOOL */
     , (9813, 19, True) /* ATTACKABLE_BOOL */
     , (9813, 1, True) /* STUCK_BOOL */
