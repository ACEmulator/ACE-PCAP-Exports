/* Weenie - HouseObjects - Villa (14217) */
...
VALUES (14217, 148, 14217, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (14217, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (14217, 8, 100671886) /* ICON_DID */
     , (14217, 1, 33557058) /* SETUP_DID */
     , (14217, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (14217, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (14217, 13, True) /* ETHEREAL_BOOL */
     , (14217, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (14217, 71, True) /* NODRAW_BOOL */
     , (14217, 19, True) /* ATTACKABLE_BOOL */
     , (14217, 1, True) /* STUCK_BOOL */
