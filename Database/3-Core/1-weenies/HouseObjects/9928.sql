/* Weenie - HouseObjects - Cottage (9928) */
...
VALUES (9928, 148, 9928, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9928, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9928, 8, 100671873) /* ICON_DID */
     , (9928, 1, 33557058) /* SETUP_DID */
     , (9928, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9928, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9928, 13, True) /* ETHEREAL_BOOL */
     , (9928, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9928, 71, True) /* NODRAW_BOOL */
     , (9928, 19, True) /* ATTACKABLE_BOOL */
     , (9928, 1, True) /* STUCK_BOOL */
