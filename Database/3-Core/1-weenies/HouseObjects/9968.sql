/* Weenie - HouseObjects - Cottage (9968) */
...
VALUES (9968, 148, 9968, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9968, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9968, 8, 100671873) /* ICON_DID */
     , (9968, 1, 33557058) /* SETUP_DID */
     , (9968, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9968, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9968, 13, True) /* ETHEREAL_BOOL */
     , (9968, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9968, 71, True) /* NODRAW_BOOL */
     , (9968, 19, True) /* ATTACKABLE_BOOL */
     , (9968, 1, True) /* STUCK_BOOL */
