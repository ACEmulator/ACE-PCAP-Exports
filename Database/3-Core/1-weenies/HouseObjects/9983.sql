/* Weenie - HouseObjects - Cottage (9983) */
...
VALUES (9983, 148, 9983, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9983, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9983, 8, 100671873) /* ICON_DID */
     , (9983, 1, 33557058) /* SETUP_DID */
     , (9983, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9983, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9983, 13, True) /* ETHEREAL_BOOL */
     , (9983, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9983, 71, True) /* NODRAW_BOOL */
     , (9983, 19, True) /* ATTACKABLE_BOOL */
     , (9983, 1, True) /* STUCK_BOOL */
