/* Weenie - HouseObjects - Villa (10629) */
...
VALUES (10629, 148, 10629, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (10629, 1, 'Villa') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (10629, 8, 100671886) /* ICON_DID */
     , (10629, 1, 33557058) /* SETUP_DID */
     , (10629, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (10629, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (10629, 13, True) /* ETHEREAL_BOOL */
     , (10629, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (10629, 71, True) /* NODRAW_BOOL */
     , (10629, 19, True) /* ATTACKABLE_BOOL */
     , (10629, 1, True) /* STUCK_BOOL */
