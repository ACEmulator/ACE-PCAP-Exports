/* Weenie - HouseObjects - Cottage (9879) */
...
VALUES (9879, 148, 9879, 236978192, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9879, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9879, 8, 100671873) /* ICON_DID */
     , (9879, 1, 33557058) /* SETUP_DID */
     , (9879, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9879, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9879, 13, True) /* ETHEREAL_BOOL */
     , (9879, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9879, 71, True) /* NODRAW_BOOL */
     , (9879, 19, True) /* ATTACKABLE_BOOL */
     , (9879, 1, True) /* STUCK_BOOL */
