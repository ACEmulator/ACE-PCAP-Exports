/* Weenie - HouseObjects - Cottage (9806) */
...
VALUES (9806, 148, 9806, 203423760, NULL, NULL, 163969);

INSERT INTO `ace_object_properties_string` (`aceObjectId`, `strPropertyId`, `propertyValue`)
VALUES (9806, 1, 'Cottage') /* NAME_STRING */;

INSERT INTO `ace_object_properties_did` (`aceObjectId`, `didPropertyId`, `propertyValue`)
VALUES (9806, 8, 100671873) /* ICON_DID */
     , (9806, 1, 33557058) /* SETUP_DID */
     , (9806, 30, 152) /* PHYSICS_SCRIPT_DID */;

INSERT INTO `ace_object_properties_int` (`aceObjectId`, `intPropertyId`, `propertyValue`)
VALUES (9806, 53, 101) /* PLACEMENT_POSITION_INT */
...
VALUES (9806, 13, True) /* ETHEREAL_BOOL */
     , (9806, 11, True) /* IGNORE_COLLISIONS_BOOL */
     , (9806, 71, True) /* NODRAW_BOOL */
     , (9806, 19, True) /* ATTACKABLE_BOOL */
     , (9806, 1, True) /* STUCK_BOOL */
