...
VALUES (2880146265, 'Shard Vigil Memorial', 8192, 0, 0, 8, 276, 10000, 0, 0, 0, 0, 0, 11534384, 0, 100671330, 0, 0, 0, 0, 0, 0, 0, 0, 4, 0, 0, 0, 0, 0, 48, 5, 0, 0, 0, 0, 0, 0, 0, 0, 0, 33556953, 0, 32769, 0, 0, 0, 1048, 0, '0');

INSERT INTO `ace_object` (`baseAceObjectId`, `weenieClassId`, `landblock`, `cell`, `posX`, `posY`, `posZ`, `qW`, `qX`, `qY`, `qZ`)
VALUES (2880146265, 9002, 62488, 13, 36, 108, 160, 1, 0, 0, 0);
